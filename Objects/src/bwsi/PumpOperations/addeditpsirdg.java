...
anywheresoftware.b4a.keywords.Common.LogImpl("070844419",("Permission to Read External Storage GRANTED"),anywheresoftware.b4a.keywords.Common.Colors.Yellow);
...
anywheresoftware.b4a.keywords.Common.LogImpl("070844422",("Permission to Write External Storage GRANTED"),anywheresoftware.b4a.keywords.Common.Colors.White);
...
anywheresoftware.b4a.keywords.Common.LogImpl("070844425",("Permission to Access Coarse Location GRANTED"),anywheresoftware.b4a.keywords.Common.Colors.Magenta);
...
anywheresoftware.b4a.keywords.Common.LogImpl("070844428",("Permission to Access Fine Location GRANTED"),anywheresoftware.b4a.keywords.Common.Colors.Cyan);
...
anywheresoftware.b4a.keywords.Common.LogImpl("070844439",_permission,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("071303215",("Reading Time: ")+mostCurrent._srdgtime,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
...
anywheresoftware.b4a.keywords.Common.LogImpl("070778881","Checking Permissions",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("071696416",_ampm,anywheresoftware.b4a.keywords.Common.Colors.Cyan);
...
anywheresoftware.b4a.keywords.Common.LogImpl("071696448",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("071696452",parent.mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Magenta);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("071696459",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("072024072",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("072089622",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("071630869",("FLP is COnnected? ")+BA.ObjectToString(mostCurrent._starter._flp /*uk.co.martinpearman.b4a.fusedlocationprovider.FusedLocationProviderWrapper*/ .IsConnected()),0);
 //BA.debugLineNum = 308;BA.debugLine="LogColor($\"Latitude: \"$ & GlobalVar.Lat, Colors.M";
anywheresoftware.b4a.keywords.Common.LogImpl("071630871",("Latitude: ")+mostCurrent._globalvar._lat /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Magenta);
 //BA.debugLineNum = 309;BA.debugLine="LogColor($\"Longitude: \"$ & GlobalVar.Lon, Colors.";
anywheresoftware.b4a.keywords.Common.LogImpl("071630872",("Longitude: ")+mostCurrent._globalvar._lon /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Cyan);
...
anywheresoftware.b4a.keywords.Common.LogImpl("071630875",("Location is ")+_slocation,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
...
anywheresoftware.b4a.keywords.Common.LogImpl("071630884",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("072417286",("Header ID: ")+BA.NumberToString(mostCurrent._globalvar._tranheaderid /*int*/ ),anywheresoftware.b4a.keywords.Common.Colors.Cyan);
...
anywheresoftware.b4a.keywords.Common.LogImpl("071827478",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("071761940",("FLP is COnnected? ")+BA.ObjectToString(mostCurrent._starter._flp /*uk.co.martinpearman.b4a.fusedlocationprovider.FusedLocationProviderWrapper*/ .IsConnected()),0);
 //BA.debugLineNum = 433;BA.debugLine="LogColor($\"Latitude: \"$ & GlobalVar.Lat, Colors.M";
anywheresoftware.b4a.keywords.Common.LogImpl("071761942",("Latitude: ")+mostCurrent._globalvar._lat /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Magenta);
 //BA.debugLineNum = 434;BA.debugLine="LogColor($\"Longitude: \"$ & GlobalVar.Lon, Colors.";
anywheresoftware.b4a.keywords.Common.LogImpl("071761943",("Longitude: ")+mostCurrent._globalvar._lon /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Cyan);
...
anywheresoftware.b4a.keywords.Common.LogImpl("071761946",("Location is ")+_slocation,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
...
anywheresoftware.b4a.keywords.Common.LogImpl("071761959",mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
...
anywheresoftware.b4a.keywords.Common.LogImpl("071761965",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("071893022",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
