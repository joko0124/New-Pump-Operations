...
anywheresoftware.b4a.keywords.Common.LogImpl("1118423553","Message arrived",0);
 //BA.debugLineNum = 40;BA.debugLine="Log($\"Message data: ${Message.GetData}\"$)";
anywheresoftware.b4a.keywords.Common.LogImpl("1118423554",("Message data: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_message.GetData().getObject()))+""),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("1118423592",("Token: ")+_fm.getToken(),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("1118489089","TokenRefresh: "+_token,0);
