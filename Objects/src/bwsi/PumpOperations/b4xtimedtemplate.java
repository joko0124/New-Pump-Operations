...
public class b4xtimedtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "bwsi.PumpOperations.b4xtimedtemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", bwsi.PumpOperations.b4xtimedtemplate.class).invoke(this, new Object[] {null});
        else
...
public bwsi.PumpOperations.anotherprogressbar _anotherprogressbar1 = null;
...
_anotherprogressbar1 = new bwsi.PumpOperations.anotherprogressbar();
...
public ResumableSub_Show(bwsi.PumpOperations.b4xtimedtemplate parent,bwsi.PumpOperations.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
bwsi.PumpOperations.b4xtimedtemplate parent;
