...
public class b4xfloattextfield extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "bwsi.PumpOperations.b4xfloattextfield");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", bwsi.PumpOperations.b4xfloattextfield.class).invoke(this, new Object[] {null});
        else
...
public bwsi.PumpOperations.b4xfloattextfield _mnexttextfield = null;
...
_mnexttextfield = new bwsi.PumpOperations.b4xfloattextfield();
...
__c.LogImpl("9106758168","Multiline not supported with password mode.",0);
 };
...
public bwsi.PumpOperations.b4xfloattextfield  _getnextfield() throws Exception{
...
if (_mnexttextfield.IsInitialized /*boolean*/ ()==__c.False || (_mnexttextfield).equals((bwsi.PumpOperations.b4xfloattextfield)(this))) { 
...
public String  _setnextfield(bwsi.PumpOperations.b4xfloattextfield _field) throws Exception{
...
if ((_field).equals((bwsi.PumpOperations.b4xfloattextfield)(this)) == false) { 
...
_mnexttextfield = (bwsi.PumpOperations.b4xfloattextfield)(_o);
...
if (_mnexttextfield.IsInitialized /*boolean*/ () && (_mnexttextfield).equals((bwsi.PumpOperations.b4xfloattextfield)(this)) == false) { 
