...
public class b4xdialog extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "bwsi.PumpOperations.b4xdialog");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", bwsi.PumpOperations.b4xdialog.class).invoke(this, new Object[] {null});
        else
...
__c.LogImpl("9105644068","Time: "+BA.NumberToString((__c.DateTime.getNow()-_n)),0);
...
public ResumableSub_Show(bwsi.PumpOperations.b4xdialog parent,Object _text,Object _yes,Object _no,Object _cancel) {
this.parent = parent;
this._text = _text;
this._yes = _yes;
this._no = _no;
...
bwsi.PumpOperations.b4xdialog parent;
Object _text;
Object _yes;
Object _no;
Object _cancel;
...
public ResumableSub_ShowCustom(bwsi.PumpOperations.b4xdialog parent,anywheresoftware.b4a.objects.B4XViewWrapper _content,Object _yes,Object _no,Object _cancel) {
this.parent = parent;
...
public ResumableSub_ShowTemplate(bwsi.PumpOperations.b4xdialog parent,Object _dialogtemplate,Object _yes,Object _no,Object _cancel) {
this.parent = parent;
