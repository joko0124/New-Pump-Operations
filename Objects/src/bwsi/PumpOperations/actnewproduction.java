...
public static String  _btnaddchlorine_click() throws Exception{
 //BA.debugLineNum = 1059;BA.debugLine="Sub btnAddChlorine_Click";
 //BA.debugLineNum = 1060;BA.debugLine="GlobalVar.blnNewChlorine = True";
mostCurrent._globalvar._blnnewchlorine /*boolean*/  = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 1061;BA.debugLine="StartActivity(AddEditChlorineRecord)";
...
public static String  _btnaddconcerns_click() throws Exception{
 //BA.debugLineNum = 1068;BA.debugLine="Sub btnAddConcerns_Click";
 //BA.debugLineNum = 1069;BA.debugLine="GlobalVar.blnNewProblem = True";
mostCurrent._globalvar._blnnewproblem /*boolean*/  = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 1070;BA.debugLine="StartActivity(AddEditProblem)";
...
public static String  _btnaddfm_click() throws Exception{
 //BA.debugLineNum = 624;BA.debugLine="Sub btnAddFM_Click";
 //BA.debugLineNum = 625;BA.debugLine="GlobalVar.blnNewFMRdg = True";
mostCurrent._globalvar._blnnewfmrdg /*boolean*/  = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 626;BA.debugLine="StartActivity(AddEditFMRdg)";
...
public static String  _btnaddpsi_click() throws Exception{
 //BA.debugLineNum = 884;BA.debugLine="Sub btnAddPSI_Click";
 //BA.debugLineNum = 885;BA.debugLine="GlobalVar.blnNewPSIRdg = True";
mostCurrent._globalvar._blnnewpsirdg /*boolean*/  = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 886;BA.debugLine="StartActivity(AddEditPSIRdg)";
...
public static String  _btnaddtime_click() throws Exception{
 //BA.debugLineNum = 439;BA.debugLine="Sub btnAddTime_Click";
 //BA.debugLineNum = 440;BA.debugLine="GlobalVar.blnNewTime = True";
mostCurrent._globalvar._blnnewtime /*boolean*/  = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 441;BA.debugLine="If DBaseFunctions.GetPumpPowerStatus(GlobalVar.Pu";
if (mostCurrent._dbasefunctions._getpumppowerstatus /*int*/ (mostCurrent.activityBA,mostCurrent._globalvar._pumphouseid /*int*/ )==1) { 
 //BA.debugLineNum = 442;BA.debugLine="GlobalVar.TimeDetailID = DBaseFunctions.GetLastT";
mostCurrent._globalvar._timedetailid /*int*/  = mostCurrent._dbasefunctions._getlasttimeonid /*int*/ (mostCurrent.activityBA,mostCurrent._globalvar._trandate /*String*/ ,mostCurrent._globalvar._pumphouseid /*int*/ );
 //BA.debugLineNum = 443;BA.debugLine="blnAddTime = True";
_blnaddtime = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 444;BA.debugLine="ConfirmPumpOff";
_confirmpumpoff();
 }else {
 //BA.debugLineNum = 446;BA.debugLine="blnAddTime = False";
_blnaddtime = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 447;BA.debugLine="StartActivity(AddEditTimeRecord)";
...
bwsi.PumpOperations.actnewproduction._chlorinerecords _rec = null;
 //BA.debugLineNum = 989;BA.debugLine="Sub clvChlorine_ItemClick (Index As Int, Value As";
 //BA.debugLineNum = 990;BA.debugLine="Dim Rec As ChlorineRecords = Value";
_rec = (bwsi.PumpOperations.actnewproduction._chlorinerecords)(_value);
 //BA.debugLineNum = 991;BA.debugLine="Log(Rec.ID)";
anywheresoftware.b4a.keywords.Common.LogImpl("79437186",BA.NumberToString(_rec.ID /*int*/ ),0);
 //BA.debugLineNum = 992;BA.debugLine="ShowChlorinatorRecDetails(Rec.ID)";
_showchlorinatorrecdetails(_rec.ID /*int*/ );
 //BA.debugLineNum = 993;BA.debugLine="GlobalVar.ChlorineDetailID = Rec.ID";
...
bwsi.PumpOperations.actnewproduction._chlorinerecords _cr = null;
 //BA.debugLineNum = 964;BA.debugLine="Sub clvChlorine_VisibleRangeChanged (FirstIndex As";
 //BA.debugLineNum = 965;BA.debugLine="Dim ExtraSize As Int = 15 'List size";
_extrasize = (int) (15);
 //BA.debugLineNum = 966;BA.debugLine="For i = Max(0, FirstIndex - ExtraSize) To Min(Las";
{
final int step2 = 1;
...
for (;_i <= limit2 ;_i = _i + step2 ) {
 //BA.debugLineNum = 967;BA.debugLine="Dim Pnl As B4XView = clvChlorine.GetPanel(i)";
_pnl = new anywheresoftware.b4a.objects.B4XViewWrapper();
_pnl = mostCurrent._clvchlorine._getpanel(_i);
 //BA.debugLineNum = 968;BA.debugLine="If i > FirstIndex - ExtraSize And i < LastIndex";
if (_i>_firstindex-_extrasize && _i<_lastindex+_extrasize) { 
 //BA.debugLineNum = 969;BA.debugLine="If Pnl.NumberOfViews = 0 Then 'Add each item/la";
if (_pnl.getNumberOfViews()==0) { 
 //BA.debugLineNum = 970;BA.debugLine="Dim CR As ChlorineRecords = clvChlorine.GetVal";
_cr = (bwsi.PumpOperations.actnewproduction._chlorinerecords)(mostCurrent._clvchlorine._getvalue(_i));
 //BA.debugLineNum = 971;BA.debugLine="Pnl.LoadLayout(\"ListChlorinatorRecords\")";
_pnl.LoadLayout("ListChlorinatorRecords",mostCurrent.activityBA);
 //BA.debugLineNum = 972;BA.debugLine="lblTimeRep.TextColor = GlobalVar.PriColor";
mostCurrent._lbltimerep.setTextColor((int) (mostCurrent._globalvar._pricolor /*double*/ ));
 //BA.debugLineNum = 973;BA.debugLine="lblChlorineType.TextColor = GlobalVar.PriColor";
mostCurrent._lblchlorinetype.setTextColor((int) (mostCurrent._globalvar._pricolor /*double*/ ));
 //BA.debugLineNum = 974;BA.debugLine="lblVolume.TextColor = GlobalVar.PriColor";
mostCurrent._lblvolume.setTextColor((int) (mostCurrent._globalvar._pricolor /*double*/ ));
 //BA.debugLineNum = 976;BA.debugLine="lblTimeRep.Text = CR.sTimeRep";
mostCurrent._lbltimerep.setText(BA.ObjectToCharSequence(_cr.sTimeRep /*String*/ ));
 //BA.debugLineNum = 977;BA.debugLine="lblChlorineType.Text = CR.sChlorineType";
mostCurrent._lblchlorinetype.setText(BA.ObjectToCharSequence(_cr.sChlorineType /*String*/ ));
 //BA.debugLineNum = 978;BA.debugLine="lblVolume.Text = CR.iVolume & $\" \"$ & sUnit &";
mostCurrent._lblvolume.setText(BA.ObjectToCharSequence(BA.NumberToString(_cr.iVolume /*int*/ )+(" ")+mostCurrent._sunit+("(s)")));
 };
 }else {
 //BA.debugLineNum = 981;BA.debugLine="If Pnl.NumberOfViews > 0 Then";
if (_pnl.getNumberOfViews()>0) { 
 //BA.debugLineNum = 982;BA.debugLine="Pnl.RemoveAllViews 'Remove none visable item/l";
_pnl.RemoveAllViews();
 };
 };
 }
...
bwsi.PumpOperations.actnewproduction._concernsrecords _rec = null;
 //BA.debugLineNum = 1139;BA.debugLine="Sub clvConcerns_ItemClick (Index As Int, Value As";
 //BA.debugLineNum = 1140;BA.debugLine="Dim Rec As ConcernsRecords = Value";
_rec = (bwsi.PumpOperations.actnewproduction._concernsrecords)(_value);
 //BA.debugLineNum = 1141;BA.debugLine="Log(Rec.ID)";
anywheresoftware.b4a.keywords.Common.LogImpl("79895938",BA.NumberToString(_rec.ID /*int*/ ),0);
 //BA.debugLineNum = 1142;BA.debugLine="GlobalVar.ProblemDetailID = Rec.ID";
mostCurrent._globalvar._problemdetailid /*int*/  = _rec.ID /*int*/ ;
 //BA.debugLineNum = 1143;BA.debugLine="ShowProblemRecDetails(GlobalVar.ProblemDetailID)";
...
bwsi.PumpOperations.actnewproduction._concernsrecords _concernrec = null;
 //BA.debugLineNum = 1116;BA.debugLine="Sub clvConcerns_VisibleRangeChanged (FirstIndex As";
 //BA.debugLineNum = 1117;BA.debugLine="Dim ExtraSize As Int = 15 'List size";
_extrasize = (int) (15);
 //BA.debugLineNum = 1118;BA.debugLine="For i = Max(0, FirstIndex - ExtraSize) To Min(Las";
{
final int step2 = 1;
final int limit2 = (int) (anywheresoftware.b4a.keywords.Common.Min(_lastindex+_extrasize,mostCurrent._clvconcerns._getsize()-1));
_i = (int) (anywheresoftware.b4a.keywords.Common.Max(0,_firstindex-_extrasize)) ;
for (;_i <= limit2 ;_i = _i + step2 ) {
 //BA.debugLineNum = 1119;BA.debugLine="Dim Pnl As B4XView = clvConcerns.GetPanel(i)";
_pnl = new anywheresoftware.b4a.objects.B4XViewWrapper();
_pnl = mostCurrent._clvconcerns._getpanel(_i);
 //BA.debugLineNum = 1120;BA.debugLine="If i > FirstIndex - ExtraSize And i < LastIndex";
if (_i>_firstindex-_extrasize && _i<_lastindex+_extrasize) { 
 //BA.debugLineNum = 1121;BA.debugLine="If Pnl.NumberOfViews = 0 Then 'Add each item/la";
if (_pnl.getNumberOfViews()==0) { 
 //BA.debugLineNum = 1122;BA.debugLine="Dim ConcernRec As ConcernsRecords = clvConcern";
_concernrec = (bwsi.PumpOperations.actnewproduction._concernsrecords)(mostCurrent._clvconcerns._getvalue(_i));
 //BA.debugLineNum = 1123;BA.debugLine="Pnl.LoadLayout(\"ListProblemsRecords\")";
_pnl.LoadLayout("ListProblemsRecords",mostCurrent.activityBA);
 //BA.debugLineNum = 1124;BA.debugLine="lblTimeEnc.TextColor = GlobalVar.PriColor";
mostCurrent._lbltimeenc.setTextColor((int) (mostCurrent._globalvar._pricolor /*double*/ ));
 //BA.debugLineNum = 1125;BA.debugLine="lblProblems.TextColor = GlobalVar.PriColor";
mostCurrent._lblproblems.setTextColor((int) (mostCurrent._globalvar._pricolor /*double*/ ));
 //BA.debugLineNum = 1127;BA.debugLine="lblTimeEnc.Text = ConcernRec.sTimeEnc";
mostCurrent._lbltimeenc.setText(BA.ObjectToCharSequence(_concernrec.sTimeEnc /*String*/ ));
 //BA.debugLineNum = 1128;BA.debugLine="lblProblems.Text = ConcernRec.sProblem";
mostCurrent._lblproblems.setText(BA.ObjectToCharSequence(_concernrec.sProblem /*String*/ ));
 };
 }else {
 //BA.debugLineNum = 1131;BA.debugLine="If Pnl.NumberOfViews > 0 Then";
if (_pnl.getNumberOfViews()>0) { 
 //BA.debugLineNum = 1132;BA.debugLine="Pnl.RemoveAllViews 'Remove none visable item/l";
_pnl.RemoveAllViews();
 };
 };
 }
...
bwsi.PumpOperations.actnewproduction._fmrecords _rec = null;
 //BA.debugLineNum = 629;BA.debugLine="Sub clvFM_ItemClick (Index As Int, Value As Object";
 //BA.debugLineNum = 630;BA.debugLine="Dim Rec As FMRecords = Value";
_rec = (bwsi.PumpOperations.actnewproduction._fmrecords)(_value);
 //BA.debugLineNum = 631;BA.debugLine="Log(Rec.ID)";
anywheresoftware.b4a.keywords.Common.LogImpl("78519682",BA.NumberToString(_rec.ID /*int*/ ),0);
 //BA.debugLineNum = 632;BA.debugLine="ShowFMRdgRecDetails(Rec.ID)";
...
bwsi.PumpOperations.actnewproduction._fmrecords _fmrec = null;
 //BA.debugLineNum = 553;BA.debugLine="Sub clvFM_VisibleRangeChanged (FirstIndex As Int,";
 //BA.debugLineNum = 554;BA.debugLine="Dim ExtraSize As Int = 15 'List size";
_extrasize = (int) (15);
 //BA.debugLineNum = 556;BA.debugLine="Dim Matcher1 As Matcher";
_matcher1 = new anywheresoftware.b4a.keywords.Regex.MatcherWrapper();
 //BA.debugLineNum = 557;BA.debugLine="Dim sMin As String";
_smin = "";
 //BA.debugLineNum = 560;BA.debugLine="For i = Max(0, FirstIndex - ExtraSize) To Min(Las";
{
final int step4 = 1;
final int limit4 = (int) (anywheresoftware.b4a.keywords.Common.Min(_lastindex+_extrasize,mostCurrent._clvfm._getsize()-1));
_i = (int) (anywheresoftware.b4a.keywords.Common.Max(0,_firstindex-_extrasize)) ;
for (;_i <= limit4 ;_i = _i + step4 ) {
 //BA.debugLineNum = 561;BA.debugLine="Dim Pnl As B4XView = clvFM.GetPanel(i)";
_pnl = new anywheresoftware.b4a.objects.B4XViewWrapper();
_pnl = mostCurrent._clvfm._getpanel(_i);
 //BA.debugLineNum = 562;BA.debugLine="If i > FirstIndex - ExtraSize And i < LastIndex";
if (_i>_firstindex-_extrasize && _i<_lastindex+_extrasize) { 
 //BA.debugLineNum = 563;BA.debugLine="If Pnl.NumberOfViews = 0 Then 'Add each item/la";
if (_pnl.getNumberOfViews()==0) { 
 //BA.debugLineNum = 564;BA.debugLine="Dim FMRec As FMRecords = clvFM.GetValue(i)";
_fmrec = (bwsi.PumpOperations.actnewproduction._fmrecords)(mostCurrent._clvfm._getvalue(_i));
 //BA.debugLineNum = 565;BA.debugLine="Pnl.LoadLayout(\"ListFMRdg\")";
_pnl.LoadLayout("ListFMRdg",mostCurrent.activityBA);
 //BA.debugLineNum = 566;BA.debugLine="If FMRec.iBackFlow >0 Then";
if (_fmrec.iBackFlow /*int*/ >0) { 
 //BA.debugLineNum = 567;BA.debugLine="lblRdgTime.TextColor = GlobalVar.RedColor";
mostCurrent._lblrdgtime.setTextColor((int) (mostCurrent._globalvar._redcolor /*double*/ ));
 //BA.debugLineNum = 568;BA.debugLine="lblPrevCuM.TextColor = GlobalVar.RedColor";
mostCurrent._lblprevcum.setTextColor((int) (mostCurrent._globalvar._redcolor /*double*/ ));
 //BA.debugLineNum = 569;BA.debugLine="lblPresCuM.TextColor = GlobalVar.RedColor";
mostCurrent._lblprescum.setTextColor((int) (mostCurrent._globalvar._redcolor /*double*/ ));
 //BA.debugLineNum = 570;BA.debugLine="lblTotProd.TextColor = GlobalVar.RedColor";
mostCurrent._lbltotprod.setTextColor((int) (mostCurrent._globalvar._redcolor /*double*/ ));
 }else {
 //BA.debugLineNum = 572;BA.debugLine="lblRdgTime.TextColor = GlobalVar.PriColor";
mostCurrent._lblrdgtime.setTextColor((int) (mostCurrent._globalvar._pricolor /*double*/ ));
 //BA.debugLineNum = 573;BA.debugLine="lblPrevCuM.TextColor = GlobalVar.PriColor";
mostCurrent._lblprevcum.setTextColor((int) (mostCurrent._globalvar._pricolor /*double*/ ));
 //BA.debugLineNum = 574;BA.debugLine="lblPresCuM.TextColor = GlobalVar.PriColor";
mostCurrent._lblprescum.setTextColor((int) (mostCurrent._globalvar._pricolor /*double*/ ));
 //BA.debugLineNum = 575;BA.debugLine="lblTotProd.TextColor = GlobalVar.PriColor";
mostCurrent._lbltotprod.setTextColor((int) (mostCurrent._globalvar._pricolor /*double*/ ));
 };
 //BA.debugLineNum = 610;BA.debugLine="lblRdgTime.Text = FMRec.sRdgTime";
mostCurrent._lblrdgtime.setText(BA.ObjectToCharSequence(_fmrec.sRdgTime /*String*/ ));
 //BA.debugLineNum = 611;BA.debugLine="lblPrevCuM.Text = FMRec.iPrevRdg";
mostCurrent._lblprevcum.setText(BA.ObjectToCharSequence(_fmrec.iPrevRdg /*int*/ ));
 //BA.debugLineNum = 612;BA.debugLine="lblPresCuM.Text = FMRec.iPresRdg";
mostCurrent._lblprescum.setText(BA.ObjectToCharSequence(_fmrec.iPresRdg /*int*/ ));
 //BA.debugLineNum = 613;BA.debugLine="lblTotProd.Text = NumberFormat(FMRec.iTotProd,";
mostCurrent._lbltotprod.setText(BA.ObjectToCharSequence(anywheresoftware.b4a.keywords.Common.NumberFormat(_fmrec.iTotProd /*int*/ ,(int) (0),(int) (0))+(" CuM")));
 ...
 //BA.debugLineNum = 616;BA.debugLine="If Pnl.NumberOfViews > 0 Then";
if (_pnl.getNumberOfViews()>0) { 
 //BA.debugLineNum = 617;BA.debugLine="Pnl.RemoveAllViews 'Remove none visable item/l";
_pnl.RemoveAllViews();
 };
 };
 }
...
bwsi.PumpOperations.actnewproduction._psirecords _rec = null;
 //BA.debugLineNum = 813;BA.debugLine="Sub clvPSI_ItemClick (Index As Int, Value As Objec";
 //BA.debugLineNum = 814;BA.debugLine="Dim Rec As PSIRecords = Value";
_rec = (bwsi.PumpOperations.actnewproduction._psirecords)(_value);
 //BA.debugLineNum = 815;BA.debugLine="Log(Rec.ID)";
anywheresoftware.b4a.keywords.Common.LogImpl("78978434",BA.NumberToString(_rec.ID /*int*/ ),0);
 //BA.debugLineNum = 816;BA.debugLine="ShowPSIRdgRecDetails(Rec.ID)";
_showpsirdgrecdetails(_rec.ID /*int*/ );
 //BA.debugLineNum = 817;BA.debugLine="GlobalVar.PSIRdgDetailID = Rec.ID";
...
bwsi.PumpOperations.actnewproduction._psirecords _psirec = null;
 //BA.debugLineNum = 790;BA.debugLine="Sub clvPSI_VisibleRangeChanged (FirstIndex As Int,";
 //BA.debugLineNum = 791;BA.debugLine="Dim ExtraSize As Int = 15 'List size";
_extrasize = (int) (15);
 //BA.debugLineNum = 792;BA.debugLine="For i = Max(0, FirstIndex - ExtraSize) To Min(Las";
{
final int step2 = 1;
final int limit2 = (int) (anywheresoftware.b4a.keywords.Common.Min(_lastindex+_extrasize,mostCurrent._clvpsi._getsize()-1));
_i = (int) (anywheresoftware.b4a.keywords.Common.Max(0,_firstindex-_extrasize)) ;
for (;_i <= limit2 ;_i = _i + step2 ) {
 //BA.debugLineNum = 793;BA.debugLine="Dim Pnl As B4XView = clvPSI.GetPanel(i)";
_pnl = new anywheresoftware.b4a.objects.B4XViewWrapper();
_pnl = mostCurrent._clvpsi._getpanel(_i);
 //BA.debugLineNum = 794;BA.debugLine="If i > FirstIndex - ExtraSize And i < LastIndex";
if (_i>_firstindex-_extrasize && _i<_lastindex+_extrasize) { 
 //BA.debugLineNum = 795;BA.debugLine="If Pnl.NumberOfViews = 0 Then 'Add each item/la";
if (_pnl.getNumberOfViews()==0) { 
 //BA.debugLineNum = 796;BA.debugLine="Dim PSIRec As PSIRecords = clvPSI.GetValue(i)";
_psirec = (bwsi.PumpOperations.actnewproduction._psirecords)(mostCurrent._clvpsi._getvalue(_i));
 //BA.debugLineNum = 797;BA.debugLine="Pnl.LoadLayout(\"ListPSIRecords\")";
_pnl.LoadLayout("ListPSIRecords",mostCurrent.activityBA);
 //BA.debugLineNum = 798;BA.debugLine="lblPSIRdgTime.TextColor = GlobalVar.PriColor";
mostCurrent._lblpsirdgtime.setTextColor((int) (mostCurrent._globalvar._pricolor /*double*/ ));
 //BA.debugLineNum = 799;BA.debugLine="lblPSIRdg.TextColor = GlobalVar.PriColor";
mostCurrent._lblpsirdg.setTextColor((int) (mostCurrent._globalvar._pricolor /*double*/ ));
 //BA.debugLineNum = 801;BA.debugLine="lblPSIRdgTime.Text = PSIRec.sRdgTime";
mostCurrent._lblpsirdgtime.setText(BA.ObjectToCharSequence(_psirec.sRdgTime /*String*/ ));
 //BA.debugLineNum = 802;BA.debugLine="lblPSIRdg.Text = NumberFormat(PSIRec.iPSIRdg,0";
mostCurrent._lblpsirdg.setText(BA.ObjectToCharSequence(anywheresoftware.b4a.keywords.Common.NumberFormat(_psirec.iPSIRdg /*int*/ ,(int) (0),(int) (2))+(" PSI")));
 ...
 //BA.debugLineNum = 805;BA.debugLine="If Pnl.NumberOfViews > 0 Then";
if (_pnl.getNumberOfViews()>0) { 
 //BA.debugLineNum = 806;BA.debugLine="Pnl.RemoveAllViews 'Remove none visable item/l";
_pnl.RemoveAllViews();
 };
 };
 }
...
anywheresoftware.b4a.keywords.Common.LogImpl("77864322",BA.NumberToString(_rec.ID /*int*/ ),0);
...
_blnaddtime = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 348;BA.debugLine="ShowMessagePumpTime";
_showmessagepumptime();
 }else {
 //BA.debugLineNum = 351;BA.debugLine="ShowPumpTimeRecDetails(GlobalVar.TimeDetailID)";
...
String _stitle = "";
String _scontent = "";
 //BA.debugLineNum = 451;BA.debugLine="Private Sub ConfirmPumpOff";
...
mostCurrent._alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 454;BA.debugLine="Dim sTitle, sContent As String";
_stitle = "";
_scontent = "";
 //BA.debugLineNum = 456;BA.debugLine="If blnAddTime = True Then";
if (_blnaddtime==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 457;BA.debugLine="sTitle = $\"CONFIRM PUMP OFF TIME\"$";
_stitle = ("CONFIRM PUMP OFF TIME");
 //BA.debugLineNum = 458;BA.debugLine="sContent = $\"Cannot add new Time record due to P";
_scontent = ("Cannot add new Time record due to Pump is currently running...")+anywheresoftware.b4a.keywords.Common.CRLF+("Do you want to Record the Pump Off Time Now?");
 ...
 //BA.debugLineNum = 460;BA.debugLine="sTitle = $\"CONFIRM PUMP OFF TIME\"$";
_stitle = ("CONFIRM PUMP OFF TIME");
 //BA.debugLineNum = 461;BA.debugLine="sContent = $\"Do you want to Record the Pump Off";
_scontent = ("Do you want to Record the Pump Off Time Now?");
 };
 //BA.debugLineNum = 464;BA.debugLine="Alert.Initialize.Create _ 			.SetDialogStyleName(";
mostCurrent._alert.Initialize().Create(mostCurrent.activityBA).SetDialogStyleName("MyDialogDisableStatus").SetStyle(mostCurrent._alert.getSTYLE_DIALOGUE()).SetCancelable(anywheresoftware.b4a.keywords.Common.False).SetTitleTypeface((android.graphics.Typeface)(mostCurrent._fontbold.getObject())).SetTitle(_stitle).SetTitleColor((int) (mostCurrent._globalvar._negcolor /*double*/ )).SetMessageTypeface((android.graphics.Typeface)(mostCurrent._font.getObject())).SetMessage(_scontent).SetPositiveText("Confirm").SetPositiveColor((int) (mostCurrent._globalvar._poscolor /*double*/ )).SetPositiveTypeface((android.graphics.Typeface)(mostCurrent._fontbold.getObject())).SetOnPositiveClicked(mostCurrent.activityBA,"PumpOff").SetNegativeText("Cancel").SetNegativeColor((int) (mostCurrent._globalvar._negcolor /*double*/ )).SetNegativeTypeface((android.graphics.Typeface)(mostCurrent._fontbold.getObject())).SetOnNegativeClicked(mostCurrent.activityBA,"PumpOff");
 //BA.debugLineNum = 481;BA.debugLine="Alert.SetDialogBackground(MyFunctions.myCD)";
mostCurrent._alert.SetDialogBackground((android.graphics.drawable.Drawable)(mostCurrent._myfunctions._mycd /*anywheresoftware.b4a.objects.drawable.ColorDrawable*/ (mostCurrent.activityBA).getObject()));
 //BA.debugLineNum = 482;BA.debugLine="Alert.Build.Show";
...
public static String  _editchlorinetime_buttonpressed(de.amberhome.materialdialogs.MaterialDialogWrapper _mdialog,String _saction) throws Exception{
 //BA.debugLineNum = 1048;BA.debugLine="Private Sub EditChlorineTime_ButtonPressed(mDialog";
 //BA.debugLineNum = 1049;BA.debugLine="Select Case sAction";
switch (BA.switchObjectToInt(_saction,_mdialog.ACTION_POSITIVE,_mdialog.ACTION_NEGATIVE,_mdialog.ACTION_NEUTRAL)) {
case 0: {
 break; }
case 1: {
 //BA.debugLineNum = 1052;BA.debugLine="GlobalVar.blnNewChlorine = False";
mostCurrent._globalvar._blnnewchlorine /*boolean*/  = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 1053;BA.debugLine="StartActivity(AddEditChlorineRecord)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._addeditchlorinerecord.getObject()));
 break; }
case 2: {
 break; }
...
public static String  _editfmrdg_buttonpressed(de.amberhome.materialdialogs.MaterialDialogWrapper _mdialog,String _saction) throws Exception{
 //BA.debugLineNum = 703;BA.debugLine="Private Sub EditFMRdg_ButtonPressed(mDialog As Mat";
 //BA.debugLineNum = 704;BA.debugLine="Select Case sAction";
switch (BA.switchObjectToInt(_saction,_mdialog.ACTION_POSITIVE,_mdialog.ACTION_NEGATIVE,_mdialog.ACTION_NEUTRAL)) {
case 0: {
 break; }
case 1: {
 //BA.debugLineNum = 707;BA.debugLine="GlobalVar.blnNewFMRdg = False";
mostCurrent._globalvar._blnnewfmrdg /*boolean*/  = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 708;BA.debugLine="StartActivity(AddEditFMRdg)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._addeditfmrdg.getObject()));
 break; }
case 2: {
 break; }
...
public static String  _editproblemrecord_buttonpressed(de.amberhome.materialdialogs.MaterialDialogWrapper _mdialog,String _saction) throws Exception{
 //BA.debugLineNum = 1226;BA.debugLine="Private Sub EditProblemRecord_ButtonPressed(mDialo";
 //BA.debugLineNum = 1227;BA.debugLine="Select Case sAction";
switch (BA.switchObjectToInt(_saction,_mdialog.ACTION_NEGATIVE)) {
case 0: {
 //BA.debugLineNum = 1229;BA.debugLine="GlobalVar.blnNewProblem = False";
mostCurrent._globalvar._blnnewproblem /*boolean*/  = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 1230;BA.debugLine="StartActivity(AddEditProblem)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._addeditproblem.getObject()));
 break; }
}
;
...
public static String  _editpsirdg_buttonpressed(de.amberhome.materialdialogs.MaterialDialogWrapper _mdialog,String _saction) throws Exception{
 //BA.debugLineNum = 876;BA.debugLine="Private Sub EditPSIRdg_ButtonPressed(mDialog As Ma";
 //BA.debugLineNum = 877;BA.debugLine="Select Case sAction";
switch (BA.switchObjectToInt(_saction,_mdialog.ACTION_NEGATIVE)) {
case 0: {
 //BA.debugLineNum = 879;BA.debugLine="GlobalVar.blnNewPSIRdg = False";
mostCurrent._globalvar._blnnewpsirdg /*boolean*/  = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 880;BA.debugLine="StartActivity(AddEditPSIRdg)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._addeditpsirdg.getObject()));
 break; }
}
;
...
public static String  _edittime_buttonpressed(de.amberhome.materialdialogs.MaterialDialogWrapper _mdialog,String _saction) throws Exception{
 //BA.debugLineNum = 426;BA.debugLine="Private Sub EditTime_ButtonPressed(mDialog As Mate";
 //BA.debugLineNum = 427;BA.debugLine="Select Case sAction";
switch (BA.switchObjectToInt(_saction,_mdialog.ACTION_POSITIVE,_mdialog.ACTION_NEGATIVE,_mdialog.ACTION_NEUTRAL)) {
case 0: {
 break; }
case 1: {
 //BA.debugLineNum = 430;BA.debugLine="GlobalVar.blnNewTime = False";
mostCurrent._globalvar._blnnewtime /*boolean*/  = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 431;BA.debugLine="LogColor($\"Header ID: \"$ & GlobalVar.TranHeader";
anywheresoftware.b4a.keywords.Common.LogImpl("77995397",("Header ID: ")+BA.NumberToString(mostCurrent._globalvar._tranheaderid /*int*/ ),anywheresoftware.b4a.keywords.Common.Colors.Magenta);
 //BA.debugLineNum = 432;BA.debugLine="LogColor($\"Detail ID: \"$ & GlobalVar.TimeDetail";
anywheresoftware.b4a.keywords.Common.LogImpl("77995398",("Detail ID: ")+BA.NumberToString(mostCurrent._globalvar._timedetailid /*int*/ ),anywheresoftware.b4a.keywords.Common.Colors.Yellow);
 //BA.debugLineNum = 433;BA.debugLine="StartActivity(EditTimeRecord)";
...
//C
this.state = 1;
 //BA.debugLineNum = 917;BA.debugLine="Dim SenderFilter As Object";
_senderfilter = new Object();
 //BA.debugLineNum = 918;BA.debugLine="clvChlorine.Clear";
...
this.state = 4;
this.catchState = 15;
 //BA.debugLineNum = 920;BA.debugLine="Starter.strCriteria = \"SELECT Details.DetailID,";
parent.mostCurrent._starter._strcriteria /*String*/  = "SELECT Details.DetailID, Details.TimeReplenished, Details.ChlorineType, Details.Volume, Details.UoM "+"FROM ChlorineDetails AS Details "+"INNER JOIN TranHeader AS Header ON Details.HeaderID = Header.HeaderID "+"WHERE Header.PumpID = "+BA.NumberToString(_ipumpid)+" "+"AND Header.TranDate = '"+_strandate+"' "+"ORDER BY Details.DetailID, TimeReplenished ASC";
 //BA.debugLineNum = 927;BA.debugLine="SenderFilter = Starter.DBCon.ExecQueryAsync(\"SQL";
_senderfilter = parent.mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQueryAsync(processBA,"SQL",parent.mostCurrent._starter._strcriteria /*String*/ ,(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(anywheresoftware.b4a.keywords.Common.Null)));
 //BA.debugLineNum = 928;BA.debugLine="Wait For (SenderFilter) SQL_QueryComplete (Succe";
...
;
 //BA.debugLineNum = 930;BA.debugLine="If Success Then";
if (true) break;
...
//C
this.state = 7;
 //BA.debugLineNum = 931;BA.debugLine="Dim StartTime As Long = DateTime.Now";
_starttime = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 932;BA.debugLine="Do While RS.NextRow";
if (true) break;
...
//C
this.state = 7;
 //BA.debugLineNum = 933;BA.debugLine="Dim CR As ChlorineRecords";
_cr = new bwsi.PumpOperations.actnewproduction._chlorinerecords();
 //BA.debugLineNum = 934;BA.debugLine="CR.Initialize";
_cr.Initialize();
 //BA.debugLineNum = 935;BA.debugLine="CR.ID = RS.GetInt(\"DetailID\")";
_cr.ID /*int*/  = _rs.GetInt("DetailID");
 //BA.debugLineNum = 936;BA.debugLine="CR.sTimeRep = RS.GetString(\"TimeReplenished\")";
_cr.sTimeRep /*String*/  = _rs.GetString("TimeReplenished");
 //BA.debugLineNum = 937;BA.debugLine="CR.sChlorineType = RS.GetString(\"ChlorineType\"";
_cr.sChlorineType /*String*/  = _rs.GetString("ChlorineType");
 //BA.debugLineNum = 938;BA.debugLine="CR.iVolume = RS.GetInt(\"Volume\")";
_cr.iVolume /*int*/  = _rs.GetInt("Volume");
 //BA.debugLineNum = 939;BA.debugLine="sUnit = RS.GetString(\"UoM\")";
parent.mostCurrent._sunit = _rs.GetString("UoM");
 //BA.debugLineNum = 941;BA.debugLine="Dim Pnl As B4XView = xui.CreatePanel(\"\")";
_pnl = new anywheresoftware.b4a.objects.B4XViewWrapper();
_pnl = parent._xui.CreatePanel(processBA,"");
 //BA.debugLineNum = 942;BA.debugLine="Pnl.SetLayoutAnimated(0, 10dip, 0, clvChlorine";
_pnl.SetLayoutAnimated((int) (0),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(int) (0),(int) (parent.mostCurrent._clvchlorine._asview().getWidth()-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30)));
 //BA.debugLineNum = 943;BA.debugLine="clvChlorine.Add(Pnl, CR)";
...
//C
this.state = 13;
 //BA.debugLineNum = 946;BA.debugLine="snack.Initialize(\"\", Activity,$\"\"$ & LastExcept";
parent.mostCurrent._snack.Initialize(mostCurrent.activityBA,"",(android.view.View)(parent.mostCurrent._activity.getObject()),("")+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),(int) (5000));
 //BA.debugLineNum = 947;BA.debugLine="MyFunctions.SetSnackBarTextColor(snack, Colors.";
parent.mostCurrent._myfunctions._setsnackbartextcolor /*String*/ (mostCurrent.activityBA,parent.mostCurrent._snack,anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 948;BA.debugLine="MyFunctions.SetSnackBarBackground(snack, Global";
parent.mostCurrent._myfunctions._setsnackbarbackground /*String*/ (mostCurrent.activityBA,parent.mostCurrent._snack,(int) (parent.mostCurrent._globalvar._redcolor /*double*/ ));
 //BA.debugLineNum = 949;BA.debugLine="snack.Show";
parent.mostCurrent._snack.Show();
 //BA.debugLineNum = 950;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("79306146",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
...
this.state = 16;
this.catchState = 0;
 //BA.debugLineNum = 956;BA.debugLine="snack.Initialize(\"\", Activity,$\"\"$ & LastExcepti";
parent.mostCurrent._snack.Initialize(mostCurrent.activityBA,"",(android.view.View)(parent.mostCurrent._activity.getObject()),("")+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),(int) (5000));
 //BA.debugLineNum = 957;BA.debugLine="MyFunctions.SetSnackBarTextColor(snack, Colors.W";
parent.mostCurrent._myfunctions._setsnackbartextcolor /*String*/ (mostCurrent.activityBA,parent.mostCurrent._snack,anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 958;BA.debugLine="MyFunctions.SetSnackBarBackground(snack, GlobalV";
parent.mostCurrent._myfunctions._setsnackbarbackground /*String*/ (mostCurrent.activityBA,parent.mostCurrent._snack,(int) (parent.mostCurrent._globalvar._redcolor /*double*/ ));
 //BA.debugLineNum = 959;BA.debugLine="snack.Show";
parent.mostCurrent._snack.Show();
 //BA.debugLineNum = 960;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("79306156",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
//C
this.state = 1;
 //BA.debugLineNum = 504;BA.debugLine="Dim SenderFilter As Object";
_senderfilter = new Object();
 //BA.debugLineNum = 505;BA.debugLine="clvFM.Clear";
...
this.state = 4;
this.catchState = 15;
 //BA.debugLineNum = 507;BA.debugLine="Starter.strCriteria = \"SELECT Details.DetailID,";
parent.mostCurrent._starter._strcriteria /*String*/  = "SELECT Details.DetailID, Details.RdgTime, "+"Details.PrevRdg, Details.PresRdg, Details.PresCum, Details.BackFlowCum "+"FROM ProductionDetails AS Details "+"INNER JOIN TranHeader AS Header ON Details.HeaderID = Header.HeaderID "+"WHERE Header.PumpID = "+BA.NumberToString(_ipumpid)+" "+"AND Header.TranDate = '"+_strandate+"' "+"ORDER BY Details.DetailID, Details.RdgTime ASC";
 //BA.debugLineNum = 515;BA.debugLine="SenderFilter = Starter.DBCon.ExecQueryAsync(\"SQL";
_senderfilter = parent.mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQueryAsync(processBA,"SQL",parent.mostCurrent._starter._strcriteria /*String*/ ,(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(anywheresoftware.b4a.keywords.Common.Null)));
 //BA.debugLineNum = 516;BA.debugLine="Wait For (SenderFilter) SQL_QueryComplete (Succe";
anywheresoftware.b4a.keywords.Common.WaitFor("sql_querycomplete", processBA, this, _senderfilter);
this.state = 17;
return;
case 17:
...
_rs = (anywheresoftware.b4a.sql.SQL.ResultSetWrapper) result[1];
;
 //BA.debugLineNum = 518;BA.debugLine="If Success Then";
if (true) break;
...
//C
this.state = 7;
 //BA.debugLineNum = 519;BA.debugLine="Dim StartTime As Long = DateTime.Now";
_starttime = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 520;BA.debugLine="Do While RS.NextRow";
if (true) break;
...
//C
this.state = 7;
 //BA.debugLineNum = 521;BA.debugLine="Dim FMRec As FMRecords";
_fmrec = new bwsi.PumpOperations.actnewproduction._fmrecords();
 //BA.debugLineNum = 522;BA.debugLine="FMRec.Initialize";
_fmrec.Initialize();
 //BA.debugLineNum = 523;BA.debugLine="FMRec.ID = RS.GetInt(\"DetailID\")";
_fmrec.ID /*int*/  = _rs.GetInt("DetailID");
 //BA.debugLineNum = 524;BA.debugLine="FMRec.sRdgTime = RS.GetString(\"RdgTime\")";
_fmrec.sRdgTime /*String*/  = _rs.GetString("RdgTime");
 //BA.debugLineNum = 525;BA.debugLine="FMRec.iPrevRdg = RS.GetInt(\"PrevRdg\")";
_fmrec.iPrevRdg /*int*/  = _rs.GetInt("PrevRdg");
 //BA.debugLineNum = 526;BA.debugLine="FMRec.iPresRdg = RS.GetInt(\"PresRdg\")";
_fmrec.iPresRdg /*int*/  = _rs.GetInt("PresRdg");
 //BA.debugLineNum = 527;BA.debugLine="FMRec.iTotProd = RS.GetInt(\"PresCum\")";
_fmrec.iTotProd /*int*/  = _rs.GetInt("PresCum");
 //BA.debugLineNum = 528;BA.debugLine="FMRec.iBackFlow = RS.GetInt(\"BackFlowCum\")";
_fmrec.iBackFlow /*int*/  = _rs.GetInt("BackFlowCum");
 //BA.debugLineNum = 530;BA.debugLine="Dim Pnl As B4XView = xui.CreatePanel(\"\")";
_pnl = new anywheresoftware.b4a.objects.B4XViewWrapper();
_pnl = parent._xui.CreatePanel(processBA,"");
 //BA.debugLineNum = 531;BA.debugLine="Pnl.SetLayoutAnimated(0, 10dip, 0, clvFM.AsVie";
_pnl.SetLayoutAnimated((int) (0),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(int) (0),(int) (parent.mostCurrent._clvfm._asview().getWidth()-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30)));
 //BA.debugLineNum = 532;BA.debugLine="clvFM.Add(Pnl, FMRec)";
...
//C
this.state = 13;
 //BA.debugLineNum = 535;BA.debugLine="snack.Initialize(\"\", Activity,$\"\"$ & LastExcept";
parent.mostCurrent._snack.Initialize(mostCurrent.activityBA,"",(android.view.View)(parent.mostCurrent._activity.getObject()),("")+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),(int) (5000));
 //BA.debugLineNum = 536;BA.debugLine="MyFunctions.SetSnackBarTextColor(snack, Colors.";
parent.mostCurrent._myfunctions._setsnackbartextcolor /*String*/ (mostCurrent.activityBA,parent.mostCurrent._snack,anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 537;BA.debugLine="MyFunctions.SetSnackBarBackground(snack, Global";
parent.mostCurrent._myfunctions._setsnackbarbackground /*String*/ (mostCurrent.activityBA,parent.mostCurrent._snack,(int) (parent.mostCurrent._globalvar._redcolor /*double*/ ));
 //BA.debugLineNum = 538;BA.debugLine="snack.Show";
parent.mostCurrent._snack.Show();
 //BA.debugLineNum = 539;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("78323108",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
...
this.state = 16;
;
 //BA.debugLineNum = 542;BA.debugLine="Log($\"List of FM Reading Records = ${NumberForma";
anywheresoftware.b4a.keywords.Common.LogImpl("78323111",("List of FM Reading Records = "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(anywheresoftware.b4a.keywords.Common.NumberFormat2((anywheresoftware.b4a.keywords.Common.DateTime.getNow()-_starttime)/(double)1000,(int) (0),(int) (2),(int) (2),anywheresoftware.b4a.keywords.Common.False)))+" seconds to populate "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(parent.mostCurrent._clvfm._getsize()))+" Flow Meter Reading Records"),0);
 if (true) break;
...
this.state = 16;
this.catchState = 0;
 //BA.debugLineNum = 545;BA.debugLine="snack.Initialize(\"\", Activity,$\"\"$ & LastExcepti";
parent.mostCurrent._snack.Initialize(mostCurrent.activityBA,"",(android.view.View)(parent.mostCurrent._activity.getObject()),("")+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),(int) (5000));
 //BA.debugLineNum = 546;BA.debugLine="MyFunctions.SetSnackBarTextColor(snack, Colors.W";
parent.mostCurrent._myfunctions._setsnackbartextcolor /*String*/ (mostCurrent.activityBA,parent.mostCurrent._snack,anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 547;BA.debugLine="MyFunctions.SetSnackBarBackground(snack, GlobalV";
parent.mostCurrent._myfunctions._setsnackbarbackground /*String*/ (mostCurrent.activityBA,parent.mostCurrent._snack,(int) (parent.mostCurrent._globalvar._redcolor /*double*/ ));
 //BA.debugLineNum = 548;BA.debugLine="snack.Show";
parent.mostCurrent._snack.Show();
 //BA.debugLineNum = 549;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("78323118",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
//C
this.state = 1;
 //BA.debugLineNum = 1074;BA.debugLine="Dim SenderFilter As Object";
_senderfilter = new Object();
 //BA.debugLineNum = 1075;BA.debugLine="clvConcerns.Clear";
...
this.state = 4;
this.catchState = 15;
 //BA.debugLineNum = 1077;BA.debugLine="Starter.strCriteria = \"SELECT Problem.DetailID,";
parent.mostCurrent._starter._strcriteria /*String*/  = "SELECT Problem.DetailID, Problem.TimeStart, Problem.ProblemTitle "+"FROM ProblemDetails AS Problem "+"INNER JOIN TranHeader AS Header ON Problem.HeaderID = Header.HeaderID "+"WHERE Header.PumpID = "+BA.NumberToString(_ipumpid)+" "+"AND Header.TranDate = '"+_strandate+"' "+"ORDER BY Problem.DetailID, Problem.TimeStart ASC";
 //BA.debugLineNum = 1084;BA.debugLine="SenderFilter = Starter.DBCon.ExecQueryAsync(\"SQL";
_senderfilter = parent.mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQueryAsync(processBA,"SQL",parent.mostCurrent._starter._strcriteria /*String*/ ,(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(anywheresoftware.b4a.keywords.Common.Null)));
 //BA.debugLineNum = 1085;BA.debugLine="Wait For (SenderFilter) SQL_QueryComplete (Succe";
anywheresoftware.b4a.keywords.Common.WaitFor("sql_querycomplete", processBA, this, _senderfilter);
this.state = 17;
return;
case 17:
...
_rs = (anywheresoftware.b4a.sql.SQL.ResultSetWrapper) result[1];
;
 //BA.debugLineNum = 1087;BA.debugLine="If Success Then";
if (true) break;
...
//C
this.state = 7;
 //BA.debugLineNum = 1088;BA.debugLine="Dim StartTime As Long = DateTime.Now";
_starttime = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 1089;BA.debugLine="Do While RS.NextRow";
if (true) break;
...
//C
this.state = 7;
 //BA.debugLineNum = 1090;BA.debugLine="Dim ConcernRec As ConcernsRecords";
_concernrec = new bwsi.PumpOperations.actnewproduction._concernsrecords();
 //BA.debugLineNum = 1091;BA.debugLine="ConcernRec.Initialize";
_concernrec.Initialize();
 //BA.debugLineNum = 1092;BA.debugLine="ConcernRec.ID = RS.GetInt(\"DetailID\")";
_concernrec.ID /*int*/  = _rs.GetInt("DetailID");
 //BA.debugLineNum = 1093;BA.debugLine="ConcernRec.sTimeEnc = RS.GetString(\"TimeStart\"";
_concernrec.sTimeEnc /*String*/  = _rs.GetString("TimeStart");
 //BA.debugLineNum = 1094;BA.debugLine="ConcernRec.sProblem= RS.GetString(\"ProblemTitl";
_concernrec.sProblem /*String*/  = _rs.GetString("ProblemTitle");
 //BA.debugLineNum = 1096;BA.debugLine="Dim Pnl As B4XView = xui.CreatePanel(\"\")";
_pnl = new anywheresoftware.b4a.objects.B4XViewWrapper();
_pnl = parent._xui.CreatePanel(processBA,"");
 //BA.debugLineNum = 1097;BA.debugLine="Pnl.SetLayoutAnimated(0, 10dip, 0, clvConcerns";
_pnl.SetLayoutAnimated((int) (0),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(int) (0),(int) (parent.mostCurrent._clvconcerns._asview().getWidth()-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30)));
 //BA.debugLineNum = 1098;BA.debugLine="clvConcerns.Add(Pnl, ConcernRec)";
...
//C
this.state = 13;
 //BA.debugLineNum = 1101;BA.debugLine="ToastMessageShow($\"Unable to fetch Problem Enco";
...
anywheresoftware.b4a.keywords.Common.LogImpl("79764893",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
...
this.state = 16;
;
 //BA.debugLineNum = 1105;BA.debugLine="Log($\"List of Problem Encountered Records = ${Nu";
anywheresoftware.b4a.keywords.Common.LogImpl("79764896",("List of Problem Encountered Records = "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(anywheresoftware.b4a.keywords.Common.NumberFormat2((anywheresoftware.b4a.keywords.Common.DateTime.getNow()-_starttime)/(double)1000,(int) (0),(int) (2),(int) (2),anywheresoftware.b4a.keywords.Common.False)))+" seconds to populate "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(parent.mostCurrent._clvconcerns._getsize()))+" PSI Reading Records"),0);
 if (true) break;
...
this.state = 16;
this.catchState = 0;
 //BA.debugLineNum = 1108;BA.debugLine="snack.Initialize(\"\", Activity,$\"\"$ & LastExcepti";
parent.mostCurrent._snack.Initialize(mostCurrent.activityBA,"",(android.view.View)(parent.mostCurrent._activity.getObject()),("")+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),(int) (5000));
 //BA.debugLineNum = 1109;BA.debugLine="MyFunctions.SetSnackBarTextColor(snack, Colors.W";
parent.mostCurrent._myfunctions._setsnackbartextcolor /*String*/ (mostCurrent.activityBA,parent.mostCurrent._snack,anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 1110;BA.debugLine="MyFunctions.SetSnackBarBackground(snack, GlobalV";
parent.mostCurrent._myfunctions._setsnackbarbackground /*String*/ (mostCurrent.activityBA,parent.mostCurrent._snack,(int) (parent.mostCurrent._globalvar._redcolor /*double*/ ));
 //BA.debugLineNum = 1111;BA.debugLine="snack.Show";
parent.mostCurrent._snack.Show();
 //BA.debugLineNum = 1112;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("79764903",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
//C
this.state = 1;
 //BA.debugLineNum = 745;BA.debugLine="Dim SenderFilter As Object";
_senderfilter = new Object();
 //BA.debugLineNum = 746;BA.debugLine="clvPSI.Clear";
...
this.state = 4;
this.catchState = 15;
 //BA.debugLineNum = 748;BA.debugLine="Starter.strCriteria = \"SELECT Details.DetailID,";
parent.mostCurrent._starter._strcriteria /*String*/  = "SELECT Details.DetailID, Details.RdgTime, Details.PSIReading "+"FROM PressureRdgDetails AS Details "+"INNER JOIN TranHeader AS Header ON Details.HeaderID = Header.HeaderID "+"WHERE Header.PumpID = "+BA.NumberToString(_ipumpid)+" "+"AND Header.TranDate = '"+_strandate+"' "+"ORDER BY Details.DetailID, Details.RdgTime ASC";
 //BA.debugLineNum = 755;BA.debugLine="SenderFilter = Starter.DBCon.ExecQueryAsync(\"SQL";
_senderfilter = parent.mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQueryAsync(processBA,"SQL",parent.mostCurrent._starter._strcriteria /*String*/ ,(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(anywheresoftware.b4a.keywords.Common.Null)));
 //BA.debugLineNum = 756;BA.debugLine="Wait For (SenderFilter) SQL_QueryComplete (Succe";
anywheresoftware.b4a.keywords.Common.WaitFor("sql_querycomplete", processBA, this, _senderfilter);
this.state = 17;
return;
case 17:
...
_rs = (anywheresoftware.b4a.sql.SQL.ResultSetWrapper) result[1];
;
 //BA.debugLineNum = 758;BA.debugLine="If Success Then";
if (true) break;
...
//C
this.state = 7;
 //BA.debugLineNum = 759;BA.debugLine="Dim StartTime As Long = DateTime.Now";
_starttime = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 760;BA.debugLine="Do While RS.NextRow";
if (true) break;
...
//C
this.state = 7;
 //BA.debugLineNum = 761;BA.debugLine="Dim PSIRec As PSIRecords";
_psirec = new bwsi.PumpOperations.actnewproduction._psirecords();
 //BA.debugLineNum = 762;BA.debugLine="PSIRec.Initialize";
_psirec.Initialize();
 //BA.debugLineNum = 763;BA.debugLine="PSIRec.ID = RS.GetInt(\"DetailID\")";
_psirec.ID /*int*/  = _rs.GetInt("DetailID");
 //BA.debugLineNum = 764;BA.debugLine="PSIRec.sRdgTime = RS.GetString(\"RdgTime\")";
_psirec.sRdgTime /*String*/  = _rs.GetString("RdgTime");
 //BA.debugLineNum = 765;BA.debugLine="PSIRec.iPSIRdg = RS.GetInt(\"PSIReading\")";
_psirec.iPSIRdg /*int*/  = _rs.GetInt("PSIReading");
 //BA.debugLineNum = 767;BA.debugLine="Dim Pnl As B4XView = xui.CreatePanel(\"\")";
_pnl = new anywheresoftware.b4a.objects.B4XViewWrapper();
_pnl = parent._xui.CreatePanel(processBA,"");
 //BA.debugLineNum = 768;BA.debugLine="Pnl.SetLayoutAnimated(0, 10dip, 0, clvPSI.AsVi";
_pnl.SetLayoutAnimated((int) (0),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(int) (0),(int) (parent.mostCurrent._clvpsi._asview().getWidth()-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30)));
 //BA.debugLineNum = 769;BA.debugLine="clvPSI.Add(Pnl, PSIRec)";
...
//C
this.state = 13;
 //BA.debugLineNum = 772;BA.debugLine="snack.Initialize(\"\", Activity,$\"\"$ & LastExcept";
parent.mostCurrent._snack.Initialize(mostCurrent.activityBA,"",(android.view.View)(parent.mostCurrent._activity.getObject()),("")+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),(int) (5000));
 //BA.debugLineNum = 773;BA.debugLine="MyFunctions.SetSnackBarTextColor(snack, Colors.";
parent.mostCurrent._myfunctions._setsnackbartextcolor /*String*/ (mostCurrent.activityBA,parent.mostCurrent._snack,anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 774;BA.debugLine="MyFunctions.SetSnackBarBackground(snack, Global";
parent.mostCurrent._myfunctions._setsnackbarbackground /*String*/ (mostCurrent.activityBA,parent.mostCurrent._snack,(int) (parent.mostCurrent._globalvar._redcolor /*double*/ ));
 //BA.debugLineNum = 775;BA.debugLine="snack.Show";
parent.mostCurrent._snack.Show();
 //BA.debugLineNum = 776;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("78847392",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
...
this.state = 16;
;
 //BA.debugLineNum = 779;BA.debugLine="Log($\"List of PSI Reading Records = ${NumberForm";
anywheresoftware.b4a.keywords.Common.LogImpl("78847395",("List of PSI Reading Records = "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(anywheresoftware.b4a.keywords.Common.NumberFormat2((anywheresoftware.b4a.keywords.Common.DateTime.getNow()-_starttime)/(double)1000,(int) (0),(int) (2),(int) (2),anywheresoftware.b4a.keywords.Common.False)))+" seconds to populate "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(parent.mostCurrent._clvpsi._getsize()))+" PSI Reading Records"),0);
 if (true) break;
...
this.state = 16;
this.catchState = 0;
 //BA.debugLineNum = 782;BA.debugLine="snack.Initialize(\"\", Activity,$\"\"$ & LastExcepti";
parent.mostCurrent._snack.Initialize(mostCurrent.activityBA,"",(android.view.View)(parent.mostCurrent._activity.getObject()),("")+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),(int) (5000));
 //BA.debugLineNum = 783;BA.debugLine="MyFunctions.SetSnackBarTextColor(snack, Colors.W";
parent.mostCurrent._myfunctions._setsnackbartextcolor /*String*/ (mostCurrent.activityBA,parent.mostCurrent._snack,anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 784;BA.debugLine="MyFunctions.SetSnackBarBackground(snack, GlobalV";
parent.mostCurrent._myfunctions._setsnackbarbackground /*String*/ (mostCurrent.activityBA,parent.mostCurrent._snack,(int) (parent.mostCurrent._globalvar._redcolor /*double*/ ));
 //BA.debugLineNum = 785;BA.debugLine="snack.Show";
parent.mostCurrent._snack.Show();
 //BA.debugLineNum = 786;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("78847402",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("77733282",_stimeon,anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 270;BA.debugLine="LogColor(sTimeOFF, Colors.White)";
anywheresoftware.b4a.keywords.Common.LogImpl("77733283",_stimeoff,anywheresoftware.b4a.keywords.Common.Colors.White);
...
anywheresoftware.b4a.keywords.Common.LogImpl("77733304",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("77733314",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
int _idcheck = 0;
 //BA.debugLineNum = 718;BA.debugLine="Private Sub isLastFMReading(iDetailsID As Int, iHe";
 //BA.debugLineNum = 719;BA.debugLine="Dim bRetVal As Boolean";
_bretval = false;
 //BA.debugLineNum = 720;BA.debugLine="Dim idCheck As Int";
_idcheck = 0;
...
try { //BA.debugLineNum = 724;BA.debugLine="idCheck = Starter.DBCon.ExecQuerySingleResult(\"S";
_idcheck = (int)(Double.parseDouble(mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQuerySingleResult("SELECT Max(DetailID) FROM ProductionDetails WHERE HeaderID = "+BA.NumberToString(_iheaderid)+" "+"GROUP BY HeaderID")));
 //BA.debugLineNum = 726;BA.debugLine="LogColor($\"Selected ID: \"$ & iDetailsID & $\" - L";
anywheresoftware.b4a.keywords.Common.LogImpl("78781832",("Selected ID: ")+BA.NumberToString(_idetailsid)+(" - Last ID: ")+BA.NumberToString(_idcheck),anywheresoftware.b4a.keywords.Common.Colors.Yellow);
 //BA.debugLineNum = 728;BA.debugLine="If iDetailsID = idCheck Then";
if (_idetailsid==_idcheck) { 
 //BA.debugLineNum = 729;BA.debugLine="bRetVal = True";
_bretval = anywheresoftware.b4a.keywords.Common.True;
 }else {
 //BA.debugLineNum = 731;BA.debugLine="bRetVal = False";
_bretval = anywheresoftware.b4a.keywords.Common.False;
 };
 } 
       catch (Exception e13) {
			processBA.setLastException(e13); //BA.debugLineNum = 734;BA.debugLine="bRetVal = False";
_bretval = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 735;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("78781841",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
 //BA.debugLineNum = 737;BA.debugLine="Return bRetVal";
...
boolean _bretval = false;
int _idcheck = 0;
 //BA.debugLineNum = 889;BA.debugLine="Private Sub isLastPSIReading(iDetailsID As Int, iH";
 //BA.debugLineNum = 890;BA.debugLine="Dim bRetVal As Boolean";
_bretval = false;
 //BA.debugLineNum = 891;BA.debugLine="Dim idCheck As Int";
_idcheck = 0;
 //BA.debugLineNum = 892;BA.debugLine="bRetVal = False";
_bretval = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 894;BA.debugLine="Try";
try { //BA.debugLineNum = 895;BA.debugLine="idCheck = Starter.DBCon.ExecQuerySingleResult(\"S";
_idcheck = (int)(Double.parseDouble(mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQuerySingleResult("SELECT Max(DetailID) FROM PressureRdgDetails WHERE HeaderID = "+BA.NumberToString(_iheaderid)+" "+"GROUP BY HeaderID")));
 //BA.debugLineNum = 897;BA.debugLine="LogColor($\"Selected ID: \"$ & iDetailsID & $\" - L";
anywheresoftware.b4a.keywords.Common.LogImpl("79240584",("Selected ID: ")+BA.NumberToString(_idetailsid)+(" - Last ID: ")+BA.NumberToString(_idcheck),anywheresoftware.b4a.keywords.Common.Colors.Yellow);
 //BA.debugLineNum = 899;BA.debugLine="If iDetailsID = idCheck Then";
if (_idetailsid==_idcheck) { 
 //BA.debugLineNum = 900;BA.debugLine="bRetVal = True";
_bretval = anywheresoftware.b4a.keywords.Common.True;
 }else {
 //BA.debugLineNum = 902;BA.debugLine="bRetVal = False";
_bretval = anywheresoftware.b4a.keywords.Common.False;
 };
 } 
       catch (Exception e13) {
			processBA.setLastException(e13); //BA.debugLineNum = 905;BA.debugLine="bRetVal = False";
_bretval = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 906;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("79240593",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
 //BA.debugLineNum = 908;BA.debugLine="Return bRetVal";
if (true) return _bretval;
...
public static String  _pnladdeditfmrdg_touch(int _action,float _x,float _y) throws Exception{
 //BA.debugLineNum = 714;BA.debugLine="Sub pnlAddEditFMRdg_Touch (Action As Int, X As Flo";
...
public static String  _pumpoff_onnegativeclicked(anywheresoftware.b4a.objects.ConcreteViewWrapper _view,Object _dialog) throws Exception{
 //BA.debugLineNum = 486;BA.debugLine="Private Sub PumpOff_OnNegativeClicked (View As Vie";
 //BA.debugLineNum = 488;BA.debugLine="Alert.Initialize.Dismiss(Dialog)";
...
public static String  _pumpoff_onpositiveclicked(anywheresoftware.b4a.objects.ConcreteViewWrapper _view,Object _dialog) throws Exception{
 //BA.debugLineNum = 491;BA.debugLine="Private Sub PumpOff_OnPositiveClicked (View As Vie";
 //BA.debugLineNum = 494;BA.debugLine="LogColor(GlobalVar.SelectedJOID, Colors.Cyan)";
anywheresoftware.b4a.keywords.Common.LogImpl("78257539",BA.NumberToString(mostCurrent._globalvar._selectedjoid /*int*/ ),anywheresoftware.b4a.keywords.Common.Colors.Cyan);
 //BA.debugLineNum = 495;BA.debugLine="Alert.Initialize.Dismiss2";
mostCurrent._alert.Initialize().Dismiss2();
 //BA.debugLineNum = 496;BA.debugLine="StartActivity(actPumpOff)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._actpumpoff.getObject()));
 //BA.debugLineNum = 497;BA.debugLine="End Sub";
return "";
}
public static String  _pumptime_oncancelclicked(anywheresoftware.b4a.objects.ConcreteViewWrapper _view,Object _dialog) throws Exception{
 //BA.debugLineNum = 1262;BA.debugLine="Private Sub PumpTime_OnCancelClicked (View As View";
 //BA.debugLineNum = 1263;BA.debugLine="If View<>Null Then";
if (_view!= null) { 
 //BA.debugLineNum = 1264;BA.debugLine="ToastMessageShow(\"More Button Clicked!\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("More Button Clicked!"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1265;BA.debugLine="Dim Alert As AX_CustomAlertDialog";
mostCurrent._alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 1266;BA.debugLine="Alert.Initialize.Dismiss(Dialog)";
mostCurrent._alert.Initialize().Dismiss((android.app.Dialog)(_dialog));
 };
...
//C
this.state = 1;
 //BA.debugLineNum = 997;BA.debugLine="Dim csTitle As CSBuilder";
_cstitle = new anywheresoftware.b4a.objects.CSBuilder();
 //BA.debugLineNum = 998;BA.debugLine="Dim SenderFilter As Object";
_senderfilter = new Object();
 //BA.debugLineNum = 999;BA.debugLine="Dim sDate, sPCode, sTimeReplenished, sChloType, s";
_sdate = "";
_spcode = "";
_stimereplenished = "";
_schlotype = "";
_srem = "";
 //BA.debugLineNum = 1000;BA.debugLine="Dim iKG As Int";
_ikg = 0;
 //BA.debugLineNum = 1002;BA.debugLine="Starter.strCriteria = \"SELECT Header.TranDate, Pu";
parent.mostCurrent._starter._strcriteria /*String*/  = "SELECT Header.TranDate, Pump.PumpHouseCode, "+"Details.TimeReplenished, Details.ChlorineType, Details.Volume, Details.Remarks "+"FROM ChlorineDetails AS Details "+"INNER JOIN TranHeader AS Header ON Details.HeaderID = Header.HeaderID "+"INNER JOIN tblPumpStation AS Pump ON Pump.StationID = Header.PumpID "+"WHERE Details.DetailID = "+BA.NumberToString(_iid);
 //BA.debugLineNum = 1009;BA.debugLine="SenderFilter = Starter.DBCon.ExecQueryAsync(\"SQL\"";
_senderfilter = parent.mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQueryAsync(processBA,"SQL",parent.mostCurrent._starter._strcriteria /*String*/ ,(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(anywheresoftware.b4a.keywords.Common.Null)));
 //BA.debugLineNum = 1010;BA.debugLine="Wait For (SenderFilter) SQL_QueryComplete (Succes";
anywheresoftware.b4a.keywords.Common.WaitFor("sql_querycomplete", processBA, this, _senderfilter);
this.state = 7;
return;
case 7:
...
_rs = (anywheresoftware.b4a.sql.SQL.ResultSetWrapper) result[1];
;
 //BA.debugLineNum = 1012;BA.debugLine="If Success Then";
if (true) break;
...
//C
this.state = 6;
 //BA.debugLineNum = 1013;BA.debugLine="RS.Position = 0";
_rs.setPosition((int) (0));
 //BA.debugLineNum = 1014;BA.debugLine="sDate = RS.GetString(\"TranDate\")";
_sdate = _rs.GetString("TranDate");
 //BA.debugLineNum = 1015;BA.debugLine="sPCode = RS.GetString(\"PumpHouseCode\")";
_spcode = _rs.GetString("PumpHouseCode");
 //BA.debugLineNum = 1016;BA.debugLine="sTimeReplenished = RS.GetString(\"TimeReplenished";
_stimereplenished = _rs.GetString("TimeReplenished");
 //BA.debugLineNum = 1017;BA.debugLine="sChloType = RS.GetString(\"ChlorineType\")";
_schlotype = _rs.GetString("ChlorineType");
 //BA.debugLineNum = 1018;BA.debugLine="iKG = RS.GetInt(\"Volume\")";
_ikg = _rs.GetInt("Volume");
 //BA.debugLineNum = 1019;BA.debugLine="sRem = RS.GetString(\"Remarks\")";
...
//C
this.state = 6;
 //BA.debugLineNum = 1021;BA.debugLine="snack.Initialize(\"\", Activity,$\"\"$ & LastExcepti";
parent.mostCurrent._snack.Initialize(mostCurrent.activityBA,"",(android.view.View)(parent.mostCurrent._activity.getObject()),("")+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),(int) (5000));
 //BA.debugLineNum = 1022;BA.debugLine="MyFunctions.SetSnackBarTextColor(snack, Colors.W";
parent.mostCurrent._myfunctions._setsnackbartextcolor /*String*/ (mostCurrent.activityBA,parent.mostCurrent._snack,anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 1023;BA.debugLine="MyFunctions.SetSnackBarBackground(snack, GlobalV";
parent.mostCurrent._myfunctions._setsnackbarbackground /*String*/ (mostCurrent.activityBA,parent.mostCurrent._snack,(int) (parent.mostCurrent._globalvar._redcolor /*double*/ ));
 //BA.debugLineNum = 1024;BA.debugLine="snack.Show";
parent.mostCurrent._snack.Show();
 //BA.debugLineNum = 1025;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("79502749",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
...
this.state = -1;
;
 //BA.debugLineNum = 1028;BA.debugLine="csTitle.Initialize.Size(18).Bold.Color(GlobalVar.";
_cstitle.Initialize().Size((int) (18)).Bold().Color((int) (parent.mostCurrent._globalvar._bluecolor /*double*/ )).Append(BA.ObjectToCharSequence(("CHLORINATOR RECORD DETAILS"))).PopAll();
 //BA.debugLineNum = 1030;BA.debugLine="MatDialogBuilder.Initialize(\"EditChlorineTime\")";
parent.mostCurrent._matdialogbuilder.Initialize(mostCurrent.activityBA,"EditChlorineTime");
 //BA.debugLineNum = 1031;BA.debugLine="MatDialogBuilder.PositiveText(\"OK\").PositiveColor";
parent.mostCurrent._matdialogbuilder.PositiveText(BA.ObjectToCharSequence("OK")).PositiveColor((int) (parent.mostCurrent._globalvar._bluecolor /*double*/ ));
 //BA.debugLineNum = 1032;BA.debugLine="MatDialogBuilder.NegativeText(\"EDIT\").NegativeCol";
parent.mostCurrent._matdialogbuilder.NegativeText(BA.ObjectToCharSequence("EDIT")).NegativeColor((int) (parent.mostCurrent._globalvar._greencolor /*double*/ ));
 //BA.debugLineNum = 1033;BA.debugLine="MatDialogBuilder.NeutralText(\"DELETE\").NeutralCol";
parent.mostCurrent._matdialogbuilder.NeutralText(BA.ObjectToCharSequence("DELETE")).NeutralColor((int) (parent.mostCurrent._globalvar._redcolor /*double*/ ));
 //BA.debugLineNum = 1034;BA.debugLine="MatDialogBuilder.Title(csTitle)";
parent.mostCurrent._matdialogbuilder.Title(BA.ObjectToCharSequence(_cstitle.getObject()));
 //BA.debugLineNum = 1035;BA.debugLine="MatDialogBuilder.Content($\"  Pump: ${sPCode} 	Tra";
parent.mostCurrent._matdialogbuilder.Content(BA.ObjectToCharSequence(("  Pump: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_spcode))+"\n"+"	Transaction Date: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_sdate))+"\n"+"\n"+"	Time Replenished: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_stimereplenished))+"\n"+"	Chlorine Type: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_schlotype))+"\n"+"	Volume: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_ikg))+" Kg(s).\n"+"	Remarks: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_srem))+"")));
 //BA.debugLineNum = 1042;BA.debugLine="MatDialogBuilder.Theme(MatDialogBuilder.THEME_LIG";
parent.mostCurrent._matdialogbuilder.Theme(parent.mostCurrent._matdialogbuilder.THEME_LIGHT);
 //BA.debugLineNum = 1043;BA.debugLine="MatDialogBuilder.CanceledOnTouchOutside(False)";
parent.mostCurrent._matdialogbuilder.CanceledOnTouchOutside(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1044;BA.debugLine="MatDialogBuilder.Cancelable(True)";
parent.mostCurrent._matdialogbuilder.Cancelable(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1045;BA.debugLine="MatDialogBuilder.Show";
...
//C
this.state = 1;
 //BA.debugLineNum = 636;BA.debugLine="Dim csTitle As CSBuilder";
_cstitle = new anywheresoftware.b4a.objects.CSBuilder();
 //BA.debugLineNum = 637;BA.debugLine="Dim SenderFilter As Object";
_senderfilter = new Object();
 //BA.debugLineNum = 638;BA.debugLine="Dim sDate, sPCode, sReadTime, sRem As String";
_sdate = "";
_spcode = "";
_sreadtime = "";
_srem = "";
 //BA.debugLineNum = 639;BA.debugLine="Dim iPreviousRdg, iPresentRdg, iTotCum, iBackFlow";
_ipreviousrdg = 0;
_ipresentrdg = 0;
_itotcum = 0;
_ibackflow = 0;
 //BA.debugLineNum = 641;BA.debugLine="GlobalVar.TranHeaderID = DBaseFunctions.GetHeader";
...
this.state = 4;
this.catchState = 11;
 //BA.debugLineNum = 643;BA.debugLine="Starter.strCriteria = \"SELECT Header.TranDate, P";
parent.mostCurrent._starter._strcriteria /*String*/  = "SELECT Header.TranDate, Pump.PumpHouseCode, "+"Details.DetailID, Details.RdgTime, Details.PrevRdg, Details.PresRdg, "+"Details.PresCum, Details.Remarks, BackFlowCum "+"FROM ProductionDetails As Details "+"INNER JOIN TranHeader As Header ON Details.HeaderID = Header.HeaderID "+"INNER JOIN tblPumpStation AS Pump ON Pump.StationID = Header.PumpID "+"WHERE Details.DetailID = "+BA.NumberToString(_iid);
 //BA.debugLineNum = 651;BA.debugLine="SenderFilter = Starter.DBCon.ExecQueryAsync(\"SQL";
_senderfilter = parent.mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQueryAsync(processBA,"SQL",parent.mostCurrent._starter._strcriteria /*String*/ ,(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(anywheresoftware.b4a.keywords.Common.Null)));
 //BA.debugLineNum = 652;BA.debugLine="Wait For (SenderFilter) SQL_QueryComplete (Succe";
anywheresoftware.b4a.keywords.Common.WaitFor("sql_querycomplete", processBA, this, _senderfilter);
this.state = 19;
return;
case 19:
...
_rs = (anywheresoftware.b4a.sql.SQL.ResultSetWrapper) result[1];
;
 //BA.debugLineNum = 654;BA.debugLine="If Success Then";
if (true) break;
...
//C
this.state = 9;
 //BA.debugLineNum = 655;BA.debugLine="RS.Position = 0";
_rs.setPosition((int) (0));
 //BA.debugLineNum = 656;BA.debugLine="GlobalVar.FMRdgDetailID = RS.GetInt(\"DetailID\")";
parent.mostCurrent._globalvar._fmrdgdetailid /*int*/  = _rs.GetInt("DetailID");
 //BA.debugLineNum = 657;BA.debugLine="sDate = RS.GetString(\"TranDate\")";
_sdate = _rs.GetString("TranDate");
 //BA.debugLineNum = 658;BA.debugLine="sPCode = RS.GetString(\"PumpHouseCode\")";
_spcode = _rs.GetString("PumpHouseCode");
 //BA.debugLineNum = 659;BA.debugLine="sReadTime = RS.GetString(\"RdgTime\")";
_sreadtime = _rs.GetString("RdgTime");
 //BA.debugLineNum = 660;BA.debugLine="iPreviousRdg = RS.GetInt(\"PrevRdg\")";
_ipreviousrdg = _rs.GetInt("PrevRdg");
 //BA.debugLineNum = 661;BA.debugLine="iPresentRdg = RS.GetInt(\"PresRdg\")";
_ipresentrdg = _rs.GetInt("PresRdg");
 //BA.debugLineNum = 662;BA.debugLine="iTotCum = RS.GetInt(\"PresCum\")";
_itotcum = _rs.GetInt("PresCum");
 //BA.debugLineNum = 663;BA.debugLine="sRem = RS.GetString(\"Remarks\")";
_srem = _rs.GetString("Remarks");
 //BA.debugLineNum = 664;BA.debugLine="iBackFlow = RS.GetInt(\"BackFlowCum\")";
...
//C
this.state = 9;
 //BA.debugLineNum = 666;BA.debugLine="snack.Initialize(\"\", Activity,$\"\"$ & LastExcept";
parent.mostCurrent._snack.Initialize(mostCurrent.activityBA,"",(android.view.View)(parent.mostCurrent._activity.getObject()),("")+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),(int) (5000));
 //BA.debugLineNum = 667;BA.debugLine="MyFunctions.SetSnackBarTextColor(snack, Colors.";
parent.mostCurrent._myfunctions._setsnackbartextcolor /*String*/ (mostCurrent.activityBA,parent.mostCurrent._snack,anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 668;BA.debugLine="MyFunctions.SetSnackBarBackground(snack, Global";
parent.mostCurrent._myfunctions._setsnackbarbackground /*String*/ (mostCurrent.activityBA,parent.mostCurrent._snack,(int) (parent.mostCurrent._globalvar._redcolor /*double*/ ));
 //BA.debugLineNum = 669;BA.debugLine="snack.Show";
parent.mostCurrent._snack.Show();
 //BA.debugLineNum = 670;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("78585251",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
...
this.state = 12;
this.catchState = 0;
 //BA.debugLineNum = 674;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("78585255",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
this.catchState = 0;
;
 //BA.debugLineNum = 677;BA.debugLine="csTitle.Initialize.Size(18).Bold.Color(GlobalVar.";
_cstitle.Initialize().Size((int) (18)).Bold().Color((int) (parent.mostCurrent._globalvar._bluecolor /*double*/ )).Append(BA.ObjectToCharSequence(("FLOW METER READING DETAILS"))).PopAll();
 //BA.debugLineNum = 679;BA.debugLine="MatDialogBuilder.Initialize(\"EditFMRdg\")";
parent.mostCurrent._matdialogbuilder.Initialize(mostCurrent.activityBA,"EditFMRdg");
 //BA.debugLineNum = 680;BA.debugLine="MatDialogBuilder.PositiveText(\"OK\").PositiveColor";
parent.mostCurrent._matdialogbuilder.PositiveText(BA.ObjectToCharSequence("OK")).PositiveColor((int) (parent.mostCurrent._globalvar._poscolor /*double*/ ));
 //BA.debugLineNum = 681;BA.debugLine="If isLastFMReading(GlobalVar.FMRdgDetailID, Globa";
if (true) break;
...
//C
this.state = 18;
 //BA.debugLineNum = 682;BA.debugLine="MatDialogBuilder.NegativeText(\"EDIT\").NegativeCo";
parent.mostCurrent._matdialogbuilder.NegativeText(BA.ObjectToCharSequence("EDIT")).NegativeColor((int) (parent.mostCurrent._globalvar._greencolor /*double*/ ));
 if (true) break;
...
//C
this.state = 18;
 //BA.debugLineNum = 684;BA.debugLine="MatDialogBuilder.NegativeText(\"\")";
...
this.state = -1;
;
 //BA.debugLineNum = 686;BA.debugLine="MatDialogBuilder.NeutralText(\"DELETE\").NeutralCol";
parent.mostCurrent._matdialogbuilder.NeutralText(BA.ObjectToCharSequence("DELETE")).NeutralColor((int) (parent.mostCurrent._globalvar._redcolor /*double*/ ));
 //BA.debugLineNum = 687;BA.debugLine="MatDialogBuilder.Title(csTitle)";
parent.mostCurrent._matdialogbuilder.Title(BA.ObjectToCharSequence(_cstitle.getObject()));
 //BA.debugLineNum = 688;BA.debugLine="MatDialogBuilder.Content($\"  Pump: ${sPCode} 	Tra";
parent.mostCurrent._matdialogbuilder.Content(BA.ObjectToCharSequence(("  Pump: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_spcode))+"\n"+"	Transaction Date: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_sdate))+"\n"+"\n"+"	Reading Time: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_sreadtime))+"\n"+"	Present Reading: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_ipresentrdg))+"\n"+"	Previous Reading: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_ipreviousrdg))+"\n"+"	Total Prod.: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(anywheresoftware.b4a.keywords.Common.NumberFormat(_itotcum,(int) (0),(int) (0))))+" CuM\n"+"	Backflow: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(anywheresoftware.b4a.keywords.Common.NumberFormat(_ibackflow,(int) (0),(int) (0))))+" CuM\n"+"	Remarks: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_srem))+"")));
 //BA.debugLineNum = 697;BA.debugLine="MatDialogBuilder.Theme(MatDialogBuilder.THEME_LIG";
parent.mostCurrent._matdialogbuilder.Theme(parent.mostCurrent._matdialogbuilder.THEME_LIGHT);
 //BA.debugLineNum = 698;BA.debugLine="MatDialogBuilder.CanceledOnTouchOutside(False)";
parent.mostCurrent._matdialogbuilder.CanceledOnTouchOutside(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 699;BA.debugLine="MatDialogBuilder.Cancelable(True)";
parent.mostCurrent._matdialogbuilder.Cancelable(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 700;BA.debugLine="MatDialogBuilder.Show";
parent.mostCurrent._matdialogbuilder.Show();
...
public static String  _showmessagepumptime() throws Exception{
anywheresoftware.b4a.objects.collections.List _items = null;
 //BA.debugLineNum = 1236;BA.debugLine="Private Sub ShowMessagePumpTime";
 //BA.debugLineNum = 1237;BA.debugLine="Dim Alert As AX_CustomAlertDialog";
mostCurrent._alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 1239;BA.debugLine="Dim items As List";
_items = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 1240;BA.debugLine="items.Initialize";
_items.Initialize();
 //BA.debugLineNum = 1241;BA.debugLine="items.Add(\"Edit Pump On Time\")";
_items.Add((Object)("Edit Pump On Time"));
 //BA.debugLineNum = 1242;BA.debugLine="items.Add(\"Delete Record\")";
_items.Add((Object)("Delete Record"));
 //BA.debugLineNum = 1244;BA.debugLine="Alert.Initialize.Create _ 			.SetDialogStyleName(";
mostCurrent._alert.Initialize().Create(mostCurrent.activityBA).SetDialogStyleName("MyDialog").SetStyle(mostCurrent._alert.getSTYLE_ACTIONSHEET()).SetTitle("Select an option").SetTitleColor(anywheresoftware.b4a.keywords.Common.Colors.Black).SetCancelText("Pump Off...").SetNegativeTypeface((android.graphics.Typeface)(mostCurrent._fontbold.getObject())).SetOthers((java.util.ArrayList)(_items.getObject())).SetActionsheetTypeface((android.graphics.Typeface)(mostCurrent._font.getObject())).SetTitleTypeface((android.graphics.Typeface)(mostCurrent._font.getObject())).SetMessageTypeface((android.graphics.Typeface)(mostCurrent._font.getObject())).SetOnCancelClicked(mostCurrent.activityBA,"PumpTime").SetOnItemClickListener(mostCurrent.activityBA,"PumpTime");
 //BA.debugLineNum = 1258;BA.debugLine="Alert.SetDialogBackground(MyFunctions.myCD)";
mostCurrent._alert.SetDialogBackground((android.graphics.drawable.Drawable)(mostCurrent._myfunctions._mycd /*anywheresoftware.b4a.objects.drawable.ColorDrawable*/ (mostCurrent.activityBA).getObject()));
 //BA.debugLineNum = 1259;BA.debugLine="Alert.Build.Show";
mostCurrent._alert.Build().Show();
...
//C
this.state = 1;
 //BA.debugLineNum = 1147;BA.debugLine="Dim csTitle As CSBuilder";
_cstitle = new anywheresoftware.b4a.objects.CSBuilder();
 //BA.debugLineNum = 1148;BA.debugLine="Dim SenderFilter As Object";
_senderfilter = new Object();
 //BA.debugLineNum = 1149;BA.debugLine="Dim sTrandate, sPumpCode, sPumpArea As String";
_strandate = "";
_spumpcode = "";
_spumparea = "";
 //BA.debugLineNum = 1150;BA.debugLine="Dim iIsCritical, iWasSolved As Int";
_iiscritical = 0;
_iwassolved = 0;
 //BA.debugLineNum = 1151;BA.debugLine="Dim sIsCritical, sWasSolved, sProbTitle, sProbDes";
_siscritical = "";
_swassolved = "";
_sprobtitle = "";
_sprobdesc = "";
...
_stimefinished = "";
_sactiontaken = "";
 //BA.debugLineNum = 1153;BA.debugLine="LogColor(iID, Colors.Yellow)";
anywheresoftware.b4a.keywords.Common.LogImpl("79961479",BA.NumberToString(_iid),anywheresoftware.b4a.keywords.Common.Colors.Yellow);
...
this.state = 4;
this.catchState = 23;
 //BA.debugLineNum = 1155;BA.debugLine="Starter.strCriteria = \"SELECT Header.TranDate, S";
parent.mostCurrent._starter._strcriteria /*String*/  = "SELECT Header.TranDate, Station.PumpHouseCode, Areas.PumpArea, "+"ProblemDtls.IsCritical, ProblemDtls.ProblemTitle, ProblemDtls.ProbDesc, "+"ProblemDtls.TimeStart, ProblemDtls.TimeFinished, "+"ProblemDtls.WasSolved, ProblemDtls.ActionTaken "+"FROM ProblemDetails AS ProblemDtls "+"INNER JOIN TranHeader AS Header ON ProblemDtls.HeaderID = Header.HeaderID "+"INNER JOIN tblPumpStation AS Station ON Header.PumpID = Station.StationID "+"INNER JOIN PumpAreas AS Areas ON ProblemDtls.AreaID = Areas.ID "+"WHERE ProblemDtls.DetailID = "+BA.NumberToString(_iid);
 //BA.debugLineNum = 1165;BA.debugLine="SenderFilter = Starter.DBCon.ExecQueryAsync(\"SQL";
_senderfilter = parent.mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQueryAsync(processBA,"SQL",parent.mostCurrent._starter._strcriteria /*String*/ ,(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(anywheresoftware.b4a.keywords.Common.Null)));
 //BA.debugLineNum = 1166;BA.debugLine="Wait For (SenderFilter) SQL_QueryComplete (Succe";
anywheresoftware.b4a.keywords.Common.WaitFor("sql_querycomplete", processBA, this, _senderfilter);
this.state = 25;
return;
case 25:
...
_rs = (anywheresoftware.b4a.sql.SQL.ResultSetWrapper) result[1];
;
 //BA.debugLineNum = 1168;BA.debugLine="If Success Then";
if (true) break;
...
//C
this.state = 7;
 //BA.debugLineNum = 1169;BA.debugLine="RS.Position = 0";
_rs.setPosition((int) (0));
 //BA.debugLineNum = 1170;BA.debugLine="sTrandate = RS.GetString(\"TranDate\")";
_strandate = _rs.GetString("TranDate");
 //BA.debugLineNum = 1171;BA.debugLine="sPumpCode = RS.GetString(\"PumpHouseCode\")";
_spumpcode = _rs.GetString("PumpHouseCode");
 //BA.debugLineNum = 1172;BA.debugLine="sPumpArea = RS.GetString(\"PumpArea\")";
_spumparea = _rs.GetString("PumpArea");
 //BA.debugLineNum = 1173;BA.debugLine="iIsCritical = RS.GetInt(\"IsCritical\")";
_iiscritical = _rs.GetInt("IsCritical");
 //BA.debugLineNum = 1174;BA.debugLine="If iIsCritical = 1 Then";
if (true) break;
...
//C
this.state = 12;
 //BA.debugLineNum = 1175;BA.debugLine="sIsCritical = $\"YES\"$";
_siscritical = ("YES");
 if (true) break;
...
//C
this.state = 12;
 //BA.debugLineNum = 1177;BA.debugLine="sIsCritical = $\"NO\"$";
_siscritical = ("NO");
 if (true) break;
...
this.state = 13;
;
 //BA.debugLineNum = 1179;BA.debugLine="sProbTitle = RS.GetString(\"ProblemTitle\")";
_sprobtitle = _rs.GetString("ProblemTitle");
 //BA.debugLineNum = 1180;BA.debugLine="sProbDesc = RS.GetString(\"ProbDesc\")";
_sprobdesc = _rs.GetString("ProbDesc");
 //BA.debugLineNum = 1181;BA.debugLine="sTimeStart = RS.GetString(\"TimeStart\")";
_stimestart = _rs.GetString("TimeStart");
 //BA.debugLineNum = 1182;BA.debugLine="sTimeFinished = RS.GetString(\"TimeFinished\")";
_stimefinished = _rs.GetString("TimeFinished");
 //BA.debugLineNum = 1183;BA.debugLine="iWasSolved = RS.GetInt(\"WasSolved\")";
_iwassolved = _rs.GetInt("WasSolved");
 //BA.debugLineNum = 1184;BA.debugLine="If iWasSolved = 1 Then";
if (true) break;
...
//C
this.state = 18;
 //BA.debugLineNum = 1185;BA.debugLine="sWasSolved = $\"YES\"$";
_swassolved = ("YES");
 if (true) break;
...
//C
this.state = 18;
 //BA.debugLineNum = 1187;BA.debugLine="sWasSolved = $\"NO\"$";
_swassolved = ("NO");
 if (true) break;
...
this.state = 21;
;
 //BA.debugLineNum = 1189;BA.debugLine="sActionTaken = RS.GetString(\"ActionTaken\")";
...
//C
this.state = 21;
 //BA.debugLineNum = 1191;BA.debugLine="ToastMessageShow($\"Unable to fetch Problem Deta";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(("Unable to fetch Problem Details due to ")+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage()),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1192;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("79961518",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("79961523",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
this.catchState = 0;
;
 //BA.debugLineNum = 1201;BA.debugLine="csTitle.Initialize.Size(18).Bold.Color(GlobalVar.";
_cstitle.Initialize().Size((int) (18)).Bold().Color((int) (parent.mostCurrent._globalvar._bluecolor /*double*/ )).Append(BA.ObjectToCharSequence(("PROBLEM ENCOUNTERED DETAILS"))).PopAll();
 //BA.debugLineNum = 1203;BA.debugLine="MatDialogBuilder.Initialize(\"EditProblemRecord\")";
parent.mostCurrent._matdialogbuilder.Initialize(mostCurrent.activityBA,"EditProblemRecord");
 //BA.debugLineNum = 1204;BA.debugLine="MatDialogBuilder.PositiveText(\"OK\").PositiveColor";
parent.mostCurrent._matdialogbuilder.PositiveText(BA.ObjectToCharSequence("OK")).PositiveColor((int) (parent.mostCurrent._globalvar._poscolor /*double*/ ));
 //BA.debugLineNum = 1205;BA.debugLine="GlobalVar.TranHeaderID = DBaseFunctions.GetHeader";
parent.mostCurrent._globalvar._tranheaderid /*int*/  = parent.mostCurrent._dbasefunctions._getheaderid /*int*/ (mostCurrent.activityBA,parent.mostCurrent._globalvar._pumphouseid /*int*/ ,parent.mostCurrent._globalvar._trandate /*String*/ );
 //BA.debugLineNum = 1206;BA.debugLine="MatDialogBuilder.NegativeText(\"EDIT\").NegativeCol";
parent.mostCurrent._matdialogbuilder.NegativeText(BA.ObjectToCharSequence("EDIT")).NegativeColor((int) (parent.mostCurrent._globalvar._greencolor /*double*/ ));
 //BA.debugLineNum = 1207;BA.debugLine="MatDialogBuilder.NeutralText(\"DELETE\").NeutralCol";
parent.mostCurrent._matdialogbuilder.NeutralText(BA.ObjectToCharSequence("DELETE")).NeutralColor((int) (parent.mostCurrent._globalvar._redcolor /*double*/ ));
 //BA.debugLineNum = 1208;BA.debugLine="MatDialogBuilder.Title(csTitle)";
parent.mostCurrent._matdialogbuilder.Title(BA.ObjectToCharSequence(_cstitle.getObject()));
 //BA.debugLineNum = 1209;BA.debugLine="MatDialogBuilder.Content($\"  Pump: ${sPumpCode}";
parent.mostCurrent._matdialogbuilder.Content(BA.ObjectToCharSequence(("  Pump: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_spumpcode))+"\n"+"	Transaction Date: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_strandate))+"\n"+"\n"+"	Pump Area: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_spumparea))+"\n"+"	Is Critical: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_siscritical))+"\n"+"	Time Started: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_stimestart))+"\n"+"	Time Finished: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_stimefinished))+"\n"+"	Problem Title: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_sprobtitle))+"\n"+"	Problem Detail: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_sprobdesc))+"\n"+"	Was Solved?: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_swassolved))+"\n"+"	Action Taken: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_sactiontaken))+"")));
 //BA.debugLineNum = 1220;BA.debugLine="MatDialogBuilder.Theme(MatDialogBuilder.THEME_LIG";
parent.mostCurrent._matdialogbuilder.Theme(parent.mostCurrent._matdialogbuilder.THEME_LIGHT);
 //BA.debugLineNum = 1221;BA.debugLine="MatDialogBuilder.CanceledOnTouchOutside(False)";
parent.mostCurrent._matdialogbuilder.CanceledOnTouchOutside(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1222;BA.debugLine="MatDialogBuilder.Cancelable(True)";
parent.mostCurrent._matdialogbuilder.Cancelable(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1223;BA.debugLine="MatDialogBuilder.Show";
parent.mostCurrent._matdialogbuilder.Show();
...
//C
this.state = 1;
 //BA.debugLineNum = 821;BA.debugLine="Dim csTitle As CSBuilder";
_cstitle = new anywheresoftware.b4a.objects.CSBuilder();
 //BA.debugLineNum = 822;BA.debugLine="Dim SenderFilter As Object";
_senderfilter = new Object();
 //BA.debugLineNum = 823;BA.debugLine="Dim sDate, sPCode, sReadTime, sRem As String";
_sdate = "";
_spcode = "";
_sreadtime = "";
_srem = "";
 //BA.debugLineNum = 824;BA.debugLine="Dim iPressureRdg As Int";
_ipressurerdg = 0;
 //BA.debugLineNum = 826;BA.debugLine="Starter.strCriteria = \"SELECT Header.TranDate, Pu";
parent.mostCurrent._starter._strcriteria /*String*/  = "SELECT Header.TranDate, Pump.PumpHouseCode, "+"Details.RdgTime, Details.PSIReading, Details.Remarks "+"FROM PressureRdgDetails AS Details "+"INNER JOIN TranHeader AS Header ON Details.HeaderID = Header.HeaderID "+"INNER JOIN tblPumpStation AS Pump ON Pump.StationID = Header.PumpID "+"WHERE Details.DetailID = "+BA.NumberToString(_iid);
 //BA.debugLineNum = 833;BA.debugLine="SenderFilter = Starter.DBCon.ExecQueryAsync(\"SQL\"";
_senderfilter = parent.mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQueryAsync(processBA,"SQL",parent.mostCurrent._starter._strcriteria /*String*/ ,(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(anywheresoftware.b4a.keywords.Common.Null)));
 //BA.debugLineNum = 834;BA.debugLine="Wait For (SenderFilter) SQL_QueryComplete (Succes";
anywheresoftware.b4a.keywords.Common.WaitFor("sql_querycomplete", processBA, this, _senderfilter);
this.state = 13;
return;
case 13:
...
//C
this.state = 6;
 //BA.debugLineNum = 837;BA.debugLine="RS.Position = 0";
_rs.setPosition((int) (0));
 //BA.debugLineNum = 838;BA.debugLine="sDate = RS.GetString(\"TranDate\")";
_sdate = _rs.GetString("TranDate");
 //BA.debugLineNum = 839;BA.debugLine="sPCode = RS.GetString(\"PumpHouseCode\")";
_spcode = _rs.GetString("PumpHouseCode");
 //BA.debugLineNum = 840;BA.debugLine="sReadTime = RS.GetString(\"RdgTime\")";
_sreadtime = _rs.GetString("RdgTime");
 //BA.debugLineNum = 841;BA.debugLine="iPressureRdg = RS.GetInt(\"PSIReading\")";
_ipressurerdg = _rs.GetInt("PSIReading");
 //BA.debugLineNum = 842;BA.debugLine="sRem = RS.GetString(\"Remarks\")";
_srem = _rs.GetString("Remarks");
 if (true) break;
...
//C
this.state = 6;
 //BA.debugLineNum = 844;BA.debugLine="snack.Initialize(\"\", Activity,$\"\"$ & LastExcepti";
parent.mostCurrent._snack.Initialize(mostCurrent.activityBA,"",(android.view.View)(parent.mostCurrent._activity.getObject()),("")+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),(int) (5000));
 //BA.debugLineNum = 845;BA.debugLine="MyFunctions.SetSnackBarTextColor(snack, Colors.W";
parent.mostCurrent._myfunctions._setsnackbartextcolor /*String*/ (mostCurrent.activityBA,parent.mostCurrent._snack,anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 846;BA.debugLine="MyFunctions.SetSnackBarBackground(snack, GlobalV";
parent.mostCurrent._myfunctions._setsnackbarbackground /*String*/ (mostCurrent.activityBA,parent.mostCurrent._snack,(int) (parent.mostCurrent._globalvar._redcolor /*double*/ ));
 //BA.debugLineNum = 847;BA.debugLine="snack.Show";
parent.mostCurrent._snack.Show();
 //BA.debugLineNum = 848;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("79043996",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
...
this.state = 7;
;
 //BA.debugLineNum = 851;BA.debugLine="csTitle.Initialize.Size(18).Bold.Color(GlobalVar.";
_cstitle.Initialize().Size((int) (18)).Bold().Color((int) (parent.mostCurrent._globalvar._bluecolor /*double*/ )).Append(BA.ObjectToCharSequence(("PRESSURE READING DETAILS"))).PopAll();
 //BA.debugLineNum = 853;BA.debugLine="MatDialogBuilder.Initialize(\"EditPSIRdg\")";
parent.mostCurrent._matdialogbuilder.Initialize(mostCurrent.activityBA,"EditPSIRdg");
 //BA.debugLineNum = 854;BA.debugLine="MatDialogBuilder.PositiveText(\"OK\").PositiveColor";
parent.mostCurrent._matdialogbuilder.PositiveText(BA.ObjectToCharSequence("OK")).PositiveColor((int) (parent.mostCurrent._globalvar._poscolor /*double*/ ));
 //BA.debugLineNum = 855;BA.debugLine="LogColor(GlobalVar.PSIRdgDetailID, Colors.Yellow)";
anywheresoftware.b4a.keywords.Common.LogImpl("79044003",BA.NumberToString(parent.mostCurrent._globalvar._psirdgdetailid /*int*/ ),anywheresoftware.b4a.keywords.Common.Colors.Yellow);
 //BA.debugLineNum = 856;BA.debugLine="GlobalVar.TranHeaderID = DBaseFunctions.GetHeader";
parent.mostCurrent._globalvar._tranheaderid /*int*/  = parent.mostCurrent._dbasefunctions._getheaderid /*int*/ (mostCurrent.activityBA,parent.mostCurrent._globalvar._pumphouseid /*int*/ ,parent.mostCurrent._globalvar._trandate /*String*/ );
 //BA.debugLineNum = 857;BA.debugLine="If isLastPSIReading(GlobalVar.PSIRdgDetailID, Glo";
if (true) break;
...
//C
this.state = 12;
 //BA.debugLineNum = 858;BA.debugLine="MatDialogBuilder.NegativeText(\"EDIT\").NegativeCo";
parent.mostCurrent._matdialogbuilder.NegativeText(BA.ObjectToCharSequence("EDIT")).NegativeColor((int) (parent.mostCurrent._globalvar._greencolor /*double*/ ));
 if (true) break;
...
//C
this.state = 12;
 //BA.debugLineNum = 860;BA.debugLine="MatDialogBuilder.NegativeText(\"\")";
parent.mostCurrent._matdialogbuilder.NegativeText(BA.ObjectToCharSequence(""));
 if (true) break;
...
this.state = -1;
;
 //BA.debugLineNum = 862;BA.debugLine="MatDialogBuilder.NeutralText(\"DELETE\").NeutralCol";
parent.mostCurrent._matdialogbuilder.NeutralText(BA.ObjectToCharSequence("DELETE")).NeutralColor((int) (parent.mostCurrent._globalvar._redcolor /*double*/ ));
 //BA.debugLineNum = 863;BA.debugLine="MatDialogBuilder.Title(csTitle)";
parent.mostCurrent._matdialogbuilder.Title(BA.ObjectToCharSequence(_cstitle.getObject()));
 //BA.debugLineNum = 864;BA.debugLine="MatDialogBuilder.Content($\"  Pump: ${sPCode} 	Tra";
parent.mostCurrent._matdialogbuilder.Content(BA.ObjectToCharSequence(("  Pump: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_spcode))+"\n"+"	Transaction Date: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_sdate))+"\n"+"\n"+"	Reading Time: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_sreadtime))+"\n"+"	Pressure Reading: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_ipressurerdg))+"  PSI\n"+"	Remarks: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_srem))+"")));
 //BA.debugLineNum = 870;BA.debugLine="MatDialogBuilder.Theme(MatDialogBuilder.THEME_LIG";
parent.mostCurrent._matdialogbuilder.Theme(parent.mostCurrent._matdialogbuilder.THEME_LIGHT);
 //BA.debugLineNum = 871;BA.debugLine="MatDialogBuilder.CanceledOnTouchOutside(False)";
parent.mostCurrent._matdialogbuilder.CanceledOnTouchOutside(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 872;BA.debugLine="MatDialogBuilder.Cancelable(True)";
parent.mostCurrent._matdialogbuilder.Cancelable(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 873;BA.debugLine="MatDialogBuilder.Show";
parent.mostCurrent._matdialogbuilder.Show();
...
anywheresoftware.b4a.sql.SQL.CursorWrapper _rsdetails = null;
 //BA.debugLineNum = 355;BA.debugLine="Sub ShowPumpTimeRecDetails (iID As Int)";
 //BA.debugLineNum = 356;BA.debugLine="Dim csTitle As CSBuilder";
_cstitle = new anywheresoftware.b4a.objects.CSBuilder();
 //BA.debugLineNum = 357;BA.debugLine="Dim sDate, sPCode, sTimeOn, sTimeOff, sPowerSourc";
_sdate = "";
_spcode = "";
_stimeon = "";
_stimeoff = "";
_spowersource = "";
_srem = "";
 //BA.debugLineNum = 358;BA.debugLine="Dim iPowerSource, iDrainTime, iDrainCum As Int";
_ipowersource = 0;
_idraintime = 0;
_idraincum = 0;
 //BA.debugLineNum = 359;BA.debugLine="Dim iTotOPHrs As Double";
_itotophrs = 0;
 //BA.debugLineNum = 360;BA.debugLine="Dim rsDetails As Cursor";
_rsdetails = new anywheresoftware.b4a.sql.SQL.CursorWrapper();
 //BA.debugLineNum = 362;BA.debugLine="LogColor (iID, Colors.White)";
anywheresoftware.b4a.keywords.Common.LogImpl("77929863",BA.NumberToString(_iid),anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 363;BA.debugLine="Try";
try { //BA.debugLineNum = 364;BA.debugLine="Starter.strCriteria = \"SELECT Header.TranDate, \"";
mostCurrent._starter._strcriteria /*String*/  = "SELECT Header.TranDate, "+"Pump.PumpHouseCode, Details.PumpOnTime, Details.PumpOffTime, Details.TotOpHrs, "+"Details.PowerSourceID, Details.DrainTime, Details.DrainCum, Details.TimeOnRemarks, Details.TimeOffRemarks "+"FROM OnOffDetails AS Details "+"INNER JOIN TranHeader AS Header ON Details.HeaderID = Header.HeaderID "+"INNER JOIN tblPumpStation AS Pump ON Pump.StationID = Header.PumpID "+"WHERE Details.DetailID = "+BA.NumberToString(_iid);
 //BA.debugLineNum = 372;BA.debugLine="rsDetails = Starter.DBCon.ExecQuery(Starter.strC";
_rsdetails = (anywheresoftware.b4a.sql.SQL.CursorWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.sql.SQL.CursorWrapper(), (android.database.Cursor)(mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQuery(mostCurrent._starter._strcriteria /*String*/ )));
 //BA.debugLineNum = 373;BA.debugLine="If rsDetails.RowCount > 0 Then";
if (_rsdetails.getRowCount()>0) { 
 //BA.debugLineNum = 374;BA.debugLine="rsDetails.Position = 0";
_rsdetails.setPosition((int) (0));
 //BA.debugLineNum = 375;BA.debugLine="sDate = rsDetails.GetString(\"TranDate\")";
_sdate = _rsdetails.GetString("TranDate");
 //BA.debugLineNum = 376;BA.debugLine="sPCode = rsDetails.GetString(\"PumpHouseCode\")";
_spcode = _rsdetails.GetString("PumpHouseCode");
 //BA.debugLineNum = 377;BA.debugLine="sTimeOn = rsDetails.GetString(\"PumpOnTime\")";
_stimeon = _rsdetails.GetString("PumpOnTime");
 //BA.debugLineNum = 378;BA.debugLine="sTimeOff = rsDetails.GetString(\"PumpOffTime\")";
_stimeoff = _rsdetails.GetString("PumpOffTime");
 //BA.debugLineNum = 379;BA.debugLine="iTotOPHrs = rsDetails.GetDouble(\"TotOpHrs\")";
_itotophrs = _rsdetails.GetDouble("TotOpHrs");
 //BA.debugLineNum = 380;BA.debugLine="iPowerSource = rsDetails.GetInt(\"PowerSourceID\"";
_ipowersource = _rsdetails.GetInt("PowerSourceID");
 //BA.debugLineNum = 381;BA.debugLine="If iPowerSource = 1 Then";
if (_ipowersource==1) { 
 //BA.debugLineNum = 382;BA.debugLine="sPowerSource = $\"Electricity\"$";
_spowersource = ("Electricity");
 }else {
 //BA.debugLineNum = 384;BA.debugLine="sPowerSource = $\"Generator\"$";
_spowersource = ("Generator");
 };
 //BA.debugLineNum = 386;BA.debugLine="iDrainTime = rsDetails.GetInt(\"DrainTime\")";
_idraintime = _rsdetails.GetInt("DrainTime");
 //BA.debugLineNum = 387;BA.debugLine="iDrainCum = rsDetails.GetInt(\"DrainCum\")";
_idraincum = _rsdetails.GetInt("DrainCum");
 //BA.debugLineNum = 388;BA.debugLine="sRem = rsDetails.GetString(\"TimeOnRemarks\") & \"";
...
if (true) return "";
			...
			processBA.setLastException(e30); //BA.debugLineNum = 399;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("77929900",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
 //BA.debugLineNum = 401;BA.debugLine="rsDetails.Close";
_rsdetails.Close();
 //BA.debugLineNum = 403;BA.debugLine="csTitle.Initialize.Size(18).Bold.Color(GlobalVar.";
_cstitle.Initialize().Size((int) (18)).Bold().Color((int) (mostCurrent._globalvar._bluecolor /*double*/ )).Append(BA.ObjectToCharSequence(("PUMP ON/OFF DETAILS"))).PopAll();
 //BA.debugLineNum = 405;BA.debugLine="MatDialogBuilder.Initialize(\"EditTime\")";
mostCurrent._matdialogbuilder.Initialize(mostCurrent.activityBA,"EditTime");
 //BA.debugLineNum = 406;BA.debugLine="MatDialogBuilder.PositiveText(\"OK\").PositiveColor";
mostCurrent._matdialogbuilder.PositiveText(BA.ObjectToCharSequence("OK")).PositiveColor((int) (mostCurrent._globalvar._bluecolor /*double*/ ));
 //BA.debugLineNum = 407;BA.debugLine="MatDialogBuilder.NegativeText(\"EDIT\").NegativeCol";
mostCurrent._matdialogbuilder.NegativeText(BA.ObjectToCharSequence("EDIT")).NegativeColor((int) (mostCurrent._globalvar._greencolor /*double*/ ));
 //BA.debugLineNum = 408;BA.debugLine="MatDialogBuilder.NeutralText(\"DELETE\").NeutralCol";
mostCurrent._matdialogbuilder.NeutralText(BA.ObjectToCharSequence("DELETE")).NeutralColor((int) (mostCurrent._globalvar._redcolor /*double*/ ));
 //BA.debugLineNum = 409;BA.debugLine="MatDialogBuilder.Title(csTitle)";
mostCurrent._matdialogbuilder.Title(BA.ObjectToCharSequence(_cstitle.getObject()));
 //BA.debugLineNum = 410;BA.debugLine="MatDialogBuilder.Content($\"  Pump: ${sPCode} 	Tra";
mostCurrent._matdialogbuilder.Content(BA.ObjectToCharSequence(("  Pump: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_spcode))+"\n"+"	Transaction Date: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_sdate))+"\n"+"\n"+"	Time On:	"+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_stimeon))+"\n"+"	Time Off:	"+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_stimeoff))+"\n"+"	Total Operating Hrs:	"+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(anywheresoftware.b4a.keywords.Common.NumberFormat2(_itotophrs,(int) (1),(int) (2),(int) (2),anywheresoftware.b4a.keywords.Common.True)))+" Hr(s).\n"+"	Power Source:	"+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_spowersource))+"\n"+"	Drain Time:	"+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_idraintime))+" Min(s).\n"+"	Drain CuM:	"+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_idraincum))+" CuM\n"+"	Remarks:	"+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_srem))+"")));
 //BA.debugLineNum = 420;BA.debugLine="MatDialogBuilder.Theme(MatDialogBuilder.THEME_LIG";
mostCurrent._matdialogbuilder.Theme(mostCurrent._matdialogbuilder.THEME_LIGHT);
 //BA.debugLineNum = 421;BA.debugLine="MatDialogBuilder.CanceledOnTouchOutside(False)";
mostCurrent._matdialogbuilder.CanceledOnTouchOutside(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 422;BA.debugLine="MatDialogBuilder.Cancelable(True)";
mostCurrent._matdialogbuilder.Cancelable(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 423;BA.debugLine="MatDialogBuilder.Show";
