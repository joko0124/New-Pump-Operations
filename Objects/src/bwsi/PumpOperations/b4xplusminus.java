...
public class b4xplusminus extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "bwsi.PumpOperations.b4xplusminus");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", bwsi.PumpOperations.b4xplusminus.class).invoke(this, new Object[] {null});
        else
...
public bwsi.PumpOperations.b4xformatter _formatter = null;
...
_formatter = new bwsi.PumpOperations.b4xformatter();
...
_formatter._getdefaultformat /*bwsi.PumpOperations.b4xformatter._b4xformatdata*/ ().FormatFont /*anywheresoftware.b4a.objects.B4XViewWrapper.B4XFont*/  = _mainlabel.getFont();
 //BA.debugLineNum = 60;BA.debugLine="Formatter.GetDefaultFormat.TextColor = MainLabel.";
_formatter._getdefaultformat /*bwsi.PumpOperations.b4xformatter._b4xformatdata*/ ().TextColor /*int*/  = _mainlabel.getTextColor();
...
public ResumableSub_StartDownLoop(bwsi.PumpOperations.b4xplusminus parent,boolean _up) {
this.parent = parent;
this._up = _up;
}
bwsi.PumpOperations.b4xplusminus parent;
boolean _up;
int _myindex = 0;
