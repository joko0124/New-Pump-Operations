...
public class b4xformatter extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "bwsi.PumpOperations.b4xformatter");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", bwsi.PumpOperations.b4xformatter.class).invoke(this, new Object[] {null});
        else
...
public String  _addformatdata(bwsi.PumpOperations.b4xformatter._b4xformatdata _data,double _rangestart,double _rangeend,boolean _includeedges) throws Exception{
double _factor = 0;
...
public bwsi.PumpOperations.b4xformatter._b4xformatdata  _copyformatdata(bwsi.PumpOperations.b4xformatter._b4xformatdata _data) throws Exception{
bwsi.PumpOperations.b4xformatter._b4xformatdata _d = null;
...
_d = new bwsi.PumpOperations.b4xformatter._b4xformatdata();
...
public bwsi.PumpOperations.b4xformatter._b4xformatdata  _createdefaultformat() throws Exception{
bwsi.PumpOperations.b4xformatter._b4xformatdata _d = null;
...
bwsi.PumpOperations.b4xformatter._b4xformatdata _data = null;
...
public bwsi.PumpOperations.b4xformatter._b4xformatdata  _getdefaultformat() throws Exception{
...
if (true) return (bwsi.PumpOperations.b4xformatter._b4xformatdata)(_formats.Get((int) (0)));
 //BA.debugLineNum = 78;BA.debugLine="End Sub";
return null;
}
public bwsi.PumpOperations.b4xformatter._b4xformatdata  _getformatdata(double _number) throws Exception{
int _i = 0;
bwsi.PumpOperations.b4xformatter._b4xformatdata _d = null;
...
_d = (bwsi.PumpOperations.b4xformatter._b4xformatdata)(_formats.Get(_i));
...
public bwsi.PumpOperations.b4xformatter._b4xformatdata  _newformatdata() throws Exception{
