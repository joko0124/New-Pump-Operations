...
public class actjoreasons extends androidx.appcompat.app.AppCompatActivity implements B4AActivity{
	public static actjoreasons mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "bwsi.PumpOperations", "bwsi.PumpOperations.actjoreasons");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (actjoreasons).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "bwsi.PumpOperations", "bwsi.PumpOperations.actjoreasons");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "bwsi.PumpOperations.actjoreasons", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (actjoreasons) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (actjoreasons) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (actjoreasons) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (actjoreasons) Pause event (activity is not paused). **");
        if (mostCurrent != null)
...
public static class _joreasondetails{
...
mostCurrent._activity.LoadLayout("JOList",mostCurrent.activityBA);
 //BA.debugLineNum = 90;BA.debugLine="GlobalVar.CSTitle.Initialize.Size(15).Bold.Append";
mostCurrent._globalvar._cstitle /*anywheresoftware.b4a.objects.CSBuilder*/ .Initialize().Size((int) (15)).Bold().Append(BA.ObjectToCharSequence(mostCurrent._globalvar._selectedjodesc /*String*/ +(" - Job Order(s)"))).PopAll();
 //BA.debugLineNum = 91;BA.debugLine="GlobalVar.CSSubTitle.Initialize.Size(12).Append($";
mostCurrent._globalvar._cssubtitle /*anywheresoftware.b4a.objects.CSBuilder*/ .Initialize().Size((int) (12)).Append(BA.ObjectToCharSequence(("List of Job Orders"))).PopAll();
 //BA.debugLineNum = 93;BA.debugLine="ToolBar.InitMenuListener";
mostCurrent._toolbar.InitMenuListener();
 //BA.debugLineNum = 94;BA.debugLine="ToolBar.Title = GlobalVar.CSTitle";
mostCurrent._toolbar.setTitle(BA.ObjectToCharSequence(mostCurrent._globalvar._cstitle /*anywheresoftware.b4a.objects.CSBuilder*/ .getObject()));
 //BA.debugLineNum = 95;BA.debugLine="ToolBar.SubTitle = GlobalVar.CSSubTitle";
mostCurrent._toolbar.setSubTitle(BA.ObjectToCharSequence(mostCurrent._globalvar._cssubtitle /*anywheresoftware.b4a.objects.CSBuilder*/ .getObject()));
 //BA.debugLineNum = 97;BA.debugLine="Dim jo As JavaObject";
_jo = new anywheresoftware.b4j.object.JavaObject();
 //BA.debugLineNum = 98;BA.debugLine="Dim xl As XmlLayoutBuilder";
_xl = new anywheresoftware.b4a.object.XmlLayoutBuilder();
 //BA.debugLineNum = 99;BA.debugLine="jo = ToolBar";
_jo = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(mostCurrent._toolbar.getObject()));
 //BA.debugLineNum = 100;BA.debugLine="jo.RunMethod(\"setPopupTheme\", Array(xl.GetResourc";
_jo.RunMethod("setPopupTheme",new Object[]{(Object)(_xl.GetResourceId("style","ToolbarMenu"))});
 //BA.debugLineNum = 101;BA.debugLine="jo.RunMethod(\"setContentInsetStartWithNavigation\"";
...
if (_firsttime) { 
 //BA.debugLineNum = 111;BA.debugLine="FillJOList(GlobalVar.SelectedJOCatCode, GlobalVa";
_filljolist(mostCurrent._globalvar._selectedjocatcode /*String*/ ,mostCurrent._globalvar._selectedjodesc /*String*/ );
 //BA.debugLineNum = 112;BA.debugLine="HideDialogs";
_hidedialogs();
 };
...
de.amberhome.objects.appcompat.ACMenuItemWrapper _item = null;
 //BA.debugLineNum = 137;BA.debugLine="Sub Activity_CreateMenu(Menu As ACMenu)";
 //BA.debugLineNum = 138;BA.debugLine="Dim Item As ACMenuItem";
_item = new de.amberhome.objects.appcompat.ACMenuItemWrapper();
 //BA.debugLineNum = 140;BA.debugLine="Menu.Clear";
_menu.Clear();
 //BA.debugLineNum = 141;BA.debugLine="Menu.Add2(1, 1, \"Filter by\",xmlIcon.GetDrawable(\"";
_menu.Add2((int) (1),(int) (1),BA.ObjectToCharSequence("Filter by"),mostCurrent._xmlicon.GetDrawable("baseline_filter_alt_white_24dp")).setShowAsAction(_item.SHOW_AS_ACTION_IF_ROOM);
 //BA.debugLineNum = 143;BA.debugLine="CreateSubMenus";
_createsubmenus();
...
public static boolean  _activity_keypress(int _keycode) throws Exception{
 ...
 //BA.debugLineNum = 118;BA.debugLine="If KeyCode = 4 Then";
if (_keycode==4) { 
 //BA.debugLineNum = 119;BA.debugLine="ToolBar_NavigationItemClick";
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 127;BA.debugLine="FillJOList(GlobalVar.SelectedJOCatCode, GlobalVar";
_filljolist(mostCurrent._globalvar._selectedjocatcode /*String*/ ,mostCurrent._globalvar._selectedjodesc /*String*/ );
 //BA.debugLineNum = 128;BA.debugLine="HideDialogs";
_hidedialogs();
 //BA.debugLineNum = 129;BA.debugLine="End Sub";
return "";
}
public static String  _btnedit_click() throws Exception{
 //BA.debugLineNum = 601;BA.debugLine="Sub btnEdit_Click";
 //BA.debugLineNum = 603;BA.debugLine="End Sub";
return "";
}
public static String  _btnsasok_click() throws Exception{
 //BA.debugLineNum = 597;BA.debugLine="Sub btnSASOK_Click";
 //BA.debugLineNum = 598;BA.debugLine="HideDialogs";
_hidedialogs();
 //BA.debugLineNum = 599;BA.debugLine="End Sub";
return "";
}
public static String  _clvjos_itemclick(int _index,Object _value) throws Exception{
bwsi.PumpOperations.actjoreasons._joreasondetails _jorec = null;
 //BA.debugLineNum = 294;BA.debugLine="Sub clvJOs_ItemClick (Index As Int, Value As Objec";
 //BA.debugLineNum = 295;BA.debugLine="Dim JORec As JOReasonDetails = Value";
_jorec = (bwsi.PumpOperations.actjoreasons._joreasondetails)(_value);
 //BA.debugLineNum = 296;BA.debugLine="LogColor(Value, Colors.Yellow)";
anywheresoftware.b4a.keywords.Common.LogImpl("035061762",BA.ObjectToString(_value),anywheresoftware.b4a.keywords.Common.Colors.Yellow);
 //BA.debugLineNum = 297;BA.debugLine="LogColor(JORec.JOID, Colors.Red)";
anywheresoftware.b4a.keywords.Common.LogImpl("035061763",BA.NumberToString(_jorec.JOID /*int*/ ),anywheresoftware.b4a.keywords.Common.Colors.Red);
 //BA.debugLineNum = 298;BA.debugLine="LogColor(JORec.JONum, Colors.Magenta)";
anywheresoftware.b4a.keywords.Common.LogImpl("035061764",_jorec.JONum /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Magenta);
 //BA.debugLineNum = 299;BA.debugLine="LogColor(JORec.JOStatus, Colors.Red)";
anywheresoftware.b4a.keywords.Common.LogImpl("035061765",BA.NumberToString(_jorec.JOStatus /*int*/ ),anywheresoftware.b4a.keywords.Common.Colors.Red);
 //BA.debugLineNum = 301;BA.debugLine="GlobalVar.SelectedJOID = JORec.JOID";
mostCurrent._globalvar._selectedjoid /*int*/  = _jorec.JOID /*int*/ ;
 //BA.debugLineNum = 302;BA.debugLine="Select JORec.JOStatus";
switch (BA.switchObjectToInt(_jorec.JOStatus /*int*/ ,(int) (1),(int) (2),(int) (3),(int) (4),(int) (5))) {
case 0: {
 //BA.debugLineNum = 304;BA.debugLine="vibration.vibrateOnce(2000)";
mostCurrent._vibration.vibrateOnce(processBA,(long) (2000));
 //BA.debugLineNum = 305;BA.debugLine="ConfirmStartJO(JORec.JOID)";
_confirmstartjo(_jorec.JOID /*int*/ );
 break; }
case 1: {
 //BA.debugLineNum = 307;BA.debugLine="Select JORec.JOCatCode";
switch (BA.switchObjectToInt(_jorec.JOCatCode /*String*/ ,"MC")) {
case 0: {
 //BA.debugLineNum = 309;BA.debugLine="StartActivity(actMCJOFindings)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._actmcjofindings.getObject()));
 break; }
}
;
 break; }
case 2: {
 //BA.debugLineNum = 312;BA.debugLine="Select JORec.JOCatCode";
switch (BA.switchObjectToInt(_jorec.JOCatCode /*String*/ ,"SAS","NC","DC-CR","DC-DA","RC","CM")) {
case 0: {
 //BA.debugLineNum = 314;BA.debugLine="StartActivity(actJOAccomplishedSAS)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._actjoaccomplishedsas.getObject()));
 break; }
case 1: {
 //BA.debugLineNum = 316;BA.debugLine="StartActivity(actNCJOFindings)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._actncjofindings.getObject()));
 break; }
case 2: {
 //BA.debugLineNum = 318;BA.debugLine="StartActivity(actDCCRJOFindings)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._actdccrjofindings.getObject()));
 break; }
case 3: {
 //BA.debugLineNum = 320;BA.debugLine="StartActivity(actDCDAJOFindings)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._actdcdajofindings.getObject()));
 break; }
case 4: {
 //BA.debugLineNum = 322;BA.debugLine="StartActivity(actRCJOFindings)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._actrcjofindings.getObject()));
 break; }
case 5: {
 //BA.debugLineNum = 324;BA.debugLine="StartActivity(actCMJOFindings)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._actcmjofindings.getObject()));
 break; }
default: {
 //BA.debugLineNum = 326;BA.debugLine="ShowSASJODetails(JORec.JOID)";
...
bwsi.PumpOperations.actjoreasons._joreasondetails _jorec = null;
 //BA.debugLineNum = 334;BA.debugLine="Sub clvJOs_VisibleRangeChanged (FirstIndex As Int,";
 //BA.debugLineNum = 335;BA.debugLine="Dim ExtraSize As Int = 15 'List size";
_extrasize = (int) (15);
 //BA.debugLineNum = 336;BA.debugLine="clvJOs.Refresh";
mostCurrent._clvjos._refresh();
 //BA.debugLineNum = 338;BA.debugLine="For i = Max(0, FirstIndex - ExtraSize) To Min(Las";
{
final int step3 = 1;
...
for (;_i <= limit3 ;_i = _i + step3 ) {
 //BA.debugLineNum = 339;BA.debugLine="Dim Pnl As B4XView = clvJOs.GetPanel(i)";
_pnl = new anywheresoftware.b4a.objects.B4XViewWrapper();
_pnl = mostCurrent._clvjos._getpanel(_i);
 //BA.debugLineNum = 340;BA.debugLine="If i > FirstIndex - ExtraSize And i < LastIndex";
if (_i>_firstindex-_extrasize && _i<_lastindex+_extrasize) { 
 //BA.debugLineNum = 341;BA.debugLine="If Pnl.NumberOfViews = 0 Then 'Add each item/la";
if (_pnl.getNumberOfViews()==0) { 
 //BA.debugLineNum = 342;BA.debugLine="Dim JORec As JOReasonDetails = clvJOs.GetValue";
_jorec = (bwsi.PumpOperations.actjoreasons._joreasondetails)(mostCurrent._clvjos._getvalue(_i));
 //BA.debugLineNum = 343;BA.debugLine="Pnl.LoadLayout(\"JOInfo\")";
_pnl.LoadLayout("JOInfo",mostCurrent.activityBA);
 //BA.debugLineNum = 344;BA.debugLine="lblRefTitle.Text = $\"Account No.: \"$";
mostCurrent._lblreftitle.setText(BA.ObjectToCharSequence(("Account No.: ")));
 //BA.debugLineNum = 345;BA.debugLine="lblJONum.Text = JORec.JONum";
mostCurrent._lbljonum.setText(BA.ObjectToCharSequence(_jorec.JONum /*String*/ ));
 //BA.debugLineNum = 346;BA.debugLine="lblAppNo.Text = JORec.RefNo";
mostCurrent._lblappno.setText(BA.ObjectToCharSequence(_jorec.RefNo /*String*/ ));
 //BA.debugLineNum = 347;BA.debugLine="lblCustName.Text = JORec.CustName";
mostCurrent._lblcustname.setText(BA.ObjectToCharSequence(_jorec.CustName /*String*/ ));
 //BA.debugLineNum = 348;BA.debugLine="lblCustAddress.Text = JORec.CustAdd";
mostCurrent._lblcustaddress.setText(BA.ObjectToCharSequence(_jorec.CustAdd /*String*/ ));
 //BA.debugLineNum = 349;BA.debugLine="lblCustAddress.Ellipsize = \"END\"";
mostCurrent._lblcustaddress.setEllipsize("END");
 //BA.debugLineNum = 351;BA.debugLine="If JORec.JOStatus = 1 Then";
if (_jorec.JOStatus /*int*/ ==1) { 
 //BA.debugLineNum = 352;BA.debugLine="lblStatus.Color = GlobalVar.GrayColor";
mostCurrent._lblstatus.setColor((int) (mostCurrent._globalvar._graycolor /*double*/ ));
 //BA.debugLineNum = 353;BA.debugLine="lblStatus.Text = \"PENDING\"";
mostCurrent._lblstatus.setText(BA.ObjectToCharSequence("PENDING"));
 }else if(_jorec.JOStatus /*int*/ ==2) { 
 //BA.debugLineNum = 355;BA.debugLine="lblStatus.Color = GlobalVar.YellowColor";
mostCurrent._lblstatus.setColor((int) (mostCurrent._globalvar._yellowcolor /*double*/ ));
 //BA.debugLineNum = 356;BA.debugLine="lblStatus.Text = \"ON GOING\"";
mostCurrent._lblstatus.setText(BA.ObjectToCharSequence("ON GOING"));
 }else if(_jorec.JOStatus /*int*/ ==3) { 
 //BA.debugLineNum = 358;BA.debugLine="lblStatus.Color = GlobalVar.GreenColor";
mostCurrent._lblstatus.setColor((int) (mostCurrent._globalvar._greencolor /*double*/ ));
 //BA.debugLineNum = 359;BA.debugLine="lblStatus.Text = \"ACCOMPLISHED\"";
mostCurrent._lblstatus.setText(BA.ObjectToCharSequence("ACCOMPLISHED"));
 }else if(_jorec.JOStatus /*int*/ ==4) { 
 //BA.debugLineNum = 361;BA.debugLine="lblStatus.Color= GlobalVar.RedColor";
mostCurrent._lblstatus.setColor((int) (mostCurrent._globalvar._redcolor /*double*/ ));
 //BA.debugLineNum = 362;BA.debugLine="lblStatus.Text = \"CANCELLED\"";
mostCurrent._lblstatus.setText(BA.ObjectToCharSequence("CANCELLED"));
 }else if(_jorec.JOStatus /*int*/ ==5) { 
 //BA.debugLineNum = 364;BA.debugLine="lblStatus.Color= GlobalVar.BlueColor";
mostCurrent._lblstatus.setColor((int) (mostCurrent._globalvar._bluecolor /*double*/ ));
 //BA.debugLineNum = 365;BA.debugLine="lblStatus.Text = \"UPLOADED\"";
mostCurrent._lblstatus.setText(BA.ObjectToCharSequence("UPLOADED"));
 };
 };
 }else {
 //BA.debugLineNum = 369;BA.debugLine="If Pnl.NumberOfViews > 0 Then";
if (_pnl.getNumberOfViews()>0) { 
 //BA.debugLineNum = 370;BA.debugLine="Pnl.RemoveAllViews 'Remove none visable item/l";
_pnl.RemoveAllViews();
 };
 };
 }
...
public static String  _confirmstartjo(int _ijoid) throws Exception{
 //BA.debugLineNum = 605;BA.debugLine="Private Sub ConfirmStartJO(iJOID As Int)";
...
mostCurrent._alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 608;BA.debugLine="Alert.Initialize.Create _ 			.SetDialogStyleName(";
mostCurrent._alert.Initialize().Create(mostCurrent.activityBA).SetDialogStyleName("MyDialogDisableStatus").SetStyle(mostCurrent._alert.getSTYLE_DIALOGUE()).SetCancelable(anywheresoftware.b4a.keywords.Common.False).SetTitle("START JO").SetTitleColor((int) (mostCurrent._globalvar._bluecolor /*double*/ )).SetTitleTypeface((android.graphics.Typeface)(mostCurrent._fontbold.getObject())).SetMessage(("You are about to Start this JO,")+anywheresoftware.b4a.keywords.Common.CRLF+("JO Date & Time Started will be today.")+anywheresoftware.b4a.keywords.Common.CRLF+anywheresoftware.b4a.keywords.Common.CRLF+("Do you want to START this JO Now?")).SetPositiveText("Confirm").SetPositiveColor((int) (mostCurrent._globalvar._poscolor /*double*/ )).SetPositiveTypeface((android.graphics.Typeface)(mostCurrent._fontbold.getObject())).SetNegativeText("Cancel").SetNegativeColor((int) (mostCurrent._globalvar._negcolor /*double*/ )).SetNegativeTypeface((android.graphics.Typeface)(mostCurrent._font.getObject())).SetMessageTypeface((android.graphics.Typeface)(mostCurrent._font.getObject())).SetOnPositiveClicked(mostCurrent.activityBA,"JO_Started").SetOnNegativeClicked(mostCurrent.activityBA,"JO_Started").SetOnViewBinder(mostCurrent.activityBA,"JOFontSizeBinder");
 //BA.debugLineNum = 626;BA.debugLine="Alert.SetDialogBackground(MyFunctions.myCD)";
mostCurrent._alert.SetDialogBackground((android.graphics.drawable.Drawable)(mostCurrent._myfunctions._mycd /*anywheresoftware.b4a.objects.drawable.ColorDrawable*/ (mostCurrent.activityBA).getObject()));
 //BA.debugLineNum = 627;BA.debugLine="Alert.Build.Show";
...
anywheresoftware.b4a.objects.CSBuilder _cscan = null;
 //BA.debugLineNum = 146;BA.debugLine="Private Sub CreateSubMenus";
 //BA.debugLineNum = 147;BA.debugLine="Dim csAll, csPending, csAccomp, csOnGoing, csCan";
...
_cscan = new anywheresoftware.b4a.objects.CSBuilder();
 //BA.debugLineNum = 149;BA.debugLine="csAll.Initialize.Color(Colors.White).Append($\"All";
_csall.Initialize().Color(anywheresoftware.b4a.keywords.Common.Colors.White).Append(BA.ObjectToCharSequence(("All"))).PopAll();
 //BA.debugLineNum = 150;BA.debugLine="csPending.Initialize.Color(Colors.White).Append($";
_cspending.Initialize().Color(anywheresoftware.b4a.keywords.Common.Colors.White).Append(BA.ObjectToCharSequence(("Pending"))).PopAll();
 //BA.debugLineNum = 151;BA.debugLine="csOnGoing.Initialize.Color(Colors.White).Append($";
_csongoing.Initialize().Color(anywheresoftware.b4a.keywords.Common.Colors.White).Append(BA.ObjectToCharSequence(("On-Going"))).PopAll();
 //BA.debugLineNum = 152;BA.debugLine="csAccomp.Initialize.Color(Colors.White).Append($\"";
_csaccomp.Initialize().Color(anywheresoftware.b4a.keywords.Common.Colors.White).Append(BA.ObjectToCharSequence(("Accomplished"))).PopAll();
 //BA.debugLineNum = 153;BA.debugLine="csCan.Initialize.Color(Colors.White).Append($\"Can";
_cscan.Initialize().Color(anywheresoftware.b4a.keywords.Common.Colors.White).Append(BA.ObjectToCharSequence(("Cancelled"))).PopAll();
 //BA.debugLineNum = 155;BA.debugLine="PopSubMenu.Initialize(\"FilterBy\", ToolBar.GetView";
mostCurrent._popsubmenu.Initialize(mostCurrent.activityBA,"FilterBy",(android.view.View)(mostCurrent._toolbar.GetView((int) (3)).getObject()));
 //BA.debugLineNum = 156;BA.debugLine="PopSubMenu.AddMenuItem(0,csAll,xmlIcon.GetDrawabl";
mostCurrent._popsubmenu.AddMenuItem((int) (0),BA.ObjectToCharSequence(_csall.getObject()),mostCurrent._xmlicon.GetDrawable("ic_select_all_white_24dp"));
 //BA.debugLineNum = 157;BA.debugLine="PopSubMenu.AddMenuItem(1,csPending,xmlIcon.GetDra";
mostCurrent._popsubmenu.AddMenuItem((int) (1),BA.ObjectToCharSequence(_cspending.getObject()),mostCurrent._xmlicon.GetDrawable("baseline_pending_actions_white_24dp"));
 //BA.debugLineNum = 158;BA.debugLine="PopSubMenu.AddMenuItem(2,csOnGoing,xmlIcon.GetDra";
mostCurrent._popsubmenu.AddMenuItem((int) (2),BA.ObjectToCharSequence(_csongoing.getObject()),mostCurrent._xmlicon.GetDrawable("baseline_engineering_white_24dp"));
 //BA.debugLineNum = 159;BA.debugLine="PopSubMenu.AddMenuItem(3,csAccomp,xmlIcon.GetDraw";
mostCurrent._popsubmenu.AddMenuItem((int) (3),BA.ObjectToCharSequence(_csaccomp.getObject()),mostCurrent._xmlicon.GetDrawable("baseline_assignment_turned_in_white_24dp"));
 //BA.debugLineNum = 160;BA.debugLine="PopSubMenu.AddMenuItem(4,csCan,xmlIcon.GetDrawabl";
...
com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder _infomsg = null;
 //BA.debugLineNum = 685;BA.debugLine="Private Sub DispInfoMsg(sMsg As String, sTitle As";
 //BA.debugLineNum = 687;BA.debugLine="Dim InfoMsg As AX_CustomAlertDialog";
_infomsg = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 689;BA.debugLine="InfoMsg.Initialize.Create _ 			.SetDialogStyleNam";
_infomsg.Initialize().Create(mostCurrent.activityBA).SetDialogStyleName("MyDialogDisableStatus").SetStyle(_infomsg.getSTYLE_DIALOGUE()).SetCancelable(anywheresoftware.b4a.keywords.Common.False).SetTitle(_stitle).SetMessage(_smsg).SetPositiveText("OK").SetPositiveColor((int) (mostCurrent._globalvar._poscolor /*double*/ )).SetPositiveTypeface((android.graphics.Typeface)(mostCurrent._fontbold.getObject())).SetTitleTypeface((android.graphics.Typeface)(mostCurrent._font.getObject())).SetMessageTypeface((android.graphics.Typeface)(mostCurrent._font.getObject())).SetOnPositiveClicked(mostCurrent.activityBA,"MessageBox").SetOnViewBinder(mostCurrent.activityBA,"FontSizeBinder");
 //BA.debugLineNum = 703;BA.debugLine="InfoMsg.SetDialogBackground(MyFunctions.myCD)";
_infomsg.SetDialogBackground((android.graphics.drawable.Drawable)(mostCurrent._myfunctions._mycd /*anywheresoftware.b4a.objects.drawable.ColorDrawable*/ (mostCurrent.activityBA).getObject()));
 //BA.debugLineNum = 704;BA.debugLine="InfoMsg.Build.Show";
_infomsg.Build().Show();
 //BA.debugLineNum = 705;BA.debugLine="End Sub";
return "";
}
public static void  _filljolist(String _sselectedjocat,String _sselectedjodesc) throws Exception{
ResumableSub_FillJOList rsub = new ResumableSub_FillJOList(null,_sselectedjocat,_sselectedjodesc);
rsub.resume(processBA, null);
}
public static class ResumableSub_FillJOList extends BA.ResumableSub {
public ResumableSub_FillJOList(bwsi.PumpOperations.actjoreasons parent,String _sselectedjocat,String _sselectedjodesc) {
this.parent = parent;
this._sselectedjocat = _sselectedjocat;
this._sselectedjodesc = _sselectedjodesc;
}
bwsi.PumpOperations.actjoreasons parent;
String _sselectedjocat;
String _sselectedjodesc;
...
this.state = 4;
this.catchState = 15;
 //BA.debugLineNum = 186;BA.debugLine="Starter.strCriteria = \"SELECT * FROM tblJOs \" &";
parent.mostCurrent._starter._strcriteria /*String*/  = "SELECT * FROM tblJOs "+"WHERE JOCatCode = '"+_sselectedjocat+"' "+"AND JoDesc = '"+_sselectedjodesc+"' "+"ORDER BY JOCreatedAt ASC";
 //BA.debugLineNum = 190;BA.debugLine="LogColor(Starter.strCriteria, Colors.Yellow)";
anywheresoftware.b4a.keywords.Common.LogImpl("034930695",parent.mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
 //BA.debugLineNum = 192;BA.debugLine="SenderFilter = Starter.DBCon.ExecQueryAsync(\"SQL";
_senderfilter = parent.mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQueryAsync(processBA,"SQL",parent.mostCurrent._starter._strcriteria /*String*/ ,(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(anywheresoftware.b4a.keywords.Common.Null)));
 //BA.debugLineNum = 193;BA.debugLine="Wait For (SenderFilter) SQL_QueryComplete (Succe";
...
;
 //BA.debugLineNum = 194;BA.debugLine="If Success Then";
if (true) break;
...
//C
this.state = 7;
 //BA.debugLineNum = 195;BA.debugLine="Dim StartTime As Long = DateTime.Now";
_starttime = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 196;BA.debugLine="clvJOs.Clear";
...
//C
this.state = 7;
 //BA.debugLineNum = 198;BA.debugLine="Dim JORec As JOReasonDetails";
_jorec = new bwsi.PumpOperations.actjoreasons._joreasondetails();
 //BA.debugLineNum = 199;BA.debugLine="JORec.Initialize";
_jorec.Initialize();
 //BA.debugLineNum = 200;BA.debugLine="JORec.JOID = RS.GetInt(\"JOID\")";
_jorec.JOID /*int*/  = _rs.GetInt("JOID");
 //BA.debugLineNum = 201;BA.debugLine="JORec.JONum = GlobalVar.SF.Upper(RS.GetString(";
_jorec.JONum /*String*/  = parent.mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv5(_rs.GetString("JONo"));
 //BA.debugLineNum = 202;BA.debugLine="JORec.JOCatCode = GlobalVar.SF.Upper(RS.GetStr";
_jorec.JOCatCode /*String*/  = parent.mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv5(_rs.GetString("JOCatCode"));
 //BA.debugLineNum = 203;BA.debugLine="JORec.RefID= RS.GetInt(\"RefID\")";
_jorec.RefID /*int*/  = _rs.GetInt("RefID");
 //BA.debugLineNum = 204;BA.debugLine="JORec.RefNo= GlobalVar.SF.Upper(RS.GetString(\"";
_jorec.RefNo /*String*/  = parent.mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv5(_rs.GetString("RefNo"));
 //BA.debugLineNum = 205;BA.debugLine="JORec.CustName = GlobalVar.SF.Upper(RS.GetStri";
_jorec.CustName /*String*/  = parent.mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv5(_rs.GetString("CustName"));
 //BA.debugLineNum = 206;BA.debugLine="JORec.CustAdd = GlobalVar.SF.Upper(RS.GetStrin";
_jorec.CustAdd /*String*/  = parent.mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv5(_rs.GetString("CustAddress"));
 //BA.debugLineNum = 207;BA.debugLine="JORec.AcctClass = GlobalVar.SF.Upper(RS.GetStr";
_jorec.AcctClass /*String*/  = parent.mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv5(_rs.GetString("AcctClass"));
 //BA.debugLineNum = 208;BA.debugLine="JORec.AcctSubClass = GlobalVar.SF.Upper(RS.Get";
_jorec.AcctSubClass /*String*/  = parent.mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv5(_rs.GetString("AcctSubClass"));
 //BA.debugLineNum = 209;BA.debugLine="JORec.JOStatus = RS.GetInt(\"JOStatus\")";
_jorec.JOStatus /*int*/  = _rs.GetInt("JOStatus");
 //BA.debugLineNum = 211;BA.debugLine="Dim Pnl As B4XView = xui.CreatePanel(\"\")";
_pnl = new anywheresoftware.b4a.objects.B4XViewWrapper();
_pnl = parent._xui.CreatePanel(processBA,"");
 //BA.debugLineNum = 212;BA.debugLine="Pnl.SetLayoutAnimated(0, 10dip, 0, clvJOs.AsVi";
_pnl.SetLayoutAnimated((int) (0),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(int) (0),parent.mostCurrent._clvjos._asview().getWidth(),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (150)));
 //BA.debugLineNum = 213;BA.debugLine="clvJOs.Add(Pnl, JORec)";
...
this.state = 13;
;
 //BA.debugLineNum = 215;BA.debugLine="lblCount.Text = RS.RowCount & $\" Record(s) Foun";
...
//C
this.state = 13;
 //BA.debugLineNum = 217;BA.debugLine="snack.Initialize(\"\", Activity,$\"\"$ & LastExcept";
parent.mostCurrent._snack.Initialize(mostCurrent.activityBA,"",(android.view.View)(parent.mostCurrent._activity.getObject()),("")+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),(int) (5000));
 //BA.debugLineNum = 218;BA.debugLine="MyFunctions.SetSnackBarTextColor(snack, Colors.";
parent.mostCurrent._myfunctions._setsnackbartextcolor /*String*/ (mostCurrent.activityBA,parent.mostCurrent._snack,anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 219;BA.debugLine="MyFunctions.SetSnackBarBackground(snack, Global";
parent.mostCurrent._myfunctions._setsnackbarbackground /*String*/ (mostCurrent.activityBA,parent.mostCurrent._snack,(int) (parent.mostCurrent._globalvar._redcolor /*double*/ ));
 //BA.debugLineNum = 220;BA.debugLine="snack.Show";
parent.mostCurrent._snack.Show();
 //BA.debugLineNum = 221;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("034930726",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("034930731",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
public static String  _filterby_itemclicked(de.amberhome.objects.appcompat.ACMenuItemWrapper _item) throws Exception{
 //BA.debugLineNum = 175;BA.debugLine="Sub FilterBy_ItemClicked (Item As ACMenuItem)";
 //BA.debugLineNum = 176;BA.debugLine="Log(\"Popupmenu Item clicked: \" & Item.Id & \" - \"";
anywheresoftware.b4a.keywords.Common.LogImpl("034865153","Popupmenu Item clicked: "+BA.NumberToString(_item.getId())+" - "+_item.getTitle(),0);
 //BA.debugLineNum = 177;BA.debugLine="FilterJoList(GlobalVar.SelectedJOCatCode, GlobalV";
_filterjolist(mostCurrent._globalvar._selectedjocatcode /*String*/ ,mostCurrent._globalvar._selectedjodesc /*String*/ ,_item.getId());
 //BA.debugLineNum = 178;BA.debugLine="End Sub";
return "";
}
public static void  _filterjolist(String _sselectedjocat,String _sselectedjodesc,int _istatus) throws Exception{
ResumableSub_FilterJoList rsub = new ResumableSub_FilterJoList(null,_sselectedjocat,_sselectedjodesc,_istatus);
rsub.resume(processBA, null);
}
public static class ResumableSub_FilterJoList extends BA.ResumableSub {
public ResumableSub_FilterJoList(bwsi.PumpOperations.actjoreasons parent,String _sselectedjocat,String _sselectedjodesc,int _istatus) {
this.parent = parent;
this._sselectedjocat = _sselectedjocat;
this._sselectedjodesc = _sselectedjodesc;
...
//C
this.state = 1;
 //BA.debugLineNum = 232;BA.debugLine="Dim SenderFilter As Object";
_senderfilter = new Object();
 //BA.debugLineNum = 234;BA.debugLine="clvJOs.Clear";
parent.mostCurrent._clvjos._clear();
...
this.state = 4;
this.catchState = 24;
 //BA.debugLineNum = 237;BA.debugLine="If iStatus = 0 Then";
if (true) break;
...
//C
this.state = 7;
 //BA.debugLineNum = 238;BA.debugLine="clvJOs.Clear";
parent.mostCurrent._clvjos._clear();
 //BA.debugLineNum = 239;BA.debugLine="clvJOs.Refresh";
parent.mostCurrent._clvjos._refresh();
 //BA.debugLineNum = 240;BA.debugLine="FillJOList(sSelectedJOCat, sSelectedJODesc)";
_filljolist(_sselectedjocat,_sselectedjodesc);
...
this.state = 12;
this.catchState = 11;
 //BA.debugLineNum = 244;BA.debugLine="Starter.strCriteria = \"SELECT * FROM tblJOs \" &";
...
anywheresoftware.b4a.keywords.Common.LogImpl("034996242",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
this.catchState = 24;
;
 //BA.debugLineNum = 253;BA.debugLine="LogColor(Starter.strCriteria, Colors.Yellow)";
anywheresoftware.b4a.keywords.Common.LogImpl("034996246",parent.mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
 //BA.debugLineNum = 254;BA.debugLine="SenderFilter = Starter.DBCon.ExecQueryAsync(\"SQL";
_senderfilter = parent.mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQueryAsync(processBA,"SQL",parent.mostCurrent._starter._strcriteria /*String*/ ,(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(anywheresoftware.b4a.keywords.Common.Null)));
 //BA.debugLineNum = 255;BA.debugLine="Wait For (SenderFilter) SQL_QueryComplete (Succe";
anywheresoftware.b4a.keywords.Common.WaitFor("sql_querycomplete", processBA, this, _senderfilter);
this.state = 26;
return;
case 26:
...
_rs = (anywheresoftware.b4a.sql.SQL.ResultSetWrapper) result[1];
;
 //BA.debugLineNum = 256;BA.debugLine="If Success Then";
if (true) break;
...
_starttime = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 258;BA.debugLine="Do While RS.NextRow";
if (true) break;
...
//C
this.state = 16;
 //BA.debugLineNum = 259;BA.debugLine="Dim JORec As JOReasonDetails";
_jorec = new bwsi.PumpOperations.actjoreasons._joreasondetails();
 //BA.debugLineNum = 260;BA.debugLine="JORec.Initialize";
_jorec.Initialize();
 //BA.debugLineNum = 261;BA.debugLine="JORec.JOID = RS.GetInt(\"JOID\")";
_jorec.JOID /*int*/  = _rs.GetInt("JOID");
 //BA.debugLineNum = 262;BA.debugLine="JORec.JONum = GlobalVar.SF.Upper(RS.GetString(";
_jorec.JONum /*String*/  = parent.mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv5(_rs.GetString("JONo"));
 //BA.debugLineNum = 263;BA.debugLine="JORec.JOCatCode = GlobalVar.SF.Upper(RS.GetStr";
_jorec.JOCatCode /*String*/  = parent.mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv5(_rs.GetString("JOCatCode"));
 //BA.debugLineNum = 264;BA.debugLine="JORec.RefID= RS.GetInt(\"RefID\")";
_jorec.RefID /*int*/  = _rs.GetInt("RefID");
 //BA.debugLineNum = 265;BA.debugLine="JORec.RefNo= GlobalVar.SF.Upper(RS.GetString(\"";
_jorec.RefNo /*String*/  = parent.mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv5(_rs.GetString("RefNo"));
 //BA.debugLineNum = 266;BA.debugLine="JORec.CustName = GlobalVar.SF.Upper(RS.GetStri";
_jorec.CustName /*String*/  = parent.mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv5(_rs.GetString("CustName"));
 //BA.debugLineNum = 267;BA.debugLine="JORec.CustAdd = GlobalVar.SF.Upper(RS.GetStrin";
_jorec.CustAdd /*String*/  = parent.mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv5(_rs.GetString("CustAddress"));
 //BA.debugLineNum = 268;BA.debugLine="JORec.AcctClass = GlobalVar.SF.Upper(RS.GetStr";
_jorec.AcctClass /*String*/  = parent.mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv5(_rs.GetString("AcctClass"));
 //BA.debugLineNum = 269;BA.debugLine="JORec.AcctSubClass = GlobalVar.SF.Upper(RS.Get";
_jorec.AcctSubClass /*String*/  = parent.mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv5(_rs.GetString("AcctSubClass"));
 //BA.debugLineNum = 270;BA.debugLine="JORec.JOStatus = RS.GetInt(\"JOStatus\")";
_jorec.JOStatus /*int*/  = _rs.GetInt("JOStatus");
 //BA.debugLineNum = 273;BA.debugLine="Dim Pnl As B4XView = xui.CreatePanel(\"\")";
_pnl = new anywheresoftware.b4a.objects.B4XViewWrapper();
_pnl = parent._xui.CreatePanel(processBA,"");
 //BA.debugLineNum = 274;BA.debugLine="Pnl.SetLayoutAnimated(0, 10dip, 0, clvJOs.AsVi";
_pnl.SetLayoutAnimated((int) (0),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(int) (0),parent.mostCurrent._clvjos._asview().getWidth(),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (150)));
 //BA.debugLineNum = 275;BA.debugLine="clvJOs.Add(Pnl, JORec)";
parent.mostCurrent._clvjos._add(_pnl,(Object)(_jorec));
 if (true) break;
...
this.state = 22;
;
 //BA.debugLineNum = 277;BA.debugLine="lblCount.Text = RS.RowCount & $\" Record(s) Foun";
parent.mostCurrent._lblcount.setText(BA.ObjectToCharSequence(BA.NumberToString(_rs.getRowCount())+(" Record(s) Found")));
 if (true) break;
...
//C
this.state = 22;
 //BA.debugLineNum = 279;BA.debugLine="snack.Initialize(\"\", Activity,$\"\"$ & LastExcept";
parent.mostCurrent._snack.Initialize(mostCurrent.activityBA,"",(android.view.View)(parent.mostCurrent._activity.getObject()),("")+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),(int) (5000));
 //BA.debugLineNum = 280;BA.debugLine="MyFunctions.SetSnackBarTextColor(snack, Colors.";
parent.mostCurrent._myfunctions._setsnackbartextcolor /*String*/ (mostCurrent.activityBA,parent.mostCurrent._snack,anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 281;BA.debugLine="MyFunctions.SetSnackBarBackground(snack, Global";
parent.mostCurrent._myfunctions._setsnackbarbackground /*String*/ (mostCurrent.activityBA,parent.mostCurrent._snack,(int) (parent.mostCurrent._globalvar._redcolor /*double*/ ));
 //BA.debugLineNum = 282;BA.debugLine="snack.Show";
parent.mostCurrent._snack.Show();
 //BA.debugLineNum = 283;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("034996276",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
...
this.state = 25;
;
 //BA.debugLineNum = 286;BA.debugLine="Log($\"List of Job Order Records = ${NumberFormat";
anywheresoftware.b4a.keywords.Common.LogImpl("034996279",("List of Job Order Records = "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(anywheresoftware.b4a.keywords.Common.NumberFormat2((anywheresoftware.b4a.keywords.Common.DateTime.getNow()-_starttime)/(double)1000,(int) (0),(int) (2),(int) (2),anywheresoftware.b4a.keywords.Common.False)))+" seconds to populate "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(parent.mostCurrent._clvjos._getsize()))+" SAS JO Records"),0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("034996281",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
mostCurrent._popsubmenu = new de.amberhome.objects.appcompat.ACPopupMenuWrapper();
 //BA.debugLineNum = 47;BA.debugLine="Type JOReasonDetails (JOID As Int, JONum As Strin";
;
...
public static String  _hidedialogs() throws Exception{
 //BA.debugLineNum = 742;BA.debugLine="Private Sub HideDialogs";
 //BA.debugLineNum = 743;BA.debugLine="pnlSASDetails.Visible = False";
...
public static String  _jo_started_onnegativeclicked(anywheresoftware.b4a.objects.ConcreteViewWrapper _view,Object _dialog) throws Exception{
 //BA.debugLineNum = 632;BA.debugLine="Private Sub JO_Started_OnNegativeClicked (View As";
 //BA.debugLineNum = 634;BA.debugLine="vibration.vibrateCancel";
mostCurrent._vibration.vibrateCancel(processBA);
 //BA.debugLineNum = 635;BA.debugLine="Alert.Initialize.Dismiss(Dialog)";
...
public static String  _jo_started_onpositiveclicked(anywheresoftware.b4a.objects.ConcreteViewWrapper _view,Object _dialog) throws Exception{
 //BA.debugLineNum = 638;BA.debugLine="Private Sub JO_Started_OnPositiveClicked (View As";
 //BA.debugLineNum = 640;BA.debugLine="vibration.vibrateCancel";
mostCurrent._vibration.vibrateCancel(processBA);
 //BA.debugLineNum = 641;BA.debugLine="LogColor(GlobalVar.SelectedJOID, Colors.Cyan)";
anywheresoftware.b4a.keywords.Common.LogImpl("035848195",BA.NumberToString(mostCurrent._globalvar._selectedjoid /*int*/ ),anywheresoftware.b4a.keywords.Common.Colors.Cyan);
 //BA.debugLineNum = 643;BA.debugLine="If StartJO(GlobalVar.SelectedJOID) = True Then";
if (_startjo(mostCurrent._globalvar._selectedjoid /*int*/ )==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 644;BA.debugLine="Alert.Initialize.Dismiss(Dialog)";
mostCurrent._alert.Initialize().Dismiss((android.app.Dialog)(_dialog));
 //BA.debugLineNum = 645;BA.debugLine="FillJOList(GlobalVar.SelectedJOCatCode, GlobalVa";
_filljolist(mostCurrent._globalvar._selectedjocatcode /*String*/ ,mostCurrent._globalvar._selectedjodesc /*String*/ );
 //BA.debugLineNum = 646;BA.debugLine="DispInfoMsg($\"Selected JO Started...\"$, $\"JO UPD";
...
anywheresoftware.b4a.objects.CSBuilder _cs = null;
 //BA.debugLineNum = 653;BA.debugLine="Private Sub JOFontSizeBinder_OnBindView (View As V";
 //BA.debugLineNum = 654;BA.debugLine="Dim Alert As AX_CustomAlertDialog";
mostCurrent._alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 655;BA.debugLine="Alert.Initialize";
mostCurrent._alert.Initialize();
 //BA.debugLineNum = 656;BA.debugLine="If ViewType = Alert.VIEW_TITLE Then ' Title";
if (_viewtype==mostCurrent._alert.VIEW_TITLE) { 
 //BA.debugLineNum = 657;BA.debugLine="Dim lbl As Label = View";
...
_cs = new anywheresoftware.b4a.objects.CSBuilder();
 //BA.debugLineNum = 666;BA.debugLine="CS.Initialize.Typeface(Typeface.DEFAULT_BOLD).Ty";
_cs.Initialize().Typeface(anywheresoftware.b4a.keywords.Common.Typeface.DEFAULT_BOLD).Typeface(anywheresoftware.b4a.keywords.Common.Typeface.getMATERIALICONS()).Size((int) (26)).Color(anywheresoftware.b4a.keywords.Common.Colors.Red).Append(BA.ObjectToCharSequence(BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (0xe066)))+" "));
 //BA.debugLineNum = 667;BA.debugLine="CS.Typeface(Font).Size(22).Append(lbl.Text).Pop";
_cs.Typeface((android.graphics.Typeface)(mostCurrent._font.getObject())).Size((int) (22)).Append(BA.ObjectToCharSequence(_lbl.getText())).Pop();
 //BA.debugLineNum = 669;BA.debugLine="lbl.Text = CS.PopAll";
_lbl.setText(BA.ObjectToCharSequence(_cs.PopAll().getObject()));
 };
 //BA.debugLineNum = 671;BA.debugLine="If ViewType = Alert.VIEW_MESSAGE Then";
if (_viewtype==mostCurrent._alert.VIEW_MESSAGE) { 
 //BA.debugLineNum = 672;BA.debugLine="Dim lbl As Label = View";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
_lbl = (anywheresoftware.b4a.objects.LabelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.LabelWrapper(), (android.widget.TextView)(_view.getObject()));
 //BA.debugLineNum = 673;BA.debugLine="lbl.TextSize = 16";
_lbl.setTextSize((float) (16));
 //BA.debugLineNum = 674;BA.debugLine="lbl.TextColor = Colors.Gray";
_lbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Gray);
 };
 //BA.debugLineNum = 677;BA.debugLine="If ViewType = Alert.VIEW_NEGATIVE Or ViewType = A";
...
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
_lbl = (anywheresoftware.b4a.objects.LabelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.LabelWrapper(), (android.widget.TextView)(_view.getObject()));
 //BA.debugLineNum = 679;BA.debugLine="lbl.TextSize = 18";
...
public static String  _messagebox_onpositiveclicked(anywheresoftware.b4a.objects.ConcreteViewWrapper _view,Object _dialog) throws Exception{
 //BA.debugLineNum = 707;BA.debugLine="Private Sub MessageBox_OnPositiveClicked (View As";
...
public static String  _pnlsasdetails_click() throws Exception{
 //BA.debugLineNum = 593;BA.debugLine="Sub pnlSASDetails_Click";
...
public static String  _pnlsasdetails_touch(int _action,float _x,float _y) throws Exception{
 //BA.debugLineNum = 589;BA.debugLine="Sub pnlSASDetails_Touch (Action As Int, X As Float";
...
public ResumableSub_ShowJODetails(bwsi.PumpOperations.actjoreasons parent,int _iid,String _scatcode) {
this.parent = parent;
this._iid = _iid;
...
//C
this.state = 1;
 //BA.debugLineNum = 432;BA.debugLine="Dim csTitle As CSBuilder";
_cstitle = new anywheresoftware.b4a.objects.CSBuilder();
 //BA.debugLineNum = 433;BA.debugLine="Dim SenderFilter As Object";
_senderfilter = new Object();
 //BA.debugLineNum = 434;BA.debugLine="Dim sJONo, sJOCatCode, sJODesc, sRefNo, sCustName";
_sjono = "";
_sjocatcode = "";
_sjodesc = "";
_srefno = "";
...
_sacctclass = "";
_scontype = "";
 //BA.debugLineNum = 435;BA.debugLine="Dim sDateCreated, sDateStart, sDateFinished As St";
_sdatecreated = "";
_sdatestart = "";
_sdatefinished = "";
 //BA.debugLineNum = 438;BA.debugLine="sJONo = \"\"";
_sjono = "";
 //BA.debugLineNum = 439;BA.debugLine="sJODesc = \"\"";
_sjodesc = "";
 //BA.debugLineNum = 440;BA.debugLine="sRefNo = \"\"";
_srefno = "";
 //BA.debugLineNum = 441;BA.debugLine="sCustName = \"\"";
_scustname = "";
 //BA.debugLineNum = 442;BA.debugLine="sCustAdd = \"\"";
_scustadd = "";
 //BA.debugLineNum = 443;BA.debugLine="sAcctClass = \"\"";
_sacctclass = "";
 //BA.debugLineNum = 444;BA.debugLine="sDateCreated = \"\"";
_sdatecreated = "";
 //BA.debugLineNum = 445;BA.debugLine="sDateStart = \"\"";
_sdatestart = "";
 //BA.debugLineNum = 446;BA.debugLine="sDateFinished = \"\"";
_sdatefinished = "";
 //BA.debugLineNum = 447;BA.debugLine="sConType = \"\"";
_scontype = "";
 //BA.debugLineNum = 449;BA.debugLine="GlobalVar.TranHeaderID = DBaseFunctions.GetHeader";
...
this.state = 4;
this.catchState = 11;
 //BA.debugLineNum = 451;BA.debugLine="Starter.strCriteria = \"SELECT JO.JONo, JO.JoDesc";
parent.mostCurrent._starter._strcriteria /*String*/  = "SELECT JO.JONo, JO.JoDesc, "+"JO.RefNo AS App_AcctNo, JO.CustName, JO.CustAddress, "+"JO.AcctClass, JO.AcctSubClass, JO.ConType, "+"JO.JOCreatedAt, JO.DateStarted, JO.DateFinished "+"FROM tblJOs AS JO "+"WHERE JO.JOID = "+BA.NumberToString(_iid);
 //BA.debugLineNum = 458;BA.debugLine="SenderFilter = Starter.DBCon.ExecQueryAsync(\"SQL";
_senderfilter = parent.mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQueryAsync(processBA,"SQL",parent.mostCurrent._starter._strcriteria /*String*/ ,(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(anywheresoftware.b4a.keywords.Common.Null)));
 //BA.debugLineNum = 459;BA.debugLine="Wait For (SenderFilter) SQL_QueryComplete (Succe";
anywheresoftware.b4a.keywords.Common.WaitFor("sql_querycomplete", processBA, this, _senderfilter);
this.state = 24;
return;
case 24:
...
_rs = (anywheresoftware.b4a.sql.SQL.ResultSetWrapper) result[1];
;
 //BA.debugLineNum = 461;BA.debugLine="If Success Then";
if (true) break;
...
//C
this.state = 9;
 //BA.debugLineNum = 462;BA.debugLine="RS.Position = 0";
_rs.setPosition((int) (0));
 //BA.debugLineNum = 463;BA.debugLine="sJONo = RS.GetString(\"JONo\")";
_sjono = _rs.GetString("JONo");
 //BA.debugLineNum = 464;BA.debugLine="sJODesc = RS.GetString(\"JoDesc\")";
_sjodesc = _rs.GetString("JoDesc");
 //BA.debugLineNum = 465;BA.debugLine="sRefNo = RS.GetString(\"App_AcctNo\")";
_srefno = _rs.GetString("App_AcctNo");
 //BA.debugLineNum = 466;BA.debugLine="sCustName = RS.GetString(\"CustName\")";
_scustname = _rs.GetString("CustName");
 //BA.debugLineNum = 467;BA.debugLine="sCustAdd = RS.GetString(\"CustAddress\")";
_scustadd = _rs.GetString("CustAddress");
 //BA.debugLineNum = 468;BA.debugLine="sAcctClass = RS.GetString(\"AcctClass\") & \"-\" &";
_sacctclass = _rs.GetString("AcctClass")+"-"+_rs.GetString("AcctSubClass");
 //BA.debugLineNum = 469;BA.debugLine="sConType = RS.GetString(\"ConType\")";
_scontype = _rs.GetString("ConType");
 //BA.debugLineNum = 470;BA.debugLine="sDateCreated = RS.GetString(\"JOCreatedAt\")";
_sdatecreated = _rs.GetString("JOCreatedAt");
 //BA.debugLineNum = 471;BA.debugLine="sDateStart = RS.GetString(\"DateStarted\")";
_sdatestart = _rs.GetString("DateStarted");
 //BA.debugLineNum = 472;BA.debugLine="sDateFinished = RS.GetString(\"DateFinished\")";
...
//C
this.state = 9;
 //BA.debugLineNum = 474;BA.debugLine="snack.Initialize(\"\", Activity,$\"\"$ & LastExcept";
parent.mostCurrent._snack.Initialize(mostCurrent.activityBA,"",(android.view.View)(parent.mostCurrent._activity.getObject()),("")+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),(int) (5000));
 //BA.debugLineNum = 475;BA.debugLine="MyFunctions.SetSnackBarTextColor(snack, Colors.";
parent.mostCurrent._myfunctions._setsnackbartextcolor /*String*/ (mostCurrent.activityBA,parent.mostCurrent._snack,anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 476;BA.debugLine="MyFunctions.SetSnackBarBackground(snack, Global";
parent.mostCurrent._myfunctions._setsnackbarbackground /*String*/ (mostCurrent.activityBA,parent.mostCurrent._snack,(int) (parent.mostCurrent._globalvar._redcolor /*double*/ ));
 //BA.debugLineNum = 477;BA.debugLine="snack.Show";
parent.mostCurrent._snack.Show();
 //BA.debugLineNum = 478;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("035323951",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("035323955",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
;
 //BA.debugLineNum = 485;BA.debugLine="If sCatCode = \"SAS\" Then";
...
//C
this.state = 17;
 //BA.debugLineNum = 486;BA.debugLine="sJOCatCode = \"Application No. :\"";
...
//C
this.state = 17;
 //BA.debugLineNum = 488;BA.debugLine="sJOCatCode = \"Account No. :\"";
...
this.state = 18;
;
 //BA.debugLineNum = 491;BA.debugLine="csTitle.Initialize.Size(18).Bold.Color(GlobalVar.";
_cstitle.Initialize().Size((int) (18)).Bold().Color((int) (parent.mostCurrent._globalvar._bluecolor /*double*/ )).Append(BA.ObjectToCharSequence(_scatcode+(" ")+("JO DETAILS"))).PopAll();
 //BA.debugLineNum = 493;BA.debugLine="If sCatCode = \"SAS\" Then";
if (true) break;
...
//C
this.state = 23;
 //BA.debugLineNum = 494;BA.debugLine="MatDialogBuilder.Initialize(\"JODetails\")";
parent.mostCurrent._matdialogbuilder.Initialize(mostCurrent.activityBA,"JODetails");
 //BA.debugLineNum = 495;BA.debugLine="MatDialogBuilder.PositiveText(\"OK\").PositiveColo";
parent.mostCurrent._matdialogbuilder.PositiveText(BA.ObjectToCharSequence("OK")).PositiveColor((int) (parent.mostCurrent._globalvar._poscolor /*double*/ ));
 //BA.debugLineNum = 496;BA.debugLine="MatDialogBuilder.NeutralText(\"EDIT\").NeutralColo";
parent.mostCurrent._matdialogbuilder.NeutralText(BA.ObjectToCharSequence("EDIT")).NeutralColor((int) (parent.mostCurrent._globalvar._redcolor /*double*/ ));
 //BA.debugLineNum = 497;BA.debugLine="MatDialogBuilder.Title(csTitle)";
parent.mostCurrent._matdialogbuilder.Title(BA.ObjectToCharSequence(_cstitle.getObject()));
 //BA.debugLineNum = 498;BA.debugLine="MatDialogBuilder.Content($\"  JO No. : ${sJONo}";
...
public ResumableSub_ShowSASJODetails(bwsi.PumpOperations.actjoreasons parent,int _iid) {
this.parent = parent;
this._iid = _iid;
}
bwsi.PumpOperations.actjoreasons parent;
...
//C
this.state = 1;
 //BA.debugLineNum = 517;BA.debugLine="Dim csTitle As CSBuilder";
_cstitle = new anywheresoftware.b4a.objects.CSBuilder();
 //BA.debugLineNum = 518;BA.debugLine="Dim SenderFilter As Object";
_senderfilter = new Object();
 //BA.debugLineNum = 519;BA.debugLine="Dim sJONo, sJOCatCode, sJODesc, sRefNo, sCustName";
_sjono = "";
_sjocatcode = "";
_sjodesc = "";
_srefno = "";
...
_sacctclass = "";
_scontype = "";
 //BA.debugLineNum = 520;BA.debugLine="Dim sDateCreated, sDateStart, sDateFinished As St";
_sdatecreated = "";
_sdatestart = "";
_sdatefinished = "";
 //BA.debugLineNum = 523;BA.debugLine="sJONo = \"\"";
_sjono = "";
 //BA.debugLineNum = 524;BA.debugLine="sJODesc = \"\"";
_sjodesc = "";
 //BA.debugLineNum = 525;BA.debugLine="sRefNo = \"\"";
_srefno = "";
 //BA.debugLineNum = 526;BA.debugLine="sCustName = \"\"";
_scustname = "";
 //BA.debugLineNum = 527;BA.debugLine="sCustAdd = \"\"";
_scustadd = "";
 //BA.debugLineNum = 528;BA.debugLine="sAcctClass = \"\"";
_sacctclass = "";
 //BA.debugLineNum = 529;BA.debugLine="sDateCreated = \"\"";
_sdatecreated = "";
 //BA.debugLineNum = 530;BA.debugLine="sDateStart = \"\"";
_sdatestart = "";
 //BA.debugLineNum = 531;BA.debugLine="sDateFinished = \"\"";
_sdatefinished = "";
 //BA.debugLineNum = 532;BA.debugLine="sConType = \"\"";
_scontype = "";
...
this.state = 4;
this.catchState = 11;
 //BA.debugLineNum = 535;BA.debugLine="Starter.strCriteria = \"SELECT JO.JONo, JO.JoDesc";
parent.mostCurrent._starter._strcriteria /*String*/  = "SELECT JO.JONo, JO.JoDesc, "+"JO.RefNo AS App_AcctNo, JO.CustName, JO.CustAddress, "+"JO.AcctClass, JO.AcctSubClass, JO.ConType, "+"JO.JOCreatedAt, JO.DateStarted, JO.DateFinished "+"FROM tblJOs AS JO "+"WHERE JO.JOID = "+BA.NumberToString(_iid);
 //BA.debugLineNum = 542;BA.debugLine="SenderFilter = Starter.DBCon.ExecQueryAsync(\"SQL";
_senderfilter = parent.mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQueryAsync(processBA,"SQL",parent.mostCurrent._starter._strcriteria /*String*/ ,(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(anywheresoftware.b4a.keywords.Common.Null)));
 //BA.debugLineNum = 543;BA.debugLine="Wait For (SenderFilter) SQL_QueryComplete (Succe";
anywheresoftware.b4a.keywords.Common.WaitFor("sql_querycomplete", processBA, this, _senderfilter);
this.state = 13;
return;
case 13:
...
_rs = (anywheresoftware.b4a.sql.SQL.ResultSetWrapper) result[1];
;
 //BA.debugLineNum = 545;BA.debugLine="If Success Then";
if (true) break;
...
//C
this.state = 9;
 //BA.debugLineNum = 546;BA.debugLine="RS.Position = 0";
_rs.setPosition((int) (0));
 //BA.debugLineNum = 547;BA.debugLine="sJONo = RS.GetString(\"JONo\")";
_sjono = _rs.GetString("JONo");
 //BA.debugLineNum = 548;BA.debugLine="sJODesc = RS.GetString(\"JoDesc\")";
_sjodesc = _rs.GetString("JoDesc");
 //BA.debugLineNum = 549;BA.debugLine="sRefNo = RS.GetString(\"App_AcctNo\")";
_srefno = _rs.GetString("App_AcctNo");
 //BA.debugLineNum = 550;BA.debugLine="sCustName = RS.GetString(\"CustName\")";
_scustname = _rs.GetString("CustName");
 //BA.debugLineNum = 551;BA.debugLine="sCustAdd = RS.GetString(\"CustAddress\")";
_scustadd = _rs.GetString("CustAddress");
 //BA.debugLineNum = 552;BA.debugLine="sAcctClass = RS.GetString(\"AcctClass\") & \"-\" &";
_sacctclass = _rs.GetString("AcctClass")+"-"+_rs.GetString("AcctSubClass");
 //BA.debugLineNum = 553;BA.debugLine="sConType = RS.GetString(\"ConType\")";
_scontype = _rs.GetString("ConType");
 //BA.debugLineNum = 554;BA.debugLine="sDateCreated = RS.GetString(\"JOCreatedAt\")";
_sdatecreated = _rs.GetString("JOCreatedAt");
 //BA.debugLineNum = 555;BA.debugLine="sDateStart = RS.GetString(\"DateStarted\")";
_sdatestart = _rs.GetString("DateStarted");
 //BA.debugLineNum = 556;BA.debugLine="sDateFinished = RS.GetString(\"DateFinished\")";
_sdatefinished = _rs.GetString("DateFinished");
 if (true) break;
...
//C
this.state = 9;
 //BA.debugLineNum = 558;BA.debugLine="snack.Initialize(\"\", Activity,$\"\"$ & LastExcept";
parent.mostCurrent._snack.Initialize(mostCurrent.activityBA,"",(android.view.View)(parent.mostCurrent._activity.getObject()),("")+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),(int) (5000));
 //BA.debugLineNum = 559;BA.debugLine="MyFunctions.SetSnackBarTextColor(snack, Colors.";
parent.mostCurrent._myfunctions._setsnackbartextcolor /*String*/ (mostCurrent.activityBA,parent.mostCurrent._snack,anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 560;BA.debugLine="MyFunctions.SetSnackBarBackground(snack, Global";
parent.mostCurrent._myfunctions._setsnackbarbackground /*String*/ (mostCurrent.activityBA,parent.mostCurrent._snack,(int) (parent.mostCurrent._globalvar._redcolor /*double*/ ));
 //BA.debugLineNum = 561;BA.debugLine="snack.Show";
parent.mostCurrent._snack.Show();
 //BA.debugLineNum = 562;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("035389487",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
...
parent.mostCurrent._cddialogedit.Initialize2((int) (parent.mostCurrent._globalvar._yellowcolor /*double*/ ),(int) (10),(int) (0),anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 576;BA.debugLine="btnSASEdit.Background = cdDialogEdit";
parent.mostCurrent._btnsasedit.setBackground((android.graphics.drawable.Drawable)(parent.mostCurrent._cddialogedit.getObject()));
 //BA.debugLineNum = 578;BA.debugLine="btnSASEdit.Text = Chr(0xE8AD) & $\" Print JO\"$";
parent.mostCurrent._btnsasedit.setText(BA.ObjectToCharSequence(BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (0xe8ad)))+(" Print JO")));
 //BA.debugLineNum = 580;BA.debugLine="cdDialogOk.Initialize2(GlobalVar.GreenColor, 10,";
parent.mostCurrent._cddialogok.Initialize2((int) (parent.mostCurrent._globalvar._greencolor /*double*/ ),(int) (10),(int) (0),anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 581;BA.debugLine="btnSASOK.Background = cdDialogOk";
parent.mostCurrent._btnsasok.setBackground((android.graphics.drawable.Drawable)(parent.mostCurrent._cddialogok.getObject()));
 //BA.debugLineNum = 582;BA.debugLine="btnSASOK.Text = Chr(0xE5CA) & $\" Ok\"$";
...
this.state = 12;
this.catchState = 0;
 //BA.debugLineNum = 584;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("035389509",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
String _sdatestart = "";
 //BA.debugLineNum = 711;BA.debugLine="Private Sub StartJO (iJOID As Int) As Boolean";
 //BA.debugLineNum = 712;BA.debugLine="Dim bRetVal As Boolean";
_bretval = false;
 //BA.debugLineNum = 713;BA.debugLine="Dim lngDateTime As Long";
_lngdatetime = 0L;
 //BA.debugLineNum = 714;BA.debugLine="Dim sDateStart As String";
_sdatestart = "";
 //BA.debugLineNum = 716;BA.debugLine="bRetVal = False";
_bretval = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 717;BA.debugLine="lngDateTime = DateTime.Now";
_lngdatetime = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 718;BA.debugLine="DateTime.TimeFormat = \"hh:mm:ss a\"";
anywheresoftware.b4a.keywords.Common.DateTime.setTimeFormat("hh:mm:ss a");
 //BA.debugLineNum = 719;BA.debugLine="DateTime.DateFormat = \"yyyy-MM-dd\"";
anywheresoftware.b4a.keywords.Common.DateTime.setDateFormat("yyyy-MM-dd");
 //BA.debugLineNum = 720;BA.debugLine="sDateStart = DateTime.Date(lngDateTime) & $\" \"$ &";
...
try { //BA.debugLineNum = 724;BA.debugLine="Starter.strCriteria = \"UPDATE tblJOs \" & _";
mostCurrent._starter._strcriteria /*String*/  = "UPDATE tblJOs "+"SET JOStatus = ?, DateStarted = ? "+"WHERE JOID = "+BA.NumberToString(_ijoid);
 //BA.debugLineNum = 728;BA.debugLine="LogColor(Starter.strCriteria,Colors.Yellow)";
anywheresoftware.b4a.keywords.Common.LogImpl("036110353",mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
 //BA.debugLineNum = 729;BA.debugLine="Starter.DBCon.ExecNonQuery2(Starter.strCriteria,";
mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecNonQuery2(mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.ArrayToList(new String[]{"2",_sdatestart}));
 //BA.debugLineNum = 730;BA.debugLine="Starter.DBCon.TransactionSuccessful";
mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .TransactionSuccessful();
 //BA.debugLineNum = 732;BA.debugLine="bRetVal = True";
_bretval = anywheresoftware.b4a.keywords.Common.True;
 } 
       catch (Exception e17) {
			processBA.setLastException(e17); //BA.debugLineNum = 734;BA.debugLine="bRetVal = False";
_bretval = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 735;BA.debugLine="Log(LastException.Message)";
anywheresoftware.b4a.keywords.Common.LogImpl("036110360",anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
 };
 //BA.debugLineNum = 737;BA.debugLine="Starter.DBCon.EndTransaction";
mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .EndTransaction();
 //BA.debugLineNum = 738;BA.debugLine="Return bRetVal";
...
public static String  _toolbar_menuitemclick(de.amberhome.objects.appcompat.ACMenuItemWrapper _item) throws Exception{
 ...
 //BA.debugLineNum = 169;BA.debugLine="Select Item.Id";
switch (BA.switchObjectToInt(_item.getId(),(int) (1))) {
case 0: {
 //BA.debugLineNum = 171;BA.debugLine="PopSubMenu.Show";
...
public static String  _toolbar_navigationitemclick() throws Exception{
 ...
 //BA.debugLineNum = 164;BA.debugLine="IMEKeyboard.HideKeyboard";
...
public static String  _txtsearch_enterpressed() throws Exception{
 //BA.debugLineNum = 427;BA.debugLine="Sub txtSearch_EnterPressed";
...
public ResumableSub_txtSearch_TextChanged(bwsi.PumpOperations.actjoreasons parent,String _old,String _new) {
this.parent = parent;
this._old = _old;
this._new = _new;
}
...
//C
this.state = 1;
 //BA.debugLineNum = 377;BA.debugLine="If New.Length = 1 Or txtSearch.Text.Length = 2 Th";
if (true) break;
...
this.state = 7;
;
 //BA.debugLineNum = 378;BA.debugLine="clvJOs.Clear";
parent.mostCurrent._clvjos._clear();
...
this.state = 7;
;
 //BA.debugLineNum = 381;BA.debugLine="Dim SenderFilter As Object";
_senderfilter = new Object();
 //BA.debugLineNum = 382;BA.debugLine="If New.Length = 0  Then";
if (true) break;
...
//C
this.state = 12;
 //BA.debugLineNum = 383;BA.debugLine="JOCounts = Starter.DBCon.ExecQuerySingleResult(\"";
parent._jocounts = (int)(Double.parseDouble(parent.mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQuerySingleResult("SELECT COUNT(*) FROM `tblJOs`;")));
 //BA.debugLineNum = 384;BA.debugLine="Starter.strCriteria = \"SELECT * FROM tblJOs \" &";
parent.mostCurrent._starter._strcriteria /*String*/  = "SELECT * FROM tblJOs "+"WHERE JOCatCode = '"+parent.mostCurrent._globalvar._selectedjocatcode /*String*/ +"' "+"ORDER BY JOCreatedAt ASC";
 //BA.debugLineNum = 387;BA.debugLine="LogColor(Starter.strCriteria, Colors.Yellow)";
anywheresoftware.b4a.keywords.Common.LogImpl("035192843",parent.mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
...
//C
this.state = 12;
 //BA.debugLineNum = 392;BA.debugLine="JOCounts = 0";
parent._jocounts = (int) (0);
 //BA.debugLineNum = 393;BA.debugLine="SenderFilter = Starter.DBCon.ExecQueryAsync(\"SQL";
...
this.state = 13;
;
 //BA.debugLineNum = 396;BA.debugLine="Wait For (SenderFilter) SQL_QueryComplete (Succes";
anywheresoftware.b4a.keywords.Common.WaitFor("sql_querycomplete", processBA, this, _senderfilter);
this.state = 24;
return;
case 24:
...
_rs = (anywheresoftware.b4a.sql.SQL.ResultSetWrapper) result[1];
;
 //BA.debugLineNum = 397;BA.debugLine="If Success Then";
if (true) break;
...
//C
this.state = 16;
 //BA.debugLineNum = 398;BA.debugLine="clvJOs.Clear";
parent.mostCurrent._clvjos._clear();
 //BA.debugLineNum = 399;BA.debugLine="clvJOs.Refresh";
parent.mostCurrent._clvjos._refresh();
 //BA.debugLineNum = 400;BA.debugLine="Dim StartTime As Long = DateTime.Now";
_starttime = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 401;BA.debugLine="Do While RS.NextRow";
if (true) break;
...
//C
this.state = 16;
 //BA.debugLineNum = 402;BA.debugLine="Dim JORec As JOReasonDetails";
_jorec = new bwsi.PumpOperations.actjoreasons._joreasondetails();
 //BA.debugLineNum = 403;BA.debugLine="JORec.Initialize";
_jorec.Initialize();
 //BA.debugLineNum = 404;BA.debugLine="JORec.JOID = RS.GetInt(\"JOID\")";
_jorec.JOID /*int*/  = _rs.GetInt("JOID");
 //BA.debugLineNum = 405;BA.debugLine="JORec.JONum = GlobalVar.SF.Upper(RS.GetString(\"";
_jorec.JONum /*String*/  = parent.mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv5(_rs.GetString("JONo"));
 //BA.debugLineNum = 406;BA.debugLine="JORec.JOCatCode = GlobalVar.SF.Upper(RS.GetStri";
_jorec.JOCatCode /*String*/  = parent.mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv5(_rs.GetString("JOCatCode"));
 //BA.debugLineNum = 407;BA.debugLine="JORec.RefID= RS.GetInt(\"RefID\")";
_jorec.RefID /*int*/  = _rs.GetInt("RefID");
 //BA.debugLineNum = 408;BA.debugLine="JORec.RefNo= GlobalVar.SF.Upper(RS.GetString(\"R";
_jorec.RefNo /*String*/  = parent.mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv5(_rs.GetString("RefNo"));
 //BA.debugLineNum = 409;BA.debugLine="JORec.CustName = GlobalVar.SF.Upper(RS.GetStrin";
_jorec.CustName /*String*/  = parent.mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv5(_rs.GetString("CustName"));
 //BA.debugLineNum = 410;BA.debugLine="JORec.CustAdd = GlobalVar.SF.Upper(RS.GetString";
_jorec.CustAdd /*String*/  = parent.mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv5(_rs.GetString("CustAddress"));
 //BA.debugLineNum = 411;BA.debugLine="JORec.AcctClass = GlobalVar.SF.Upper(RS.GetStri";
_jorec.AcctClass /*String*/  = parent.mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv5(_rs.GetString("AcctClass"));
 //BA.debugLineNum = 412;BA.debugLine="JORec.AcctSubClass = GlobalVar.SF.Upper(RS.GetS";
_jorec.AcctSubClass /*String*/  = parent.mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv5(_rs.GetString("AcctSubClass"));
 //BA.debugLineNum = 413;BA.debugLine="JORec.JOStatus = RS.GetInt(\"JOStatus\")";
_jorec.JOStatus /*int*/  = _rs.GetInt("JOStatus");
 //BA.debugLineNum = 414;BA.debugLine="Dim Pnl As B4XView = xui.CreatePanel(\"\")";
_pnl = new anywheresoftware.b4a.objects.B4XViewWrapper();
_pnl = parent._xui.CreatePanel(processBA,"");
 //BA.debugLineNum = 415;BA.debugLine="Pnl.SetLayoutAnimated(0, 10dip, 0, clvJOs.AsVie";
_pnl.SetLayoutAnimated((int) (0),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(int) (0),parent.mostCurrent._clvjos._asview().getWidth(),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (150)));
 //BA.debugLineNum = 416;BA.debugLine="clvJOs.Add(Pnl, JORec)";
parent.mostCurrent._clvjos._add(_pnl,(Object)(_jorec));
 if (true) break;
...
this.state = 22;
;
 //BA.debugLineNum = 418;BA.debugLine="RS.Close";
_rs.Close();
 //BA.debugLineNum = 420;BA.debugLine="Log($\"List population time = ${NumberFormat2((Da";
anywheresoftware.b4a.keywords.Common.LogImpl("035192876",("List population time = "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(anywheresoftware.b4a.keywords.Common.NumberFormat2((anywheresoftware.b4a.keywords.Common.DateTime.getNow()-_starttime)/(double)1000,(int) (1),(int) (2),(int) (2),anywheresoftware.b4a.keywords.Common.False)))+" seconds to populate "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(parent.mostCurrent._clvjos._getsize()))+" airport names"),0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("035192878",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
