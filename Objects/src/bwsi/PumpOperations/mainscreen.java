...
anywheresoftware.b4a.keywords.Common.LogImpl("710682369",_permission,0);
...
public static String  _btncancel_click() throws Exception{
 //BA.debugLineNum = 1449;BA.debugLine="Sub btnCancel_Click";
 //BA.debugLineNum = 1450;BA.debugLine="pnlPumpSelection.Visible = False";
...
public static String  _clearuserdata() throws Exception{
 //BA.debugLineNum = 1529;BA.debugLine="Private Sub ClearUserData";
 //BA.debugLineNum = 1530;BA.debugLine="KVS.Remove(\"user_data\")";
...
bwsi.PumpOperations.mainscreen._pumpassigned _rec = null;
 //BA.debugLineNum = 1365;BA.debugLine="Sub clvPumpList_ItemClick (Index As Int, Value As";
 //BA.debugLineNum = 1366;BA.debugLine="Dim Rec As PumpAssigned = Value";
_rec = (bwsi.PumpOperations.mainscreen._pumpassigned)(_value);
 //BA.debugLineNum = 1367;BA.debugLine="Log(Rec.PumpID)";
anywheresoftware.b4a.keywords.Common.LogImpl("713238274",BA.NumberToString(_rec.PumpID /*int*/ ),0);
 //BA.debugLineNum = 1368;BA.debugLine="GlobalVar.PumpHouseID = Rec.PumpID";
mostCurrent._globalvar._pumphouseid /*int*/  = _rec.PumpID /*int*/ ;
 //BA.debugLineNum = 1369;BA.debugLine="GlobalVar.PumpHouseCode = Rec.PumpCode";
mostCurrent._globalvar._pumphousecode /*String*/  = _rec.PumpCode /*String*/ ;
 //BA.debugLineNum = 1371;BA.debugLine="GlobalVar.PumpDrainPipeType = DBaseFunctions.GetD";
mostCurrent._globalvar._pumpdrainpipetype /*String*/  = mostCurrent._dbasefunctions._getdrainpipetype /*String*/ (mostCurrent.activityBA,_rec.PumpID /*int*/ );
 //BA.debugLineNum = 1372;BA.debugLine="GlobalVar.PumpDrainPipeSize = DBaseFunctions.GetD";
mostCurrent._globalvar._pumpdrainpipesize /*String*/  = mostCurrent._dbasefunctions._getdrainpipesize /*String*/ (mostCurrent.activityBA,_rec.PumpID /*int*/ );
 //BA.debugLineNum = 1374;BA.debugLine="pnlPumpSelection.Visible = False";
mostCurrent._pnlpumpselection.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1375;BA.debugLine="MyToast.DefaultTextColor = Colors.White";
mostCurrent._mytoast._defaulttextcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.White;
 //BA.debugLineNum = 1376;BA.debugLine="MyToast.pnl.Color = GlobalVar.BlueColor";
mostCurrent._mytoast._pnl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .setColor((int) (mostCurrent._globalvar._bluecolor /*double*/ ));
 //BA.debugLineNum = 1377;BA.debugLine="MyFunctions.MyToastMsg(MyToast, $\"Selected Pump:";
...
bwsi.PumpOperations.mainscreen._pumpassigned _pa = null;
 //BA.debugLineNum = 1380;BA.debugLine="Sub clvPumpList_VisibleRangeChanged (FirstIndex As";
 //BA.debugLineNum = 1381;BA.debugLine="Dim ExtraSize As Int = 15 'List size";
_extrasize = (int) (15);
 //BA.debugLineNum = 1382;BA.debugLine="For i = Max(0, FirstIndex - ExtraSize) To Min(Las";
{
final int step2 = 1;
...
for (;_i <= limit2 ;_i = _i + step2 ) {
 //BA.debugLineNum = 1383;BA.debugLine="Dim Pnl As B4XView = clvPumpList.GetPanel(i)";
_pnl = new anywheresoftware.b4a.objects.B4XViewWrapper();
_pnl = mostCurrent._clvpumplist._getpanel(_i);
 //BA.debugLineNum = 1384;BA.debugLine="If i > FirstIndex - ExtraSize And i < LastIndex";
if (_i>_firstindex-_extrasize && _i<_lastindex+_extrasize) { 
 //BA.debugLineNum = 1385;BA.debugLine="If Pnl.NumberOfViews = 0 Then 'Add each item/la";
if (_pnl.getNumberOfViews()==0) { 
 //BA.debugLineNum = 1386;BA.debugLine="Dim PA As PumpAssigned = clvPumpList.GetValue(";
_pa = (bwsi.PumpOperations.mainscreen._pumpassigned)(mostCurrent._clvpumplist._getvalue(_i));
 //BA.debugLineNum = 1387;BA.debugLine="Pnl.LoadLayout(\"PumpList\")";
_pnl.LoadLayout("PumpList",mostCurrent.activityBA);
 //BA.debugLineNum = 1388;BA.debugLine="lblPumpCode.TextColor = GlobalVar.BlueColor";
mostCurrent._lblpumpcode.setTextColor((int) (mostCurrent._globalvar._bluecolor /*double*/ ));
 //BA.debugLineNum = 1389;BA.debugLine="lblPumpLoc.TextColor = Colors.Gray";
mostCurrent._lblpumploc.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Gray);
 //BA.debugLineNum = 1390;BA.debugLine="lblPumpCode.Text = $\"PUMP - \"$ & PA.PumpCode";
mostCurrent._lblpumpcode.setText(BA.ObjectToCharSequence(("PUMP - ")+_pa.PumpCode /*String*/ ));
 //BA.debugLineNum = 1391;BA.debugLine="lblPumpLoc.Text  = PA.PumpLoc";
mostCurrent._lblpumploc.setText(BA.ObjectToCharSequence(_pa.PumpLoc /*String*/ ));
 };
 }else {
 //BA.debugLineNum = 1394;BA.debugLine="If Pnl.NumberOfViews > 0 Then";
if (_pnl.getNumberOfViews()>0) { 
 //BA.debugLineNum = 1395;BA.debugLine="Pnl.RemoveAllViews 'Remove none visable item/l";
_pnl.RemoveAllViews();
 };
 };
 }
...
anywheresoftware.b4a.keywords.Common.LogImpl("710878990",mostCurrent._globalvar._useravatar /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Cyan);
...
anywheresoftware.b4a.sql.SQL.CursorWrapper _rspumpinfo = null;
 //BA.debugLineNum = 1343;BA.debugLine="Private Sub GetPumpInfo (iPumpStationID As Int)";
 //BA.debugLineNum = 1344;BA.debugLine="Dim rsPumpInfo As Cursor";
_rspumpinfo = new anywheresoftware.b4a.sql.SQL.CursorWrapper();
 //BA.debugLineNum = 1345;BA.debugLine="Try";
try { //BA.debugLineNum = 1346;BA.debugLine="Starter.strCriteria = \"SELECT Station.PumpHouseC";
mostCurrent._starter._strcriteria /*String*/  = "SELECT Station.PumpHouseCode, Station.PumpLocation, "+"Station.PumpHouseID, Station.FMID, Station.FMNo, Station.LastRdg "+"FROM tblPumpStation AS Station "+"WHERE Station.StationID = "+BA.NumberToString(_ipumpstationid);
 //BA.debugLineNum = 1350;BA.debugLine="rsPumpInfo = Starter.DBCon.ExecQuery(Starter.str";
_rspumpinfo = (anywheresoftware.b4a.sql.SQL.CursorWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.sql.SQL.CursorWrapper(), (android.database.Cursor)(mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQuery(mostCurrent._starter._strcriteria /*String*/ )));
 //BA.debugLineNum = 1352;BA.debugLine="If rsPumpInfo.RowCount > 0 Then";
if (_rspumpinfo.getRowCount()>0) { 
 //BA.debugLineNum = 1353;BA.debugLine="rsPumpInfo.Position = 0";
_rspumpinfo.setPosition((int) (0));
 };
 } 
       catch (Exception e9) {
			processBA.setLastException(e9); //BA.debugLineNum = 1357;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("713107214",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("712648451",BA.NumberToString(mostCurrent._globalvar._selectedjocat /*int*/ ),anywheresoftware.b4a.keywords.Common.Colors.Red);
...
anywheresoftware.b4a.keywords.Common.LogImpl("712648515",mostCurrent._globalvar._selectedjocatcode /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
 break; }
case 1: {
 break; }
}
...
anywheresoftware.b4a.keywords.Common.LogImpl("712517377","Dialog dismissed",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("712582915",("JO Category: ")+BA.NumberToString(_position)+anywheresoftware.b4a.keywords.Common.CRLF+("JO Cat Code: ")+_text,anywheresoftware.b4a.keywords.Common.Colors.Magenta);
...
anywheresoftware.b4a.keywords.Common.LogImpl("712910595",BA.NumberToString(mostCurrent._globalvar._selectedjocat /*int*/ ),anywheresoftware.b4a.keywords.Common.Colors.Red);
...
anywheresoftware.b4a.keywords.Common.LogImpl("712910601",mostCurrent._globalvar._selectedjocatcode /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
 break; }
case 1: {
...
anywheresoftware.b4a.keywords.Common.LogImpl("712910606",mostCurrent._globalvar._selectedjocatcode /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
 break; }
case 2: {
...
anywheresoftware.b4a.keywords.Common.LogImpl("712910611",mostCurrent._globalvar._selectedjocatcode /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
 break; }
case 3: {
...
anywheresoftware.b4a.keywords.Common.LogImpl("712910616",mostCurrent._globalvar._selectedjocatcode /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
 break; }
case 4: {
...
anywheresoftware.b4a.keywords.Common.LogImpl("712910621",mostCurrent._globalvar._selectedjocatcode /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
 break; }
case 5: {
...
anywheresoftware.b4a.keywords.Common.LogImpl("712910626",mostCurrent._globalvar._selectedjocatcode /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
 break; }
case 6: {
...
anywheresoftware.b4a.keywords.Common.LogImpl("712910631",mostCurrent._globalvar._selectedjocatcode /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
 break; }
case 7: {
...
anywheresoftware.b4a.keywords.Common.LogImpl("712779521","Dialog dismissed",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("712845059",("JO Category: ")+BA.NumberToString(_position)+anywheresoftware.b4a.keywords.Common.CRLF+("JO Cat Code: ")+_text,anywheresoftware.b4a.keywords.Common.Colors.Magenta);
...
anywheresoftware.b4a.keywords.Common.LogImpl("710944513",BA.ObjectToString(_value),anywheresoftware.b4a.keywords.Common.Colors.Red);
...
boolean _bretval = false;
 //BA.debugLineNum = 1479;BA.debugLine="Private Sub NotifyCountJO As Boolean";
 //BA.debugLineNum = 1480;BA.debugLine="Dim bRetVal As Boolean";
_bretval = false;
 //BA.debugLineNum = 1482;BA.debugLine="bRetVal = False";
_bretval = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 1483;BA.debugLine="iJOUnreadCount = 0";
_ijounreadcount = (int) (0);
 //BA.debugLineNum = 1485;BA.debugLine="Try";
try { //BA.debugLineNum = 1486;BA.debugLine="iJOUnreadCount = Starter.DBCon.ExecQuerySingleRe";
_ijounreadcount = (int)(Double.parseDouble(mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQuerySingleResult("SELECT COUNT(JOID) FROM tblJOs WHERE WasRead = 0 AND JOStatus = 1")));
 //BA.debugLineNum = 1487;BA.debugLine="bRetVal = True";
_bretval = anywheresoftware.b4a.keywords.Common.True;
 } 
       catch (Exception e8) {
			processBA.setLastException(e8); //BA.debugLineNum = 1489;BA.debugLine="iJOUnreadCount = 0";
_ijounreadcount = (int) (0);
 //BA.debugLineNum = 1490;BA.debugLine="bRetVal = False";
_bretval = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 1491;BA.debugLine="ToastMessageShow($\"Unable to count JO due to \"$";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(("Unable to count JO due to ")+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage()),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1492;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("713697037",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
 //BA.debugLineNum = 1494;BA.debugLine="Return bRetVal";
...
if (true) return "";
 ...
 //BA.debugLineNum = 1308;BA.debugLine="If DBaseFunctions.IsTherePressurePoint(GlobalVar";
if (mostCurrent._dbasefunctions._istherepressurepoint /*boolean*/ (mostCurrent.activityBA,mostCurrent._globalvar._pumphouseid /*int*/ )==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 1309;BA.debugLine="MyToast.DefaultTextColor = Colors.White";
mostCurrent._mytoast._defaulttextcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.White;
 //BA.debugLineNum = 1310;BA.debugLine="MyToast.pnl.Color = GlobalVar.RedColor";
mostCurrent._mytoast._pnl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .setColor((int) (mostCurrent._globalvar._redcolor /*double*/ ));
 //BA.debugLineNum = 1311;BA.debugLine="MyFunctions.MyToastMsg(MyToast, $\"No pressure p";
mostCurrent._myfunctions._mytoastmsg /*String*/ (mostCurrent.activityBA,mostCurrent._mytoast,("No pressure point set for the Selected Pump!"));
 //BA.debugLineNum = 1313;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 1315;BA.debugLine="StartActivity(actCriticalPoint)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._actcriticalpoint.getObject()));
 }else {
 //BA.debugLineNum = 1318;BA.debugLine="vibration.vibrateOnce(1000)";
mostCurrent._vibration.vibrateOnce(processBA,(long) (1000));
 //BA.debugLineNum = 1319;BA.debugLine="MyToast.DefaultTextColor = GlobalVar.RedColor";
mostCurrent._mytoast._defaulttextcolor /*int*/  = (int) (mostCurrent._globalvar._redcolor /*double*/ );
 //BA.debugLineNum = 1320;BA.debugLine="MyToast.pnl.Color = Colors.White";
mostCurrent._mytoast._pnl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 1321;BA.debugLine="MyToast.Show($\"You are Login as Plumber!\"$ & CRL";
...
public static String  _pnlgpm_click() throws Exception{
 //BA.debugLineNum = 1329;BA.debugLine="Sub pnlGPM_Click";
 //BA.debugLineNum = 1330;BA.debugLine="If GlobalVar.UserPosID = 5 Then";
if (mostCurrent._globalvar._userposid /*int*/ ==5) { 
 //BA.debugLineNum = 1331;BA.debugLine="GlobalVar.blnNewGPM = True";
mostCurrent._globalvar._blnnewgpm /*boolean*/  = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 1332;BA.debugLine="StartActivity(actGPMCalc)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._actgpmcalc.getObject()));
 }else {
 //BA.debugLineNum = 1334;BA.debugLine="vibration.vibrateOnce(1000)";
mostCurrent._vibration.vibrateOnce(processBA,(long) (1000));
 //BA.debugLineNum = 1335;BA.debugLine="MyToast.DefaultTextColor = GlobalVar.RedColor";
mostCurrent._mytoast._defaulttextcolor /*int*/  = (int) (mostCurrent._globalvar._redcolor /*double*/ );
 //BA.debugLineNum = 1336;BA.debugLine="MyToast.pnl.Color = Colors.White";
mostCurrent._mytoast._pnl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 1337;BA.debugLine="MyToast.Show($\"You are Login as Plumber!\"$ & CRL";
mostCurrent._mytoast._show /*void*/ (("You are Login as Plumber!")+anywheresoftware.b4a.keywords.Common.CRLF+("Login your Pump Operator Account first..."));
 };
...
public static String  _pnlpumpselection_touch(int _action,float _x,float _y) throws Exception{
 //BA.debugLineNum = 1361;BA.debugLine="Sub pnlPumpSelection_Touch (Action As Int, X As Fl";
...
public static String  _removetrandate() throws Exception{
 //BA.debugLineNum = 1533;BA.debugLine="Private Sub RemoveTranDate";
 //BA.debugLineNum = 1534;BA.debugLine="KVS.Remove(\"trans_date\")";
...
anywheresoftware.b4a.keywords.Common.LogImpl("711927555",mostCurrent._globalvar._selectedjoreason /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Red);
...
anywheresoftware.b4a.keywords.Common.LogImpl("711927570",mostCurrent._globalvar._selectedjoreason /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
 break; }
case 1: {
 break; }
}
...
anywheresoftware.b4a.keywords.Common.LogImpl("711796481","Dialog dismissed",0);
...
anywheresoftware.b4a.objects.collections.Map _transdate = null;
 //BA.debugLineNum = 1520;BA.debugLine="Private Sub SaveTranDate";
 //BA.debugLineNum = 1522;BA.debugLine="Dim TransDate As Map";
_transdate = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 1523;BA.debugLine="TransDate.Initialize";
_transdate.Initialize();
 //BA.debugLineNum = 1524;BA.debugLine="TransDate.Put(\"TransDate\", GlobalVar.TranDate)";
_transdate.Put((Object)("TransDate"),(Object)(mostCurrent._globalvar._trandate /*String*/ ));
 //BA.debugLineNum = 1526;BA.debugLine="KVS.Put(\"trans_date\",TransDate)";
...
anywheresoftware.b4a.objects.collections.Map _userdata = null;
 //BA.debugLineNum = 1498;BA.debugLine="Private Sub SaveUserData";
 //BA.debugLineNum = 1499;BA.debugLine="Dim UserData As Map";
_userdata = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 1500;BA.debugLine="UserData.Initialize";
_userdata.Initialize();
 //BA.debugLineNum = 1501;BA.debugLine="UserData.Put(\"UserID\", GlobalVar.UserID)";
_userdata.Put((Object)("UserID"),(Object)(mostCurrent._globalvar._userid /*int*/ ));
 //BA.debugLineNum = 1502;BA.debugLine="UserData.Put(\"UserName\", GlobalVar.UserName)";
_userdata.Put((Object)("UserName"),(Object)(mostCurrent._globalvar._username /*String*/ ));
 //BA.debugLineNum = 1504;BA.debugLine="UserData.Put(\"UserPassword\", GlobalVar.UserPW)";
_userdata.Put((Object)("UserPassword"),(Object)(mostCurrent._globalvar._userpw /*String*/ ));
 //BA.debugLineNum = 1505;BA.debugLine="UserData.Put(\"EmpName\", GlobalVar.EmpName)";
_userdata.Put((Object)("EmpName"),(Object)(mostCurrent._globalvar._empname /*String*/ ));
 //BA.debugLineNum = 1506;BA.debugLine="UserData.Put(\"UserAvatar\", GlobalVar.UserAvatar)";
_userdata.Put((Object)("UserAvatar"),(Object)(mostCurrent._globalvar._useravatar /*String*/ ));
 //BA.debugLineNum = 1508;BA.debugLine="UserData.Put(\"BranchID\",GlobalVar.BranchID)";
_userdata.Put((Object)("BranchID"),(Object)(mostCurrent._globalvar._branchid /*int*/ ));
 //BA.debugLineNum = 1509;BA.debugLine="UserData.Put(\"BranchCode\", GlobalVar.BranchCode)";
_userdata.Put((Object)("BranchCode"),(Object)(mostCurrent._globalvar._branchcode /*String*/ ));
 //BA.debugLineNum = 1510;BA.debugLine="UserData.Put(\"BranchName\", GlobalVar.BranchName)";
_userdata.Put((Object)("BranchName"),(Object)(mostCurrent._globalvar._branchname /*String*/ ));
 //BA.debugLineNum = 1512;BA.debugLine="UserData.Put(\"UserPosID\", GlobalVar.UserPosID)";
_userdata.Put((Object)("UserPosID"),(Object)(mostCurrent._globalvar._userposid /*int*/ ));
 //BA.debugLineNum = 1513;BA.debugLine="UserData.Put(\"UserPosition\", GlobalVar.UserPos)";
_userdata.Put((Object)("UserPosition"),(Object)(mostCurrent._globalvar._userpos /*String*/ ));
 //BA.debugLineNum = 1515;BA.debugLine="UserData.Put(\"SysMode\", GlobalVar.SysMode)";
_userdata.Put((Object)("SysMode"),(Object)(mostCurrent._globalvar._sysmode /*int*/ ));
 //BA.debugLineNum = 1517;BA.debugLine="KVS.Put(\"user_data\",UserData)";
...
anywheresoftware.b4a.keywords.Common.LogImpl("712255235",BA.NumberToString(mostCurrent._globalvar._pumphouseid /*int*/ ),anywheresoftware.b4a.keywords.Common.Colors.Blue);
...
anywheresoftware.b4a.keywords.Common.LogImpl("712124161","Dialog dismissed",0);
...
public static String  _setdashboardicons() throws Exception{
 //BA.debugLineNum = 1453;BA.debugLine="Private Sub SetDashboardIcons";
 //BA.debugLineNum = 1454;BA.debugLine="If GlobalVar.UserPosID = 5 Then";
if (mostCurrent._globalvar._userposid /*int*/ ==5) { 
 //BA.debugLineNum = 1455;BA.debugLine="pnlProd.Enabled = True";
mostCurrent._pnlprod.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1456;BA.debugLine="img1.Bitmap = LoadBitmap(File.DirAssets,\"product";
mostCurrent._img1.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"production.png").getObject()));
 ...
 //BA.debugLineNum = 1458;BA.debugLine="pnlProd.Enabled = False";
mostCurrent._pnlprod.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1459;BA.debugLine="pnlProd.Color = Colors.LightGray";
mostCurrent._pnlprod.setColor(anywheresoftware.b4a.keywords.Common.Colors.LightGray);
 //BA.debugLineNum = 1460;BA.debugLine="img1.Bitmap = LoadBitmap(File.DirAssets,\"prod-di";
...
//C
this.state = 1;
 //BA.debugLineNum = 1402;BA.debugLine="Dim SenderFilter As Object";
_senderfilter = new Object();
 //BA.debugLineNum = 1403;BA.debugLine="clvPumpList.Clear";
parent.mostCurrent._clvpumplist._clear();
 //BA.debugLineNum = 1404;BA.debugLine="Try";
if (true) break;
...
this.state = 4;
this.catchState = 15;
 //BA.debugLineNum = 1405;BA.debugLine="Starter.strCriteria = \"SELECT Assignment.Assigne";
parent.mostCurrent._starter._strcriteria /*String*/  = "SELECT Assignment.AssignedID, "+"Assignment.StationID, Station.PumpHouseCode, Station.PumpLocation "+"FROM tblAssignedStation AS Assignment "+"INNER JOIN tblPumpStation AS Station ON Assignment.StationID = Station.StationID "+"WHERE Assignment.OpID = "+BA.NumberToString(_iuserid)+" "+"ORDER BY Station.PumpID ASC";
 //BA.debugLineNum = 1412;BA.debugLine="SenderFilter = Starter.DBCon.ExecQueryAsync(\"SQL";
_senderfilter = parent.mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQueryAsync(processBA,"SQL",parent.mostCurrent._starter._strcriteria /*String*/ ,(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(anywheresoftware.b4a.keywords.Common.Null)));
 //BA.debugLineNum = 1413;BA.debugLine="Wait For (SenderFilter) SQL_QueryComplete (Succe";
...
;
 //BA.debugLineNum = 1415;BA.debugLine="If Success Then";
if (true) break;
...
//C
this.state = 7;
 //BA.debugLineNum = 1416;BA.debugLine="Dim StartTime As Long = DateTime.Now";
_starttime = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 1417;BA.debugLine="Do While RS.NextRow";
if (true) break;
...
//C
this.state = 7;
 //BA.debugLineNum = 1418;BA.debugLine="Dim PA As PumpAssigned";
_pa = new bwsi.PumpOperations.mainscreen._pumpassigned();
 //BA.debugLineNum = 1419;BA.debugLine="PA.Initialize";
_pa.Initialize();
 //BA.debugLineNum = 1420;BA.debugLine="PA.PumpID = RS.GetInt(\"StationID\")";
_pa.PumpID /*int*/  = _rs.GetInt("StationID");
 //BA.debugLineNum = 1421;BA.debugLine="PA.PumpCode = RS.GetString(\"PumpHouseCode\")";
_pa.PumpCode /*String*/  = _rs.GetString("PumpHouseCode");
 //BA.debugLineNum = 1422;BA.debugLine="PA.PumpLoc = RS.GetString(\"PumpLocation\")";
_pa.PumpLoc /*String*/  = _rs.GetString("PumpLocation");
 //BA.debugLineNum = 1424;BA.debugLine="Dim Pnl As B4XView = xui.CreatePanel(\"\")";
_pnl = new anywheresoftware.b4a.objects.B4XViewWrapper();
_pnl = parent._xui.CreatePanel(processBA,"");
 //BA.debugLineNum = 1425;BA.debugLine="Pnl.SetLayoutAnimated(0, 10dip, 0dip, clvPumpL";
_pnl.SetLayoutAnimated((int) (0),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (0)),(int) (parent.mostCurrent._clvpumplist._asview().getWidth()-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)));
 //BA.debugLineNum = 1426;BA.debugLine="clvPumpList.Add(Pnl, PA)";
...
//C
this.state = 13;
 //BA.debugLineNum = 1429;BA.debugLine="snack.Initialize(\"\", Activity,$\"\"$ & LastExcept";
parent.mostCurrent._snack.Initialize(mostCurrent.activityBA,"",(android.view.View)(parent.mostCurrent._activity.getObject()),("")+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),(int) (5000));
 //BA.debugLineNum = 1430;BA.debugLine="MyFunctions.SetSnackBarTextColor(snack, Colors.";
parent.mostCurrent._myfunctions._setsnackbartextcolor /*String*/ (mostCurrent.activityBA,parent.mostCurrent._snack,anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 1431;BA.debugLine="MyFunctions.SetSnackBarBackground(snack, Global";
...
anywheresoftware.b4a.keywords.Common.LogImpl("713369376",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
...
this.state = 16;
this.catchState = 0;
 //BA.debugLineNum = 1439;BA.debugLine="snack.Initialize(\"\", Activity,$\"\"$ & LastExcepti";
parent.mostCurrent._snack.Initialize(mostCurrent.activityBA,"",(android.view.View)(parent.mostCurrent._activity.getObject()),("")+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),(int) (5000));
 //BA.debugLineNum = 1440;BA.debugLine="MyFunctions.SetSnackBarTextColor(snack, Colors.W";
parent.mostCurrent._myfunctions._setsnackbartextcolor /*String*/ (mostCurrent.activityBA,parent.mostCurrent._snack,anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 1441;BA.debugLine="MyFunctions.SetSnackBarBackground(snack, GlobalV";
parent.mostCurrent._myfunctions._setsnackbarbackground /*String*/ (mostCurrent.activityBA,parent.mostCurrent._snack,(int) (parent.mostCurrent._globalvar._redcolor /*double*/ ));
 //BA.debugLineNum = 1442;BA.debugLine="snack.Show";
parent.mostCurrent._snack.Show();
 //BA.debugLineNum = 1443;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("713369386",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("712451852",mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Blue);
...
anywheresoftware.b4a.keywords.Common.LogImpl("712713996",mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Blue);
...
anywheresoftware.b4a.keywords.Common.LogImpl("712058638",mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Blue);
...
//C
this.state = -1;
 //BA.debugLineNum = 1467;BA.debugLine="SettingsStatus.StartResolutionDialog(\"srd\")";
_settingsstatus.StartResolutionDialog(mostCurrent.activityBA,"srd");
 //BA.debugLineNum = 1468;BA.debugLine="Wait For srd_ResolutionDialogDismissed(LocationSe";
...
;
 //BA.debugLineNum = 1469;BA.debugLine="Return LocationSettingsUpdated";
if (true) {
...
anywheresoftware.b4a.keywords.Common.LogImpl("711730956",mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Blue);
...
public static String  _timer1_tick() throws Exception{
 //BA.debugLineNum = 1473;BA.debugLine="Private Sub Timer1_Tick";
 //BA.debugLineNum = 1474;BA.debugLine="If NotifyCountJO = True Then";
if (_notifycountjo()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 1475;BA.debugLine="UpdateBadge(\"Notif\", AddBadgeToIcon(NotifBMP, iJ";
