...
public class b4xsearchtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "bwsi.PumpOperations.b4xsearchtemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", bwsi.PumpOperations.b4xsearchtemplate.class).invoke(this, new Object[] {null});
        else
...
public bwsi.PumpOperations.b4xfloattextfield _searchfield = null;
...
_searchfield = new bwsi.PumpOperations.b4xfloattextfield();
...
__c.LogImpl("9112328737","Index time: "+BA.NumberToString((__c.DateTime.getNow()-_starttime))+" ms ("+BA.NumberToString(_items.getSize())+" Items)",0);
...
public ResumableSub_Show(bwsi.PumpOperations.b4xsearchtemplate parent,bwsi.PumpOperations.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
bwsi.PumpOperations.b4xsearchtemplate parent;
