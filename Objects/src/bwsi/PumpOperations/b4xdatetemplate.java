...
public class b4xdatetemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "bwsi.PumpOperations.b4xdatetemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", bwsi.PumpOperations.b4xdatetemplate.class).invoke(this, new Object[] {null});
        else
...
public bwsi.PumpOperations.b4xdialog _mdialog = null;
...
_mdialog = new bwsi.PumpOperations.b4xdialog();
...
public String  _show(bwsi.PumpOperations.b4xdialog _dialog) throws Exception{
...
if (BA.fastSubCompare(sub, "SHOW"))
	return _show((bwsi.PumpOperations.b4xdialog) args[0]);
