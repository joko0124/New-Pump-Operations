...
public class b4xbytesbuilder extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "bwsi.PumpOperations.b4xbytesbuilder");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", bwsi.PumpOperations.b4xbytesbuilder.class).invoke(this, new Object[] {null});
        else
...
public bwsi.PumpOperations.b4xbytesbuilder  _append(byte[] _data) throws Exception{
int _oldlength = 0;
...
if (true) return (bwsi.PumpOperations.b4xbytesbuilder)(this);
...
if (_index>_mlength) { 
__c.LogImpl("9119668738","Index too large",0);};
...
if (_index>_mlength) { 
__c.LogImpl("9119734274","Index too large",0);};
