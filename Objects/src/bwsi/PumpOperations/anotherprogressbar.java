...
public class anotherprogressbar extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "bwsi.PumpOperations.anotherprogressbar");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", bwsi.PumpOperations.anotherprogressbar.class).invoke(this, new Object[] {null});
        else
...
public ResumableSub_BusyLoop(bwsi.PumpOperations.anotherprogressbar parent) {
this.parent = parent;
}
bwsi.PumpOperations.anotherprogressbar parent;
int _myindex = 0;
