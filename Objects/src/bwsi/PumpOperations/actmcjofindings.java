...
anywheresoftware.b4a.keywords.Common.LogImpl("739452675",("Permission to Read External Storage GRANTED"),anywheresoftware.b4a.keywords.Common.Colors.Yellow);
...
anywheresoftware.b4a.keywords.Common.LogImpl("739452678",("Permission to Write External Storage GRANTED"),anywheresoftware.b4a.keywords.Common.Colors.White);
...
anywheresoftware.b4a.keywords.Common.LogImpl("739452681",("Permission to Access Coarse Location GRANTED"),anywheresoftware.b4a.keywords.Common.Colors.Magenta);
...
anywheresoftware.b4a.keywords.Common.LogImpl("739452684",("Permission to Access Fine Location GRANTED"),anywheresoftware.b4a.keywords.Common.Colors.Cyan);
...
anywheresoftware.b4a.keywords.Common.LogImpl("739452695",_permission,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("740304649","SignaturePad_onSigned(sign)",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("740632324","No Selected",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("739387137","Checking Permissions",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("740042501",mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
...
anywheresoftware.b4a.keywords.Common.LogImpl("740042523",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("740042527",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("740763406",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("740697870",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("740828939",mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Blue);
...
anywheresoftware.b4a.keywords.Common.LogImpl("740894472",_urlname+("BranchID = ")+_sbranchid,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("740894479",_retval,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("740894488",_j._errormessage /*String*/ ,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("740960020",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("740960025",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("741811969",_item,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
...
anywheresoftware.b4a.keywords.Common.LogImpl("741877537",("FLP is COnnected? ")+BA.ObjectToString(mostCurrent._starter._flp /*uk.co.martinpearman.b4a.fusedlocationprovider.FusedLocationProviderWrapper*/ .IsConnected()),0);
 //BA.debugLineNum = 788;BA.debugLine="LogColor($\"Latitude: \"$ & GlobalVar.Lat, Colors.M";
anywheresoftware.b4a.keywords.Common.LogImpl("741877539",("Latitude: ")+mostCurrent._globalvar._lat /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Magenta);
 //BA.debugLineNum = 789;BA.debugLine="LogColor($\"Longitude: \"$ & GlobalVar.Lon, Colors.";
anywheresoftware.b4a.keywords.Common.LogImpl("741877540",("Longitude: ")+mostCurrent._globalvar._lon /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Cyan);
...
anywheresoftware.b4a.keywords.Common.LogImpl("741877543",("Location is ")+_slocation,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
...
anywheresoftware.b4a.keywords.Common.LogImpl("741877567",mostCurrent._sigfilename+" Saved",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("741877594",anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("741025576",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
