...
public class actdebugkeyboard extends Activity implements B4AActivity{
	public static actdebugkeyboard mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "bwsi.PumpOperations", "bwsi.PumpOperations.actdebugkeyboard");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (actdebugkeyboard).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "bwsi.PumpOperations", "bwsi.PumpOperations.actdebugkeyboard");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "bwsi.PumpOperations.actdebugkeyboard", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (actdebugkeyboard) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (actdebugkeyboard) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (actdebugkeyboard) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (actdebugkeyboard) Pause event (activity is not paused). **");
        if (mostCurrent != null)
    ...
    private static class ResumeMessage implements Runnable {
		...
		public void run() {
            actdebugkeyboard mc = mostCurrent;
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 24;BA.debugLine="Activity.LoadLayout(\"DebugKeyboard\")";
mostCurrent._activity.LoadLayout("DebugKeyboard",mostCurrent.activityBA);
 //BA.debugLineNum = 25;BA.debugLine="txtFMRdg.InputType = Bit.Or(txtFMRdg.InputType,TY";
mostCurrent._txtfmrdg.setInputType(anywheresoftware.b4a.keywords.Common.Bit.Or(mostCurrent._txtfmrdg.getInputType(),_type_text_flag_no_suggestions));
 //BA.debugLineNum = 26;BA.debugLine="txtFMRdg.SingleLine = True";
mostCurrent._txtfmrdg.setSingleLine(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 27;BA.debugLine="txtFMRdg.ForceDoneButton = True";
mostCurrent._txtfmrdg.setForceDoneButton(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 29;BA.debugLine="cKeyboard.Initialize(\"CKB\",\"keyboardview_trans\")";
mostCurrent._ckeyboard.Initialize(mostCurrent.activityBA,"CKB","keyboardview_trans");
 //BA.debugLineNum = 30;BA.debugLine="cKeyboard.RegisterEditText(txtFMRdg,\"txtFMRdg\",\"n";
mostCurrent._ckeyboard.RegisterEditText((android.widget.EditText)(mostCurrent._txtfmrdg.getObject()),"txtFMRdg","num",anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 31;BA.debugLine="cKeyboard.ShowKeyboard(txtFMRdg)";
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 18;BA.debugLine="Private txtFMRdg As EditText";
mostCurrent._txtfmrdg = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 19;BA.debugLine="Private cKeyboard As CustomKeyboard";
...
_xui = new anywheresoftware.b4a.objects.B4XViewWrapper.XUI();
 //BA.debugLineNum = 10;BA.debugLine="Dim TYPE_TEXT_FLAG_NO_SUGGESTIONS  As Int = 0x800";
