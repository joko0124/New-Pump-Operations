...
anywheresoftware.b4a.keywords.Common.LogImpl("738010883",BA.ObjectToString(_value),anywheresoftware.b4a.keywords.Common.Colors.Yellow);
 //BA.debugLineNum = 177;BA.debugLine="LogColor(JOCount.JOCatCode, Colors.Red)";
anywheresoftware.b4a.keywords.Common.LogImpl("738010884",_jocount.JOCatCode /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Red);
 //BA.debugLineNum = 178;BA.debugLine="LogColor(JOCount.JODesc, Colors.Magenta)";
anywheresoftware.b4a.keywords.Common.LogImpl("738010885",_jocount.JODesc /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Magenta);
 //BA.debugLineNum = 179;BA.debugLine="LogColor(JOCount.JOTotals, Colors.Red)";
anywheresoftware.b4a.keywords.Common.LogImpl("738010886",BA.NumberToString(_jocount.JOTotals /*int*/ ),anywheresoftware.b4a.keywords.Common.Colors.Red);
...
anywheresoftware.b4a.keywords.Common.LogImpl("737945359",parent.mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
...
anywheresoftware.b4a.keywords.Common.LogImpl("737945386",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("737945391",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("738141985",parent.mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
...
anywheresoftware.b4a.keywords.Common.LogImpl("738142012",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("738142015",("List of Job Order Records = "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(anywheresoftware.b4a.keywords.Common.NumberFormat2((anywheresoftware.b4a.keywords.Common.DateTime.getNow()-_starttime)/(double)1000,(int) (0),(int) (2),(int) (2),anywheresoftware.b4a.keywords.Common.False)))+" seconds to populate "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(parent.mostCurrent._clvjos._getsize()))+" Job Order Records"),0);
