...
public class httpjob extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "bwsi.PumpOperations.httpjob");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", bwsi.PumpOperations.httpjob.class).invoke(this, new Object[] {null});
        else
...
__c.LogImpl("921626887","Cannot send files from the assets folder.",0);
...
String _value = "";
String _s = "";
bwsi.PumpOperations.httpjob._multipartfiledata _fd = null;
anywheresoftware.b4a.objects.streams.File.InputStreamWrapper _in = null;
...
_fd = (bwsi.PumpOperations.httpjob._multipartfiledata)(group17.Get(index17));
