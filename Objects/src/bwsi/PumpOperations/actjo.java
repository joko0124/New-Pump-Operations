...
anywheresoftware.b4a.keywords.Common.LogImpl("028966914",BA.ObjectToString(_value),anywheresoftware.b4a.keywords.Common.Colors.Yellow);
 //BA.debugLineNum = 298;BA.debugLine="LogColor(JORec.JOID, Colors.Red)";
anywheresoftware.b4a.keywords.Common.LogImpl("028966915",BA.NumberToString(_jorec.JOID /*int*/ ),anywheresoftware.b4a.keywords.Common.Colors.Red);
 //BA.debugLineNum = 299;BA.debugLine="LogColor(JORec.JONum, Colors.Magenta)";
anywheresoftware.b4a.keywords.Common.LogImpl("028966916",_jorec.JONum /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Magenta);
 //BA.debugLineNum = 300;BA.debugLine="LogColor(JORec.JOStatus, Colors.Red)";
anywheresoftware.b4a.keywords.Common.LogImpl("028966917",BA.NumberToString(_jorec.JOStatus /*int*/ ),anywheresoftware.b4a.keywords.Common.Colors.Red);
...
anywheresoftware.b4a.keywords.Common.LogImpl("028835847",parent.mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
...
anywheresoftware.b4a.keywords.Common.LogImpl("028835877",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("028835882",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("028770305","Popupmenu Item clicked: "+BA.NumberToString(_item.getId())+" - "+_item.getTitle(),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("028901394",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("028901398",parent.mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
...
anywheresoftware.b4a.keywords.Common.LogImpl("028901428",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("028901431",("List of Job Order Records = "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(anywheresoftware.b4a.keywords.Common.NumberFormat2((anywheresoftware.b4a.keywords.Common.DateTime.getNow()-_starttime)/(double)1000,(int) (0),(int) (2),(int) (2),anywheresoftware.b4a.keywords.Common.False)))+" seconds to populate "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(parent.mostCurrent._clvjos._getsize()))+" SAS JO Records"),0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("028901433",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("029753347",BA.NumberToString(mostCurrent._globalvar._selectedjoid /*int*/ ),anywheresoftware.b4a.keywords.Common.Colors.Cyan);
...
anywheresoftware.b4a.keywords.Common.LogImpl("029229103",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("029229107",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
;
...
anywheresoftware.b4a.keywords.Common.LogImpl("029294639",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("029294661",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("030015505",mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
...
anywheresoftware.b4a.keywords.Common.LogImpl("030015512",anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("029097995",parent.mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
...
anywheresoftware.b4a.keywords.Common.LogImpl("029098030",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
