...
anywheresoftware.b4a.keywords.Common.LogImpl("738928387",BA.ObjectToString(_value),anywheresoftware.b4a.keywords.Common.Colors.Yellow);
 //BA.debugLineNum = 176;BA.debugLine="LogColor(JOCount.JOCatCode, Colors.Red)";
anywheresoftware.b4a.keywords.Common.LogImpl("738928388",_jocount.JOCatCode /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Red);
 //BA.debugLineNum = 177;BA.debugLine="LogColor(JOCount.JODesc, Colors.Magenta)";
anywheresoftware.b4a.keywords.Common.LogImpl("738928389",_jocount.JODesc /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Magenta);
 //BA.debugLineNum = 178;BA.debugLine="LogColor(JOCount.JOTotals, Colors.Red)";
anywheresoftware.b4a.keywords.Common.LogImpl("738928390",BA.NumberToString(_jocount.JOTotals /*int*/ ),anywheresoftware.b4a.keywords.Common.Colors.Red);
...
anywheresoftware.b4a.keywords.Common.LogImpl("738862862",parent.mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
...
anywheresoftware.b4a.keywords.Common.LogImpl("738862889",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("738862894",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("739059489",parent.mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
...
anywheresoftware.b4a.keywords.Common.LogImpl("739059516",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("739059519",("List of Job Order Records = "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(anywheresoftware.b4a.keywords.Common.NumberFormat2((anywheresoftware.b4a.keywords.Common.DateTime.getNow()-_starttime)/(double)1000,(int) (0),(int) (2),(int) (2),anywheresoftware.b4a.keywords.Common.False)))+" seconds to populate "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(parent.mostCurrent._clvjos._getsize()))+" Job Order Records"),0);
