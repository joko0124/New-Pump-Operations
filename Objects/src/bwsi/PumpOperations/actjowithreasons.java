...
public class actjowithreasons extends androidx.appcompat.app.AppCompatActivity implements B4AActivity{
	public static actjowithreasons mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "bwsi.PumpOperations", "bwsi.PumpOperations.actjowithreasons");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (actjowithreasons).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "bwsi.PumpOperations", "bwsi.PumpOperations.actjowithreasons");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "bwsi.PumpOperations.actjowithreasons", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (actjowithreasons) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (actjowithreasons) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (actjowithreasons) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (actjowithreasons) Pause event (activity is not paused). **");
        if (mostCurrent != null)
    ...
    private static class ResumeMessage implements Runnable {
		...
		public void run() {
            actjowithreasons mc = mostCurrent;
...
public static class _josummary{
...
_filljolist(mostCurrent._globalvar._userid /*int*/ ,mostCurrent._globalvar._branchid /*int*/ ,mostCurrent._globalvar._selectedjocatcode /*String*/ );
 };
...
bwsi.PumpOperations.actjowithreasons._josummary _jocount = null;
 //BA.debugLineNum = 172;BA.debugLine="Sub clvJOs_ItemClick (Index As Int, Value As Objec";
...
anywheresoftware.b4a.keywords.Common.LogImpl("838666243",BA.ObjectToString(_value),anywheresoftware.b4a.keywords.Common.Colors.Yellow);
 //BA.debugLineNum = 176;BA.debugLine="LogColor(JOCount.JOCatCode, Colors.Red)";
anywheresoftware.b4a.keywords.Common.LogImpl("838666244",_jocount.JOCatCode /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Red);
 //BA.debugLineNum = 177;BA.debugLine="LogColor(JOCount.JODesc, Colors.Magenta)";
anywheresoftware.b4a.keywords.Common.LogImpl("838666245",_jocount.JODesc /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Magenta);
 //BA.debugLineNum = 178;BA.debugLine="LogColor(JOCount.JOTotals, Colors.Red)";
anywheresoftware.b4a.keywords.Common.LogImpl("838666246",BA.NumberToString(_jocount.JOTotals /*int*/ ),anywheresoftware.b4a.keywords.Common.Colors.Red);
...
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._actjoreasons.getObject()));
...
bwsi.PumpOperations.actjowithreasons._josummary _jorec = null;
 //BA.debugLineNum = 185;BA.debugLine="Sub clvJOs_VisibleRangeChanged (FirstIndex As Int,";
 //BA.debugLineNum = 186;BA.debugLine="Dim ExtraSize As Int = 15 'List size";
_extrasize = (int) (15);
 //BA.debugLineNum = 187;BA.debugLine="clvJOs.Refresh";
mostCurrent._clvjos._refresh();
 //BA.debugLineNum = 189;BA.debugLine="For i = Max(0, FirstIndex - ExtraSize) To Min(Las";
{
final int step3 = 1;
...
for (;_i <= limit3 ;_i = _i + step3 ) {
 //BA.debugLineNum = 190;BA.debugLine="Dim Pnl As B4XView = clvJOs.GetPanel(i)";
_pnl = new anywheresoftware.b4a.objects.B4XViewWrapper();
_pnl = mostCurrent._clvjos._getpanel(_i);
 //BA.debugLineNum = 191;BA.debugLine="If i > FirstIndex - ExtraSize And i < LastIndex";
if (_i>_firstindex-_extrasize && _i<_lastindex+_extrasize) { 
 //BA.debugLineNum = 192;BA.debugLine="If Pnl.NumberOfViews = 0 Then 'Add each item/la";
if (_pnl.getNumberOfViews()==0) { 
 //BA.debugLineNum = 193;BA.debugLine="Dim JORec As JOSummary = clvJOs.GetValue(i)";
_jorec = (bwsi.PumpOperations.actjowithreasons._josummary)(mostCurrent._clvjos._getvalue(_i));
 //BA.debugLineNum = 194;BA.debugLine="Pnl.LoadLayout(\"JOCategories\")";
_pnl.LoadLayout("JOCategories",mostCurrent.activityBA);
 //BA.debugLineNum = 196;BA.debugLine="lblJOCatDesc.Text = JORec.JODesc";
mostCurrent._lbljocatdesc.setText(BA.ObjectToCharSequence(_jorec.JODesc /*String*/ ));
 //BA.debugLineNum = 197;BA.debugLine="lblPending.Text = JORec.TotalPending";
mostCurrent._lblpending.setText(BA.ObjectToCharSequence(_jorec.TotalPending /*int*/ ));
 //BA.debugLineNum = 198;BA.debugLine="lblOnGoing.Text = JORec.TotalOnGoing";
mostCurrent._lblongoing.setText(BA.ObjectToCharSequence(_jorec.TotalOnGoing /*int*/ ));
 //BA.debugLineNum = 199;BA.debugLine="lblAccomplished.Text = JORec.TotalAccomplished";
mostCurrent._lblaccomplished.setText(BA.ObjectToCharSequence(_jorec.TotalAccomplished /*int*/ ));
 //BA.debugLineNum = 200;BA.debugLine="lblCancelled.Text = JORec.TotalCancelled";
mostCurrent._lblcancelled.setText(BA.ObjectToCharSequence(_jorec.TotalCancelled /*int*/ ));
 //BA.debugLineNum = 201;BA.debugLine="lblTotals.Text = JORec.JOTotals";
mostCurrent._lbltotals.setText(BA.ObjectToCharSequence(_jorec.JOTotals /*int*/ ));
 //BA.debugLineNum = 203;BA.debugLine="If JORec.TotalPending > 0 Then";
if (_jorec.TotalPending /*int*/ >0) { 
 //BA.debugLineNum = 204;BA.debugLine="lblPending.TextColor = GlobalVar.RedColor";
mostCurrent._lblpending.setTextColor((int) (mostCurrent._globalvar._redcolor /*double*/ ));
 }else {
 //BA.debugLineNum = 206;BA.debugLine="lblPending.TextColor = GlobalVar.BlueColor";
mostCurrent._lblpending.setTextColor((int) (mostCurrent._globalvar._bluecolor /*double*/ ));
 };
 //BA.debugLineNum = 209;BA.debugLine="If JORec.TotalOnGoing > 0 Then";
if (_jorec.TotalOnGoing /*int*/ >0) { 
 //BA.debugLineNum = 210;BA.debugLine="lblOnGoing.TextColor = GlobalVar.RedColor";
mostCurrent._lblongoing.setTextColor((int) (mostCurrent._globalvar._redcolor /*double*/ ));
 }else {
 //BA.debugLineNum = 212;BA.debugLine="lblOnGoing.TextColor = GlobalVar.BlueColor";
mostCurrent._lblongoing.setTextColor((int) (mostCurrent._globalvar._bluecolor /*double*/ ));
 };
 //BA.debugLineNum = 215;BA.debugLine="If JORec.TotalAccomplished <= 0 Then";
if (_jorec.TotalAccomplished /*int*/ <=0) { 
 //BA.debugLineNum = 216;BA.debugLine="lblAccomplished.TextColor = GlobalVar.RedColo";
mostCurrent._lblaccomplished.setTextColor((int) (mostCurrent._globalvar._redcolor /*double*/ ));
 }else {
 //BA.debugLineNum = 218;BA.debugLine="lblAccomplished.TextColor = GlobalVar.BlueCol";
mostCurrent._lblaccomplished.setTextColor((int) (mostCurrent._globalvar._bluecolor /*double*/ ));
 };
 //BA.debugLineNum = 221;BA.debugLine="If JORec.TotalCancelled > 0 Then";
if (_jorec.TotalCancelled /*int*/ >0) { 
 //BA.debugLineNum = 222;BA.debugLine="lblCancelled.TextColor = GlobalVar.RedColor";
mostCurrent._lblcancelled.setTextColor((int) (mostCurrent._globalvar._redcolor /*double*/ ));
 }else {
 //BA.debugLineNum = 224;BA.debugLine="lblCancelled.TextColor = GlobalVar.BlueColor";
mostCurrent._lblcancelled.setTextColor((int) (mostCurrent._globalvar._bluecolor /*double*/ ));
 };
 //BA.debugLineNum = 227;BA.debugLine="If JORec.JOTotals > 0 Then";
if (_jorec.JOTotals /*int*/ >0) { 
 //BA.debugLineNum = 228;BA.debugLine="lblTotals.TextColor = GlobalVar.RedColor";
mostCurrent._lbltotals.setTextColor((int) (mostCurrent._globalvar._redcolor /*double*/ ));
 }else {
 //BA.debugLineNum = 230;BA.debugLine="lblTotals.TextColor = GlobalVar.BlueColor";
mostCurrent._lbltotals.setTextColor((int) (mostCurrent._globalvar._bluecolor /*double*/ ));
 };
 };
 }else {
 //BA.debugLineNum = 235;BA.debugLine="If Pnl.NumberOfViews > 0 Then";
if (_pnl.getNumberOfViews()>0) { 
 //BA.debugLineNum = 236;BA.debugLine="Pnl.RemoveAllViews 'Remove none visable item/l";
_pnl.RemoveAllViews();
 };
 };
 }
...
public static void  _filljolist(int _iuserid,int _ibranchid,String _sjocatcode) throws Exception{
ResumableSub_FillJOList rsub = new ResumableSub_FillJOList(null,_iuserid,_ibranchid,_sjocatcode);
rsub.resume(processBA, null);
}
public static class ResumableSub_FillJOList extends BA.ResumableSub {
public ResumableSub_FillJOList(bwsi.PumpOperations.actjowithreasons parent,int _iuserid,int _ibranchid,String _sjocatcode) {
this.parent = parent;
this._iuserid = _iuserid;
this._ibranchid = _ibranchid;
this._sjocatcode = _sjocatcode;
}
bwsi.PumpOperations.actjowithreasons parent;
int _iuserid;
int _ibranchid;
String _sjocatcode;
...
anywheresoftware.b4a.keywords.Common.LogImpl("838600718",parent.mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
...
;
 //BA.debugLineNum = 136;BA.debugLine="If Success Then";
if (true) break;
...
//C
this.state = 7;
 //BA.debugLineNum = 137;BA.debugLine="Dim StartTime As Long = DateTime.Now";
_starttime = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 138;BA.debugLine="clvJOs.Clear";
...
//C
this.state = 7;
 //BA.debugLineNum = 140;BA.debugLine="Dim JOCount As JOSummary";
_jocount = new bwsi.PumpOperations.actjowithreasons._josummary();
 //BA.debugLineNum = 141;BA.debugLine="JOCount.Initialize";
_jocount.Initialize();
 //BA.debugLineNum = 142;BA.debugLine="JOCount.TotalPending = RS.GetInt(\"PendingJOs\")";
_jocount.TotalPending /*int*/  = _rs.GetInt("PendingJOs");
 //BA.debugLineNum = 143;BA.debugLine="JOCount.TotalOnGoing = RS.GetInt(\"OnGoingJOs\")";
_jocount.TotalOnGoing /*int*/  = _rs.GetInt("OnGoingJOs");
 //BA.debugLineNum = 144;BA.debugLine="JOCount.TotalAccomplished = RS.GetInt(\"Accompl";
_jocount.TotalAccomplished /*int*/  = _rs.GetInt("AccomplishedJOs");
 //BA.debugLineNum = 145;BA.debugLine="JOCount.TotalCancelled = RS.GetInt(\"CancelledJ";
_jocount.TotalCancelled /*int*/  = _rs.GetInt("CancelledJOs");
 //BA.debugLineNum = 146;BA.debugLine="JOCount.JOTotals = RS.GetInt(\"TotalJOs\")";
_jocount.JOTotals /*int*/  = _rs.GetInt("TotalJOs");
 //BA.debugLineNum = 148;BA.debugLine="JOCount.JODesc = GlobalVar.SF.Proper(RS.GetStr";
_jocount.JODesc /*String*/  = parent.mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvv5(_rs.GetString("JoDesc"));
 //BA.debugLineNum = 149;BA.debugLine="Dim Pnl As B4XView = xui.CreatePanel(\"\")";
_pnl = new anywheresoftware.b4a.objects.B4XViewWrapper();
_pnl = parent._xui.CreatePanel(processBA,"");
 //BA.debugLineNum = 150;BA.debugLine="Pnl.SetLayoutAnimated(0, 10dip, 0, clvJOs.AsVi";
_pnl.SetLayoutAnimated((int) (0),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(int) (0),parent.mostCurrent._clvjos._asview().getWidth(),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (120)));
 //BA.debugLineNum = 151;BA.debugLine="clvJOs.Add(Pnl, JOCount)";
parent.mostCurrent._clvjos._add(_pnl,(Object)(_jocount));
 if (true) break;
;
 //BA.debugLineNum = 153;BA.debugLine="If JOCount.JOTotals > 1 Then";
...
//C
this.state = 15;
 //BA.debugLineNum = 154;BA.debugLine="lblCount.Text = RS.RowCount & \" \" & GlobalVar.";
parent.mostCurrent._lblcount.setText(BA.ObjectToCharSequence(BA.NumberToString(_rs.getRowCount())+" "+parent.mostCurrent._globalvar._selectedjodesc /*String*/ +(" Job Orders Found")));
 if (true) break;

case 14:
//C
this.state = 15;
 //BA.debugLineNum = 156;BA.debugLine="lblCount.Text = RS.RowCount & \" \" & GlobalVar.";
parent.mostCurrent._lblcount.setText(BA.ObjectToCharSequence(BA.NumberToString(_rs.getRowCount())+" "+parent.mostCurrent._globalvar._selectedjodesc /*String*/ +(" Job Order Found")));
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("838600745",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("838600750",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
mostCurrent._txtsearch = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 33;BA.debugLine="Type JOSummary (JOCatCode As String, JODesc As St";
;
...
public static String  _txtsearch_enterpressed() throws Exception{
 //BA.debugLineNum = 309;BA.debugLine="Sub txtSearch_EnterPressed";
...
public ResumableSub_txtSearch_TextChanged(bwsi.PumpOperations.actjowithreasons parent,String _old,String _new) {
this.parent = parent;
this._old = _old;
this._new = _new;
}
...
//C
this.state = 1;
 //BA.debugLineNum = 243;BA.debugLine="If New.Length = 1 Or txtSearch.Text.Length = 2 Th";
if (true) break;
...
this.state = 7;
;
 //BA.debugLineNum = 244;BA.debugLine="clvJOs.Clear";
parent.mostCurrent._clvjos._clear();
 //BA.debugLineNum = 245;BA.debugLine="Sleep(0)";
...
this.state = 7;
;
 //BA.debugLineNum = 247;BA.debugLine="Dim SenderFilter As Object";
_senderfilter = new Object();
 //BA.debugLineNum = 248;BA.debugLine="If New.Length = 0  Then";
if (true) break;
...
//C
this.state = 12;
 //BA.debugLineNum = 250;BA.debugLine="Starter.strCriteria = \"SELECT sum(CASE WHEN JOs.";
parent.mostCurrent._starter._strcriteria /*String*/  = "SELECT sum(CASE WHEN JOs.JOStatus = 1 THEN 1 ELSE 0 END) AS PendingJOs, "+"sum(CASE WHEN JOs.JOStatus = 2 THEN 1 ELSE 0 END) AS OnGoingJOs, "+"sum(CASE WHEN JOs.JOStatus = 3 THEN 1 ELSE 0 END) AS AccomplishedJOs, "+"sum(CASE WHEN JOs.JOStatus = 4 THEN 1 ELSE 0 END) AS CancelledJOs, "+"count(JOs.JOID) AS TotalJOs, JOs.JoDesc "+"FROM tblJOs AS JOs "+"INNER JOIN constant_jo_categories AS JOCat ON JOs.JOCatCode = JOCat.jo_code "+"WHERE JOs.JOAssignedTo = "+BA.NumberToString(parent.mostCurrent._globalvar._userid /*int*/ )+" "+"AND JOs.BranchID = "+BA.NumberToString(parent.mostCurrent._globalvar._branchid /*int*/ )+" "+"AND JOs.JOCatCode = '"+parent.mostCurrent._globalvar._selectedjocatcode /*String*/ +"' "+"GROUP BY JOs.JoDesc ORDER BY JOCat.id ASC LIMIT 100";
 if (true) break;

case 11:
//C
this.state = 12;
 //BA.debugLineNum = 262;BA.debugLine="Starter.strCriteria = \"SELECT sum(CASE WHEN JOs.";
parent.mostCurrent._starter._strcriteria /*String*/  = "SELECT sum(CASE WHEN JOs.JOStatus = 1 THEN 1 ELSE 0 END) AS PendingJOs, "+"sum(CASE WHEN JOs.JOStatus = 2 THEN 1 ELSE 0 END) AS OnGoingJOs, "+"sum(CASE WHEN JOs.JOStatus = 3 THEN 1 ELSE 0 END) AS AccomplishedJOs, "+"sum(CASE WHEN JOs.JOStatus = 4 THEN 1 ELSE 0 END) AS CancelledJOs, "+"count(JOs.JOID) AS TotalJOs, JOs.JoDesc "+"FROM tblJOs AS JOs "+"INNER JOIN constant_jo_categories AS JOCat ON JOs.JOCatCode = JOCat.jo_code "+"WHERE JOs.JOAssignedTo = "+BA.NumberToString(parent.mostCurrent._globalvar._userid /*int*/ )+" "+"AND JOs.BranchID = "+BA.NumberToString(parent.mostCurrent._globalvar._branchid /*int*/ )+" "+"AND JOs.JOCatCode = '"+parent.mostCurrent._globalvar._selectedjocatcode /*String*/ +"' "+"AND JOCat.JoDesc LIKE '%"+_new+"%' "+"GROUP BY JOs.JoDesc ORDER BY JOCat.id ASC LIMIT 100";
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("838797345",parent.mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
...
_rs = (anywheresoftware.b4a.sql.SQL.ResultSetWrapper) result[1];
;
 //BA.debugLineNum = 279;BA.debugLine="If Success Then";
if (true) break;
...
//C
this.state = 16;
 //BA.debugLineNum = 280;BA.debugLine="Dim StartTime As Long = DateTime.Now";
_starttime = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 281;BA.debugLine="clvJOs.Clear";
parent.mostCurrent._clvjos._clear();
 //BA.debugLineNum = 282;BA.debugLine="Do While RS.NextRow";
if (true) break;
...
//C
this.state = 16;
 //BA.debugLineNum = 283;BA.debugLine="Dim JOCount As JOSummary";
_jocount = new bwsi.PumpOperations.actjowithreasons._josummary();
 //BA.debugLineNum = 284;BA.debugLine="JOCount.Initialize";
_jocount.Initialize();
 //BA.debugLineNum = 285;BA.debugLine="JOCount.TotalPending = RS.GetInt(\"PendingJOs\")";
_jocount.TotalPending /*int*/  = _rs.GetInt("PendingJOs");
 //BA.debugLineNum = 286;BA.debugLine="JOCount.TotalOnGoing = RS.GetInt(\"OnGoingJOs\")";
_jocount.TotalOnGoing /*int*/  = _rs.GetInt("OnGoingJOs");
 //BA.debugLineNum = 287;BA.debugLine="JOCount.TotalAccomplished = RS.GetInt(\"Accompli";
_jocount.TotalAccomplished /*int*/  = _rs.GetInt("AccomplishedJOs");
 //BA.debugLineNum = 288;BA.debugLine="JOCount.TotalCancelled = RS.GetInt(\"CancelledJO";
_jocount.TotalCancelled /*int*/  = _rs.GetInt("CancelledJOs");
 //BA.debugLineNum = 289;BA.debugLine="JOCount.JOTotals = RS.GetInt(\"TotalJOs\")";
_jocount.JOTotals /*int*/  = _rs.GetInt("TotalJOs");
 //BA.debugLineNum = 291;BA.debugLine="JOCount.JODesc = GlobalVar.SF.Proper(RS.GetStri";
_jocount.JODesc /*String*/  = parent.mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvv5(_rs.GetString("JoDesc"));
 //BA.debugLineNum = 292;BA.debugLine="Dim Pnl As B4XView = xui.CreatePanel(\"\")";
_pnl = new anywheresoftware.b4a.objects.B4XViewWrapper();
_pnl = parent._xui.CreatePanel(processBA,"");
 //BA.debugLineNum = 293;BA.debugLine="Pnl.SetLayoutAnimated(0, 10dip, 0, clvJOs.AsVie";
_pnl.SetLayoutAnimated((int) (0),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(int) (0),parent.mostCurrent._clvjos._asview().getWidth(),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (120)));
 //BA.debugLineNum = 294;BA.debugLine="clvJOs.Add(Pnl, JOCount)";
parent.mostCurrent._clvjos._add(_pnl,(Object)(_jocount));
 if (true) break;
;
 //BA.debugLineNum = 296;BA.debugLine="If JOCount.JOTotals > 1 Then";
...
//C
this.state = 24;
 //BA.debugLineNum = 297;BA.debugLine="lblCount.Text = RS.RowCount & \" \" & GlobalVar.S";
parent.mostCurrent._lblcount.setText(BA.ObjectToCharSequence(BA.NumberToString(_rs.getRowCount())+" "+parent.mostCurrent._globalvar._selectedjodesc /*String*/ +(" Job Orders Found")));
 if (true) break;
...
//C
this.state = 24;
 //BA.debugLineNum = 299;BA.debugLine="lblCount.Text = RS.RowCount & \" \" & GlobalVar.S";
parent.mostCurrent._lblcount.setText(BA.ObjectToCharSequence(BA.NumberToString(_rs.getRowCount())+" "+parent.mostCurrent._globalvar._selectedjodesc /*String*/ +(" Job Order Found")));
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("838797372",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("838797375",("List of Job Order Records = "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(anywheresoftware.b4a.keywords.Common.NumberFormat2((anywheresoftware.b4a.keywords.Common.DateTime.getNow()-_starttime)/(double)1000,(int) (0),(int) (2),(int) (2),anywheresoftware.b4a.keywords.Common.False)))+" seconds to populate "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(parent.mostCurrent._clvjos._getsize()))+" Job Order Records"),0);
