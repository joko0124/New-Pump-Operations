...
public class keyvaluestore extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "bwsi.PumpOperations.keyvaluestore");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", bwsi.PumpOperations.keyvaluestore.class).invoke(this, new Object[] {null});
        else
...
public ResumableSub_GetMapAsync(bwsi.PumpOperations.keyvaluestore parent,anywheresoftware.b4a.objects.collections.List _keys) {
this.parent = parent;
this._keys = _keys;
}
bwsi.PumpOperations.keyvaluestore parent;
...
parent.__c.LogImpl("9129695767",BA.ObjectToString(parent.__c.LastException(parent.getActivityBA())),0);
 if (true) break;
...
public ResumableSub_PutMapAsync(bwsi.PumpOperations.keyvaluestore parent,anywheresoftware.b4a.objects.collections.Map _map) {
this.parent = parent;
this._map = _map;
}
bwsi.PumpOperations.keyvaluestore parent;
...
parent.__c.LogImpl("9129761288","Failed to serialize object: "+BA.ObjectToString(_map.Get((Object)(_key))),0);
 if (true) break;
