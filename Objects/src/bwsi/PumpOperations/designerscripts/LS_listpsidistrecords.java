...
views.get("lbldisttimeread").vw.setWidth((int)((50d / 100 * width) - ((2.5d / 100 * width))));
views.get("lbllocation").vw.setLeft((int)((2.5d / 100 * width)));
views.get("lbllocation").vw.setWidth((int)((78d / 100 * width) - ((2.5d / 100 * width))));
...
views.get("lblstyle").vw.setTop((int)((views.get("lbldistpsirdg").vw.getTop() + views.get("lbldistpsirdg").vw.getHeight())-(4d * scale)));
