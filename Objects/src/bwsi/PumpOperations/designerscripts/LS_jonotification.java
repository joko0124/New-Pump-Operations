...
public class LS_jonotification{
...
views.get("pnllist").vw.setTop((int)((views.get("pnlsearch").vw.getTop() + views.get("pnlsearch").vw.getHeight())));
views.get("pnllist").vw.setHeight((int)((views.get("pnlmain").vw.getHeight())-(4d / 100 * height) - ((views.get("pnlsearch").vw.getTop() + views.get("pnlsearch").vw.getHeight()))));
views.get("pnllist").vw.setLeft((int)((0d / 100 * width)));
views.get("pnllist").vw.setWidth((int)((views.get("pnlmain").vw.getWidth()) - ((0d / 100 * width))));
views.get("clvjos").vw.setLeft((int)((0d / 100 * width)));
views.get("clvjos").vw.setWidth((int)((views.get("pnllist").vw.getWidth()) - ((0d / 100 * width))));
...
views.get("pnlstatus").vw.setTop((int)((88d / 100 * height)));
views.get("pnlstatus").vw.setHeight((int)((views.get("pnlmain").vw.getTop() + views.get("pnlmain").vw.getHeight())-(0.25d / 100 * height) - ((88d / 100 * height))));
