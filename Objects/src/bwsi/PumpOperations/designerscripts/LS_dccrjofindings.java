...
public class LS_dccrjofindings{
...
views.get("pnlmain").vw.setHeight((int)((190d / 100 * height) - ((0.5d / 100 * height))));
...
views.get("cboactiontaken").vw.setTop((int)((0.5d / 100 * height)));
views.get("cboactiontaken").vw.setHeight((int)((views.get("pnlactiontakenanchor").vw.getHeight())-(0.5d / 100 * height) - ((0.5d / 100 * height))));
...
views.get("txtmeterfindings").vw.setLeft((int)((2d / 100 * width)));
views.get("txtmeterfindings").vw.setWidth((int)((views.get("pnlmeterfindingsanchor").vw.getWidth())-(1d / 100 * width) - ((2d / 100 * width))));
...
views.get("txtprevrdg").vw.setWidth((int)((views.get("pnlprevrdganchor").vw.getWidth())-(2d / 100 * width) - ((1d / 100 * width))));
...
views.get("txtfinalrdg").vw.setWidth((int)((views.get("pnlfinalrdganchor").vw.getWidth())-(2d / 100 * width) - ((1d / 100 * width))));
views.get("txtfinalrdg").vw.setTop((int)((0.5d / 100 * height)));
views.get("txtfinalrdg").vw.setHeight((int)((views.get("pnlfinalrdganchor").vw.getHeight())-(0.5d / 100 * height) - ((0.5d / 100 * height))));
...
views.get("pnlremarks").vw.setHeight((int)((22d / 100 * height)));
