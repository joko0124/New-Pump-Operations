...
views.get("pnllogin").vw.setTop((int)((20d / 100 * height)));
views.get("pnllogin").vw.setHeight((int)((views.get("pnlmain").vw.getHeight())-(33d / 100 * height) - ((20d / 100 * height))));
...
views.get("pnlusernameanchor").vw.setLeft((int)((5d / 100 * width)));
views.get("pnlusernameanchor").vw.setWidth((int)((views.get("pnllogin").vw.getWidth())-(5d / 100 * width) - ((5d / 100 * width))));
views.get("pnlusernameanchor").vw.setTop((int)((views.get("logo").vw.getTop() + views.get("logo").vw.getHeight())+(5d / 100 * height)));
views.get("pnlusernameanchor").vw.setHeight((int)((7.5d / 100 * height)));
...
views.get("pnlpasswordanchor").vw.setLeft((int)((5d / 100 * width)));
views.get("pnlpasswordanchor").vw.setWidth((int)((views.get("pnllogin").vw.getWidth())-(5d / 100 * width) - ((5d / 100 * width))));
...
views.get("pnlpasswordanchor").vw.setHeight((int)((7.5d / 100 * height)));
...
views.get("lblcheck").vw.setTop((int)((views.get("pnlpasswordanchor").vw.getTop() + views.get("pnlpasswordanchor").vw.getHeight())+(12d * scale)));
views.get("lblcheck").vw.setLeft((int)((views.get("pnlpasswordanchor").vw.getLeft())+(10d * scale)));
views.get("lblshow").vw.setTop((int)((views.get("lblcheck").vw.getTop() + views.get("lblcheck").vw.getHeight()/2) - (views.get("lblshow").vw.getHeight() / 2)));
views.get("lblshow").vw.setLeft((int)((views.get("lblcheck").vw.getLeft() + views.get("lblcheck").vw.getWidth())+(4d * scale)));
