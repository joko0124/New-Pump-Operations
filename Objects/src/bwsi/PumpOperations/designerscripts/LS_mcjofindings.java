...
views.get("pnlmain").vw.setHeight((int)((215d / 100 * height) - ((0.5d / 100 * height))));
views.get("pnlmain").vw.setWidth((int)((100d / 100 * width)));
views.get("pnljodetails").vw.setTop((int)((1d / 100 * height)));
views.get("pnljodetails").vw.setHeight((int)((60d / 100 * height)));
...
views.get("pnlfindings").vw.setHeight((int)((58d / 100 * height)));
...
views.get("lblcaption6").vw.setTop((int)((views.get("lblfindingstitle").vw.getTop() + views.get("lblfindingstitle").vw.getHeight())+(5d * scale)));
views.get("lblcaption6").vw.setLeft((int)((3d / 100 * width)));
...
views.get("pnlprevrdganchor").vw.setWidth((int)((views.get("pnlfindings").vw.getWidth())-(48d / 100 * width) - ((views.get("lblcaption6").vw.getLeft() + views.get("lblcaption6").vw.getWidth())+(5d * scale))));
...
views.get("lblcaption7").vw.setLeft((int)((views.get("pnlprevrdganchor").vw.getLeft() + views.get("pnlprevrdganchor").vw.getWidth())+(5d * scale)));
...
views.get("pnlfinalrdganchor").vw.setWidth((int)((views.get("pnlfindings").vw.getWidth())-(3d / 100 * width) - ((views.get("lblcaption7").vw.getLeft() + views.get("lblcaption7").vw.getWidth())+(5d * scale))));
views.get("txtcurrentrdg").vw.setLeft((int)((1d / 100 * width)));
views.get("txtcurrentrdg").vw.setWidth((int)((views.get("pnlfinalrdganchor").vw.getWidth())-(1d / 100 * width) - ((1d / 100 * width))));
views.get("txtcurrentrdg").vw.setTop((int)((0.5d / 100 * height)));
views.get("txtcurrentrdg").vw.setHeight((int)((views.get("pnlfinalrdganchor").vw.getHeight())-(0.5d / 100 * height) - ((0.5d / 100 * height))));
views.get("lblcaption8").vw.setLeft((int)((views.get("lblcaption6").vw.getLeft())));
views.get("lblcaption8").vw.setTop((int)((views.get("lblcaption6").vw.getTop() + views.get("lblcaption6").vw.getHeight())+(5d * scale)));
views.get("pnlmeterfindingsanchor").vw.setTop((int)((views.get("lblcaption8").vw.getTop() + views.get("lblcaption8").vw.getHeight())));
views.get("pnlmeterfindingsanchor").vw.setLeft((int)((views.get("lblcaption8").vw.getLeft())));
views.get("pnlmeterfindingsanchor").vw.setWidth((int)((views.get("pnlfindings").vw.getWidth())-(3d / 100 * width) - ((views.get("lblcaption8").vw.getLeft()))));
...
views.get("txtmeterfindings").vw.setTop((int)((0.5d / 100 * height)));
views.get("txtmeterfindings").vw.setHeight((int)((views.get("pnlmeterfindingsanchor").vw.getHeight())-(0.5d / 100 * height) - ((0.5d / 100 * height))));
views.get("lblcaption9").vw.setLeft((int)((views.get("lblcaption8").vw.getLeft())));
views.get("lblcaption9").vw.setTop((int)((views.get("pnlmeterfindingsanchor").vw.getTop() + views.get("pnlmeterfindingsanchor").vw.getHeight())+(5d * scale)));
views.get("pnlactiontakenanchor").vw.setTop((int)((views.get("lblcaption9").vw.getTop() + views.get("lblcaption9").vw.getHeight())));
views.get("pnlactiontakenanchor").vw.setLeft((int)((views.get("lblcaption9").vw.getLeft())));
views.get("pnlactiontakenanchor").vw.setWidth((int)((views.get("pnlfindings").vw.getWidth())-(3d / 100 * width) - ((views.get("lblcaption9").vw.getLeft()))));
views.get("txtactiontaken").vw.setLeft((int)((1d / 100 * width)));
views.get("txtactiontaken").vw.setWidth((int)((views.get("pnlactiontakenanchor").vw.getWidth())-(1d / 100 * width) - ((1d / 100 * width))));
views.get("txtactiontaken").vw.setTop((int)((0.5d / 100 * height)));
views.get("txtactiontaken").vw.setHeight((int)((views.get("pnlactiontakenanchor").vw.getHeight())-(0.5d / 100 * height) - ((0.5d / 100 * height))));
