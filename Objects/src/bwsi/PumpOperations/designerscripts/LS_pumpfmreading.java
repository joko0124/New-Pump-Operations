...
views.get("pnlreadingtime").vw.setTop((int)((8d / 100 * height)));
views.get("pnlreadingtime").vw.setHeight((int)((views.get("pnlmain").vw.getHeight())-(65d / 100 * height) - ((8d / 100 * height))));
...
views.get("pnlrdg").vw.setHeight((int)((views.get("pnlmain").vw.getHeight())-(44d / 100 * height) - ((views.get("pnlreadingtime").vw.getTop() + views.get("pnlreadingtime").vw.getHeight())+(10d * scale))));
