...
views.get("chkdrain").vw.setWidth((int)((views.get("pnldrain").vw.getWidth())-(60d / 100 * width) - ((2d / 100 * width))));
...
views.get("pnldurationanchor").vw.setWidth((int)((views.get("pnldrain").vw.getWidth())-(12d / 100 * width) - ((views.get("lbldrain1").vw.getLeft() + views.get("lbldrain1").vw.getWidth())+(3d * scale))));
...
views.get("txtduration").vw.setWidth((int)((views.get("pnldurationanchor").vw.getWidth())-(8d / 100 * width) - ((1d / 100 * width))));
