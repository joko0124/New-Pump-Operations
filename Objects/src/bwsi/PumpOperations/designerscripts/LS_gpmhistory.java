...
views.get("label1").vw.setWidth((int)((views.get("pnlmain").vw.getWidth())-(75d / 100 * width) - (0d)));
views.get("label2").vw.setLeft((int)((25d / 100 * width)));
views.get("label2").vw.setWidth((int)((views.get("pnlmain").vw.getWidth())-(48d / 100 * width) - ((25d / 100 * width))));
