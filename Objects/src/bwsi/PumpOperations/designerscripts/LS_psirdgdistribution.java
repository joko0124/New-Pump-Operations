...
views.get("label1").vw.setWidth((int)((75d / 100 * width) - (0d)));
views.get("label2").vw.setLeft((int)((75d / 100 * width)));
views.get("label2").vw.setWidth((int)((100d / 100 * width) - ((75d / 100 * width))));
