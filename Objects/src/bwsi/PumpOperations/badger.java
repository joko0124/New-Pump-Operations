...
public class badger extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "bwsi.PumpOperations.badger");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", bwsi.PumpOperations.badger.class).invoke(this, new Object[] {null});
        else
...
public ResumableSub_RemoveBadge(bwsi.PumpOperations.badger parent,anywheresoftware.b4a.objects.B4XViewWrapper _view) {
this.parent = parent;
this._view = _view;
}
bwsi.PumpOperations.badger parent;
...
public ResumableSub_ReplaceLabel(bwsi.PumpOperations.badger parent,anywheresoftware.b4a.objects.B4XViewWrapper _view,int _badge) {
this.parent = parent;
this._view = _view;
this._badge = _badge;
}
