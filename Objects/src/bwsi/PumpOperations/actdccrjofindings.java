...
public class actdccrjofindings extends androidx.appcompat.app.AppCompatActivity implements B4AActivity{
	public static actdccrjofindings mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "bwsi.PumpOperations", "bwsi.PumpOperations.actdccrjofindings");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (actdccrjofindings).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "bwsi.PumpOperations", "bwsi.PumpOperations.actdccrjofindings");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "bwsi.PumpOperations.actdccrjofindings", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (actdccrjofindings) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (actdccrjofindings) Resume **");
...
@Override
 ...
 protected void onStop() {
    ...
    public static Class<?> getObject() {
		return actdccrjofindings.class;
	}
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (actdccrjofindings) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (actdccrjofindings) Pause event (activity is not paused). **");
        if (mostCurrent != null)
    ...
    private static class ResumeMessage implements Runnable {
		...
		public void run() {
            actdccrjofindings mc = mostCurrent;
...
com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder _alert = null;
 //BA.debugLineNum = 856;BA.debugLine="Private Sub Accomplished_OnNegativeClicked (View A";
 //BA.debugLineNum = 858;BA.debugLine="Dim Alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 859;BA.debugLine="Alert.Initialize.Dismiss(Dialog)";
...
com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder _alert = null;
 //BA.debugLineNum = 862;BA.debugLine="Private Sub Accomplished_OnPositiveClicked (View A";
 //BA.debugLineNum = 865;BA.debugLine="Dim Alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 866;BA.debugLine="Alert.Initialize.Dismiss(Dialog)";
_alert.Initialize().Dismiss((android.app.Dialog)(_dialog));
 //BA.debugLineNum = 868;BA.debugLine="UpdateJO(GlobalVar.SelectedJOID)";
...
mostCurrent._myscale._setrate /*String*/ (mostCurrent.activityBA,0.5);
 //BA.debugLineNum = 107;BA.debugLine="Activity.LoadLayout(\"JOFindingsMain\")";
mostCurrent._activity.LoadLayout("JOFindingsMain",mostCurrent.activityBA);
 //BA.debugLineNum = 109;BA.debugLine="scvMain.Panel.LoadLayout(\"DCCRJOFindings\")";
mostCurrent._scvmain.getPanel().LoadLayout("DCCRJOFindings",mostCurrent.activityBA);
 //BA.debugLineNum = 110;BA.debugLine="scvMain.Panel.Height = pnlMain.Height";
mostCurrent._scvmain.getPanel().setHeight(mostCurrent._pnlmain.getHeight());
 //BA.debugLineNum = 112;BA.debugLine="GlobalVar.CSSubTitle.Initialize.Size(12).Append($";
mostCurrent._globalvar._cssubtitle /*anywheresoftware.b4a.objects.CSBuilder*/ .Initialize().Size((int) (12)).Append(BA.ObjectToCharSequence(("Accomplishment Form"))).PopAll();
 //BA.debugLineNum = 113;BA.debugLine="GlobalVar.CSTitle.Initialize.Size(15).Bold.Append";
mostCurrent._globalvar._cstitle /*anywheresoftware.b4a.objects.CSBuilder*/ .Initialize().Size((int) (15)).Bold().Append(BA.ObjectToCharSequence(("Disconnection-Customer Request JO"))).PopAll();
 //BA.debugLineNum = 115;BA.debugLine="ToolBar.InitMenuListener";
mostCurrent._toolbar.InitMenuListener();
 //BA.debugLineNum = 116;BA.debugLine="ToolBar.Title = GlobalVar.CSTitle";
mostCurrent._toolbar.setTitle(BA.ObjectToCharSequence(mostCurrent._globalvar._cstitle /*anywheresoftware.b4a.objects.CSBuilder*/ .getObject()));
 //BA.debugLineNum = 117;BA.debugLine="ToolBar.SubTitle = GlobalVar.CSSubTitle";
...
_jo = new anywheresoftware.b4j.object.JavaObject();
 //BA.debugLineNum = 120;BA.debugLine="Dim xl As XmlLayoutBuilder";
_xl = new anywheresoftware.b4a.object.XmlLayoutBuilder();
 //BA.debugLineNum = 121;BA.debugLine="jo = ToolBar";
_jo = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(mostCurrent._toolbar.getObject()));
 //BA.debugLineNum = 122;BA.debugLine="jo.RunMethod(\"setPopupTheme\", Array(xl.GetResourc";
_jo.RunMethod("setPopupTheme",new Object[]{(Object)(_xl.GetResourceId("style","ToolbarMenu"))});
 //BA.debugLineNum = 123;BA.debugLine="jo.RunMethod(\"setContentInsetStartWithNavigation\"";
_jo.RunMethod("setContentInsetStartWithNavigation",new Object[]{(Object)(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (1)))});
 //BA.debugLineNum = 124;BA.debugLine="jo.RunMethod(\"setTitleMarginStart\", Array(0dip))";
_jo.RunMethod("setTitleMarginStart",new Object[]{(Object)(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (0)))});
 //BA.debugLineNum = 126;BA.debugLine="ActionBarButton.Initialize";
mostCurrent._actionbarbutton.Initialize(mostCurrent.activityBA);
 //BA.debugLineNum = 127;BA.debugLine="ActionBarButton.ShowUpIndicator = True";
...
if (_firsttime) { 
 //BA.debugLineNum = 130;BA.debugLine="HasSign = False";
_hassign = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 131;BA.debugLine="ClearUI";
_clearui();
 //BA.debugLineNum = 132;BA.debugLine="FillJORecord(GlobalVar.SelectedJOID)";
_filljorecord(mostCurrent._globalvar._selectedjoid /*int*/ );
 //BA.debugLineNum = 133;BA.debugLine="cboActionTaken.RequestFocus";
mostCurrent._cboactiontaken.RequestFocus();
 };
 //BA.debugLineNum = 135;BA.debugLine="InpTyp.Initialize";
_inptyp._initialize /*String*/ (processBA);
 //BA.debugLineNum = 136;BA.debugLine="InpTyp.SetInputType(txtRemarks,Array As Int(InpTy";
_inptyp._setinputtype /*String*/ (mostCurrent._txtremarks,new int[]{_inptyp._type_class_text /*int*/ (),_inptyp._type_text_flag_auto_complete /*int*/ (),_inptyp._type_text_flag_cap_words /*int*/ ()});
 //BA.debugLineNum = 137;BA.debugLine="InpTyp.SetInputType(txtMeterFindings,Array As Int";
_inptyp._setinputtype /*String*/ (mostCurrent._txtmeterfindings,new int[]{_inptyp._type_class_text /*int*/ (),_inptyp._type_text_flag_auto_complete /*int*/ (),_inptyp._type_text_flag_cap_words /*int*/ ()});
 //BA.debugLineNum = 139;BA.debugLine="CheckPermissions";
_checkpermissions();
...
de.amberhome.objects.appcompat.ACMenuItemWrapper _item = null;
 //BA.debugLineNum = 204;BA.debugLine="Sub Activity_CreateMenu(Menu As ACMenu)";
 //BA.debugLineNum = 205;BA.debugLine="Dim Item As ACMenuItem";
_item = new de.amberhome.objects.appcompat.ACMenuItemWrapper();
 //BA.debugLineNum = 207;BA.debugLine="Menu.Clear";
_menu.Clear();
 //BA.debugLineNum = 208;BA.debugLine="Menu.Add2(1, 1, \"Cancel JO\",xmlIcon.GetDrawable(\"";
...
public static boolean  _activity_keypress(int _keycode) throws Exception{
 ...
 //BA.debugLineNum = 181;BA.debugLine="If KeyCode = 4 Then";
if (_keycode==4) { 
 //BA.debugLineNum = 182;BA.debugLine="ToolBar_NavigationItemClick";
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
 ...
 //BA.debugLineNum = 198;BA.debugLine="CallSubDelayed(Starter,\"StopFLP\")";
...
public static String  _activity_permissionresult(String _permission,boolean _result) throws Exception{
 //BA.debugLineNum = 154;BA.debugLine="Sub Activity_PermissionResult (Permission As Strin";
 //BA.debugLineNum = 155;BA.debugLine="If Result Then";
if (_result) { 
 //BA.debugLineNum = 156;BA.debugLine="If Permission = Starter.RTP.PERMISSION_READ_EXTE";
if ((_permission).equals(mostCurrent._starter._rtp /*anywheresoftware.b4a.objects.RuntimePermissions*/ .PERMISSION_READ_EXTERNAL_STORAGE)) { 
 //BA.debugLineNum = 157;BA.debugLine="LogColor($\"Permission to Read External Storage";
anywheresoftware.b4a.keywords.Common.LogImpl("717694723",("Permission to Read External Storage GRANTED"),anywheresoftware.b4a.keywords.Common.Colors.Yellow);
 //BA.debugLineNum = 158;BA.debugLine="ReadStoragePermission = True";
_readstoragepermission = anywheresoftware.b4a.keywords.Common.True;
 ...
 //BA.debugLineNum = 160;BA.debugLine="LogColor($\"Permission to Write External Storage";
anywheresoftware.b4a.keywords.Common.LogImpl("717694726",("Permission to Write External Storage GRANTED"),anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 161;BA.debugLine="WriteStoragePermission = True";
_writestoragepermission = anywheresoftware.b4a.keywords.Common.True;
 ...
 //BA.debugLineNum = 163;BA.debugLine="LogColor($\"Permission to Access Coarse Location";
anywheresoftware.b4a.keywords.Common.LogImpl("717694729",("Permission to Access Coarse Location GRANTED"),anywheresoftware.b4a.keywords.Common.Colors.Magenta);
 //BA.debugLineNum = 164;BA.debugLine="CoarseLocPermission = True";
_coarselocpermission = anywheresoftware.b4a.keywords.Common.True;
 ...
 //BA.debugLineNum = 166;BA.debugLine="LogColor($\"Permission to Access Fine Location G";
anywheresoftware.b4a.keywords.Common.LogImpl("717694732",("Permission to Access Fine Location GRANTED"),anywheresoftware.b4a.keywords.Common.Colors.Cyan);
 //BA.debugLineNum = 167;BA.debugLine="FineLocPermission = True";
_finelocpermission = anywheresoftware.b4a.keywords.Common.True;
 };
 //BA.debugLineNum = 169;BA.debugLine="Starter.StartFLP";
mostCurrent._starter._startflp /*void*/ ();
 }else {
 //BA.debugLineNum = 171;BA.debugLine="ReadStoragePermission = False";
_readstoragepermission = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 172;BA.debugLine="WriteStoragePermission = False";
_writestoragepermission = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 173;BA.debugLine="CoarseLocPermission = False";
_coarselocpermission = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 174;BA.debugLine="FineLocPermission = False";
...
anywheresoftware.b4a.keywords.Common.LogImpl("717694743",_permission,0);
 //BA.debugLineNum = 178;BA.debugLine="End Sub";
return "";
}
public static String  _activity_resume() throws Exception{
 //BA.debugLineNum = 189;BA.debugLine="Sub Activity_Resume";
 //BA.debugLineNum = 190;BA.debugLine="HasSign = False";
_hassign = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 191;BA.debugLine="ClearUI";
_clearui();
 //BA.debugLineNum = 192;BA.debugLine="FillJORecord(GlobalVar.SelectedJOID)";
_filljorecord(mostCurrent._globalvar._selectedjoid /*int*/ );
 //BA.debugLineNum = 193;BA.debugLine="cboActionTaken.RequestFocus";
mostCurrent._cboactiontaken.RequestFocus();
 //BA.debugLineNum = 194;BA.debugLine="CheckPermissions";
_checkpermissions();
 //BA.debugLineNum = 195;BA.debugLine="End Sub";
return "";
}
public static String  _btncancel_click() throws Exception{
 //BA.debugLineNum = 426;BA.debugLine="Sub btnCancel_Click";
 //BA.debugLineNum = 427;BA.debugLine="pnlSignature.Visible = False";
mostCurrent._pnlsignature.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 428;BA.debugLine="pnlConfirmSig.Visible = False";
...
anywheresoftware.b4a.agraham.reflection.Reflection _r = null;
 //BA.debugLineNum = 401;BA.debugLine="Sub btnClear_Click";
 //BA.debugLineNum = 402;BA.debugLine="pnlSignature.Visible = True";
mostCurrent._pnlsignature.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 403;BA.debugLine="pnlConfirmSig.Visible = False";
mostCurrent._pnlconfirmsig.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 405;BA.debugLine="cdOK.Initialize2(GlobalVar.GreenColor, 20, 0, Col";
mostCurrent._cdok.Initialize2((int) (mostCurrent._globalvar._greencolor /*double*/ ),(int) (20),(int) (0),anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 406;BA.debugLine="btnConfirmSig.Background = cdOK";
mostCurrent._btnconfirmsig.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cdok.getObject()));
 //BA.debugLineNum = 407;BA.debugLine="btnConfirmSig.Text = Chr(0xE5C8) & $\" CONFIRM SIG";
...
anywheresoftware.b4a.agraham.reflection.Reflection _r = null;
 //BA.debugLineNum = 372;BA.debugLine="Sub btnConfirmSig_Click";
 //BA.debugLineNum = 373;BA.debugLine="Dim lngDateTime As Long";
_lngdatetime = 0L;
 //BA.debugLineNum = 374;BA.debugLine="lngDateTime = DateTime.Now";
_lngdatetime = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 376;BA.debugLine="If HasSign = False Then";
if (_hassign==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 377;BA.debugLine="RequiredMsgBox(Chr(0xE002) & $\" ERROR\"$,$\"Custom";
...
if (true) return "";
 ...
 //BA.debugLineNum = 381;BA.debugLine="Log(\"SignaturePad_onSigned(sign)\")";
anywheresoftware.b4a.keywords.Common.LogImpl("718546697","SignaturePad_onSigned(sign)",0);
 //BA.debugLineNum = 383;BA.debugLine="pnlConfirmSig.Visible = True";
mostCurrent._pnlconfirmsig.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 384;BA.debugLine="pnlSignature.Visible = False";
mostCurrent._pnlsignature.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 386;BA.debugLine="Dim bmp As Bitmap = eSig";
...
_bmp = (anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper(), (android.graphics.Bitmap)(mostCurrent._esig));
 //BA.debugLineNum = 387;BA.debugLine="imgSignature.Bitmap = bmp";
mostCurrent._imgsignature.setBitmap((android.graphics.Bitmap)(_bmp.getObject()));
 //BA.debugLineNum = 388;BA.debugLine="spnPlumbers.Items = Array As String(\"\")";
...
anywheresoftware.b4a.keywords.Common.DateTime.setDateFormat("yyyy-MM-dd hh:mm:ss a");
 //BA.debugLineNum = 390;BA.debugLine="txtDateTimeFinished.Text = DateTime.Date(lngDateT";
mostCurrent._txtdatetimefinished.setText(BA.ObjectToCharSequence(anywheresoftware.b4a.keywords.Common.DateTime.Date(_lngdatetime)));
 //BA.debugLineNum = 391;BA.debugLine="scvMain.ScrollPosition = 0%x";
mostCurrent._scvmain.setScrollPosition(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (0),mostCurrent.activityBA));
 //BA.debugLineNum = 393;BA.debugLine="FillPlumbers";
_fillplumbers();
 //BA.debugLineNum = 395;BA.debugLine="Dim r As Reflector";
_r = new anywheresoftware.b4a.agraham.reflection.Reflection();
 //BA.debugLineNum = 396;BA.debugLine="r.Target = scvMain";
_r.Target = (Object)(mostCurrent._scvmain.getObject());
 //BA.debugLineNum = 397;BA.debugLine="r.RunMethod2(\"setVerticalScrollBarEnabled\", False";
_r.RunMethod2("setVerticalScrollBarEnabled",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.False),"java.lang.boolean");
 //BA.debugLineNum = 398;BA.debugLine="r.RunMethod2(\"setOverScrollMode\", 2, \"java.lang.i";
_r.RunMethod2("setOverScrollMode",BA.NumberToString(2),"java.lang.int");
 //BA.debugLineNum = 399;BA.debugLine="End Sub";
return "";
}
public static String  _btnok_click() throws Exception{
 //BA.debugLineNum = 439;BA.debugLine="Sub btnOK_Click";
 //BA.debugLineNum = 440;BA.debugLine="If spnPlumbers.SelectedItemsString = \"\" Then";
if ((mostCurrent._spnplumbers.getSelectedItemsString()).equals("")) { 
 //BA.debugLineNum = 441;BA.debugLine="RequiredMsgBox($\"ERROR\"$, $\"Unable to Accomplshe";
_requiredmsgbox(("ERROR"),("Unable to Accomplshed JO due to No selected plumber(s)."));
 //BA.debugLineNum = 442;BA.debugLine="spnPlumbers.RequestFocus";
mostCurrent._spnplumbers.RequestFocus();
 //BA.debugLineNum = 443;BA.debugLine="Log(\"No Selected\")";
anywheresoftware.b4a.keywords.Common.LogImpl("718874372","No Selected",0);
 //BA.debugLineNum = 444;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 447;BA.debugLine="If Not(MiscFunctions.IsValidDate(txtDateTimeStart";
if (anywheresoftware.b4a.keywords.Common.Not(mostCurrent._miscfunctions._isvaliddate /*boolean*/ (mostCurrent.activityBA,mostCurrent._txtdatetimestarted.getText())) || mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv4(mostCurrent._txtdatetimestarted.getText()))==0) { 
 //BA.debugLineNum = 448;BA.debugLine="RequiredMsgBox($\"ERROR\"$, $\"Invalid date Started";
_requiredmsgbox(("ERROR"),("Invalid date Started!"));
 //BA.debugLineNum = 449;BA.debugLine="txtDateTimeStarted.RequestFocus";
mostCurrent._txtdatetimestarted.RequestFocus();
 //BA.debugLineNum = 450;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 453;BA.debugLine="If Not(MiscFunctions.IsValidDate(txtDateTimeFinis";
if (anywheresoftware.b4a.keywords.Common.Not(mostCurrent._miscfunctions._isvaliddate /*boolean*/ (mostCurrent.activityBA,mostCurrent._txtdatetimefinished.getText())) || mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv4(mostCurrent._txtdatetimefinished.getText()))==0) { 
 //BA.debugLineNum = 454;BA.debugLine="RequiredMsgBox($\"ERROR\"$, $\"Invalid date finishe";
_requiredmsgbox(("ERROR"),("Invalid date finished!"));
 //BA.debugLineNum = 455;BA.debugLine="txtDateTimeFinished.RequestFocus";
mostCurrent._txtdatetimefinished.RequestFocus();
 //BA.debugLineNum = 456;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 459;BA.debugLine="scvMain.ScrollPosition = 0%x";
mostCurrent._scvmain.setScrollPosition(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (0),mostCurrent.activityBA));
 //BA.debugLineNum = 460;BA.debugLine="ConfirmJOAccomplishment";
...
anywheresoftware.b4a.agraham.reflection.Reflection _r = null;
 //BA.debugLineNum = 334;BA.debugLine="Sub btnSaveUpdate_Click";
 //BA.debugLineNum = 335;BA.debugLine="Dim cdSig As ColorDrawable";
mostCurrent._cdsig = new anywheresoftware.b4a.objects.drawable.ColorDrawable();
 //BA.debugLineNum = 336;BA.debugLine="If Not(ValidateEntries) Then";
if (anywheresoftware.b4a.keywords.Common.Not(_validateentries())) { 
 //BA.debugLineNum = 337;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 340;BA.debugLine="pnlSignature.Visible = True";
mostCurrent._pnlsignature.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 341;BA.debugLine="cdOK.Initialize2(GlobalVar.GreenColor, 20, 0, Col";
mostCurrent._cdok.Initialize2((int) (mostCurrent._globalvar._greencolor /*double*/ ),(int) (20),(int) (0),anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 342;BA.debugLine="btnConfirmSig.Background = cdOK";
mostCurrent._btnconfirmsig.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cdok.getObject()));
 //BA.debugLineNum = 343;BA.debugLine="btnConfirmSig.Text = Chr(0xE5C8) & $\" CONFIRM SIG";
mostCurrent._btnconfirmsig.setText(BA.ObjectToCharSequence(BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (0xe5c8)))+(" CONFIRM SIGNATURE")));
 //BA.debugLineNum = 345;BA.debugLine="cdSig.Initialize2(0xFFD3D3D3,0,0,Colors.Transpare";
mostCurrent._cdsig.Initialize2((int) (0xffd3d3d3),(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 346;BA.debugLine="SignaturePad.Background = cdSig";
mostCurrent._signaturepad.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cdsig.getObject()));
 //BA.debugLineNum = 348;BA.debugLine="SignaturePad.clear";
mostCurrent._signaturepad.clear();
 //BA.debugLineNum = 349;BA.debugLine="SignaturePad.StrokeWidth = 15";
mostCurrent._signaturepad.setStrokeWidth((float) (15));
 //BA.debugLineNum = 350;BA.debugLine="SignaturePad.Visible = True";
mostCurrent._signaturepad.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 351;BA.debugLine="imgSignature.Bitmap = Null";
mostCurrent._imgsignature.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null));
 //BA.debugLineNum = 352;BA.debugLine="SignaturePad.Capture(True)";
mostCurrent._signaturepad.Capture(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 353;BA.debugLine="scvMain.ScrollPosition = 0%x";
mostCurrent._scvmain.setScrollPosition(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (0),mostCurrent.activityBA));
 //BA.debugLineNum = 354;BA.debugLine="HasSign = False";
_hassign = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 355;BA.debugLine="scvMain.Enabled = False";
mostCurrent._scvmain.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 356;BA.debugLine="Dim r As Reflector";
_r = new anywheresoftware.b4a.agraham.reflection.Reflection();
 //BA.debugLineNum = 357;BA.debugLine="r.Target = scvMain";
_r.Target = (Object)(mostCurrent._scvmain.getObject());
 //BA.debugLineNum = 358;BA.debugLine="r.RunMethod2(\"setVerticalScrollBarEnabled\", False";
_r.RunMethod2("setVerticalScrollBarEnabled",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.False),"java.lang.boolean");
 //BA.debugLineNum = 359;BA.debugLine="r.RunMethod2(\"setOverScrollMode\", 2, \"java.lang.i";
_r.RunMethod2("setOverScrollMode",BA.NumberToString(2),"java.lang.int");
 //BA.debugLineNum = 360;BA.debugLine="r.SetOnTouchListener(\"scvTouch\")";
_r.SetOnTouchListener(processBA,"scvTouch");
 //BA.debugLineNum = 361;BA.debugLine="End Sub";
return "";
}
public static String  _cbopipesize_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 614;BA.debugLine="Sub cboPipeSize_ItemClick (Position As Int, Value";
 //BA.debugLineNum = 615;BA.debugLine="If GlobalVar.SF.Len(cboPipeType.SelectedItem) <=";
if (mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._cbopipetype.getSelectedItem())<=0 || mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._cbopipesize.getSelectedItem())<=0 || mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._txtminutes.getText())<=0 || mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._txtpsi.getText())<=0) { 
 //BA.debugLineNum = 616;BA.debugLine="WaterLoss = 0";
_waterloss = 0;
 }else {
 //BA.debugLineNum = 618;BA.debugLine="If txtPSI.Text <= 30 Then";
if ((double)(Double.parseDouble(mostCurrent._txtpsi.getText()))<=30) { 
 //BA.debugLineNum = 619;BA.debugLine="WaterLoss = DBaseFunctions.ComputeWaterLoss(cbo";
_waterloss = mostCurrent._dbasefunctions._computewaterloss /*double*/ (mostCurrent.activityBA,mostCurrent._cbopipetype.getSelectedItem(),mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvv2(mostCurrent._cbopipesize.getSelectedItem()),(int)(Double.parseDouble(mostCurrent._txtpsi.getText())),(int)(Double.parseDouble(mostCurrent._txtminutes.getText())));
 ...
 //BA.debugLineNum = 621;BA.debugLine="WaterLoss = 0";
_waterloss = 0;
 };
 };
 //BA.debugLineNum = 624;BA.debugLine="txtWaterLoss.Text = WaterLoss";
...
public static String  _cbopipetype_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 627;BA.debugLine="Sub cboPipeType_ItemClick (Position As Int, Value";
 //BA.debugLineNum = 628;BA.debugLine="If GlobalVar.SF.Len(cboPipeType.SelectedItem) <=";
if (mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._cbopipetype.getSelectedItem())<=0 || mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._cbopipesize.getSelectedItem())<=0 || mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._txtminutes.getText())<=0 || mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._txtpsi.getText())<=0) { 
 //BA.debugLineNum = 629;BA.debugLine="WaterLoss = 0";
_waterloss = 0;
 }else {
 //BA.debugLineNum = 631;BA.debugLine="If txtPSI.Text <= 30 Then";
if ((double)(Double.parseDouble(mostCurrent._txtpsi.getText()))<=30) { 
 //BA.debugLineNum = 632;BA.debugLine="WaterLoss = DBaseFunctions.ComputeWaterLoss(cbo";
_waterloss = mostCurrent._dbasefunctions._computewaterloss /*double*/ (mostCurrent.activityBA,mostCurrent._cbopipetype.getSelectedItem(),mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvv2(mostCurrent._cbopipesize.getSelectedItem()),(int)(Double.parseDouble(mostCurrent._txtpsi.getText())),(int)(Double.parseDouble(mostCurrent._txtminutes.getText())));
 }else {
 //BA.debugLineNum = 634;BA.debugLine="WaterLoss = 0";
_waterloss = 0;
 };
 };
 //BA.debugLineNum = 637;BA.debugLine="txtWaterLoss.Text = WaterLoss";
mostCurrent._txtwaterloss.setText(BA.ObjectToCharSequence(_waterloss));
 //BA.debugLineNum = 638;BA.debugLine="End Sub";
return "";
}
public static String  _checkpermissions() throws Exception{
 //BA.debugLineNum = 142;BA.debugLine="Private Sub CheckPermissions";
 //BA.debugLineNum = 143;BA.debugLine="Log(\"Checking Permissions\")";
anywheresoftware.b4a.keywords.Common.LogImpl("717629185","Checking Permissions",0);
...
mostCurrent._starter._rtp /*anywheresoftware.b4a.objects.RuntimePermissions*/ .CheckAndRequest(processBA,mostCurrent._starter._rtp /*anywheresoftware.b4a.objects.RuntimePermissions*/ .PERMISSION_WRITE_EXTERNAL_STORAGE);
 //BA.debugLineNum = 147;BA.debugLine="Starter.RTP.GetAllSafeDirsExternal(\"\")";
...
public static String  _clearui() throws Exception{
 //BA.debugLineNum = 229;BA.debugLine="Private Sub ClearUI";
 //BA.debugLineNum = 230;BA.debugLine="cdRemBorder.Initialize2(Colors.White, 0, 0, Color";
...
mostCurrent._cd.Initialize2((int) (mostCurrent._globalvar._greencolor /*double*/ ),(int) (30),(int) (0),anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 251;BA.debugLine="btnSaveUpdate.Background = CD";
mostCurrent._btnsaveupdate.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cd.getObject()));
 //BA.debugLineNum = 252;BA.debugLine="btnSaveUpdate.Text = Chr(0xE161) & $\" ACCOMPLISH";
mostCurrent._btnsaveupdate.setText(BA.ObjectToCharSequence(BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (0xe161)))+(" ACCOMPLISH JO")));
 //BA.debugLineNum = 254;BA.debugLine="cdCancel.Initialize2(GlobalVar.RedColor, 20, 0, C";
mostCurrent._cdcancel.Initialize2((int) (mostCurrent._globalvar._redcolor /*double*/ ),(int) (20),(int) (0),anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 255;BA.debugLine="btnCancel.Background = cdCancel";
mostCurrent._btncancel.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cdcancel.getObject()));
 //BA.debugLineNum = 256;BA.debugLine="btnCancel.Text = $\"CANCEL\"$";
mostCurrent._btncancel.setText(BA.ObjectToCharSequence(("CANCEL")));
 //BA.debugLineNum = 258;BA.debugLine="cdClear.Initialize2(GlobalVar.YellowColor, 20, 0,";
mostCurrent._cdclear.Initialize2((int) (mostCurrent._globalvar._yellowcolor /*double*/ ),(int) (20),(int) (0),anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 259;BA.debugLine="btnClear.Background = cdClear";
mostCurrent._btnclear.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cdclear.getObject()));
 //BA.debugLineNum = 260;BA.debugLine="btnClear.Text = $\"RETRY\"$";
mostCurrent._btnclear.setText(BA.ObjectToCharSequence(("RETRY")));
 //BA.debugLineNum = 262;BA.debugLine="cdOK.Initialize2(GlobalVar.GreenColor, 20, 0, Col";
mostCurrent._cdok.Initialize2((int) (mostCurrent._globalvar._greencolor /*double*/ ),(int) (20),(int) (0),anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 263;BA.debugLine="btnOk.Background = cdOK";
mostCurrent._btnok.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cdok.getObject()));
 //BA.debugLineNum = 264;BA.debugLine="btnOk.Text = $\"SAVE\"$";
mostCurrent._btnok.setText(BA.ObjectToCharSequence(("SAVE")));
 //BA.debugLineNum = 266;BA.debugLine="lblJONum.Text = \"\"";
mostCurrent._lbljonum.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 267;BA.debugLine="lblJOCat.Text = \"\"";
mostCurrent._lbljocat.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 268;BA.debugLine="lblAppNum.Text = \"\"";
mostCurrent._lblappnum.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 269;BA.debugLine="lblCustName.Text = \"\"";
mostCurrent._lblcustname.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 270;BA.debugLine="lblCustAddress.Text = \"\"";
mostCurrent._lblcustaddress.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 271;BA.debugLine="lblAcctClass.Text = \"\"";
mostCurrent._lblacctclass.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 273;BA.debugLine="txtMeterFindings.Text = \"\"";
mostCurrent._txtmeterfindings.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 274;BA.debugLine="txtPrevRdg.Text = \"\"";
mostCurrent._txtprevrdg.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 275;BA.debugLine="txtFinalRdg.Text = \"\"";
mostCurrent._txtfinalrdg.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 277;BA.debugLine="txtMinutes.Text = \"\"";
mostCurrent._txtminutes.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 278;BA.debugLine="txtWaterLoss.Text = \"\"";
mostCurrent._txtwaterloss.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 279;BA.debugLine="txtRemarks.Text = \"\"";
mostCurrent._txtremarks.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 281;BA.debugLine="txtDateTimeStarted.Text = \"\"";
mostCurrent._txtdatetimestarted.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 282;BA.debugLine="txtDateTimeFinished.Text = \"\"";
mostCurrent._txtdatetimefinished.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 283;BA.debugLine="WaterLoss = 0";
_waterloss = 0;
 //BA.debugLineNum = 285;BA.debugLine="pnlSignature.Visible = False";
mostCurrent._pnlsignature.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 286;BA.debugLine="pnlConfirmSig.Visible = False";
mostCurrent._pnlconfirmsig.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 288;BA.debugLine="cboActionTaken.Clear";
mostCurrent._cboactiontaken.Clear();
 //BA.debugLineNum = 289;BA.debugLine="cboActionTaken.Add($\"Pullout Meter\"$)";
mostCurrent._cboactiontaken.Add(BA.ObjectToCharSequence(("Pullout Meter")));
 //BA.debugLineNum = 290;BA.debugLine="cboActionTaken.Add($\"Lock Meter\"$)";
mostCurrent._cboactiontaken.Add(BA.ObjectToCharSequence(("Lock Meter")));
 //BA.debugLineNum = 292;BA.debugLine="FillPipeTypes";
_fillpipetypes();
 //BA.debugLineNum = 293;BA.debugLine="FillPipeSizes";
_fillpipesizes();
...
com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder _alert = null;
 //BA.debugLineNum = 831;BA.debugLine="Private Sub ConfirmJOAccomplishment";
 //BA.debugLineNum = 832;BA.debugLine="Dim Alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 834;BA.debugLine="Alert.Initialize.Create _ 			.SetDialogStyleName(";
_alert.Initialize().Create(mostCurrent.activityBA).SetDialogStyleName("MyDialogDisableStatus").SetStyle(_alert.getSTYLE_DIALOGUE()).SetCancelable(anywheresoftware.b4a.keywords.Common.False).SetTitle("JO Accomplishment").SetTitleColor((int) (mostCurrent._globalvar._bluecolor /*double*/ )).SetTitleTypeface((android.graphics.Typeface)(mostCurrent._fontbold.getObject())).SetMessage("Do you want to Accomplish this JO Now?").SetPositiveText("Confirm").SetPositiveColor((int) (mostCurrent._globalvar._poscolor /*double*/ )).SetPositiveTypeface((android.graphics.Typeface)(mostCurrent._fontbold.getObject())).SetNegativeText("Cancel").SetNegativeColor((int) (mostCurrent._globalvar._negcolor /*double*/ )).SetNegativeTypeface((android.graphics.Typeface)(mostCurrent._font.getObject())).SetMessageTypeface((android.graphics.Typeface)(mostCurrent._font.getObject())).SetOnPositiveClicked(mostCurrent.activityBA,"Accomplished").SetOnNegativeClicked(mostCurrent.activityBA,"Accomplished");
 //BA.debugLineNum = 851;BA.debugLine="Alert.SetDialogBackground(MyFunctions.myCD)";
_alert.SetDialogBackground((android.graphics.drawable.Drawable)(mostCurrent._myfunctions._mycd /*anywheresoftware.b4a.objects.drawable.ColorDrawable*/ (mostCurrent.activityBA).getObject()));
 //BA.debugLineNum = 852;BA.debugLine="Alert.Build.Show";
_alert.Build().Show();
 //BA.debugLineNum = 853;BA.debugLine="End Sub";
return "";
}
public static String  _dispinfomsg(String _stitle,String _smsg) throws Exception{
 //BA.debugLineNum = 893;BA.debugLine="Private Sub DispInfoMsg(sTitle As String, sMsg As";
 //BA.debugLineNum = 894;BA.debugLine="MatDialogBuilder.Initialize(\"DispInformationMsg\")";
mostCurrent._matdialogbuilder.Initialize(mostCurrent.activityBA,"DispInformationMsg");
 //BA.debugLineNum = 895;BA.debugLine="MatDialogBuilder.PositiveText(\"OK\").PositiveColor";
mostCurrent._matdialogbuilder.PositiveText(BA.ObjectToCharSequence("OK")).PositiveColor((int) (mostCurrent._globalvar._poscolor /*double*/ ));
 //BA.debugLineNum = 896;BA.debugLine="MatDialogBuilder.Title(sTitle)";
mostCurrent._matdialogbuilder.Title(BA.ObjectToCharSequence(_stitle));
 //BA.debugLineNum = 897;BA.debugLine="MatDialogBuilder.Content(sMsg)";
mostCurrent._matdialogbuilder.Content(BA.ObjectToCharSequence(_smsg));
 //BA.debugLineNum = 898;BA.debugLine="MatDialogBuilder.Theme(MatDialogBuilder.THEME_LIG";
mostCurrent._matdialogbuilder.Theme(mostCurrent._matdialogbuilder.THEME_LIGHT);
 //BA.debugLineNum = 899;BA.debugLine="MatDialogBuilder.CanceledOnTouchOutside(False)";
mostCurrent._matdialogbuilder.CanceledOnTouchOutside(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 900;BA.debugLine="MatDialogBuilder.Cancelable(False)";
mostCurrent._matdialogbuilder.Cancelable(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 901;BA.debugLine="MatDialogBuilder.Show";
...
public static String  _dispinformationmsg_buttonpressed(de.amberhome.materialdialogs.MaterialDialogWrapper _mdialog,String _saction) throws Exception{
 //BA.debugLineNum = 904;BA.debugLine="Private Sub DispInformationMsg_ButtonPressed(mDial";
 //BA.debugLineNum = 905;BA.debugLine="Select Case sAction";
...
double _dmeterid = 0;
 //BA.debugLineNum = 296;BA.debugLine="Private Sub FillJORecord (iJOID As Int)";
 //BA.debugLineNum = 297;BA.debugLine="Dim rsJONCDetails As Cursor";
_rsjoncdetails = new anywheresoftware.b4a.sql.SQL.CursorWrapper();
 //BA.debugLineNum = 298;BA.debugLine="Dim dMeterID As Double";
_dmeterid = 0;
 //BA.debugLineNum = 299;BA.debugLine="Try";
try { //BA.debugLineNum = 300;BA.debugLine="Starter.strCriteria = \"SELECT * FROM tblJOs \" &";
mostCurrent._starter._strcriteria /*String*/  = "SELECT * FROM tblJOs "+"WHERE JOID = "+BA.NumberToString(_ijoid);
 //BA.debugLineNum = 302;BA.debugLine="LogColor(Starter.strCriteria, Colors.Yellow)";
anywheresoftware.b4a.keywords.Common.LogImpl("718284550",mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
 //BA.debugLineNum = 304;BA.debugLine="rsJONCDetails = Starter.DBCon.ExecQuery(Starter.";
_rsjoncdetails = (anywheresoftware.b4a.sql.SQL.CursorWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.sql.SQL.CursorWrapper(), (android.database.Cursor)(mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQuery(mostCurrent._starter._strcriteria /*String*/ )));
 //BA.debugLineNum = 306;BA.debugLine="If rsJONCDetails.RowCount > 0 Then";
if (_rsjoncdetails.getRowCount()>0) { 
 //BA.debugLineNum = 307;BA.debugLine="rsJONCDetails.Position = 0";
_rsjoncdetails.setPosition((int) (0));
 //BA.debugLineNum = 308;BA.debugLine="DateTime.DateFormat = \"yyyy-MM-dd HH:mm:ss a\"";
anywheresoftware.b4a.keywords.Common.DateTime.setDateFormat("yyyy-MM-dd HH:mm:ss a");
 //BA.debugLineNum = 309;BA.debugLine="lblJONum.Text = rsJONCDetails.GetString(\"JONo\")";
mostCurrent._lbljonum.setText(BA.ObjectToCharSequence(_rsjoncdetails.GetString("JONo")));
 //BA.debugLineNum = 310;BA.debugLine="lblAppNum.Text = rsJONCDetails.GetString(\"RefNo";
mostCurrent._lblappnum.setText(BA.ObjectToCharSequence(_rsjoncdetails.GetString("RefNo")));
 //BA.debugLineNum = 311;BA.debugLine="lblJOCat.Text = GlobalVar.SF.Upper(rsJONCDetail";
mostCurrent._lbljocat.setText(BA.ObjectToCharSequence(mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv5(_rsjoncdetails.GetString("JoDesc"))));
 //BA.debugLineNum = 312;BA.debugLine="lblCustName.Text = GlobalVar.SF.Upper(rsJONCDet";
mostCurrent._lblcustname.setText(BA.ObjectToCharSequence(mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv5(_rsjoncdetails.GetString("CustName"))));
 //BA.debugLineNum = 313;BA.debugLine="lblCustAddress.Text = GlobalVar.SF.Upper(rsJONC";
mostCurrent._lblcustaddress.setText(BA.ObjectToCharSequence(mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv5(_rsjoncdetails.GetString("CustAddress"))));
 //BA.debugLineNum = 314;BA.debugLine="lblAcctClass.Text = GlobalVar.SF.Upper(rsJONCDe";
mostCurrent._lblacctclass.setText(BA.ObjectToCharSequence(mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv5(_rsjoncdetails.GetString("AcctClass"))+"-"+mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv5(_rsjoncdetails.GetString("AcctSubClass"))));
 //BA.debugLineNum = 315;BA.debugLine="dMeterID = GlobalVar.SF.Upper(rsJONCDetails.Get";
_dmeterid = (double)(Double.parseDouble(mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv5(_rsjoncdetails.GetString("MeterID"))));
 //BA.debugLineNum = 316;BA.debugLine="txtDateTimeStarted.Text = GlobalVar.SF.Upper(rs";
mostCurrent._txtdatetimestarted.setText(BA.ObjectToCharSequence(mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv5(_rsjoncdetails.GetString("DateStarted"))));
 //BA.debugLineNum = 317;BA.debugLine="txtPrevRdg.Text = GlobalVar.SF.Upper(rsJONCDeta";
mostCurrent._txtprevrdg.setText(BA.ObjectToCharSequence(mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv5(_rsjoncdetails.GetString("PrevRdg"))));
 ...
 //BA.debugLineNum = 319;BA.debugLine="snack.Initialize(\"\", Activity,$\"\"$ & LastExcept";
mostCurrent._snack.Initialize(mostCurrent.activityBA,"",(android.view.View)(mostCurrent._activity.getObject()),("")+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),(int) (5000));
 //BA.debugLineNum = 320;BA.debugLine="MyFunctions.SetSnackBarTextColor(snack, Colors.";
mostCurrent._myfunctions._setsnackbartextcolor /*String*/ (mostCurrent.activityBA,mostCurrent._snack,anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 321;BA.debugLine="MyFunctions.SetSnackBarBackground(snack, Global";
mostCurrent._myfunctions._setsnackbarbackground /*String*/ (mostCurrent.activityBA,mostCurrent._snack,(int) (mostCurrent._globalvar._redcolor /*double*/ ));
 //BA.debugLineNum = 322;BA.debugLine="snack.Show";
mostCurrent._snack.Show();
 //BA.debugLineNum = 323;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("718284571",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 //BA.debugLineNum = 324;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 326;BA.debugLine="lblMeterNo.Text = DBaseFunctions.GetCodeByID(\"Me";
mostCurrent._lblmeterno.setText(BA.ObjectToCharSequence(mostCurrent._dbasefunctions._getcodebyid /*String*/ (mostCurrent.activityBA,"MeterNo","tblMeters","MeterID",(int) (_dmeterid))));
			...
			processBA.setLastException(e29); //BA.debugLineNum = 328;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("718284576",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
 //BA.debugLineNum = 330;BA.debugLine="rsJONCDetails.Close";
...
int _i = 0;
 //BA.debugLineNum = 483;BA.debugLine="Private Sub FillPipeSizes";
 //BA.debugLineNum = 484;BA.debugLine="Dim rsPipeSize As Cursor";
_rspipesize = new anywheresoftware.b4a.sql.SQL.CursorWrapper();
 //BA.debugLineNum = 485;BA.debugLine="cboPipeSize.Clear";
mostCurrent._cbopipesize.Clear();
 //BA.debugLineNum = 486;BA.debugLine="Try";
try { //BA.debugLineNum = 487;BA.debugLine="Starter.strCriteria = \"SELECT * FROM cons_pipe_s";
mostCurrent._starter._strcriteria /*String*/  = "SELECT * FROM cons_pipe_size";
 //BA.debugLineNum = 488;BA.debugLine="rsPipeSize = Starter.DBCon.ExecQuery(Starter.str";
_rspipesize = (anywheresoftware.b4a.sql.SQL.CursorWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.sql.SQL.CursorWrapper(), (android.database.Cursor)(mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQuery(mostCurrent._starter._strcriteria /*String*/ )));
 //BA.debugLineNum = 489;BA.debugLine="If rsPipeSize.RowCount > 0 Then";
if (_rspipesize.getRowCount()>0) { 
 //BA.debugLineNum = 490;BA.debugLine="For i = 0 To rsPipeSize.RowCount - 1";
{
final int step7 = 1;
final int limit7 = (int) (_rspipesize.getRowCount()-1);
_i = (int) (0) ;
for (;_i <= limit7 ;_i = _i + step7 ) {
 //BA.debugLineNum = 491;BA.debugLine="rsPipeSize.Position = i";
_rspipesize.setPosition(_i);
 //BA.debugLineNum = 492;BA.debugLine="cboPipeSize.Add(GlobalVar.SF.Lower(rsPipeSize.";
mostCurrent._cbopipesize.Add(BA.ObjectToCharSequence(mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvv2(_rspipesize.GetString("SizeDesc"))));
			...
			processBA.setLastException(e13); //BA.debugLineNum = 496;BA.debugLine="ToastMessageShow(\"Unable to Load Pipe Type due t";
...
anywheresoftware.b4a.keywords.Common.LogImpl("719005454",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
 //BA.debugLineNum = 499;BA.debugLine="rsPipeSize.Close";
_rspipesize.Close();
...
int _i = 0;
 //BA.debugLineNum = 464;BA.debugLine="Private Sub FillPipeTypes";
 //BA.debugLineNum = 465;BA.debugLine="Dim rsPipeType As Cursor";
_rspipetype = new anywheresoftware.b4a.sql.SQL.CursorWrapper();
 //BA.debugLineNum = 466;BA.debugLine="cboPipeType.Clear";
mostCurrent._cbopipetype.Clear();
 //BA.debugLineNum = 467;BA.debugLine="Try";
try { //BA.debugLineNum = 468;BA.debugLine="Starter.strCriteria = \"SELECT * FROM cons_pipe_t";
mostCurrent._starter._strcriteria /*String*/  = "SELECT * FROM cons_pipe_type";
 //BA.debugLineNum = 469;BA.debugLine="rsPipeType = Starter.DBCon.ExecQuery(Starter.str";
_rspipetype = (anywheresoftware.b4a.sql.SQL.CursorWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.sql.SQL.CursorWrapper(), (android.database.Cursor)(mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQuery(mostCurrent._starter._strcriteria /*String*/ )));
 //BA.debugLineNum = 470;BA.debugLine="If rsPipeType.RowCount > 0 Then";
if (_rspipetype.getRowCount()>0) { 
 //BA.debugLineNum = 471;BA.debugLine="For i = 0 To rsPipeType.RowCount - 1";
{
final int step7 = 1;
final int limit7 = (int) (_rspipetype.getRowCount()-1);
_i = (int) (0) ;
for (;_i <= limit7 ;_i = _i + step7 ) {
 //BA.debugLineNum = 472;BA.debugLine="rsPipeType.Position = i";
_rspipetype.setPosition(_i);
 //BA.debugLineNum = 473;BA.debugLine="cboPipeType.Add(GlobalVar.SF.Proper(rsPipeType";
mostCurrent._cbopipetype.Add(BA.ObjectToCharSequence(mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvv5(_rspipetype.GetString("PipeDesc"))));
			...
			processBA.setLastException(e13); //BA.debugLineNum = 477;BA.debugLine="ToastMessageShow(\"Unable to Load Pipe Type due t";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Unable to Load Pipe Type due to "+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage()),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 478;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("718939918",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
 //BA.debugLineNum = 480;BA.debugLine="rsPipeType.Close";
_rspipetype.Close();
...
int _pcount = 0;
int _i = 0;
 //BA.debugLineNum = 502;BA.debugLine="Private Sub FillPlumbers";
 //BA.debugLineNum = 503;BA.debugLine="Dim rsPlumbers As Cursor";
_rsplumbers = new anywheresoftware.b4a.sql.SQL.CursorWrapper();
 //BA.debugLineNum = 505;BA.debugLine="Dim EmpName As String";
_empname = "";
 //BA.debugLineNum = 506;BA.debugLine="Dim EmpNameList() As String";
_empnamelist = new String[(int) (0)];
java.util.Arrays.fill(_empnamelist,"");
 //BA.debugLineNum = 507;BA.debugLine="Dim pCount As Int";
_pcount = 0;
 //BA.debugLineNum = 509;BA.debugLine="Try";
try { //BA.debugLineNum = 510;BA.debugLine="Starter.strCriteria = \"SELECT * FROM tblPlumbers";
mostCurrent._starter._strcriteria /*String*/  = "SELECT * FROM tblPlumbers "+"ORDER BY id ASC";
 //BA.debugLineNum = 513;BA.debugLine="LogColor(Starter.strCriteria, Colors.Blue)";
anywheresoftware.b4a.keywords.Common.LogImpl("719070987",mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Blue);
 //BA.debugLineNum = 515;BA.debugLine="rsPlumbers =  Starter.DBCon.ExecQuery (Starter.s";
_rsplumbers = (anywheresoftware.b4a.sql.SQL.CursorWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.sql.SQL.CursorWrapper(), (android.database.Cursor)(mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQuery(mostCurrent._starter._strcriteria /*String*/ )));
 //BA.debugLineNum = 516;BA.debugLine="If rsPlumbers.RowCount > 0 Then";
if (_rsplumbers.getRowCount()>0) { 
 //BA.debugLineNum = 517;BA.debugLine="pCount = rsPlumbers.RowCount";
_pcount = _rsplumbers.getRowCount();
 //BA.debugLineNum = 518;BA.debugLine="Dim EmpNameList(pCount) As String";
_empnamelist = new String[_pcount];
java.util.Arrays.fill(_empnamelist,"");
 //BA.debugLineNum = 520;BA.debugLine="For i = 0 To rsPlumbers.RowCount - 1";
{
final int step12 = 1;
final int limit12 = (int) (_rsplumbers.getRowCount()-1);
_i = (int) (0) ;
for (;_i <= limit12 ;_i = _i + step12 ) {
 //BA.debugLineNum = 521;BA.debugLine="rsPlumbers.Position = i";
_rsplumbers.setPosition(_i);
 //BA.debugLineNum = 522;BA.debugLine="EmpName = rsPlumbers.GetString(\"EmpName\")";
_empname = _rsplumbers.GetString("EmpName");
 //BA.debugLineNum = 523;BA.debugLine="EmpNameList(i) = EmpName";
_empnamelist[_i] = _empname;
 }
};
 }else {
 //BA.debugLineNum = 526;BA.debugLine="snack.Initialize(\"\", Activity, \"No plumber(s) f";
mostCurrent._snack.Initialize(mostCurrent.activityBA,"",(android.view.View)(mostCurrent._activity.getObject()),"No plumber(s) found!",mostCurrent._snack.DURATION_SHORT);
 //BA.debugLineNum = 527;BA.debugLine="MyFunctions.SetSnackBarBackground(snack, Colors";
mostCurrent._myfunctions._setsnackbarbackground /*String*/ (mostCurrent.activityBA,mostCurrent._snack,anywheresoftware.b4a.keywords.Common.Colors.Red);
 //BA.debugLineNum = 528;BA.debugLine="MyFunctions.SetSnackBarTextColor(snack, Colors.";
mostCurrent._myfunctions._setsnackbartextcolor /*String*/ (mostCurrent.activityBA,mostCurrent._snack,anywheresoftware.b4a.keywords.Common.Colors.White);
...
if (true) return "";
			...
			processBA.setLastException(e25); //BA.debugLineNum = 533;BA.debugLine="snack.Initialize(\"\", Activity, LastException,sna";
mostCurrent._snack.Initialize(mostCurrent.activityBA,"",(android.view.View)(mostCurrent._activity.getObject()),BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),mostCurrent._snack.DURATION_SHORT);
 //BA.debugLineNum = 534;BA.debugLine="MyFunctions.SetSnackBarBackground(snack, Colors.";
mostCurrent._myfunctions._setsnackbarbackground /*String*/ (mostCurrent.activityBA,mostCurrent._snack,anywheresoftware.b4a.keywords.Common.Colors.Red);
 //BA.debugLineNum = 535;BA.debugLine="MyFunctions.SetSnackBarTextColor(snack, Colors.W";
mostCurrent._myfunctions._setsnackbartextcolor /*String*/ (mostCurrent.activityBA,mostCurrent._snack,anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 536;BA.debugLine="snack.Show";
mostCurrent._snack.Show();
 //BA.debugLineNum = 537;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 540;BA.debugLine="spnPlumbers.Items = EmpNameList";
...
anywheresoftware.b4a.objects.CSBuilder _cs = null;
 //BA.debugLineNum = 872;BA.debugLine="Private Sub FontSizeBinder_OnBindView (View As Vie";
...
public static String  _pnlconfirmsig_touch(int _action,float _x,float _y) throws Exception{
 //BA.debugLineNum = 435;BA.debugLine="Sub pnlConfirmSig_Touch (Action As Int, X As Float";
 //BA.debugLineNum = 437;BA.debugLine="End Sub";
return "";
}
public static String  _pnlsignature_touch(int _action,float _x,float _y) throws Exception{
 //BA.debugLineNum = 431;BA.debugLine="Sub pnlSignature_Touch (Action As Int, X As Float,";
...
com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder _alert = null;
 //BA.debugLineNum = 826;BA.debugLine="Private Sub RequiredMsg_OnPositiveClicked (View As";
 //BA.debugLineNum = 827;BA.debugLine="Dim Alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 828;BA.debugLine="Alert.Initialize.Dismiss(Dialog)";
_alert.Initialize().Dismiss((android.app.Dialog)(_dialog));
...
com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder _alert = null;
 //BA.debugLineNum = 801;BA.debugLine="Private Sub RequiredMsgBox(sTitle As String, sMsg";
 //BA.debugLineNum = 802;BA.debugLine="Dim Alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 803;BA.debugLine="Alert.Initialize.Dismiss2";
_alert.Initialize().Dismiss2();
 //BA.debugLineNum = 805;BA.debugLine="Alert.Initialize.Create _ 			.SetDialogStyleName(";
_alert.Initialize().Create(mostCurrent.activityBA).SetDialogStyleName("MyDialogDisableStatus").SetStyle(_alert.getSTYLE_DIALOGUE()).SetCancelable(anywheresoftware.b4a.keywords.Common.False).SetTitle(_stitle).SetTitleColor((int) (mostCurrent._globalvar._redcolor /*double*/ )).SetTitleTypeface((android.graphics.Typeface)(mostCurrent._fontbold.getObject())).SetMessage(_smsg).SetPositiveText("OK").SetPositiveColor((int) (mostCurrent._globalvar._poscolor /*double*/ )).SetPositiveTypeface((android.graphics.Typeface)(mostCurrent._fontbold.getObject())).SetMessageTypeface((android.graphics.Typeface)(mostCurrent._font.getObject())).SetOnPositiveClicked(mostCurrent.activityBA,"RequiredMsg").SetOnViewBinder(mostCurrent.activityBA,"FontSizeBinder");
 //BA.debugLineNum = 820;BA.debugLine="Alert.SetDialogBackground(MyFunctions.myCD)";
_alert.SetDialogBackground((android.graphics.drawable.Drawable)(mostCurrent._myfunctions._mycd /*anywheresoftware.b4a.objects.drawable.ColorDrawable*/ (mostCurrent.activityBA).getObject()));
 //BA.debugLineNum = 821;BA.debugLine="Alert.Build.Show";
_alert.Build().Show();
 //BA.debugLineNum = 822;BA.debugLine="End Sub";
return "";
}
public static String  _scvmain_scrollchanged(int _position) throws Exception{
 //BA.debugLineNum = 225;BA.debugLine="Sub scvMain_ScrollChanged(Position As Int)";
...
public static boolean  _scvtouch(Object _viewtag,int _action,float _x,float _y,Object _motionevent) throws Exception{
 //BA.debugLineNum = 363;BA.debugLine="Sub scvTouch(viewtag As Object, action As Int, X A";
...
public static String  _signaturepad_onsigned(Object _sign) throws Exception{
 //BA.debugLineNum = 367;BA.debugLine="Sub SignaturePad_onSigned(sign As Object)";
 //BA.debugLineNum = 368;BA.debugLine="eSig = sign";
mostCurrent._esig = _sign;
 //BA.debugLineNum = 369;BA.debugLine="HasSign = True";
...
public static String  _spnplumbers_onitemselected(int _position,boolean _ischecked,String _item) throws Exception{
 //BA.debugLineNum = 689;BA.debugLine="Sub spnPlumbers_onItemSelected(position As Int, is";
 //BA.debugLineNum = 690;BA.debugLine="LogColor(item, Colors.Yellow)";
anywheresoftware.b4a.keywords.Common.LogImpl("719726337",_item,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
...
public static String  _toolbar_menuitemclick(de.amberhome.objects.appcompat.ACMenuItemWrapper _item) throws Exception{
 //BA.debugLineNum = 215;BA.debugLine="Sub ToolBar_MenuItemClick (Item As ACMenuItem)'Ico";
 //BA.debugLineNum = 220;BA.debugLine="End Sub";
return "";
}
public static String  _toolbar_navigationitemclick() throws Exception{
 //BA.debugLineNum = 211;BA.debugLine="Sub ToolBar_NavigationItemClick 'Toolbar Arrow";
...
public static String  _txtminutes_focuschanged(boolean _hasfocus) throws Exception{
 //BA.debugLineNum = 674;BA.debugLine="Sub txtMinutes_FocusChanged (HasFocus As Boolean)";
 //BA.debugLineNum = 675;BA.debugLine="txtMinutes.SelectAll";
...
public static String  _txtminutes_textchanged(String _old,String _new) throws Exception{
 //BA.debugLineNum = 661;BA.debugLine="Sub txtMinutes_TextChanged (Old As String, New As";
 //BA.debugLineNum = 662;BA.debugLine="If GlobalVar.SF.Len(cboPipeType.SelectedItem) <=";
if (mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._cbopipetype.getSelectedItem())<=0 || mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._cbopipesize.getSelectedItem())<=0 || mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._txtminutes.getText())<=0 || mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._txtpsi.getText())<=0) { 
 //BA.debugLineNum = 663;BA.debugLine="WaterLoss = 0";
_waterloss = 0;
 }else {
 //BA.debugLineNum = 665;BA.debugLine="If txtPSI.Text <= 30 Then";
if ((double)(Double.parseDouble(mostCurrent._txtpsi.getText()))<=30) { 
 //BA.debugLineNum = 666;BA.debugLine="WaterLoss = DBaseFunctions.ComputeWaterLoss(cbo";
_waterloss = mostCurrent._dbasefunctions._computewaterloss /*double*/ (mostCurrent.activityBA,mostCurrent._cbopipetype.getSelectedItem(),mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvv2(mostCurrent._cbopipesize.getSelectedItem()),(int)(Double.parseDouble(mostCurrent._txtpsi.getText())),(int)(Double.parseDouble(mostCurrent._txtminutes.getText())));
 }else {
 //BA.debugLineNum = 668;BA.debugLine="WaterLoss = 0";
_waterloss = 0;
 };
 };
 //BA.debugLineNum = 671;BA.debugLine="txtWaterLoss.Text = WaterLoss";
mostCurrent._txtwaterloss.setText(BA.ObjectToCharSequence(_waterloss));
 //BA.debugLineNum = 672;BA.debugLine="End Sub";
return "";
}
public static String  _txtpsi_enterpressed() throws Exception{
 //BA.debugLineNum = 657;BA.debugLine="Sub txtPSI_EnterPressed";
 //BA.debugLineNum = 658;BA.debugLine="txtMinutes.RequestFocus";
mostCurrent._txtminutes.RequestFocus();
 //BA.debugLineNum = 659;BA.debugLine="End Sub";
return "";
}
public static String  _txtpsi_focuschanged(boolean _hasfocus) throws Exception{
 //BA.debugLineNum = 653;BA.debugLine="Sub txtPSI_FocusChanged (HasFocus As Boolean)";
 //BA.debugLineNum = 654;BA.debugLine="txtPSI.SelectAll";
...
public static String  _txtpsi_textchanged(String _old,String _new) throws Exception{
 //BA.debugLineNum = 640;BA.debugLine="Sub txtPSI_TextChanged (Old As String, New As Stri";
 //BA.debugLineNum = 641;BA.debugLine="If GlobalVar.SF.Len(cboPipeType.SelectedItem) <=";
if (mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._cbopipetype.getSelectedItem())<=0 || mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._cbopipesize.getSelectedItem())<=0 || mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._txtminutes.getText())<=0 || mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._txtpsi.getText())<=0) { 
 //BA.debugLineNum = 642;BA.debugLine="WaterLoss = 0";
_waterloss = 0;
 }else {
 //BA.debugLineNum = 644;BA.debugLine="If txtPSI.Text <= 30 Then";
if ((double)(Double.parseDouble(mostCurrent._txtpsi.getText()))<=30) { 
 //BA.debugLineNum = 645;BA.debugLine="WaterLoss = DBaseFunctions.ComputeWaterLoss(cbo";
_waterloss = mostCurrent._dbasefunctions._computewaterloss /*double*/ (mostCurrent.activityBA,mostCurrent._cbopipetype.getSelectedItem(),mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvv2(mostCurrent._cbopipesize.getSelectedItem()),(int)(Double.parseDouble(mostCurrent._txtpsi.getText())),(int)(Double.parseDouble(mostCurrent._txtminutes.getText())));
 }else {
 //BA.debugLineNum = 647;BA.debugLine="WaterLoss = 0";
_waterloss = 0;
 };
 };
 //BA.debugLineNum = 650;BA.debugLine="txtWaterLoss.Text = WaterLoss";
mostCurrent._txtwaterloss.setText(BA.ObjectToCharSequence(_waterloss));
...
anywheresoftware.b4a.objects.EditTextWrapper _send = null;
 //BA.debugLineNum = 678;BA.debugLine="Sub txtRemarks_FocusChanged (HasFocus As Boolean)";
 //BA.debugLineNum = 679;BA.debugLine="Dim Send As EditText";
_send = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 681;BA.debugLine="If HasFocus Then";
if (_hasfocus) { 
 //BA.debugLineNum = 682;BA.debugLine="Send = Sender";
_send = (anywheresoftware.b4a.objects.EditTextWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.EditTextWrapper(), (android.widget.EditText)(anywheresoftware.b4a.keywords.Common.Sender(mostCurrent.activityBA)));
 //BA.debugLineNum = 683;BA.debugLine="scvMain.ScrollPosition = btnSaveUpdate.Top";
mostCurrent._scvmain.setScrollPosition(mostCurrent._btnsaveupdate.getTop());
 //BA.debugLineNum = 684;BA.debugLine="txtRemarks.SelectAll";
...
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 //BA.debugLineNum = 696;BA.debugLine="Private Sub UpdateJO (iJOID As Int)";
 //BA.debugLineNum = 697;BA.debugLine="Dim sActionTaken, sRemarks As String";
_sactiontaken = "";
_sremarks = "";
 //BA.debugLineNum = 698;BA.debugLine="Dim dMeterID, dPrevRdg, dFinalRdg, dAddCons As Do";
_dmeterid = 0;
_dprevrdg = 0;
_dfinalrdg = 0;
_daddcons = 0;
 //BA.debugLineNum = 701;BA.debugLine="Dim sPipeType, sPipeSize As String";
_spipetype = "";
_spipesize = "";
 //BA.debugLineNum = 702;BA.debugLine="Dim iPSI, iMinutes As Int";
_ipsi = 0;
_iminutes = 0;
 //BA.debugLineNum = 703;BA.debugLine="Dim dWaterLoss As Double";
_dwaterloss = 0;
 //BA.debugLineNum = 705;BA.debugLine="Dim lngDateTime As Long";
_lngdatetime = 0L;
 //BA.debugLineNum = 706;BA.debugLine="Dim sDatePosted As String";
_sdateposted = "";
 //BA.debugLineNum = 707;BA.debugLine="Dim sAccomplishedBy As String";
_saccomplishedby = "";
 //BA.debugLineNum = 708;BA.debugLine="Dim sLocation As String";
_slocation = "";
 //BA.debugLineNum = 711;BA.debugLine="sActionTaken = \"\"";
_sactiontaken = "";
 //BA.debugLineNum = 713;BA.debugLine="dMeterID = 0";
_dmeterid = 0;
 //BA.debugLineNum = 714;BA.debugLine="dPrevRdg = 0";
_dprevrdg = 0;
 //BA.debugLineNum = 715;BA.debugLine="dFinalRdg = 0";
_dfinalrdg = 0;
 //BA.debugLineNum = 716;BA.debugLine="dAddCons = 0";
_daddcons = 0;
 //BA.debugLineNum = 718;BA.debugLine="sActionTaken = cboActionTaken.SelectedItem";
_sactiontaken = mostCurrent._cboactiontaken.getSelectedItem();
 //BA.debugLineNum = 720;BA.debugLine="dMeterID = DBaseFunctions.GetIDByCode(\"MeterId\",";
_dmeterid = mostCurrent._dbasefunctions._getidbycode /*int*/ (mostCurrent.activityBA,"MeterId","tblMeters","MeterNo",mostCurrent._lblmeterno.getText());
 //BA.debugLineNum = 721;BA.debugLine="dPrevRdg = txtPrevRdg.Text";
_dprevrdg = (double)(Double.parseDouble(mostCurrent._txtprevrdg.getText()));
 //BA.debugLineNum = 722;BA.debugLine="dFinalRdg = txtFinalRdg.Text";
_dfinalrdg = (double)(Double.parseDouble(mostCurrent._txtfinalrdg.getText()));
 //BA.debugLineNum = 723;BA.debugLine="dAddCons = GlobalVar.SF.Val(txtFinalRdg.Text) - G";
_daddcons = mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv6(mostCurrent._txtfinalrdg.getText())-mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv6(mostCurrent._txtprevrdg.getText());
 //BA.debugLineNum = 726;BA.debugLine="sPipeType = cboPipeType.SelectedItem";
_spipetype = mostCurrent._cbopipetype.getSelectedItem();
 //BA.debugLineNum = 727;BA.debugLine="sPipeSize = cboPipeSize.SelectedItem";
_spipesize = mostCurrent._cbopipesize.getSelectedItem();
 //BA.debugLineNum = 728;BA.debugLine="iPSI = txtPSI.Text";
_ipsi = (int)(Double.parseDouble(mostCurrent._txtpsi.getText()));
 //BA.debugLineNum = 729;BA.debugLine="iMinutes = txtMinutes.Text";
_iminutes = (int)(Double.parseDouble(mostCurrent._txtminutes.getText()));
 //BA.debugLineNum = 730;BA.debugLine="dWaterLoss = txtWaterLoss.Text";
_dwaterloss = (double)(Double.parseDouble(mostCurrent._txtwaterloss.getText()));
 //BA.debugLineNum = 733;BA.debugLine="sRemarks = txtRemarks.Text";
_sremarks = mostCurrent._txtremarks.getText();
 //BA.debugLineNum = 734;BA.debugLine="Starter.FLP.Connect";
mostCurrent._starter._flp /*uk.co.martinpearman.b4a.fusedlocationprovider.FusedLocationProviderWrapper*/ .Connect();
 //BA.debugLineNum = 736;BA.debugLine="Log($\"FLP is COnnected? \"$ & Starter.FLP.IsConnec";
anywheresoftware.b4a.keywords.Common.LogImpl("719791912",("FLP is COnnected? ")+BA.ObjectToString(mostCurrent._starter._flp /*uk.co.martinpearman.b4a.fusedlocationprovider.FusedLocationProviderWrapper*/ .IsConnected()),0);
 //BA.debugLineNum = 738;BA.debugLine="LogColor($\"Latitude: \"$ & GlobalVar.Lat, Colors.M";
anywheresoftware.b4a.keywords.Common.LogImpl("719791914",("Latitude: ")+mostCurrent._globalvar._lat /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Magenta);
 //BA.debugLineNum = 739;BA.debugLine="LogColor($\"Longitude: \"$ & GlobalVar.Lon, Colors.";
anywheresoftware.b4a.keywords.Common.LogImpl("719791915",("Longitude: ")+mostCurrent._globalvar._lon /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Cyan);
 //BA.debugLineNum = 741;BA.debugLine="sLocation = GlobalVar.Lat & \",\" & GlobalVar.Lon";
_slocation = mostCurrent._globalvar._lat /*String*/ +","+mostCurrent._globalvar._lon /*String*/ ;
 //BA.debugLineNum = 742;BA.debugLine="LogColor($\"Location is \"$ & sLocation, Colors.Yel";
anywheresoftware.b4a.keywords.Common.LogImpl("719791918",("Location is ")+_slocation,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
 //BA.debugLineNum = 744;BA.debugLine="lngDateTime = DateTime.Now";
_lngdatetime = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 745;BA.debugLine="DateTime.DateFormat = \"yyyy-MM-dd hh:mm:ss a\"";
anywheresoftware.b4a.keywords.Common.DateTime.setDateFormat("yyyy-MM-dd hh:mm:ss a");
 //BA.debugLineNum = 746;BA.debugLine="sDatePosted = DateTime.Date(lngDateTime)";
_sdateposted = anywheresoftware.b4a.keywords.Common.DateTime.Date(_lngdatetime);
 //BA.debugLineNum = 747;BA.debugLine="sAccomplishedBy = DBaseFunctions.GetPlumberIDs(sp";
_saccomplishedby = mostCurrent._dbasefunctions._getplumberids /*String*/ (mostCurrent.activityBA,mostCurrent._spnplumbers.getSelectedItemsString());
 //BA.debugLineNum = 749;BA.debugLine="If WriteStoragePermission = False Then";
if (_writestoragepermission==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 750;BA.debugLine="ToastMessageShow ($\"Unable to Save Signature Ima";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(("Unable to Save Signature Image due to permission to write was denied")),anywheresoftware.b4a.keywords.Common.True);
 ...
 //BA.debugLineNum = 752;BA.debugLine="SigPicPath = File.Combine(RootDir, \"DCIM\")";
mostCurrent._sigpicpath = anywheresoftware.b4a.keywords.Common.File.Combine(mostCurrent._rootdir,"DCIM");
 //BA.debugLineNum = 753;BA.debugLine="SigFolderName = File.Combine(SigPicPath, \"BWSI-O";
mostCurrent._sigfoldername = anywheresoftware.b4a.keywords.Common.File.Combine(mostCurrent._sigpicpath,"BWSI-OP");
 //BA.debugLineNum = 754;BA.debugLine="If File.Exists(SigFolderName, \"\") = False Then";
if (anywheresoftware.b4a.keywords.Common.File.Exists(mostCurrent._sigfoldername,"")==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 755;BA.debugLine="File.MakeDir(SigPicPath, \"BWSI-OP\")";
anywheresoftware.b4a.keywords.Common.File.MakeDir(mostCurrent._sigpicpath,"BWSI-OP");
 //BA.debugLineNum = 756;BA.debugLine="SigFolderName = File.Combine(SigPicPath, \"BWSI-";
mostCurrent._sigfoldername = anywheresoftware.b4a.keywords.Common.File.Combine(mostCurrent._sigpicpath,"BWSI-OP");
 };
 };
 //BA.debugLineNum = 760;BA.debugLine="SigFilename = GlobalVar.SelectedJOCatCode & \" -\"&";
mostCurrent._sigfilename = mostCurrent._globalvar._selectedjocatcode /*String*/ +" -"+mostCurrent._lbljonum.getText()+"-"+mostCurrent._lblappnum.getText()+".jpg";
 //BA.debugLineNum = 761;BA.debugLine="Dim bmp As Bitmap = SignaturePad.TransparentSigna";
_bmp = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
_bmp = (anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper(), (android.graphics.Bitmap)(mostCurrent._signaturepad.getTransparentSignatureBitmap()));
 //BA.debugLineNum = 762;BA.debugLine="imgSignature.Bitmap = bmp";
mostCurrent._imgsignature.setBitmap((android.graphics.Bitmap)(_bmp.getObject()));
 //BA.debugLineNum = 765;BA.debugLine="SignaturePad.saveBitmapToJPG(bmp,File.Combine(Sig";
mostCurrent._signaturepad.saveBitmapToJPG((android.graphics.Bitmap)(_bmp.getObject()),anywheresoftware.b4a.keywords.Common.File.Combine(mostCurrent._sigfoldername,mostCurrent._sigfilename));
 //BA.debugLineNum = 766;BA.debugLine="Log(SigFilename & \" Saved\")";
anywheresoftware.b4a.keywords.Common.LogImpl("719791942",mostCurrent._sigfilename+" Saved",0);
 //BA.debugLineNum = 768;BA.debugLine="Dim Phone As Phone";
_phone = new anywheresoftware.b4a.phone.Phone();
 //BA.debugLineNum = 769;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 770;BA.debugLine="i.Initialize(\"android.intent.action.MEDIA_SCANNER";
_i.Initialize("android.intent.action.MEDIA_SCANNER_SCAN_FILE","file://"+anywheresoftware.b4a.keywords.Common.File.Combine(mostCurrent._sigfoldername,mostCurrent._sigfilename));
 //BA.debugLineNum = 772;BA.debugLine="Phone.SendBroadcastIntent(i)";
_phone.SendBroadcastIntent((android.content.Intent)(_i.getObject()));
 //BA.debugLineNum = 774;BA.debugLine="Starter.DBCon.BeginTransaction";
mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .BeginTransaction();
 //BA.debugLineNum = 775;BA.debugLine="Try";
try { //BA.debugLineNum = 777;BA.debugLine="Starter.strCriteria = \"UPDATE tblJOs \" & _";
mostCurrent._starter._strcriteria /*String*/  = "UPDATE tblJOs "+"SET FinalRdg = ?, JOStatus = ? , DateFinished = ?, AccomplishedBy = ?, SigFileName = ?, PostedAt = ?, PostedOn = ? "+"WHERE JOID = "+BA.NumberToString(_ijoid);
 //BA.debugLineNum = 780;BA.debugLine="Starter.DBCon.ExecNonQuery2(Starter.strCriteria,";
mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecNonQuery2(mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.ArrayToList(new String[]{BA.NumberToString(_dfinalrdg),BA.NumberToString(3),mostCurrent._txtdatetimefinished.getText(),_saccomplishedby,mostCurrent._sigfoldername+"/"+mostCurrent._sigfilename,_sdateposted,_slocation}));
 //BA.debugLineNum = 783;BA.debugLine="Starter.strCriteria = \"INSERT INTO tblJODCFindin";
mostCurrent._starter._strcriteria /*String*/  = "INSERT INTO tblJODCFindings VALUES (?, ?, ?, ?, ?, ?, ?)";
 //BA.debugLineNum = 784;BA.debugLine="Starter.DBCon.ExecNonQuery2(Starter.strCriteria,";
mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecNonQuery2(mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.ArrayToList(new Object[]{(Object)(mostCurrent._globalvar._selectedjoid /*int*/ ),(Object)(_dmeterid),(Object)(_dprevrdg),(Object)(_dfinalrdg),(Object)(_daddcons),(Object)(_sactiontaken),(Object)(_sremarks)}));
 //BA.debugLineNum = 787;BA.debugLine="Starter.strCriteria = \"INSERT INTO JOWaterLoss V";
mostCurrent._starter._strcriteria /*String*/  = "INSERT INTO JOWaterLoss VALUES ("+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Null)+", ?, ?, ?, ?, ?, ?, ?)";
 //BA.debugLineNum = 788;BA.debugLine="Starter.DBCon.ExecNonQuery2(Starter.strCriteria,";
mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecNonQuery2(mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.ArrayToList(new Object[]{(Object)(mostCurrent._globalvar._selectedjoid /*int*/ ),(Object)(("DC-CR")),(Object)(_spipetype),(Object)(_spipesize),(Object)(_ipsi),(Object)(_iminutes),(Object)(_dwaterloss)}));
 //BA.debugLineNum = 790;BA.debugLine="Starter.DBCon.TransactionSuccessful";
mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .TransactionSuccessful();
 //BA.debugLineNum = 791;BA.debugLine="DispInfoMsg($\"JO ACCOMPLISHED\"$,$\"JO has been su";
_dispinfomsg(("JO ACCOMPLISHED"),("JO has been successfully accomplished."));
 } 
       catch (Exception e66) {
			processBA.setLastException(e66); //BA.debugLineNum = 793;BA.debugLine="Log(LastException.Message)";
anywheresoftware.b4a.keywords.Common.LogImpl("719791969",anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
 };
 //BA.debugLineNum = 795;BA.debugLine="Starter.DBCon.EndTransaction";
...
if (mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv6(mostCurrent._txtfinalrdg.getText())<mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv6(mostCurrent._txtprevrdg.getText())) { 
 //BA.debugLineNum = 573;BA.debugLine="RequiredMsgBox($\"ERROR\"$, $\"Unable to Accomplsh";
_requiredmsgbox(("ERROR"),("Unable to Accomplshed JO due to Reading Went Back."));
 //BA.debugLineNum = 574;BA.debugLine="txtFinalRdg.RequestFocus";
mostCurrent._txtfinalrdg.RequestFocus();
 };
 //BA.debugLineNum = 577;BA.debugLine="If GlobalVar.SF.Len(cboPipeType.SelectedItem) <=";
if (mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._cbopipetype.getSelectedItem())<=0) { 
 //BA.debugLineNum = 578;BA.debugLine="RequiredMsgBox($\"ERROR\"$, $\"Unable to Accomplsh";
_requiredmsgbox(("ERROR"),("Unable to Accomplshed JO due to Water Loss Computation is missing."));
 //BA.debugLineNum = 579;BA.debugLine="cboPipeType.RequestFocus";
mostCurrent._cbopipetype.RequestFocus();
 //BA.debugLineNum = 580;BA.debugLine="Return False";
if (true) return anywheresoftware.b4a.keywords.Common.False;
 };
 //BA.debugLineNum = 583;BA.debugLine="If GlobalVar.SF.Len(cboPipeSize.SelectedItem) <=";
if (mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._cbopipesize.getSelectedItem())<=0) { 
 //BA.debugLineNum = 584;BA.debugLine="RequiredMsgBox($\"ERROR\"$, $\"Unable to Accomplsh";
_requiredmsgbox(("ERROR"),("Unable to Accomplshed JO due to Water Loss Computation is missing."));
 //BA.debugLineNum = 585;BA.debugLine="cboPipeSize.RequestFocus";
mostCurrent._cbopipesize.RequestFocus();
 //BA.debugLineNum = 586;BA.debugLine="Return False";
if (true) return anywheresoftware.b4a.keywords.Common.False;
 };
 //BA.debugLineNum = 589;BA.debugLine="If GlobalVar.SF.Len(txtPSI.Text) <= 0 Then";
if (mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._txtpsi.getText())<=0) { 
 //BA.debugLineNum = 590;BA.debugLine="RequiredMsgBox($\"ERROR\"$, $\"Unable to Accomplsh";
_requiredmsgbox(("ERROR"),("Unable to Accomplshed JO due to Water Loss Computation is missing."));
 //BA.debugLineNum = 591;BA.debugLine="txtPSI.RequestFocus";
mostCurrent._txtpsi.RequestFocus();
 //BA.debugLineNum = 592;BA.debugLine="Return False";
if (true) return anywheresoftware.b4a.keywords.Common.False;
 };
 //BA.debugLineNum = 595;BA.debugLine="If GlobalVar.SF.Len(txtMinutes.Text) <= 0 Then";
if (mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._txtminutes.getText())<=0) { 
 //BA.debugLineNum = 596;BA.debugLine="RequiredMsgBox($\"ERROR\"$, $\"Unable to Accomplsh";
_requiredmsgbox(("ERROR"),("Unable to Accomplshed JO due to Water Loss Computation is missing."));
 //BA.debugLineNum = 597;BA.debugLine="txtMinutes.RequestFocus";
mostCurrent._txtminutes.RequestFocus();
 //BA.debugLineNum = 598;BA.debugLine="Return False";
if (true) return anywheresoftware.b4a.keywords.Common.False;
 };
 //BA.debugLineNum = 601;BA.debugLine="If GlobalVar.SF.Len(txtWaterLoss.Text) <= 0 Then";
if (mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._txtwaterloss.getText())<=0) { 
 //BA.debugLineNum = 602;BA.debugLine="Return False";
if (true) return anywheresoftware.b4a.keywords.Common.False;
 };
...
if (true) return anywheresoftware.b4a.keywords.Common.True;
			...
			processBA.setLastException(e51); //BA.debugLineNum = 607;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("719136574",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
