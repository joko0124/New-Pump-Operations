...
mostCurrent._txttry3.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cdtxtbox.getObject()));
 //BA.debugLineNum = 135;BA.debugLine="cdGPM.Initialize2(Colors.Black, 0, 0, Colors.Tran";
mostCurrent._cdgpm.Initialize2(anywheresoftware.b4a.keywords.Common.Colors.Black,(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 136;BA.debugLine="txtGPM.Background = cdGPM";
mostCurrent._txtgpm.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cdgpm.getObject()));
 //BA.debugLineNum = 137;BA.debugLine="txtGPM.TextColor = 0xFFADFF2F";
mostCurrent._txtgpm.setTextColor((int) (0xffadff2f));
 //BA.debugLineNum = 139;BA.debugLine="cdRem.Initialize2(Colors.Transparent, 0, 0, Color";
...
if (_firsttime) { 
 //BA.debugLineNum = 152;BA.debugLine="txtBucketSize.RequestFocus";
mostCurrent._txtbucketsize.RequestFocus();
 //BA.debugLineNum = 153;BA.debugLine="kBoard.ShowKeyboard(txtBucketSize)";
mostCurrent._kboard.ShowKeyboard((android.view.View)(mostCurrent._txtbucketsize.getObject()));
 };
 //BA.debugLineNum = 156;BA.debugLine="kBoard.ShowKeyboard(txtBucketSize)";
mostCurrent._kboard.ShowKeyboard((android.view.View)(mostCurrent._txtbucketsize.getObject()));
 //BA.debugLineNum = 157;BA.debugLine="MyFunctions.SetButton(btnSaveUpdate, 25, 25, 25,";
mostCurrent._myfunctions._setbutton /*String*/ (mostCurrent.activityBA,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._btnsaveupdate.getObject())),(float) (25),(float) (25),(float) (25),(float) (25),(float) (25),(float) (25),(float) (25),(float) (25));
 //BA.debugLineNum = 159;BA.debugLine="SetButtonColors";
_setbuttoncolors();
 //BA.debugLineNum = 160;BA.debugLine="InitObjects";
_initobjects();
...
de.amberhome.objects.appcompat.ACMenuItemWrapper _item = null;
 //BA.debugLineNum = 183;BA.debugLine="Sub Activity_CreateMenu(Menu As ACMenu)";
 //BA.debugLineNum = 184;BA.debugLine="Dim Item As ACMenuItem";
_item = new de.amberhome.objects.appcompat.ACMenuItemWrapper();
 //BA.debugLineNum = 185;BA.debugLine="Menu.Clear";
_menu.Clear();
 //BA.debugLineNum = 187;BA.debugLine="Menu.Add2(1, 1, \"GPM History\",xmlIcon.GetDrawable";
...
if (_keycode==4) { 
 //BA.debugLineNum = 165;BA.debugLine="ToolBar_NavigationItemClick";
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 173;BA.debugLine="FillUOM";
_filluom();
 //BA.debugLineNum = 174;BA.debugLine="iTimer = 0";
_itimer = (int) (0);
 //BA.debugLineNum = 175;BA.debugLine="End Sub";
return "";
}
public static String  _btncancel_click() throws Exception{
 //BA.debugLineNum = 881;BA.debugLine="Sub btnCancel_Click";
 //BA.debugLineNum = 882;BA.debugLine="If Not(SW1.IsInitialized) Then";
if (anywheresoftware.b4a.keywords.Common.Not(mostCurrent._sw1.IsInitialized())) { 
 //BA.debugLineNum = 883;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 885;BA.debugLine="SW1.Stop";
mostCurrent._sw1.Stop();
 //BA.debugLineNum = 886;BA.debugLine="pnlMainTimer.Visible = False";
...
public static String  _btnok_click() throws Exception{
 //BA.debugLineNum = 870;BA.debugLine="Sub btnOk_Click";
 //BA.debugLineNum = 871;BA.debugLine="Select Case iTimer";
switch (_itimer) {
case 1: {
 //BA.debugLineNum = 873;BA.debugLine="ConfirmStopTimer($\"CONFIRM TIME\"$, $\"Do you wan";
_confirmstoptimer(("CONFIRM TIME"),("Do you want to fetch this as your Trial 1 time?"),_itimer);
 break; }
case 2: {
 //BA.debugLineNum = 875;BA.debugLine="ConfirmStopTimer($\"CONFIRM TIME\"$, $\"Do you wan";
...
public static String  _btnpause_click() throws Exception{
 //BA.debugLineNum = 747;BA.debugLine="Sub btnPause_Click";
 //BA.debugLineNum = 748;BA.debugLine="Select Case btnPause.Text";
switch (BA.switchObjectToInt(mostCurrent._btnpause.getText(),"PAUSE","RESUME")) {
case 0: {
 //BA.debugLineNum = 750;BA.debugLine="If Not(SW1.IsInitialized) Then";
if (anywheresoftware.b4a.keywords.Common.Not(mostCurrent._sw1.IsInitialized())) { 
 //BA.debugLineNum = 751;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 753;BA.debugLine="SW1.Pause";
mostCurrent._sw1.Pause();
 //BA.debugLineNum = 754;BA.debugLine="btnStart.Enabled = False";
mostCurrent._btnstart.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 755;BA.debugLine="btnStop.Enabled = False";
mostCurrent._btnstop.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 756;BA.debugLine="btnPause.Enabled = True";
mostCurrent._btnpause.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 757;BA.debugLine="btnReset.Enabled = False";
mostCurrent._btnreset.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 758;BA.debugLine="btnPause.Text = \"RESUME\"";
mostCurrent._btnpause.setText(BA.ObjectToCharSequence("RESUME"));
 //BA.debugLineNum = 759;BA.debugLine="btnReset.Enabled = True";
mostCurrent._btnreset.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 760;BA.debugLine="btnCancel.Enabled = True";
mostCurrent._btncancel.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 break; }
case 1: {
 //BA.debugLineNum = 762;BA.debugLine="If Not(SW1.IsInitialized) Then";
if (anywheresoftware.b4a.keywords.Common.Not(mostCurrent._sw1.IsInitialized())) { 
 //BA.debugLineNum = 763;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 765;BA.debugLine="SW1.Resume";
mostCurrent._sw1.Resume();
 //BA.debugLineNum = 767;BA.debugLine="btnStart.Enabled = False";
mostCurrent._btnstart.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 768;BA.debugLine="btnStop.Enabled = True";
mostCurrent._btnstop.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 769;BA.debugLine="btnPause.Enabled = True";
mostCurrent._btnpause.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 770;BA.debugLine="btnReset.Enabled = False";
mostCurrent._btnreset.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 771;BA.debugLine="btnPause.Text = \"PAUSE\"";
mostCurrent._btnpause.setText(BA.ObjectToCharSequence("PAUSE"));
 //BA.debugLineNum = 772;BA.debugLine="btnReset.Enabled = False";
mostCurrent._btnreset.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 773;BA.debugLine="btnCancel.Enabled = True";
mostCurrent._btncancel.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 break; }
}
;
...
public static String  _btnreset_click() throws Exception{
 //BA.debugLineNum = 706;BA.debugLine="Sub btnReset_Click";
 //BA.debugLineNum = 707;BA.debugLine="If Not(SW1.IsInitialized) Then";
if (anywheresoftware.b4a.keywords.Common.Not(mostCurrent._sw1.IsInitialized())) { 
 //BA.debugLineNum = 708;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 710;BA.debugLine="SW1.Reset";
mostCurrent._sw1.Reset();
 //BA.debugLineNum = 712;BA.debugLine="btnReset.Enabled = False";
mostCurrent._btnreset.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 713;BA.debugLine="btnPause.Enabled = False";
mostCurrent._btnpause.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 714;BA.debugLine="btnStop.Enabled = False";
mostCurrent._btnstop.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 715;BA.debugLine="btnStart.Enabled = True";
mostCurrent._btnstart.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 716;BA.debugLine="btnOk.Enabled = True";
...
public static String  _btnsaveupdate_click() throws Exception{
 //BA.debugLineNum = 213;BA.debugLine="Sub btnSaveUpdate_Click";
...
if (true) return "";};
 //BA.debugLineNum = 216;BA.debugLine="If DBaseFunctions.IsGPMTransExist(GlobalVar.PumpH";
if (mostCurrent._dbasefunctions._isgpmtransexist /*boolean*/ (mostCurrent.activityBA,mostCurrent._globalvar._pumphouseid /*int*/ ,mostCurrent._globalvar._trandate /*String*/ )==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 217;BA.debugLine="ShowGPMExist";
_showgpmexist();
 //BA.debugLineNum = 218;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 221;BA.debugLine="If Not(GlobalVar.blnNewGPM) Then";
if (anywheresoftware.b4a.keywords.Common.Not(mostCurrent._globalvar._blnnewgpm /*boolean*/ )) { 
 //BA.debugLineNum = 222;BA.debugLine="If Not(UpdateGPM(GlobalVar.GPMId, GlobalVar.Tran";
...
if (true) return "";};
 ...
 //BA.debugLineNum = 224;BA.debugLine="If Not(SaveNewGPM) Then Return";
if (anywheresoftware.b4a.keywords.Common.Not(_savenewgpm())) { 
if (true) return "";};
 };
 //BA.debugLineNum = 226;BA.debugLine="ShowSaveSuccess";
_showsavesuccess();
 //BA.debugLineNum = 227;BA.debugLine="End Sub";
return "";
}
public static String  _btnshowtimer1_click() throws Exception{
 //BA.debugLineNum = 802;BA.debugLine="Sub btnShowTimer1_Click";
 //BA.debugLineNum = 803;BA.debugLine="iTimer = 1";
_itimer = (int) (1);
 //BA.debugLineNum = 804;BA.debugLine="ShowTimer";
_showtimer();
 //BA.debugLineNum = 805;BA.debugLine="End Sub";
return "";
}
public static String  _btnshowtimer2_click() throws Exception{
 //BA.debugLineNum = 807;BA.debugLine="Sub btnShowTimer2_Click";
 //BA.debugLineNum = 808;BA.debugLine="iTimer = 2";
_itimer = (int) (2);
 //BA.debugLineNum = 809;BA.debugLine="ShowTimer";
_showtimer();
 //BA.debugLineNum = 810;BA.debugLine="End Sub";
return "";
}
public static String  _btnshowtimer3_click() throws Exception{
 //BA.debugLineNum = 812;BA.debugLine="Sub btnShowTimer3_Click";
 //BA.debugLineNum = 813;BA.debugLine="iTimer = 3";
_itimer = (int) (3);
 //BA.debugLineNum = 814;BA.debugLine="ShowTimer";
_showtimer();
 //BA.debugLineNum = 815;BA.debugLine="End Sub";
return "";
}
public static String  _btnstart_click() throws Exception{
 //BA.debugLineNum = 734;BA.debugLine="Sub btnStart_Click";
 //BA.debugLineNum = 735;BA.debugLine="If Not(SW1.IsInitialized) Then";
if (anywheresoftware.b4a.keywords.Common.Not(mostCurrent._sw1.IsInitialized())) { 
 //BA.debugLineNum = 736;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 738;BA.debugLine="SW1.Start";
mostCurrent._sw1.Start();
 //BA.debugLineNum = 740;BA.debugLine="btnStart.Enabled = False";
mostCurrent._btnstart.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 741;BA.debugLine="btnStop.Enabled = True";
mostCurrent._btnstop.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 742;BA.debugLine="btnPause.Enabled = True";
mostCurrent._btnpause.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 743;BA.debugLine="btnReset.Enabled = False";
mostCurrent._btnreset.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 744;BA.debugLine="btnCancel.Enabled = False";
...
public static String  _btnstop_click() throws Exception{
 //BA.debugLineNum = 720;BA.debugLine="Sub btnStop_Click";
 //BA.debugLineNum = 721;BA.debugLine="If Not(SW1.IsInitialized) Then";
if (anywheresoftware.b4a.keywords.Common.Not(mostCurrent._sw1.IsInitialized())) { 
 //BA.debugLineNum = 722;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 724;BA.debugLine="SW1.Stop";
mostCurrent._sw1.Stop();
 //BA.debugLineNum = 726;BA.debugLine="btnReset.Enabled = True";
mostCurrent._btnreset.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 727;BA.debugLine="btnPause.Enabled = False";
mostCurrent._btnpause.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 728;BA.debugLine="btnStop.Enabled = False";
mostCurrent._btnstop.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 729;BA.debugLine="btnStart.Enabled = False";
mostCurrent._btnstart.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 730;BA.debugLine="btnOk.Enabled = True";
mostCurrent._btnok.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 731;BA.debugLine="btnCancel.Enabled = True";
mostCurrent._btncancel.setEnabled(anywheresoftware.b4a.keywords.Common.True);
...
public static String  _cbouom_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 205;BA.debugLine="Sub cboUOM_ItemClick (Position As Int, Value As Ob";
 //BA.debugLineNum = 206;BA.debugLine="If GlobalVar.SF.Len(txtBucketSize.Text) <= 0 Or G";
if (mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._txtbucketsize.getText())<=0 || mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._cbouom.getSelectedItem())<=0 || mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._txttry1.getText())<=0 || mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._txttry2.getText())<=0 || mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._txttry3.getText())<=0) { 
 //BA.debugLineNum = 207;BA.debugLine="txtGPM.Text = 0";
mostCurrent._txtgpm.setText(BA.ObjectToCharSequence(0));
 //BA.debugLineNum = 208;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 210;BA.debugLine="txtGPM.Text = ComputeGPM";
...
public static String  _chkmanual_checkedchange(boolean _checked) throws Exception{
 //BA.debugLineNum = 829;BA.debugLine="Sub chkManual_CheckedChange(Checked As Boolean)";
 //BA.debugLineNum = 830;BA.debugLine="If Checked Then";
if (_checked) { 
 //BA.debugLineNum = 831;BA.debugLine="btnShowTimer1.Enabled = False";
mostCurrent._btnshowtimer1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 832;BA.debugLine="btnShowTimer2.Enabled = False";
mostCurrent._btnshowtimer2.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 833;BA.debugLine="btnShowTimer3.Enabled = False";
mostCurrent._btnshowtimer3.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 834;BA.debugLine="txtTry1.Text = \"\"";
mostCurrent._txttry1.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 835;BA.debugLine="txtTry2.Text = \"\"";
mostCurrent._txttry2.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 836;BA.debugLine="txtTry3.Text = \"\"";
mostCurrent._txttry3.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 837;BA.debugLine="txtTry1.Enabled = True";
mostCurrent._txttry1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 838;BA.debugLine="txtTry2.Enabled = True";
mostCurrent._txttry2.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 839;BA.debugLine="txtTry3.Enabled = True";
mostCurrent._txttry3.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 840;BA.debugLine="txtTry1.RequestFocus";
mostCurrent._txttry1.RequestFocus();
 }else {
 //BA.debugLineNum = 842;BA.debugLine="btnShowTimer1.Enabled = True";
mostCurrent._btnshowtimer1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 843;BA.debugLine="txtTry1.Text = \"\"";
mostCurrent._txttry1.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 844;BA.debugLine="txtTry2.Text = \"\"";
mostCurrent._txttry2.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 845;BA.debugLine="txtTry3.Text = \"\"";
mostCurrent._txttry3.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 846;BA.debugLine="txtTry1.Enabled = False";
mostCurrent._txttry1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 847;BA.debugLine="txtTry2.Enabled = False";
mostCurrent._txttry2.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 848;BA.debugLine="txtTry3.Enabled = False";
...
public static String  _cleardisplay() throws Exception{
 //BA.debugLineNum = 371;BA.debugLine="Private Sub ClearDisplay";
 //BA.debugLineNum = 372;BA.debugLine="txtGPM.Text = \"\"";
mostCurrent._txtgpm.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 373;BA.debugLine="txtBucketSize.Text = \"\"";
mostCurrent._txtbucketsize.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 374;BA.debugLine="txtRemarks.Text = \"\"";
mostCurrent._txtremarks.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 375;BA.debugLine="chkManual.Checked = False";
mostCurrent._chkmanual.setChecked(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 376;BA.debugLine="txtTry1.Text = \"\"";
mostCurrent._txttry1.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 377;BA.debugLine="txtTry2.Text = \"\"";
mostCurrent._txttry2.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 378;BA.debugLine="txtTry3.Text = \"\"";
mostCurrent._txttry3.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 379;BA.debugLine="txtWaterQuality.Text = \"\"";
mostCurrent._txtwaterquality.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 380;BA.debugLine="btnShowTimer1.Enabled = True";
mostCurrent._btnshowtimer1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 381;BA.debugLine="btnShowTimer2.Enabled = False";
mostCurrent._btnshowtimer2.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 382;BA.debugLine="btnShowTimer3.Enabled = False";
mostCurrent._btnshowtimer3.setEnabled(anywheresoftware.b4a.keywords.Common.False);
...
double _isecs3 = 0;
double _imilsecs3 = 0;
 //BA.debugLineNum = 424;BA.debugLine="Private Sub ComputeGPM() As Double";
 //BA.debugLineNum = 425;BA.debugLine="Dim dTry1, dTry2, dTry3 As Double";
_dtry1 = 0;
_dtry2 = 0;
_dtry3 = 0;
 //BA.debugLineNum = 426;BA.debugLine="Dim aveSec As Double";
_avesec = 0;
 //BA.debugLineNum = 427;BA.debugLine="Dim TotalGPM As BigDecimal";
_totalgpm = new anywheresoftware.b4a.agraham.bignumbers.BigDecimalWrapper();
 //BA.debugLineNum = 428;BA.debugLine="Dim dRetVal As Double";
_dretval = 0;
 //BA.debugLineNum = 429;BA.debugLine="Dim mass, hr As Double";
_mass = 0;
_hr = 0;
 //BA.debugLineNum = 431;BA.debugLine="Dim Matcher1, Matcher2, Matcher3 As Matcher";
...
_matcher3 = new anywheresoftware.b4a.keywords.Regex.MatcherWrapper();
 //BA.debugLineNum = 432;BA.debugLine="Dim iMins1, iSecs1, iMilSecs1 As Double";
_imins1 = 0;
_isecs1 = 0;
_imilsecs1 = 0;
 //BA.debugLineNum = 433;BA.debugLine="Dim iMins2, iSecs2, iMilSecs2 As Double";
_imins2 = 0;
_isecs2 = 0;
_imilsecs2 = 0;
 //BA.debugLineNum = 434;BA.debugLine="Dim iMins3, iSecs3, iMilSecs3 As Double";
_imins3 = 0;
_isecs3 = 0;
_imilsecs3 = 0;
 //BA.debugLineNum = 436;BA.debugLine="If GlobalVar.SF.Len(GlobalVar.SF.Trim(txtTry1.Tex";
if (mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv4(mostCurrent._txttry1.getText()))>0 && mostCurrent._chkmanual.getChecked()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 437;BA.debugLine="Matcher1 = Regex.Matcher(\"(\\d\\d):(\\d\\d).(\\d\\d)\",";
_matcher1 = anywheresoftware.b4a.keywords.Common.Regex.Matcher("(\\d\\d):(\\d\\d).(\\d\\d)",mostCurrent._txttry1.getText());
 //BA.debugLineNum = 438;BA.debugLine="If Matcher1.Find Then";
if (_matcher1.Find()) { 
 //BA.debugLineNum = 440;BA.debugLine="iMins1 = Matcher1.Group(1)";
_imins1 = (double)(Double.parseDouble(_matcher1.Group((int) (1))));
 //BA.debugLineNum = 441;BA.debugLine="iSecs1 = Matcher1.Group(2)";
_isecs1 = (double)(Double.parseDouble(_matcher1.Group((int) (2))));
 //BA.debugLineNum = 442;BA.debugLine="iMilSecs1 = Matcher1.Group(3)/100";
_imilsecs1 = (double)(Double.parseDouble(_matcher1.Group((int) (3))))/(double)100;
 //BA.debugLineNum = 444;BA.debugLine="LogColor($\"Minutes : \"$ & iMins1, Colors.Cyan)";
anywheresoftware.b4a.keywords.Common.LogImpl("158392596",("Minutes : ")+BA.NumberToString(_imins1),anywheresoftware.b4a.keywords.Common.Colors.Cyan);
 //BA.debugLineNum = 445;BA.debugLine="LogColor($\"Seconds : \"$ & iSecs1, Colors.Magent";
anywheresoftware.b4a.keywords.Common.LogImpl("158392597",("Seconds : ")+BA.NumberToString(_isecs1),anywheresoftware.b4a.keywords.Common.Colors.Magenta);
 //BA.debugLineNum = 446;BA.debugLine="LogColor($\"Milliseconds : \"$ & iMilSecs1, Color";
anywheresoftware.b4a.keywords.Common.LogImpl("158392598",("Milliseconds : ")+BA.NumberToString(_imilsecs1),anywheresoftware.b4a.keywords.Common.Colors.Green);
 //BA.debugLineNum = 448;BA.debugLine="If iMins1 > 1 Then";
if (_imins1>1) { 
 //BA.debugLineNum = 449;BA.debugLine="dTry1 = (iMins1 * 60) + iSecs1 + iMilSecs1";
_dtry1 = (_imins1*60)+_isecs1+_imilsecs1;
 }else {
 //BA.debugLineNum = 451;BA.debugLine="dTry1 = iSecs1 + iMilSecs1";
_dtry1 = _isecs1+_imilsecs1;
 ...
 //BA.debugLineNum = 455;BA.debugLine="dTry1 = GlobalVar.SF.Val(txtTry1.Text)";
_dtry1 = mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv6(mostCurrent._txttry1.getText());
 };
 //BA.debugLineNum = 458;BA.debugLine="If GlobalVar.SF.Len(GlobalVar.SF.Trim(txtTry2.Tex";
if (mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv4(mostCurrent._txttry2.getText()))>0 && mostCurrent._chkmanual.getChecked()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 459;BA.debugLine="Matcher2 = Regex.Matcher(\"(\\d\\d):(\\d\\d).(\\d\\d)\",";
_matcher2 = anywheresoftware.b4a.keywords.Common.Regex.Matcher("(\\d\\d):(\\d\\d).(\\d\\d)",mostCurrent._txttry2.getText());
 //BA.debugLineNum = 460;BA.debugLine="If Matcher2.Find Then";
if (_matcher2.Find()) { 
 //BA.debugLineNum = 462;BA.debugLine="iMins2 = Matcher2.Group(1)";
_imins2 = (double)(Double.parseDouble(_matcher2.Group((int) (1))));
 //BA.debugLineNum = 463;BA.debugLine="iSecs2 = Matcher2.Group(2)";
_isecs2 = (double)(Double.parseDouble(_matcher2.Group((int) (2))));
 //BA.debugLineNum = 464;BA.debugLine="iMilSecs2 = Matcher2.Group(3)/100";
_imilsecs2 = (double)(Double.parseDouble(_matcher2.Group((int) (3))))/(double)100;
 //BA.debugLineNum = 466;BA.debugLine="LogColor($\"Minutes : \"$ & iMins2, Colors.Cyan)";
anywheresoftware.b4a.keywords.Common.LogImpl("158392618",("Minutes : ")+BA.NumberToString(_imins2),anywheresoftware.b4a.keywords.Common.Colors.Cyan);
 //BA.debugLineNum = 467;BA.debugLine="LogColor($\"Seconds : \"$ & iSecs2, Colors.Magent";
anywheresoftware.b4a.keywords.Common.LogImpl("158392619",("Seconds : ")+BA.NumberToString(_isecs2),anywheresoftware.b4a.keywords.Common.Colors.Magenta);
 //BA.debugLineNum = 468;BA.debugLine="LogColor($\"Milliseconds : \"$ & iMilSecs2, Color";
anywheresoftware.b4a.keywords.Common.LogImpl("158392620",("Milliseconds : ")+BA.NumberToString(_imilsecs2),anywheresoftware.b4a.keywords.Common.Colors.Green);
 //BA.debugLineNum = 470;BA.debugLine="If iMins2 > 1 Then";
if (_imins2>1) { 
 //BA.debugLineNum = 471;BA.debugLine="dTry2 = (iMins2 * 60) + iSecs2 + iMilSecs2";
_dtry2 = (_imins2*60)+_isecs2+_imilsecs2;
 }else {
 //BA.debugLineNum = 473;BA.debugLine="dTry2 = iSecs2 + iMilSecs2";
_dtry2 = _isecs2+_imilsecs2;
 ...
 //BA.debugLineNum = 477;BA.debugLine="dTry2 = GlobalVar.SF.Val(txtTry2.Text)";
_dtry2 = mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv6(mostCurrent._txttry2.getText());
 };
 //BA.debugLineNum = 480;BA.debugLine="If GlobalVar.SF.Len(GlobalVar.SF.Trim(txtTry3.Tex";
if (mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv4(mostCurrent._txttry3.getText()))>0 && mostCurrent._chkmanual.getChecked()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 481;BA.debugLine="Matcher3 = Regex.Matcher(\"(\\d\\d):(\\d\\d).(\\d\\d)\",";
_matcher3 = anywheresoftware.b4a.keywords.Common.Regex.Matcher("(\\d\\d):(\\d\\d).(\\d\\d)",mostCurrent._txttry3.getText());
 //BA.debugLineNum = 482;BA.debugLine="If Matcher3.Find Then";
if (_matcher3.Find()) { 
 //BA.debugLineNum = 484;BA.debugLine="iMins3 = Matcher3.Group(1)";
_imins3 = (double)(Double.parseDouble(_matcher3.Group((int) (1))));
 //BA.debugLineNum = 485;BA.debugLine="iSecs3 = Matcher3.Group(2)";
_isecs3 = (double)(Double.parseDouble(_matcher3.Group((int) (2))));
 //BA.debugLineNum = 486;BA.debugLine="iMilSecs3 = Matcher3.Group(3)/100";
_imilsecs3 = (double)(Double.parseDouble(_matcher3.Group((int) (3))))/(double)100;
 //BA.debugLineNum = 488;BA.debugLine="LogColor($\"Minutes : \"$ & iMins3, Colors.Cyan)";
anywheresoftware.b4a.keywords.Common.LogImpl("158392640",("Minutes : ")+BA.NumberToString(_imins3),anywheresoftware.b4a.keywords.Common.Colors.Cyan);
 //BA.debugLineNum = 489;BA.debugLine="LogColor($\"Seconds : \"$ & iSecs3, Colors.Magent";
anywheresoftware.b4a.keywords.Common.LogImpl("158392641",("Seconds : ")+BA.NumberToString(_isecs3),anywheresoftware.b4a.keywords.Common.Colors.Magenta);
 //BA.debugLineNum = 490;BA.debugLine="LogColor($\"Milliseconds : \"$ & iMilSecs3, Color";
anywheresoftware.b4a.keywords.Common.LogImpl("158392642",("Milliseconds : ")+BA.NumberToString(_imilsecs3),anywheresoftware.b4a.keywords.Common.Colors.Green);
 //BA.debugLineNum = 492;BA.debugLine="If iMins3 > 1 Then";
if (_imins3>1) { 
 //BA.debugLineNum = 493;BA.debugLine="dTry3 = (iMins3 * 60) + iSecs3 + iMilSecs3";
_dtry3 = (_imins3*60)+_isecs3+_imilsecs3;
 }else {
 //BA.debugLineNum = 495;BA.debugLine="dTry3 = iSecs3 + iMilSecs3";
_dtry3 = _isecs3+_imilsecs3;
 ...
 //BA.debugLineNum = 499;BA.debugLine="dTry3 = GlobalVar.SF.Val(txtTry3.Text)";
_dtry3 = mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv6(mostCurrent._txttry3.getText());
 };
 //BA.debugLineNum = 502;BA.debugLine="LogColor($\"Try 1: \"$ & dTry1 & $\" Try 2: \"$ & dTr";
anywheresoftware.b4a.keywords.Common.LogImpl("158392654",("Try 1: ")+BA.NumberToString(_dtry1)+(" Try 2: ")+BA.NumberToString(_dtry2)+(" Try 3: ")+BA.NumberToString(_dtry3),anywheresoftware.b4a.keywords.Common.Colors.Cyan);
 //BA.debugLineNum = 504;BA.debugLine="If cboUOM.SelectedItem = \"Liter (L)\" Then";
if ((mostCurrent._cbouom.getSelectedItem()).equals("Liter (L)")) { 
 //BA.debugLineNum = 505;BA.debugLine="mass = GlobalVar.SF.Val(txtBucketSize.Text) / 3.";
_mass = mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv6(mostCurrent._txtbucketsize.getText())/(double)3.785;
 ...
 //BA.debugLineNum = 507;BA.debugLine="mass = GlobalVar.SF.Val(txtBucketSize.Text)";
_mass = mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv6(mostCurrent._txtbucketsize.getText());
 };
 //BA.debugLineNum = 510;BA.debugLine="aveSec = 0";
_avesec = 0;
 //BA.debugLineNum = 511;BA.debugLine="aveSec =  (dTry1 + dTry2 + dTry3) / 3";
_avesec = (_dtry1+_dtry2+_dtry3)/(double)3;
 //BA.debugLineNum = 513;BA.debugLine="hr = 60 / aveSec";
_hr = 60/(double)_avesec;
 //BA.debugLineNum = 515;BA.debugLine="dRetVal = mass * hr";
_dretval = _mass*_hr;
 //BA.debugLineNum = 517;BA.debugLine="TotalGPM.Initialize(dRetVal)";
_totalgpm.Initialize(BA.NumberToString(_dretval));
 //BA.debugLineNum = 518;BA.debugLine="TotalGPM = RoundBD(TotalGPM,2)";
_totalgpm = _roundbd(_totalgpm,(int) (2));
 //BA.debugLineNum = 520;BA.debugLine="LogColor($\"Average seconds: \"$ & aveSec, Colors.W";
anywheresoftware.b4a.keywords.Common.LogImpl("158392672",("Average seconds: ")+BA.NumberToString(_avesec),anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 521;BA.debugLine="LogColor($\"Hour: \"$ & hr, Colors.Green)";
anywheresoftware.b4a.keywords.Common.LogImpl("158392673",("Hour: ")+BA.NumberToString(_hr),anywheresoftware.b4a.keywords.Common.Colors.Green);
 //BA.debugLineNum = 522;BA.debugLine="LogColor($\"Mass: \"$ & mass, Colors.Magenta)";
anywheresoftware.b4a.keywords.Common.LogImpl("158392674",("Mass: ")+BA.NumberToString(_mass),anywheresoftware.b4a.keywords.Common.Colors.Magenta);
 //BA.debugLineNum = 523;BA.debugLine="LogColor($\"Total GPM: \"$ & TotalGPM, Colors.Cyan)";
anywheresoftware.b4a.keywords.Common.LogImpl("158392675",("Total GPM: ")+BA.ObjectToString(_totalgpm),anywheresoftware.b4a.keywords.Common.Colors.Cyan);
 //BA.debugLineNum = 525;BA.debugLine="Return TotalGPM";
...
public static String  _confirmstoptimer(String _stitle,String _smsg,int _isender) throws Exception{
 //BA.debugLineNum = 611;BA.debugLine="Private Sub ConfirmStopTimer(sTitle As String, sMs";
 //BA.debugLineNum = 612;BA.debugLine="iTimer = iSender";
_itimer = _isender;
 //BA.debugLineNum = 613;BA.debugLine="Alert.Initialize.Create _ 			.SetDialogStyleName(";
mostCurrent._alert.Initialize().Create(mostCurrent.activityBA).SetDialogStyleName("MyDialogDisableStatus").SetStyle(mostCurrent._alert.getSTYLE_DIALOGUE()).SetCancelable(anywheresoftware.b4a.keywords.Common.False).SetTitle(_stitle).SetTitleColor((int) (mostCurrent._globalvar._bluecolor /*double*/ )).SetTitleTypeface((android.graphics.Typeface)(mostCurrent._fontbold.getObject())).SetMessage(_smsg).SetPositiveText("Confirm").SetPositiveColor((int) (mostCurrent._globalvar._poscolor /*double*/ )).SetPositiveTypeface((android.graphics.Typeface)(mostCurrent._fontbold.getObject())).SetNegativeText("Cancel").SetNegativeColor((int) (mostCurrent._globalvar._negcolor /*double*/ )).SetNegativeTypeface((android.graphics.Typeface)(mostCurrent._font.getObject())).SetMessageTypeface((android.graphics.Typeface)(mostCurrent._font.getObject())).SetOnPositiveClicked(mostCurrent.activityBA,"StopTimer").SetOnNegativeClicked(mostCurrent.activityBA,"StopTimer");
 //BA.debugLineNum = 630;BA.debugLine="Alert.SetDialogBackground(MyFunctions.myCD)";
mostCurrent._alert.SetDialogBackground((android.graphics.drawable.Drawable)(mostCurrent._myfunctions._mycd /*anywheresoftware.b4a.objects.drawable.ColorDrawable*/ (mostCurrent.activityBA).getObject()));
 //BA.debugLineNum = 631;BA.debugLine="Alert.Build.Show";
...
int _seconds = 0;
int _msec = 0;
 //BA.debugLineNum = 561;BA.debugLine="Private Sub ConvertMillisecondsToString(t As Long)";
 //BA.debugLineNum = 562;BA.debugLine="Dim hours, minutes, seconds, msec As Int";
_hours = 0;
_minutes = 0;
_seconds = 0;
_msec = 0;
 //BA.debugLineNum = 563;BA.debugLine="hours = t / DateTime.TicksPerHour";
_hours = (int) (_t/(double)anywheresoftware.b4a.keywords.Common.DateTime.TicksPerHour);
 //BA.debugLineNum = 564;BA.debugLine="minutes = (t Mod DateTime.TicksPerHour) / DateTim";
_minutes = (int) ((_t%anywheresoftware.b4a.keywords.Common.DateTime.TicksPerHour)/(double)anywheresoftware.b4a.keywords.Common.DateTime.TicksPerMinute);
 //BA.debugLineNum = 565;BA.debugLine="seconds = (t Mod DateTime.TicksPerMinute) / DateT";
_seconds = (int) ((_t%anywheresoftware.b4a.keywords.Common.DateTime.TicksPerMinute)/(double)anywheresoftware.b4a.keywords.Common.DateTime.TicksPerSecond);
 //BA.debugLineNum = 566;BA.debugLine="msec = DateTime.TicksPerSecond / 100";
_msec = (int) (anywheresoftware.b4a.keywords.Common.DateTime.TicksPerSecond/(double)100);
 //BA.debugLineNum = 567;BA.debugLine="Return $\"$1.0{hours}:$2.0{minutes}:$2.0{seconds}.";
...
anywheresoftware.b4a.objects.drawable.ColorDrawable _drwpressedcolor = null;
 //BA.debugLineNum = 575;BA.debugLine="Public Sub CreateButtonColor(FocusedColor As Int,";
 //BA.debugLineNum = 577;BA.debugLine="Dim RetColor As StateListDrawable";
_retcolor = new anywheresoftware.b4a.objects.drawable.StateListDrawable();
 //BA.debugLineNum = 578;BA.debugLine="Dim drwFocusedColor, drwEnabledColor, drwDisabled";
...
//C
this.state = 1;
 //BA.debugLineNum = 393;BA.debugLine="Dim SenderFilter As Object";
_senderfilter = new Object();
 //BA.debugLineNum = 394;BA.debugLine="Dim sUOM As String";
_suom = "";
...
this.state = 4;
this.catchState = 9;
 //BA.debugLineNum = 397;BA.debugLine="Starter.strCriteria = \"SELECT BucketSize, UnitOf";
parent.mostCurrent._starter._strcriteria /*String*/  = "SELECT BucketSize, UnitOfMeasurement, Trial1, Trial2, Trial3, WaterQuality, Remarks "+"FROM tblGPMHistory "+"WHERE GPMID = "+BA.NumberToString(_igpmid);
 //BA.debugLineNum = 401;BA.debugLine="SenderFilter = Starter.DBCon.ExecQueryAsync(\"SQL";
_senderfilter = parent.mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQueryAsync(processBA,"SQL",parent.mostCurrent._starter._strcriteria /*String*/ ,(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(anywheresoftware.b4a.keywords.Common.Null)));
 //BA.debugLineNum = 402;BA.debugLine="Wait For (SenderFilter) SQL_QueryComplete (Succe";
...
;
 //BA.debugLineNum = 403;BA.debugLine="If Success Then";
if (true) break;
...
//C
this.state = 7;
 //BA.debugLineNum = 404;BA.debugLine="RS.Position = 0";
_rs.setPosition((int) (0));
 //BA.debugLineNum = 405;BA.debugLine="txtBucketSize.Text = RS.GetInt(\"BucketSize\")";
parent.mostCurrent._txtbucketsize.setText(BA.ObjectToCharSequence(_rs.GetInt("BucketSize")));
 //BA.debugLineNum = 406;BA.debugLine="sUOM = RS.GetString(\"UnitOfMeasurement\")";
_suom = _rs.GetString("UnitOfMeasurement");
 //BA.debugLineNum = 407;BA.debugLine="txtTry1.Text = RS.GetString(\"Trial1\")";
parent.mostCurrent._txttry1.setText(BA.ObjectToCharSequence(_rs.GetString("Trial1")));
 //BA.debugLineNum = 408;BA.debugLine="txtTry2.Text = RS.GetString(\"Trial2\")";
parent.mostCurrent._txttry2.setText(BA.ObjectToCharSequence(_rs.GetString("Trial2")));
 //BA.debugLineNum = 409;BA.debugLine="txtTry3.Text = RS.GetString(\"Trial3\")";
parent.mostCurrent._txttry3.setText(BA.ObjectToCharSequence(_rs.GetString("Trial3")));
 //BA.debugLineNum = 410;BA.debugLine="txtWaterQuality.Text = RS.GetString(\"WaterQuali";
parent.mostCurrent._txtwaterquality.setText(BA.ObjectToCharSequence(_rs.GetString("WaterQuality")));
 //BA.debugLineNum = 411;BA.debugLine="txtRemarks.Text = RS.GetString(\"Remarks\")";
parent.mostCurrent._txtremarks.setText(BA.ObjectToCharSequence(_rs.GetString("Remarks")));
 //BA.debugLineNum = 412;BA.debugLine="cboUOM.SelectedIndex = cboUOM.IndexOf(sUOM)";
...
this.state = 10;
this.catchState = 0;
 //BA.debugLineNum = 415;BA.debugLine="snack.Initialize(\"\", Activity,$\"\"$ & LastExcepti";
parent.mostCurrent._snack.Initialize(mostCurrent.activityBA,"",(android.view.View)(parent.mostCurrent._activity.getObject()),("")+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),(int) (5000));
 //BA.debugLineNum = 416;BA.debugLine="MyFunctions.SetSnackBarTextColor(snack, Colors.W";
parent.mostCurrent._myfunctions._setsnackbartextcolor /*String*/ (mostCurrent.activityBA,parent.mostCurrent._snack,anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 417;BA.debugLine="MyFunctions.SetSnackBarBackground(snack, GlobalV";
parent.mostCurrent._myfunctions._setsnackbarbackground /*String*/ (mostCurrent.activityBA,parent.mostCurrent._snack,(int) (parent.mostCurrent._globalvar._redcolor /*double*/ ));
 //BA.debugLineNum = 418;BA.debugLine="snack.Show";
parent.mostCurrent._snack.Show();
 //BA.debugLineNum = 419;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("158327067",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
public static String  _filluom() throws Exception{
 //BA.debugLineNum = 385;BA.debugLine="Private Sub FillUOM";
 //BA.debugLineNum = 386;BA.debugLine="cboUOM.Clear";
mostCurrent._cbouom.Clear();
 //BA.debugLineNum = 387;BA.debugLine="cboUOM.Add(\"Liter (L)\")";
mostCurrent._cbouom.Add(BA.ObjectToCharSequence("Liter (L)"));
 //BA.debugLineNum = 388;BA.debugLine="cboUOM.Add(\"Milliliter (mL)\")";
mostCurrent._cbouom.Add(BA.ObjectToCharSequence("Milliliter (mL)"));
 //BA.debugLineNum = 389;BA.debugLine="cboUOM.Add(\"Gallon (gal)\")";
...
anywheresoftware.b4a.objects.CSBuilder _cs = null;
 ...
 //BA.debugLineNum = 976;BA.debugLine="Dim SaveAlert As AX_CustomAlertDialog";
_savealert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 977;BA.debugLine="SaveAlert.Initialize";
...
int _iretval = 0;
 //BA.debugLineNum = 293;BA.debugLine="Private Sub GetGPMID (sTranDate As String, iPumpID";
 //BA.debugLineNum = 294;BA.debugLine="Dim iRetval As Int";
_iretval = 0;
 //BA.debugLineNum = 295;BA.debugLine="Try";
try { //BA.debugLineNum = 296;BA.debugLine="Starter.strCriteria = \"SELECT GPMID FROM tblGPMH";
...
anywheresoftware.b4a.keywords.Common.LogImpl("157868294",mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Blue);
...
_iretval = (int)(Double.parseDouble(mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQuerySingleResult(mostCurrent._starter._strcriteria /*String*/ )));
			...
			processBA.setLastException(e7); //BA.debugLineNum = 303;BA.debugLine="ToastMessageShow($\"Unable to fetch GPM Record ID";
...
anywheresoftware.b4a.keywords.Common.LogImpl("157868299",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 //BA.debugLineNum = 305;BA.debugLine="iRetval = 0";
_iretval = (int) (0);
 };
 //BA.debugLineNum = 307;BA.debugLine="Return iRetval";
...
public static String  _gpmexist_buttonpressed(de.amberhome.materialdialogs.MaterialDialogWrapper _mdialog,String _saction) throws Exception{
 //BA.debugLineNum = 359;BA.debugLine="Private Sub GPMExist_ButtonPressed(mDialog As Mate";
 //BA.debugLineNum = 360;BA.debugLine="Select Case sAction";
switch (BA.switchObjectToInt(_saction,_mdialog.ACTION_POSITIVE,_mdialog.ACTION_NEGATIVE)) {
case 0: {
 //BA.debugLineNum = 362;BA.debugLine="GlobalVar.blnNewGPM = False";
mostCurrent._globalvar._blnnewgpm /*boolean*/  = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 363;BA.debugLine="GlobalVar.GPMId = GetGPMID(GlobalVar.TranDate,";
mostCurrent._globalvar._gpmid /*int*/  = _getgpmid(mostCurrent._globalvar._trandate /*String*/ ,mostCurrent._globalvar._pumphouseid /*int*/ );
 //BA.debugLineNum = 364;BA.debugLine="If Not(UpdateGPM(GlobalVar.GPMId, GlobalVar.Tra";
if (anywheresoftware.b4a.keywords.Common.Not(_updategpm(mostCurrent._globalvar._gpmid /*int*/ ,mostCurrent._globalvar._trandate /*String*/ ,mostCurrent._globalvar._pumphouseid /*int*/ ))) { 
if (true) return "";};
 //BA.debugLineNum = 365;BA.debugLine="ShowSaveSuccess";
_showsavesuccess();
 break; }
case 1: {
...
public static String  _initobjects() throws Exception{
 //BA.debugLineNum = 852;BA.debugLine="Private Sub InitObjects";
 //BA.debugLineNum = 853;BA.debugLine="chkManual.Checked = False";
mostCurrent._chkmanual.setChecked(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 854;BA.debugLine="txtGPM.Text = \"0\"";
mostCurrent._txtgpm.setText(BA.ObjectToCharSequence("0"));
 //BA.debugLineNum = 855;BA.debugLine="txtBucketSize.Text = \"\"";
mostCurrent._txtbucketsize.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 856;BA.debugLine="txtTry1.Text = \"\"";
mostCurrent._txttry1.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 857;BA.debugLine="txtTry2.Text = \"\"";
mostCurrent._txttry2.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 858;BA.debugLine="txtTry3.Text = \"\"";
mostCurrent._txttry3.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 859;BA.debugLine="txtWaterQuality.Text = \"\"";
mostCurrent._txtwaterquality.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 860;BA.debugLine="txtRemarks.Text = \"\"";
mostCurrent._txtremarks.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 861;BA.debugLine="txtTry1.Enabled = False";
mostCurrent._txttry1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 862;BA.debugLine="txtTry2.Enabled = False";
mostCurrent._txttry2.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 863;BA.debugLine="txtTry3.Enabled = False";
mostCurrent._txttry3.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 864;BA.debugLine="btnShowTimer1.Enabled = True";
mostCurrent._btnshowtimer1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 865;BA.debugLine="btnShowTimer2.Enabled = False";
mostCurrent._btnshowtimer2.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 866;BA.debugLine="btnShowTimer3.Enabled = False";
mostCurrent._btnshowtimer3.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 867;BA.debugLine="pnlMainTimer.Visible = False";
mostCurrent._pnlmaintimer.setVisible(anywheresoftware.b4a.keywords.Common.False);
...
boolean _blnretval = false;
 //BA.debugLineNum = 915;BA.debugLine="Private Sub IsValidEntries() As Boolean";
 //BA.debugLineNum = 916;BA.debugLine="Dim blnRetVal As Boolean";
_blnretval = false;
 //BA.debugLineNum = 918;BA.debugLine="blnRetVal = False";
_blnretval = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 920;BA.debugLine="Try";
try { //BA.debugLineNum = 921;BA.debugLine="If GlobalVar.SF.Len(GlobalVar.SF.Trim(txtBucketS";
if (mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv4(mostCurrent._txtbucketsize.getText()))<=0 || (mostCurrent._txtbucketsize.getText()).equals("")) { 
 //BA.debugLineNum = 922;BA.debugLine="RequiredMsgBox($\"E R R O R\"$, \"Bucket size cann";
_requiredmsgbox(("E R R O R"),"Bucket size cannot be blank!");
 //BA.debugLineNum = 923;BA.debugLine="txtBucketSize.RequestFocus";
mostCurrent._txtbucketsize.RequestFocus();
 //BA.debugLineNum = 924;BA.debugLine="Return False";
if (true) return anywheresoftware.b4a.keywords.Common.False;
 };
 //BA.debugLineNum = 927;BA.debugLine="If GlobalVar.SF.Len(GlobalVar.SF.Trim(txtTry1.Te";
if (mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv4(mostCurrent._txttry1.getText()))==0 || (mostCurrent._txttry1.getText()).equals("")) { 
 //BA.debugLineNum = 928;BA.debugLine="RequiredMsgBox($\"E R R O R\"$, \"First Try cannot";
_requiredmsgbox(("E R R O R"),"First Try cannot be blank!");
 //BA.debugLineNum = 929;BA.debugLine="If chkManual.Checked = True Then";
if (mostCurrent._chkmanual.getChecked()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 930;BA.debugLine="txtTry1.Enabled = True";
mostCurrent._txttry1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 931;BA.debugLine="txtTry1.RequestFocus";
mostCurrent._txttry1.RequestFocus();
 }else {
 //BA.debugLineNum = 933;BA.debugLine="txtTry1.Enabled = False";
mostCurrent._txttry1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 934;BA.debugLine="btnShowTimer1.Enabled = True";
mostCurrent._btnshowtimer1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 935;BA.debugLine="btnShowTimer1.RequestFocus";
mostCurrent._btnshowtimer1.RequestFocus();
 };
 //BA.debugLineNum = 937;BA.debugLine="Return False";
if (true) return anywheresoftware.b4a.keywords.Common.False;
 ...
 //BA.debugLineNum = 939;BA.debugLine="RequiredMsgBox($\"E R R O R\"$, \"Second Try canno";
_requiredmsgbox(("E R R O R"),"Second Try cannot be blank!");
 //BA.debugLineNum = 940;BA.debugLine="If chkManual.Checked = True Then";
if (mostCurrent._chkmanual.getChecked()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 941;BA.debugLine="txtTry2.Enabled = True";
mostCurrent._txttry2.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 942;BA.debugLine="txtTry2.RequestFocus";
mostCurrent._txttry2.RequestFocus();
 }else {
 //BA.debugLineNum = 944;BA.debugLine="txtTry2.Enabled = False";
mostCurrent._txttry2.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 945;BA.debugLine="btnShowTimer2.Enabled = True";
mostCurrent._btnshowtimer2.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 946;BA.debugLine="btnShowTimer1.RequestFocus";
mostCurrent._btnshowtimer1.RequestFocus();
 };
 //BA.debugLineNum = 948;BA.debugLine="Return False";
if (true) return anywheresoftware.b4a.keywords.Common.False;
 ...
 //BA.debugLineNum = 950;BA.debugLine="RequiredMsgBox($\"E R R O R\"$, \"Third Try cannot";
_requiredmsgbox(("E R R O R"),"Third Try cannot be blank!");
 //BA.debugLineNum = 951;BA.debugLine="If chkManual.Checked = True Then";
if (mostCurrent._chkmanual.getChecked()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 952;BA.debugLine="txtTry3.Enabled = True";
mostCurrent._txttry3.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 953;BA.debugLine="txtTry3.RequestFocus";
mostCurrent._txttry3.RequestFocus();
 }else {
 //BA.debugLineNum = 955;BA.debugLine="txtTry3.Enabled = False";
mostCurrent._txttry3.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 956;BA.debugLine="btnShowTimer3.Enabled = True";
mostCurrent._btnshowtimer3.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 957;BA.debugLine="btnShowTimer3.RequestFocus";
mostCurrent._btnshowtimer3.RequestFocus();
 };
 //BA.debugLineNum = 959;BA.debugLine="Return False";
if (true) return anywheresoftware.b4a.keywords.Common.False;
 };
 //BA.debugLineNum = 962;BA.debugLine="If GlobalVar.SF.Len(GlobalVar.SF.Trim(txtWaterQu";
if (mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv4(mostCurrent._txtwaterquality.getText()))<=0 || (mostCurrent._txtwaterquality.getText()).equals("")) { 
 //BA.debugLineNum = 963;BA.debugLine="RequiredMsgBox($\"E R R O R\"$, \"Water Quality ca";
_requiredmsgbox(("E R R O R"),"Water Quality cannot be blank!");
 //BA.debugLineNum = 964;BA.debugLine="txtWaterQuality.RequestFocus";
mostCurrent._txtwaterquality.RequestFocus();
 //BA.debugLineNum = 965;BA.debugLine="Return False";
if (true) return anywheresoftware.b4a.keywords.Common.False;
 };
 //BA.debugLineNum = 967;BA.debugLine="blnRetVal = True";
_blnretval = anywheresoftware.b4a.keywords.Common.True;
 } 
       catch (Exception e50) {
			processBA.setLastException(e50); //BA.debugLineNum = 969;BA.debugLine="blnRetVal = False";
_blnretval = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 970;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("160227639",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
 //BA.debugLineNum = 972;BA.debugLine="Return blnRetVal";
...
public static String  _pnlmaintimer_click() throws Exception{
 //BA.debugLineNum = 995;BA.debugLine="Sub pnlMainTimer_Click";
...
public static String  _requiredmsg_onpositiveclicked(anywheresoftware.b4a.objects.ConcreteViewWrapper _view,Object _dialog) throws Exception{
 //BA.debugLineNum = 911;BA.debugLine="Private Sub RequiredMsg_OnPositiveClicked (View As";
 //BA.debugLineNum = 912;BA.debugLine="Alert.Initialize.Dismiss2";
...
public static String  _requiredmsgbox(String _stitle,String _smsg) throws Exception{
 //BA.debugLineNum = 889;BA.debugLine="Private Sub RequiredMsgBox(sTitle As String, sMsg";
 //BA.debugLineNum = 890;BA.debugLine="Alert.Initialize.Create _ 			.SetDialogStyleName(";
mostCurrent._alert.Initialize().Create(mostCurrent.activityBA).SetDialogStyleName("MyDialogDisableStatus").SetStyle(mostCurrent._alert.getSTYLE_DIALOGUE()).SetCancelable(anywheresoftware.b4a.keywords.Common.False).SetTitle(_stitle).SetTitleColor((int) (mostCurrent._globalvar._redcolor /*double*/ )).SetTitleTypeface((android.graphics.Typeface)(mostCurrent._fontbold.getObject())).SetMessage(_smsg).SetPositiveText("OK").SetPositiveColor((int) (mostCurrent._globalvar._poscolor /*double*/ )).SetPositiveTypeface((android.graphics.Typeface)(mostCurrent._fontbold.getObject())).SetMessageTypeface((android.graphics.Typeface)(mostCurrent._font.getObject())).SetOnPositiveClicked(mostCurrent.activityBA,"RequiredMsg").SetOnViewBinder(mostCurrent.activityBA,"FontSizeBinder");
 //BA.debugLineNum = 905;BA.debugLine="Alert.SetDialogBackground(MyFunctions.myCD)";
mostCurrent._alert.SetDialogBackground((android.graphics.drawable.Drawable)(mostCurrent._myfunctions._mycd /*anywheresoftware.b4a.objects.drawable.ColorDrawable*/ (mostCurrent.activityBA).getObject()));
 //BA.debugLineNum = 906;BA.debugLine="Alert.Build.Show";
mostCurrent._alert.Build().Show();
...
public static anywheresoftware.b4a.agraham.bignumbers.BigDecimalWrapper  _roundbd(anywheresoftware.b4a.agraham.bignumbers.BigDecimalWrapper _bd,int _dp) throws Exception{
 //BA.debugLineNum = 528;BA.debugLine="Sub RoundBD(BD As BigDecimal, DP As Int) As BigDec";
 //BA.debugLineNum = 529;BA.debugLine="BD.Round(BD.Precision - BD.Scale + DP, BD.ROUND_H";
_bd.Round((int) (_bd.Precision()-_bd.Scale()+_dp),_bd.ROUND_HALF_UP);
 //BA.debugLineNum = 530;BA.debugLine="Return BD";
if (true) return _bd;
...
String _sdatetime = "";
long _ldate = 0L;
 //BA.debugLineNum = 229;BA.debugLine="Private Sub SaveNewGPM() As Boolean";
 //BA.debugLineNum = 230;BA.debugLine="Dim bRetVal As Boolean";
_bretval = false;
 //BA.debugLineNum = 231;BA.debugLine="Dim sDateTime As String";
_sdatetime = "";
 //BA.debugLineNum = 232;BA.debugLine="Dim lDate As Long";
_ldate = 0L;
 //BA.debugLineNum = 234;BA.debugLine="lDate = DateTime.Now";
_ldate = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 235;BA.debugLine="DateTime.DateFormat = \"yyyy-MM-dd hh:mm:ss a\"";
anywheresoftware.b4a.keywords.Common.DateTime.setDateFormat("yyyy-MM-dd hh:mm:ss a");
 //BA.debugLineNum = 236;BA.debugLine="sDateTime = DateTime.Date(lDate)";
_sdatetime = anywheresoftware.b4a.keywords.Common.DateTime.Date(_ldate);
 //BA.debugLineNum = 238;BA.debugLine="bRetVal = False";
_bretval = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 239;BA.debugLine="Starter.DBCon.BeginTransaction";
mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .BeginTransaction();
 //BA.debugLineNum = 240;BA.debugLine="Try";
try { //BA.debugLineNum = 241;BA.debugLine="Starter.DBCon.ExecNonQuery2(\"INSERT INTO tblGPMH";
mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecNonQuery2("INSERT INTO tblGPMHistory VALUES ("+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Null)+", ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",anywheresoftware.b4a.keywords.Common.ArrayToList(new Object[]{(Object)(mostCurrent._globalvar._pumphouseid /*int*/ ),(Object)(mostCurrent._globalvar._trandate /*String*/ ),(Object)(mostCurrent._txtbucketsize.getText()),(Object)(mostCurrent._cbouom.getSelectedItem()),(Object)(mostCurrent._txttry1.getText()),(Object)(mostCurrent._txttry2.getText()),(Object)(mostCurrent._txttry3.getText()),(Object)(mostCurrent._txtgpm.getText()),(Object)(mostCurrent._txtwaterquality.getText()),(Object)(mostCurrent._txtremarks.getText()),(Object)(("0")),anywheresoftware.b4a.keywords.Common.Null,anywheresoftware.b4a.keywords.Common.Null,(Object)(mostCurrent._globalvar._userid /*int*/ ),(Object)(_sdatetime),anywheresoftware.b4a.keywords.Common.Null,anywheresoftware.b4a.keywords.Common.Null}));
 //BA.debugLineNum = 243;BA.debugLine="Starter.DBCon.TransactionSuccessful";
mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .TransactionSuccessful();
 //BA.debugLineNum = 244;BA.debugLine="bRetVal = True";
_bretval = anywheresoftware.b4a.keywords.Common.True;
 } 
       catch (Exception e14) {
			processBA.setLastException(e14); //BA.debugLineNum = 246;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("157737233",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 //BA.debugLineNum = 247;BA.debugLine="bRetVal = False";
_bretval = anywheresoftware.b4a.keywords.Common.False;
 };
 //BA.debugLineNum = 249;BA.debugLine="Starter.DBCon.EndTransaction";
mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .EndTransaction();
 //BA.debugLineNum = 250;BA.debugLine="Return bRetVal";
...
public static String  _savesuccess_buttonpressed(de.amberhome.materialdialogs.MaterialDialogWrapper _mdialog,String _saction) throws Exception{
 //BA.debugLineNum = 333;BA.debugLine="Private Sub SaveSuccess_ButtonPressed(mDialog As M";
 //BA.debugLineNum = 334;BA.debugLine="Select Case sAction";
switch (BA.switchObjectToInt(_saction,_mdialog.ACTION_POSITIVE,_mdialog.ACTION_NEUTRAL)) {
case 0: {
 //BA.debugLineNum = 336;BA.debugLine="ClearDisplay";
_cleardisplay();
 break; }
case 1: {
...
public static String  _setbuttoncolors() throws Exception{
 //BA.debugLineNum = 604;BA.debugLine="Private Sub SetButtonColors()";
 //BA.debugLineNum = 606;BA.debugLine="btnShowTimer1.Background = CreateButtonColor(0xFF";
mostCurrent._btnshowtimer1.setBackground((android.graphics.drawable.Drawable)(_createbuttoncolor((int) (0xff28a745),(int) (0xff1976d2),(int) (0xff1e88e5),(int) (0xff28a745)).getObject()));
 //BA.debugLineNum = 607;BA.debugLine="btnShowTimer2.Background = CreateButtonColor(0xFF";
mostCurrent._btnshowtimer2.setBackground((android.graphics.drawable.Drawable)(_createbuttoncolor((int) (0xff28a745),(int) (0xff1976d2),(int) (0xff1e88e5),(int) (0xff28a745)).getObject()));
 //BA.debugLineNum = 608;BA.debugLine="btnShowTimer3.Background = CreateButtonColor(0xFF";
...
anywheresoftware.b4a.objects.CSBuilder _cscontent = null;
 //BA.debugLineNum = 342;BA.debugLine="Private Sub ShowGPMExist()";
 //BA.debugLineNum = 343;BA.debugLine="Dim csTitle As CSBuilder";
_cstitle = new anywheresoftware.b4a.objects.CSBuilder();
 //BA.debugLineNum = 344;BA.debugLine="Dim csContent As CSBuilder";
_cscontent = new anywheresoftware.b4a.objects.CSBuilder();
 //BA.debugLineNum = 346;BA.debugLine="csTitle.Initialize.Size(18).Bold.Color(GlobalVar.";
_cstitle.Initialize().Size((int) (18)).Bold().Color((int) (mostCurrent._globalvar._poscolor /*double*/ )).Append(BA.ObjectToCharSequence(("Confirm Save!"))).PopAll();
 //BA.debugLineNum = 347;BA.debugLine="csContent.Initialize.Size(14).Color(Colors.Black)";
_cscontent.Initialize().Size((int) (14)).Color(anywheresoftware.b4a.keywords.Common.Colors.Black).Append(BA.ObjectToCharSequence(("GPM Result is already exist for the specified Pump and Transaction Date.")+anywheresoftware.b4a.keywords.Common.CRLF+("Do you want to overwrite existing GPM result?"))).PopAll();
 //BA.debugLineNum = 348;BA.debugLine="MatDialogBuilder.Initialize(\"GPMExist\")";
mostCurrent._matdialogbuilder.Initialize(mostCurrent.activityBA,"GPMExist");
 //BA.debugLineNum = 349;BA.debugLine="MatDialogBuilder.PositiveText(\"YES\").PositiveColo";
mostCurrent._matdialogbuilder.PositiveText(BA.ObjectToCharSequence("YES")).PositiveColor((int) (mostCurrent._globalvar._bluecolor /*double*/ ));
 //BA.debugLineNum = 350;BA.debugLine="MatDialogBuilder.NegativeText(\"NO\").NegativeColor";
...
anywheresoftware.b4a.objects.CSBuilder _cstitle = null;
anywheresoftware.b4a.objects.CSBuilder _cscontent = null;
 //BA.debugLineNum = 310;BA.debugLine="Private Sub ShowSaveSuccess()";
 //BA.debugLineNum = 311;BA.debugLine="Dim csTitle As CSBuilder";
_cstitle = new anywheresoftware.b4a.objects.CSBuilder();
 //BA.debugLineNum = 312;BA.debugLine="Dim csContent As CSBuilder";
_cscontent = new anywheresoftware.b4a.objects.CSBuilder();
 //BA.debugLineNum = 314;BA.debugLine="If GlobalVar.blnNewGPM = True Then";
if (mostCurrent._globalvar._blnnewgpm /*boolean*/ ==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 315;BA.debugLine="csTitle.Initialize.Size(18).Bold.Color(GlobalVar";
_cstitle.Initialize().Size((int) (18)).Bold().Color((int) (mostCurrent._globalvar._poscolor /*double*/ )).Append(BA.ObjectToCharSequence(("S U C C E S S!"))).PopAll();
 //BA.debugLineNum = 316;BA.debugLine="csContent.Initialize.Size(14).Color(Colors.Black";
_cscontent.Initialize().Size((int) (14)).Color(anywheresoftware.b4a.keywords.Common.Colors.Black).Append(BA.ObjectToCharSequence(("New GPM Result has been successfully saved!"))).PopAll();
 ...
 //BA.debugLineNum = 318;BA.debugLine="csTitle.Initialize.Size(18).Bold.Color(GlobalVar";
_cstitle.Initialize().Size((int) (18)).Bold().Color((int) (mostCurrent._globalvar._poscolor /*double*/ )).Append(BA.ObjectToCharSequence(("S U C C E S S!"))).PopAll();
 //BA.debugLineNum = 319;BA.debugLine="csContent.Initialize.Size(14).Color(Colors.Black";
_cscontent.Initialize().Size((int) (14)).Color(anywheresoftware.b4a.keywords.Common.Colors.Black).Append(BA.ObjectToCharSequence(("GPM Result has been successfully updated!"))).PopAll();
 ...
 //BA.debugLineNum = 322;BA.debugLine="MatDialogBuilder.Initialize(\"SaveSuccess\")";
mostCurrent._matdialogbuilder.Initialize(mostCurrent.activityBA,"SaveSuccess");
 //BA.debugLineNum = 323;BA.debugLine="MatDialogBuilder.PositiveText(\"OK\").PositiveColor";
mostCurrent._matdialogbuilder.PositiveText(BA.ObjectToCharSequence("OK")).PositiveColor((int) (mostCurrent._globalvar._poscolor /*double*/ ));
 //BA.debugLineNum = 324;BA.debugLine="MatDialogBuilder.NeutralText($\"Close GPM Calculat";
mostCurrent._matdialogbuilder.NeutralText(BA.ObjectToCharSequence(("Close GPM Calculator?"))).NeutralColor((int) (mostCurrent._globalvar._neutralcolor /*double*/ ));
 //BA.debugLineNum = 325;BA.debugLine="MatDialogBuilder.Title(csTitle)";
mostCurrent._matdialogbuilder.Title(BA.ObjectToCharSequence(_cstitle.getObject()));
 //BA.debugLineNum = 326;BA.debugLine="MatDialogBuilder.Content(csContent)";
mostCurrent._matdialogbuilder.Content(BA.ObjectToCharSequence(_cscontent.getObject()));
 //BA.debugLineNum = 327;BA.debugLine="MatDialogBuilder.Theme(MatDialogBuilder.THEME_LIG";
mostCurrent._matdialogbuilder.Theme(mostCurrent._matdialogbuilder.THEME_LIGHT);
 //BA.debugLineNum = 328;BA.debugLine="MatDialogBuilder.CanceledOnTouchOutside(False)";
mostCurrent._matdialogbuilder.CanceledOnTouchOutside(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 329;BA.debugLine="MatDialogBuilder.Cancelable(False)";
mostCurrent._matdialogbuilder.Cancelable(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 330;BA.debugLine="MatDialogBuilder.Show";
mostCurrent._matdialogbuilder.Show();
 //BA.debugLineNum = 331;BA.debugLine="End Sub";
return "";
}
public static String  _showtimer() throws Exception{
 //BA.debugLineNum = 676;BA.debugLine="Sub ShowTimer";
 //BA.debugLineNum = 677;BA.debugLine="cdStart.Initialize2(GlobalVar.GreenColor2, 20, 0,";
mostCurrent._cdstart.Initialize2((int) (mostCurrent._globalvar._greencolor2 /*double*/ ),(int) (20),(int) (0),anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 678;BA.debugLine="cdPause.Initialize2(GlobalVar.YellowColor, 20, 0,";
mostCurrent._cdpause.Initialize2((int) (mostCurrent._globalvar._yellowcolor /*double*/ ),(int) (20),(int) (0),anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 679;BA.debugLine="cdStop.Initialize2(GlobalVar.RedColor, 20, 0, Col";
mostCurrent._cdstop.Initialize2((int) (mostCurrent._globalvar._redcolor /*double*/ ),(int) (20),(int) (0),anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 680;BA.debugLine="cdReset.Initialize2(GlobalVar.BlueColor, 25, 0, C";
mostCurrent._cdreset.Initialize2((int) (mostCurrent._globalvar._bluecolor /*double*/ ),(int) (25),(int) (0),anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 682;BA.debugLine="pnlMainTimer.Visible = True";
mostCurrent._pnlmaintimer.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 683;BA.debugLine="SW1.Initialize(\"\")";
mostCurrent._sw1.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 684;BA.debugLine="pnlStopWatch.AddView(SW1,1%x, 1%y, pnlStopWatch.W";
...
mostCurrent._myfunctions._setcancelbutton /*String*/ (mostCurrent.activityBA,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._btncancel.getObject())),(float) (20),(float) (20),(float) (20),(float) (20),(float) (20),(float) (20),(float) (20),(float) (20));
 //BA.debugLineNum = 698;BA.debugLine="btnStart.Enabled = True";
mostCurrent._btnstart.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 699;BA.debugLine="btnStop.Enabled = False";
mostCurrent._btnstop.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 700;BA.debugLine="btnPause.Enabled = False";
mostCurrent._btnpause.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 701;BA.debugLine="btnOk.Enabled = False";
mostCurrent._btnok.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 702;BA.debugLine="btnCancel.Enabled = True";
mostCurrent._btncancel.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 703;BA.debugLine="btnReset.Enabled = False";
mostCurrent._btnreset.setEnabled(anywheresoftware.b4a.keywords.Common.False);
...
public static String  _stoptimer_onnegativeclicked(anywheresoftware.b4a.objects.ConcreteViewWrapper _view,Object _dialog) throws Exception{
 //BA.debugLineNum = 635;BA.debugLine="Private Sub StopTimer_OnNegativeClicked (View As V";
 //BA.debugLineNum = 636;BA.debugLine="Alert.Initialize.Dismiss2";
mostCurrent._alert.Initialize().Dismiss2();
...
String _smin = "";
 //BA.debugLineNum = 640;BA.debugLine="Private Sub StopTimer_OnPositiveClicked (View As V";
 //BA.debugLineNum = 641;BA.debugLine="Dim RetVal As Double";
_retval = 0;
 //BA.debugLineNum = 642;BA.debugLine="Dim bdTime As BigDecimal";
_bdtime = new anywheresoftware.b4a.agraham.bignumbers.BigDecimalWrapper();
 //BA.debugLineNum = 643;BA.debugLine="Dim sMin As String";
_smin = "";
 //BA.debugLineNum = 645;BA.debugLine="Alert.Initialize.Dismiss2";
mostCurrent._alert.Initialize().Dismiss2();
 //BA.debugLineNum = 648;BA.debugLine="LogColor($\"Return Value is: \"$ & RetVal, Colors.Y";
anywheresoftware.b4a.keywords.Common.LogImpl("158916872",("Return Value is: ")+BA.NumberToString(_retval),anywheresoftware.b4a.keywords.Common.Colors.Yellow);
 //BA.debugLineNum = 650;BA.debugLine="bdTime.Initialize(RetVal)";
_bdtime.Initialize(BA.NumberToString(_retval));
 //BA.debugLineNum = 651;BA.debugLine="bdTime = RoundBD(bdTime,2)";
_bdtime = _roundbd(_bdtime,(int) (2));
 //BA.debugLineNum = 654;BA.debugLine="Select Case iTimer";
switch (_itimer) {
case 1: {
 //BA.debugLineNum = 656;BA.debugLine="txtTry1.Text = SW1.Text";
mostCurrent._txttry1.setText(BA.ObjectToCharSequence(mostCurrent._sw1.getText()));
 //BA.debugLineNum = 657;BA.debugLine="dTime1 =  bdTime";
_dtime1 = (double)(BA.ObjectToNumber(_bdtime));
 //BA.debugLineNum = 658;BA.debugLine="LogColor($\"1st Try: \"$ & dTime1, Colors.Magenta";
anywheresoftware.b4a.keywords.Common.LogImpl("158916882",("1st Try: ")+BA.NumberToString(_dtime1),anywheresoftware.b4a.keywords.Common.Colors.Magenta);
 //BA.debugLineNum = 659;BA.debugLine="btnShowTimer2.Enabled = True";
mostCurrent._btnshowtimer2.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 break; }
case 2: {
 //BA.debugLineNum = 661;BA.debugLine="txtTry2.Text = SW1.Text";
mostCurrent._txttry2.setText(BA.ObjectToCharSequence(mostCurrent._sw1.getText()));
 //BA.debugLineNum = 662;BA.debugLine="dTime2 =  bdTime";
_dtime2 = (double)(BA.ObjectToNumber(_bdtime));
 //BA.debugLineNum = 663;BA.debugLine="LogColor($\"2nd Try: \"$ & dTime2, Colors.Yellow)";
anywheresoftware.b4a.keywords.Common.LogImpl("158916887",("2nd Try: ")+BA.NumberToString(_dtime2),anywheresoftware.b4a.keywords.Common.Colors.Yellow);
 //BA.debugLineNum = 664;BA.debugLine="btnShowTimer3.Enabled = True";
mostCurrent._btnshowtimer3.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 break; }
case 3: {
 //BA.debugLineNum = 666;BA.debugLine="txtTry3.Text = SW1.Text";
mostCurrent._txttry3.setText(BA.ObjectToCharSequence(mostCurrent._sw1.getText()));
 //BA.debugLineNum = 667;BA.debugLine="dTime3 =  bdTime";
_dtime3 = (double)(BA.ObjectToNumber(_bdtime));
 //BA.debugLineNum = 668;BA.debugLine="LogColor($\"3rd Try: \"$ & dTime3, Colors.Cyan)";
anywheresoftware.b4a.keywords.Common.LogImpl("158916892",("3rd Try: ")+BA.NumberToString(_dtime3),anywheresoftware.b4a.keywords.Common.Colors.Cyan);
 break; }
}
;
 //BA.debugLineNum = 671;BA.debugLine="pnlMainTimer.Visible = False";
mostCurrent._pnlmaintimer.setVisible(anywheresoftware.b4a.keywords.Common.False);
...
long _milliseconds = 0L;
 //BA.debugLineNum = 570;BA.debugLine="Private Sub Timer1_Tick";
 //BA.debugLineNum = 571;BA.debugLine="Dim milliseconds As Long = DateTime.Now - StartTi";
...
public static String  _toolbar_menuitemclick(de.amberhome.objects.appcompat.ACMenuItemWrapper _item) throws Exception{
 //BA.debugLineNum = 195;BA.debugLine="Sub ToolBar_MenuItemClick (Item As ACMenuItem)'Ico";
 //BA.debugLineNum = 196;BA.debugLine="Select Case Item.Id";
switch (BA.switchObjectToInt(_item.getId(),(int) (1))) {
case 0: {
 //BA.debugLineNum = 198;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 //BA.debugLineNum = 199;BA.debugLine="StartActivity(actGPMHistory)";
...
public static String  _toolbar_navigationitemclick() throws Exception{
 //BA.debugLineNum = 190;BA.debugLine="Sub ToolBar_NavigationItemClick 'Toolbar Arroww";
 //BA.debugLineNum = 191;BA.debugLine="kBoard.HideKeyboard";
...
public static String  _txtbucketsize_enterpressed() throws Exception{
 //BA.debugLineNum = 825;BA.debugLine="Sub txtBucketSize_EnterPressed";
 //BA.debugLineNum = 826;BA.debugLine="cboUOM.RequestFocus";
...
public static String  _txtbucketsize_textchanged(String _old,String _new) throws Exception{
 //BA.debugLineNum = 817;BA.debugLine="Sub txtBucketSize_TextChanged (Old As String, New";
 //BA.debugLineNum = 818;BA.debugLine="If GlobalVar.SF.Len(txtBucketSize.Text) <= 0 Or G";
if (mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._txtbucketsize.getText())<=0 || mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._cbouom.getSelectedItem())<=0 || mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._txttry1.getText())<=0 || mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._txttry2.getText())<=0 || mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._txttry3.getText())<=0) { 
 //BA.debugLineNum = 819;BA.debugLine="txtGPM.Text = 0";
mostCurrent._txtgpm.setText(BA.ObjectToCharSequence(0));
 //BA.debugLineNum = 820;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 822;BA.debugLine="txtGPM.Text = ComputeGPM";
mostCurrent._txtgpm.setText(BA.ObjectToCharSequence(_computegpm()));
...
public static String  _txttry1_textchanged(String _old,String _new) throws Exception{
 //BA.debugLineNum = 778;BA.debugLine="Sub txtTry1_TextChanged (Old As String, New As Str";
 //BA.debugLineNum = 779;BA.debugLine="If GlobalVar.SF.Len(txtBucketSize.Text) <= 0 Or G";
if (mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._txtbucketsize.getText())<=0 || mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._cbouom.getSelectedItem())<=0 || mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._txttry1.getText())<=0 || mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._txttry2.getText())<=0 || mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._txttry3.getText())<=0) { 
 //BA.debugLineNum = 780;BA.debugLine="txtGPM.Text = 0";
mostCurrent._txtgpm.setText(BA.ObjectToCharSequence(0));
 //BA.debugLineNum = 781;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 783;BA.debugLine="txtGPM.Text = ComputeGPM";
mostCurrent._txtgpm.setText(BA.ObjectToCharSequence(_computegpm()));
...
public static String  _txttry2_textchanged(String _old,String _new) throws Exception{
 //BA.debugLineNum = 786;BA.debugLine="Sub txtTry2_TextChanged (Old As String, New As Str";
 //BA.debugLineNum = 787;BA.debugLine="If GlobalVar.SF.Len(txtBucketSize.Text) <= 0 Or G";
if (mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._txtbucketsize.getText())<=0 || mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._cbouom.getSelectedItem())<=0 || mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._txttry1.getText())<=0 || mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._txttry2.getText())<=0 || mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._txttry3.getText())<=0) { 
 //BA.debugLineNum = 788;BA.debugLine="txtGPM.Text = 0";
mostCurrent._txtgpm.setText(BA.ObjectToCharSequence(0));
 //BA.debugLineNum = 789;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 791;BA.debugLine="txtGPM.Text = ComputeGPM";
mostCurrent._txtgpm.setText(BA.ObjectToCharSequence(_computegpm()));
...
public static String  _txttry3_textchanged(String _old,String _new) throws Exception{
 //BA.debugLineNum = 794;BA.debugLine="Sub txtTry3_TextChanged (Old As String, New As Str";
 //BA.debugLineNum = 795;BA.debugLine="If GlobalVar.SF.Len(txtBucketSize.Text) <= 0 Or G";
if (mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._txtbucketsize.getText())<=0 || mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._cbouom.getSelectedItem())<=0 || mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._txttry1.getText())<=0 || mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._txttry2.getText())<=0 || mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._txttry3.getText())<=0) { 
 //BA.debugLineNum = 796;BA.debugLine="txtGPM.Text = 0";
mostCurrent._txtgpm.setText(BA.ObjectToCharSequence(0));
 //BA.debugLineNum = 797;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 799;BA.debugLine="txtGPM.Text = ComputeGPM";
mostCurrent._txtgpm.setText(BA.ObjectToCharSequence(_computegpm()));
...
String _sdatetime = "";
long _ldate = 0L;
 //BA.debugLineNum = 253;BA.debugLine="Private Sub UpdateGPM(iGPMID As Int, sTranDate As";
 //BA.debugLineNum = 254;BA.debugLine="Dim bRetVal As Boolean";
_bretval = false;
 //BA.debugLineNum = 255;BA.debugLine="Dim sDateTime As String";
_sdatetime = "";
 //BA.debugLineNum = 256;BA.debugLine="Dim lDate As Long";
_ldate = 0L;
 //BA.debugLineNum = 258;BA.debugLine="lDate = DateTime.Now";
_ldate = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 259;BA.debugLine="DateTime.DateFormat = \"yyyy-MM-dd hh:mm:ss a\"";
anywheresoftware.b4a.keywords.Common.DateTime.setDateFormat("yyyy-MM-dd hh:mm:ss a");
 //BA.debugLineNum = 260;BA.debugLine="sDateTime = DateTime.Date(lDate)";
_sdatetime = anywheresoftware.b4a.keywords.Common.DateTime.Date(_ldate);
 //BA.debugLineNum = 262;BA.debugLine="bRetVal = False";
_bretval = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 263;BA.debugLine="Starter.DBCon.BeginTransaction";
mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .BeginTransaction();
 //BA.debugLineNum = 264;BA.debugLine="Try";
try { //BA.debugLineNum = 265;BA.debugLine="Starter.strCriteria = \"UPDATE tblGPMHistory SET";
mostCurrent._starter._strcriteria /*String*/  = "UPDATE tblGPMHistory SET "+"BucketSize = ?, "+"UnitOfMeasurement = ?, "+"Trial1 = ?, "+"Trial2 = ?, "+"Trial3 = ?, "+"GPMResult = ?, "+"WaterQuality = ?, "+"Remarks = ?, "+"ModifiedBy = ?, "+"ModifiedAt = ? "+"WHERE GPMID = "+BA.NumberToString(_igpmid)+" "+"AND TranDate = '"+_strandate+"' "+"AND PumpID = "+BA.NumberToString(_ipumpid);
 //BA.debugLineNum = 280;BA.debugLine="Starter.DBCon.ExecNonQuery2(Starter.strCriteria,";
mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecNonQuery2(mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.ArrayToList(new String[]{mostCurrent._txtbucketsize.getText(),mostCurrent._cbouom.getSelectedItem(),mostCurrent._txttry1.getText(),mostCurrent._txttry2.getText(),mostCurrent._txttry3.getText(),mostCurrent._txtgpm.getText(),mostCurrent._txtwaterquality.getText(),mostCurrent._txtremarks.getText(),BA.NumberToString(mostCurrent._globalvar._userid /*int*/ ),_sdatetime}));
 //BA.debugLineNum = 282;BA.debugLine="Starter.DBCon.TransactionSuccessful";
mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .TransactionSuccessful();
 //BA.debugLineNum = 283;BA.debugLine="bRetVal = True";
_bretval = anywheresoftware.b4a.keywords.Common.True;
 } 
       catch (Exception e15) {
			processBA.setLastException(e15); //BA.debugLineNum = 285;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("157802784",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 //BA.debugLineNum = 286;BA.debugLine="bRetVal = False";
_bretval = anywheresoftware.b4a.keywords.Common.False;
 };
 //BA.debugLineNum = 288;BA.debugLine="Starter.DBCon.EndTransaction";
mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .EndTransaction();
 //BA.debugLineNum = 289;BA.debugLine="Return bRetVal";
if (true) return _bretval;
