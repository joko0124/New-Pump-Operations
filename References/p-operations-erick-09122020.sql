...
-- ----------------------------
-- Table structure for tbl_brgys
-- ----------------------------
DROP TABLE IF EXISTS `tbl_brgys`;
CREATE TABLE `tbl_brgys` (
  `id` int(11) NOT NULL,
  `city_id` int(11) DEFAULT NULL,
...
-- ----------------------------
-- Records of tbl_brgys
-- ----------------------------
INSERT INTO `tbl_brgys` VALUES ('1', '1212', 'Agapito del Rosario');
INSERT INTO `tbl_brgys` VALUES ('2', '1212', 'Anunas');
INSERT INTO `tbl_brgys` VALUES ('3', '1212', 'Balibago');
INSERT INTO `tbl_brgys` VALUES ('4', '1212', 'Capaya');
INSERT INTO `tbl_brgys` VALUES ('5', '1212', 'Claro M. Recto');
INSERT INTO `tbl_brgys` VALUES ('6', '1212', 'Cuayan');
INSERT INTO `tbl_brgys` VALUES ('7', '1212', 'Cutcut');
INSERT INTO `tbl_brgys` VALUES ('8', '1212', 'Cutud');
INSERT INTO `tbl_brgys` VALUES ('9', '1212', 'Lourdes North West');
INSERT INTO `tbl_brgys` VALUES ('10', '1212', 'Lourdes Sur (Talimundoc)');
INSERT INTO `tbl_brgys` VALUES ('11', '1212', 'Lourdes Sur East');
INSERT INTO `tbl_brgys` VALUES ('12', '1212', 'Malabanias');
INSERT INTO `tbl_brgys` VALUES ('13', '1212', 'Margot');
INSERT INTO `tbl_brgys` VALUES ('14', '1212', 'Mining');
INSERT INTO `tbl_brgys` VALUES ('15', '1212', 'Pampang');
INSERT INTO `tbl_brgys` VALUES ('16', '1212', 'Pandan');
INSERT INTO `tbl_brgys` VALUES ('17', '1212', 'Pulung Maragul');
INSERT INTO `tbl_brgys` VALUES ('18', '1212', 'Pulungbulu');
INSERT INTO `tbl_brgys` VALUES ('19', '1212', 'Pulung Cacutud');
INSERT INTO `tbl_brgys` VALUES ('20', '1212', 'Salapungan');
INSERT INTO `tbl_brgys` VALUES ('21', '1212', 'San Jose');
INSERT INTO `tbl_brgys` VALUES ('22', '1212', 'San Nicolas');
INSERT INTO `tbl_brgys` VALUES ('23', '1212', 'Santa Teresita');
INSERT INTO `tbl_brgys` VALUES ('24', '1212', 'Santa Trinidad');
INSERT INTO `tbl_brgys` VALUES ('25', '1212', 'Santo Cristo');
INSERT INTO `tbl_brgys` VALUES ('26', '1212', 'Santo Domingo');
INSERT INTO `tbl_brgys` VALUES ('27', '1212', 'Santo Rosario (Poblacion)');
INSERT INTO `tbl_brgys` VALUES ('28', '1212', 'Sapalibutad');
INSERT INTO `tbl_brgys` VALUES ('29', '1212', 'Sapangbato');
INSERT INTO `tbl_brgys` VALUES ('30', '1212', 'Tabun');
INSERT INTO `tbl_brgys` VALUES ('31', '1212', 'Virgen Delos Remedios');
INSERT INTO `tbl_brgys` VALUES ('32', '1212', 'Amsic');
INSERT INTO `tbl_brgys` VALUES ('33', '1212', 'Ninoy Aquino (Marisol)');
...
-- ----------------------------
INSERT INTO `tbl_chlorinator` VALUES ('1', 'CR-01-0001\r\n', 'Aquatex\r\n', '0121-4224-43\r\n', '10-89-00001', '10', '0', '12', '2020-09-04 14:14:43', null, null);
...
CREATE TABLE `tbl_control_panel` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cp_code` varchar(25) DEFAULT '' COMMENT 'name/description/identifier',
  `cp_type` enum('single','triple') DEFAULT NULL COMMENT 'single/triple',
  `brand_name` varchar(25) DEFAULT '',
...
-- ----------------------------
INSERT INTO `tbl_control_panel` VALUES ('1', 'CP-01-0001', 'single', 'Romatiko', '2', '220', '110', '220', '220', 'single', '220', 'single', '220', '2', '15', '240', 'single', '1', '220', 'single', '220', '220', 'triple', '220', '15', '220', '10', 'single', '15', '2', '2020-05-03', '25', '25', '30', '200', '200', '2020-05-02', '12', '2020-09-04 03:02:09', null, null);
...
-- ----------------------------
-- Table structure for tbl_electric_cons
-- ----------------------------
DROP TABLE IF EXISTS `tbl_electric_cons`;
CREATE TABLE `tbl_electric_cons` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pump_house_id` int(11) DEFAULT NULL,
  `bill_period` varchar(15) DEFAULT '',
  `bill_from` date DEFAULT NULL,
  `bill_to` date DEFAULT NULL,
  `no_of_days` int(11) DEFAULT NULL,
  `tot_prod` double(11,0) DEFAULT 0,
  `prev_rdg` int(11) DEFAULT NULL,
  `pres_rdg` int(11) DEFAULT NULL,
  `tot_kwh` double(11,0) DEFAULT 0 COMMENT 'kwh',
  `bill_amt` decimal(11,2) DEFAULT 0.00 COMMENT 'php',
  `cost_per_kwh` decimal(11,2) DEFAULT 0.00 COMMENT 'php',
  `cost_per_cum` double(11,2) DEFAULT 0.00 COMMENT 'php',
  `kwh_per_cum` double(11,2) DEFAULT 0.00 COMMENT 'kwh',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT;

-- ----------------------------
-- Records of tbl_electric_cons
-- ----------------------------
INSERT INTO `tbl_electric_cons` VALUES ('1', '1', 'April 2020', '2020-04-01', '2020-04-30', '30', '15000', null, null, '25840', '220124.00', '8.51', '0.10', '0.59');
...
-- ----------------------------
INSERT INTO `tbl_fittings` VALUES ('1', null, '1', '2', '3');
INSERT INTO `tbl_fittings` VALUES ('2', null, '2', '3', '4');
INSERT INTO `tbl_fittings` VALUES ('3', null, '3', '4', '5');
INSERT INTO `tbl_fittings` VALUES ('8', '1', '1', '2', '3');
INSERT INTO `tbl_fittings` VALUES ('9', '1', '2', '3', '4');

-- ----------------------------
-- Table structure for tbl_fittings_components
-- ----------------------------
DROP TABLE IF EXISTS `tbl_fittings_components`;
CREATE TABLE `tbl_fittings_components` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of tbl_fittings_components
-- ----------------------------
INSERT INTO `tbl_fittings_components` VALUES ('1', 'Gate Valve', null, null, null, null);
INSERT INTO `tbl_fittings_components` VALUES ('2', 'Strainer', null, null, null, null);
INSERT INTO `tbl_fittings_components` VALUES ('3', 'STC Gbault', null, null, null, null);
INSERT INTO `tbl_fittings_components` VALUES ('4', 'Check Valve', null, null, null, null);
...
CREATE TABLE `tbl_flow_meter` (
  ...
  `flow_meter_status` varchar(255) DEFAULT '0' COMMENT '0-stock/1-installed/2-deffective',
...
-- ----------------------------
INSERT INTO `tbl_flow_meter` VALUES ('1', 'FM-01-0001', 'E-jet', '1402000072', '4', 'Vortex', '1', '1', '2020-09-12', null, '1', null, null, '12', '2020-09-04 06:11:48', null, null);

-- ----------------------------
-- Table structure for tbl_flow_meter_status
-- ----------------------------
DROP TABLE IF EXISTS `tbl_flow_meter_status`;
CREATE TABLE `tbl_flow_meter_status` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `description` varchar(25) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- ----------------------------
-- Records of tbl_flow_meter_status
-- ----------------------------
...
-- ----------------------------
INSERT INTO `tbl_genset` VALUES ('1', 'GS-01-0001', 'Megabyte', '5454-13113-12', '100', '2', '0', null, '12', '2020-09-04 06:15:50', null, null);
...
CREATE TABLE `tbl_jo_details` (
  ...
  `has_water_lost` int(1) DEFAULT 0,
  PRIMARY KEY (`id`)
...
-- ----------------------------
INSERT INTO `tbl_jo_details` VALUES ('1', '2294', 'JO15-0820-0047', null, null, 'dispatched', '2020-08-16 23:25:50', null, null, '0');
INSERT INTO `tbl_jo_details` VALUES ('2', '2295', 'JO15-0820-0048', null, null, 'dispatched', '2020-08-16 23:26:15', null, null, '0');
INSERT INTO `tbl_jo_details` VALUES ('3', '2296', 'JO15-0820-0049', null, null, 'dispatched', '2020-08-16 23:26:45', null, null, '0');
INSERT INTO `tbl_jo_details` VALUES ('4', '16917', 'JO14-0820-0001', null, null, 'dispatched', '2020-08-18 00:00:00', null, null, '0');
INSERT INTO `tbl_jo_details` VALUES ('5', '16918', 'JO14-0820-0002', null, null, 'dispatched', '2020-08-18 00:00:00', null, null, '0');
INSERT INTO `tbl_jo_details` VALUES ('6', '16919', 'JO14-0820-0003', null, null, 'dispatched', '2020-08-18 00:00:00', null, null, '0');
INSERT INTO `tbl_jo_details` VALUES ('7', '10128', 'JO61-0820-0388', null, null, 'dispatched', '2020-08-28 00:00:00', null, null, '0');
INSERT INTO `tbl_jo_details` VALUES ('8', '10086', 'JO61-0820-0346', null, null, 'dispatched', '2020-08-25 00:00:00', null, null, '0');
...
-- ----------------------------
INSERT INTO `tbl_pressure_gauge` VALUES ('1', null, '9667-015-0001', 'E-Jet', 'SN012-998-1423', '30', '80', '12', '2020-09-12 08:35:30', null, null);
...
-- ----------------------------
INSERT INTO `tbl_pumps` VALUES ('1', 'PM-01-0001\r\n', '1', 'Makita', '9088113', 'M-6345109', '10', '0', '2020-09-04', '12', '2020-09-04 13:57:04', null, null);

-- ----------------------------
-- Table structure for tbl_pumps_types
-- ----------------------------
DROP TABLE IF EXISTS `tbl_pumps_types`;
CREATE TABLE `tbl_pumps_types` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of tbl_pumps_types
-- ----------------------------
INSERT INTO `tbl_pumps_types` VALUES ('1', 'Well Pump');
INSERT INTO `tbl_pumps_types` VALUES ('2', 'Bladder Pump');
...
-- ----------------------------
INSERT INTO `tbl_pump_station` VALUES ('7', null, 'PUMP-01-0001', '250', '#3 Lot 5 Blk 7, Mabalacat', 'owned', '2020-09-12 00:00:00', null, null, null, 'PUMP-01-0001', '5', '1', '1', '1', null, null, null, null, null, null, null, '1', null, '1', '1', '12', '2020-09-12 08:35:30', null, null);
...
CREATE TABLE `tbl_riser_pipe` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Unique Identifier',
  `pump_id` int(11) DEFAULT NULL COMMENT 'name/description/identifier',
...
-- ----------------------------
INSERT INTO `tbl_riser_pipe` VALUES ('3', '1', '25', '250', '15', null);
...
CREATE TABLE `tbl_sub_cable` (
  ...
  `date_installed` date DEFAULT NULL,
  `cable_size` int(11) DEFAULT NULL COMMENT 'diameter of cable in inches',
  `cable_length` int(11) DEFAULT NULL COMMENT 'length of cable in meter',
  `add_length` int(11) DEFAULT NULL COMMENT 'additional cable length in meter',
  `total_length` int(11) DEFAULT NULL COMMENT 'total cable length in meter',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `tbl_sub_cable` VALUES ('2', '1', '2020-09-12', '25', '300', null, '300');
...
-- ----------------------------
INSERT INTO `tbl_sub_motor` VALUES ('1', 'MR-01-0001\r\n', '300', 'Franklin\r\n', '0121-4224-43\r\n', '200', '220', 'triple', '110', '220', '0', '2020-09-04', '12', '2020-09-04 14:01:45', null, null);
...
-- ----------------------------
INSERT INTO `tbl_wells` VALUES ('1', 'WL-01-0001', 'Mabalacat', 'Lot 9 Block 10 Mabini St.', '2020-02-05', '25', '500', '400', '450', '300', 'Good water.', '0', '12', '2020-09-03 11:51:36', '12', '2020-09-03 11:52:12');
INSERT INTO `tbl_wells` VALUES ('2', 'WL-01-0002', 'angeles', 'Lot 5 BLcK 7', '2020-05-01', '400', '500', '300', '500', '550', 'nice quality', '0', '12', '2020-09-03 12:48:03', null, null);
INSERT INTO `tbl_wells` VALUES ('3', 'WL-01-0003', 'mabalacat', 'Lot 3 Blk 4 Rizal St.', '2020-09-03', '35', '700', '400', '500', '650', 'nice and clean', '0', '12', '2020-09-03 12:52:23', null, null);
INSERT INTO `tbl_wells` VALUES ('4', 'WL-01-0004', 'angeles', 'lot 1 blk 2 mabini st.', '2020-09-01', '25', '500', '400', '500', '500', 'good water.', '0', '12', '2020-09-03 12:54:04', null, null);
INSERT INTO `tbl_wells` VALUES ('5', 'WL-01-0005', 'Mabalacat', '#3 Lot 5 Blk 7', '2020-08-01', '25', '500', '400', '450', '450', 'Good', '0', '12', '2020-09-11 02:13:12', null, null);
...
CREATE TABLE `tran_prod_header` (
  ...
  `date_uploaded` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp() COMMENT 'Date and time of uploading',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `users` VALUES ('12', 'cbit-erick', '$2y$10$wZky0rCXMZ7u/s5AaRTIyOdxaEBszxSJhbsWTMjni8G8cupweqLJW', 'bmjt931rptZ6gjziwWHKSsrwZPG1EoL6u5hFzYF2NBYEMRb7H7BEustNzlfI', '1', null, '2019-10-24 11:32:41', null, '2020-09-10 09:24:40');
